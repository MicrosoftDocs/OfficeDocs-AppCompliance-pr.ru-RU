...
<span data-ttu-id="a87d1-107">Сведения, предоставляемые корпорацией Майкрософт в компании JiJi Technologies Private Limited:</span><span class="sxs-lookup"><span data-stu-id="a87d1-107">Information provided by JiJi Technologies Private Limited to Microsoft:</span></span>
...
### <a name="identity-information"></a><span data-ttu-id="a87d1-182">Сведения о удостоверениях</span><span class="sxs-lookup"><span data-stu-id="a87d1-182">Identity information</span></span>

<span data-ttu-id="a87d1-183">Эти сведения были предоставлены jiJi Technologies Private Limited о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.</span><span class="sxs-lookup"><span data-stu-id="a87d1-183">This information has been provided by JiJi Technologies Private Limited about how this app handles authentication, authorization, application registration best practices, and other Identity criteria.</span></span>

| <span data-ttu-id="a87d1-184">**Information**</span><span class="sxs-lookup"><span data-stu-id="a87d1-184">**Information**</span></span> | <span data-ttu-id="a87d1-185">**Отклик**</span><span class="sxs-lookup"><span data-stu-id="a87d1-185">**Response**</span></span> |
|:----------------|:-------------|
| <span data-ttu-id="a87d1-186">Интеграция с платформой Microsoft Identify Platform (Azure AD)?</span><span class="sxs-lookup"><span data-stu-id="a87d1-186">Do you integrate with Microsoft Identify Platform (Azure AD)?</span></span>  | <span data-ttu-id="a87d1-187">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-187">Yes</span></span> |
| <span data-ttu-id="a87d1-188">Рассмотрели ли вы и выполнили все применимые методы, описанные в платформа удостоверений Майкрософт списке интеграции?</span><span class="sxs-lookup"><span data-stu-id="a87d1-188">Have you reviewed and complied with all applicable best practices outlined in the Microsoft identity platform integration checklist?</span></span>  | <span data-ttu-id="a87d1-189">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-189">Yes</span></span> |
| <span data-ttu-id="a87d1-190">Использует ли ваше приложение MSAL (Microsoft Authentication Library) для проверки подлинности?</span><span class="sxs-lookup"><span data-stu-id="a87d1-190">Does your app use MSAL (Microsoft Authentication Library) for authentication?</span></span> | <span data-ttu-id="a87d1-191">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-191">Yes</span></span> |
| <span data-ttu-id="a87d1-192">Поддерживает ли ваше приложение политики условного доступа?</span><span class="sxs-lookup"><span data-stu-id="a87d1-192">Does your app support Conditional Access policies?</span></span> | <span data-ttu-id="a87d1-193">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-193">Yes</span></span> |
| <span data-ttu-id="a87d1-194">Список типов поддерживаемых политик</span><span class="sxs-lookup"><span data-stu-id="a87d1-194">List the types of policies supported</span></span> | <span data-ttu-id="a87d1-195">Требование многофакторной проверки подлинности для пользователей с административными ролями, требование многофакторной проверки подлинности для задач управления Azure, блокировка входных входов для пользователей, пытающихся использовать устаревшие протоколы проверки подлинности, требование надежных местоположений для регистрации многофакторной проверки подлинности Azure AD, блокировка или предоставление доступа из определенных местоположений, блокировка рискованного поведения при входе</span><span class="sxs-lookup"><span data-stu-id="a87d1-195">Requiring multi-factor authentication for users with administrative roles, Requiring multi-factor authentication for Azure management tasks, Blocking sign-ins for users attempting to use legacy authentication protocols, Requiring trusted locations for Azure AD Multi-Factor Authentication registration, Blocking or granting access from specific locations, Blocking risky sign-in behavior</span></span> |
| <span data-ttu-id="a87d1-196">Запрашивает ли ваше приложение наименьшие разрешения на привилегии для вашего сценария?</span><span class="sxs-lookup"><span data-stu-id="a87d1-196">Does your app request least privilege permissions for your scenario?</span></span> | <span data-ttu-id="a87d1-197">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-197">Yes</span></span> |
| <span data-ttu-id="a87d1-198">Точно ли статически зарегистрированные разрешения вашего приложения отражают разрешения, которые ваше приложение запрашивает динамически и постепенно?</span><span class="sxs-lookup"><span data-stu-id="a87d1-198">Does your app's statically registered permissions accurately reflect the permissions your app will request dynamically and incrementally?</span></span> | <span data-ttu-id="a87d1-199">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-199">Yes</span></span> |
| <span data-ttu-id="a87d1-200">Поддерживает ли ваше приложение многотенантность?</span><span class="sxs-lookup"><span data-stu-id="a87d1-200">Does your app support multi-tenancy?</span></span> | <span data-ttu-id="a87d1-201">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-201">Yes</span></span> |
| <span data-ttu-id="a87d1-202">У вашего приложения есть конфиденциальный клиент?</span><span class="sxs-lookup"><span data-stu-id="a87d1-202">Does your app have a confidential client?</span></span> | <span data-ttu-id="a87d1-203">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-203">Yes</span></span> |
| <span data-ttu-id="a87d1-204">У вас есть все идентификаторы единого ресурса перенаправления, зарегистрированные для вашего приложения?</span><span class="sxs-lookup"><span data-stu-id="a87d1-204">Do you own all of the redirect Unified Resource Identifier (URI) registered for your app?</span></span> | <span data-ttu-id="a87d1-205">Да</span><span class="sxs-lookup"><span data-stu-id="a87d1-205">Yes</span></span> |
| <span data-ttu-id="a87d1-206">Что вы не используете для вашего приложения?</span><span class="sxs-lookup"><span data-stu-id="a87d1-206">For your app, what do you avoid using?</span></span> | <span data-ttu-id="a87d1-207">- Перенаправление URL-адресов под диктовки,</span><span class="sxs-lookup"><span data-stu-id="a87d1-207">- Wildcard redirect URIs,</span></span>
<br />
