---
title: Сведения о приложении для Clausebook от LeasePilot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Все доступные сведения о безопасности и соответствии для Clausebook, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 19edef1a016c74f2db3d63c8033d05d9c65ccee4
ms.sourcegitcommit: c06f3d478e1b4f66c02e2855ffac6de2f350208a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66247397"
---
# <a name="clausebook"></a>Clausebook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 27 июня 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые LeasePilot корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Clausebook |
| Идентификатор | WA200004044 |
| Office 365 поддерживаемые клиенты | Word 2016 mac, Word в Интернете, Word 2016 или более поздней версии в Windows |
| Название партнерской компании | LeasePilot |
| Веб-сайт компании | [https://clausebook.com](https://clausebook.com) |
| Условия использования приложения | [https://clausebook.com/terms](https://clausebook.com/terms) |
| Основные функциональные возможности приложения | Clausebook — это ваш компаньон для черновиков документов! Она помогает командам собирать, упорядочивать, делиться формами и библиотеками предложений для быстрого создания черновиков и институализации методов организации. |
...
| Какие поставщики облачных служб используются приложением? | Other, Vercel |
...
Эти сведения были предоставлены LeasePilot о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
