---
title: Сведения о приложении для RetMig &amp; Kommaforslag от GrammarSoft ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для RetMig &amp; Kommaforslag, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 89d70e514a9b19888c66df0ae407abe6d21e51ab
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880456"
---
...
Сведения, предоставляемые GrammarSoft ApS корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | RetMig &amp; Kommaforslag |
| Идентификатор | WA104382003 |
| Office 365 поддерживаемые клиенты | Word 2016 mac, Word 2016 или более поздней версии Windows Word в Интернете |
| Название партнерской компании | GrammarSoft ApS |
| Веб-сайт компании | [https://retmig.dk](https://retmig.dk) |
| Условия использования приложения | [https://retmig.dk/terms](https://retmig.dk/terms) |
| Основные функциональные возможности приложения | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| Расположение компании | Дания |
| Страница сведений о приложении | [https://retmig.dk](https://retmig.dk) |
...
Эта информация была предоставлена GrammarSoft ApS о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
