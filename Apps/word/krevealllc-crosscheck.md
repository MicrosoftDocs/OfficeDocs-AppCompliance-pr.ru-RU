---
title: Сведения о приложении для CrossCheck от kRevealLLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: Все доступные сведения о безопасности и соответствии для CrossCheck, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 1c5420dc6a53f816bbd2d516c005a33404bb7c74
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881206"
---
# <a name="crosscheck"></a>Перекрестная проверка
...
Сведения, предоставляемые kRevealLLC корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Перекрестная проверка |
...
| Название партнерской компании | kRevealLLC |
| Веб-сайт компании | [https://kreveal.com](https://kreveal.com) |
| Условия использования приложения | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| Основные функциональные возможности приложения | CrossCheck упрощает проверку документов и выявляет распространенные ошибки в черновике. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
Эта информация была предоставлена kRevealLLC о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | приложение | Данные не собираются и не используются. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
