---
title: Application Information for TaxKit Docs by Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для документации TaxKit, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 9dd9c8cb8bc153571c43b92a45059c121d970108
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880856"
---
# <a name="taxkit-docs"></a>Документация по TaxKit
...
Сведения, предоставляемые Taxy.io GmbH корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Документация по TaxKit |
...
| Название партнерской компании | Taxy.io GmbH |
| Веб-сайт компании | [https://www.taxy.io](https://www.taxy.io) |
| Условия использования приложения | [https://go.microsoft.com](https://go.microsoft.com) |
| Основные функциональные возможности приложения | Документация по TaxKit помогает налоговым консультантам найти соответствующую юридическую документацию по документу и делу, над чем они работают. Это помогает им эффективнее советуем клиентам. |
...
Эта информация была предоставлена Taxy.io GmbH о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
