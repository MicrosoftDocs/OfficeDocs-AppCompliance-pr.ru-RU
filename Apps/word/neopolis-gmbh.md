---
title: Сведения о приложениях для неополиса от neopolis GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для неополиса, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002920" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые неополисом GmbH Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | neopolis |
| ID | WA200002920 |
| Office 365 поддерживаемые клиенты | Word 2016 mac, Word в Интернете, Word 2013 или более поздней Windows |
| Имя компании-партнера | neopolis GmbH |
| Веб-сайт компании | [https://neopol.is](https://neopol.is) |
| Условия использования приложения | [https://app.termly.io/document/terms-of-use-for-saas/655330...](https://app.termly.io/document/terms-of-use-for-saas/655330e8-5787-47b4-8957-90006db46c80) |
| Основные функции приложения | Professionelle Textdokumente parallel schreiben, &#252;berarbeiten und versionieren. Wir wenden das in der Softwareentwicklung etablierte Git-Prinzip auf die kollaborative Bearbeitung professioneller Textdokumente an. Unser Word Plug-in erm&#246;glicht parallele und kontrollierte Zusammenarbeit, ohne dass bestehende Prozesse oder Software umgestellt werden m&#252;ssen. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://neopol.is](https://neopol.is) |
...
Эта информация предоставлена неополисом GmbH о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
...
| URL-адрес политики конфиденциальности | https://neopol.is/gdpr/ |
