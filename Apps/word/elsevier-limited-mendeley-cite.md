...
description: Вся доступная информация о безопасности и соответствии для Mendeley Cite, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: fe22f5a9f449e60bde7694598835edc3d4602045
ms.sourcegitcommit: c06f3d478e1b4f66c02e2855ffac6de2f350208a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66249954"
---
# <a name="mendeley-cite"></a>Мэндли Сит (Mendeley),
...
Сведения, предоставляемые корпорацией Майкрософт с помощью ELSEVIER LIMITED:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Мэндли Сит (Mendeley), |
| Идентификатор | WA104382081 |
| Office 365 поддерживаемые клиенты | Word на iPad, Word 2016 или более поздней версии в Windows, Word 2016 или более поздней версии на Mac, Word в Интернете |
| Название партнерской компании | ELSEVIER LIMITED |
| Веб-сайт компании | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| Условия использования приложения | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| Основные функциональные возможности приложения | Пишите при написании. Создайте ссылки и списки литературы и измените стиль ссылок. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
Эта информация была предоставлена ELSEVIER LIMITED о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://privacy.elsevier.com |
