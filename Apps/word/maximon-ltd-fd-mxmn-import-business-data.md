---
title: Application Information for FD Mxmn — import business data by Maximon Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Вся доступная информация о безопасности и соответствии для FD Mxmn — импорт бизнес-данных, их политик обработки данных, сведений каталога приложений Microsoft Cloud App Security, а также сведений о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "65943242"
---
# <a name="fd-mxmn---import-business-data"></a>FD Mxmn — импорт бизнес-данных

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 3 мая 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004151" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт от Maximon Ltd.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | FD Mxmn — импорт бизнес-данных |
| Идентификатор | WA200004151 |
| Поддерживаемые клиенты Office 365 | Word 2016 или более поздней версии для Mac, Word в Интернете, Word 2013 или более поздней версии в Windows |
| Название партнерской компании | Maximon Ltd. |
| Веб-сайт компании | [https://www.maximon.ltd/fdmxmn/](https://www.maximon.ltd/fdmxmn/) |
| Условия использования приложения | [https://www.maximon.ltd/legal_tou.php](https://www.maximon.ltd/legal_tou.php) |
| Основные функциональные возможности приложения | Упрощение юридической подготовки путем импорта корпоративных данных непосредственно из извлечений ACRA BizFile. |
...
Эта информация была предоставлена Maximon Ltd. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://www.maximon.ltd/legal_privacy.php |
...
| Вы проверяли и соблюдали все применимые рекомендации, описанные в контрольном списке интеграции платформы удостоверений Майкрософт? | Нет |
