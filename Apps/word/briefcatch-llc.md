---
title: Сведения о приложении для BriefCatch от BriefCatch LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для BriefCatch, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт с помощью BriefCatch LLC:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | BriefCatch |
| ID | WA200003725 |
| Office 365 поддерживаемые клиенты | Word 2016 mac, Word в Интернете, Word 2013 или более поздней версии Windows |
| Название партнерской компании | BriefCatch LLC |
| Веб-сайт компании | [https://briefcatch.com](https://briefcatch.com) |
| Условия использования приложения | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| Основные функциональные возможности приложения | Юридическое редактирование экспертов на вашей стороне. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
Эта информация была предоставлена корпорацией BriefCatch LLC о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемыми приложением.
