...
| Основные функции приложения | Отправка факса из Microsoft Word Или Word Online с помощью CocoFax, без факса модема, необходимых стационарных линий. |
