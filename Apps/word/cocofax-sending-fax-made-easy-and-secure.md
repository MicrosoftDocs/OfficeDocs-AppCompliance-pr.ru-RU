...
| Основные функции приложения | Отправка факса из Microsoft Word Или Word Online с помощью CocoFax, без факса модема, стационарных линий. |
| Расположение штаб-квартиры компании | Китай |
| Страница информация о приложении | [https://cocofax.com/terms.html](https://cocofax.com/terms.html) |
