---
title: Сведения о приложениях для showmaster (помощник плагина) по cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Showmaster (помощник plugin), политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63545247"
---
# <a name="showmaster-helper-plugin"></a>Showmaster (Помощник плагина)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 8 декабря 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые вишневым программным обеспечением Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Showmaster (Помощник плагина) |
| ID | WA200003676 |
...
| Имя компании-партнера | cherryware |
...
| Основные функции приложения | Showmaster — это надстройка PowerPoint, которая создает волнующий кадр вокруг вашего разговора во время ожидания и разрывается с заголовками, обратным отсчетом, музыкой и другими. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://showmaster.app](https://showmaster.app) |
...
Эти сведения были предоставлены вишневым программным обеспечением о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
