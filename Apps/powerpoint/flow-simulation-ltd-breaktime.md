---
title: Application Information for Breaktime by Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для среды останова, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 253c11dc30532954c2d65b2c8579fb94087b8ea3
ms.sourcegitcommit: 7a7de9f48f6cf5b6acd435412477b6a59127f19a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 05/05/2022
ms.locfileid: "65229411"
---
# <a name="breaktime"></a>Время останова

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 мая 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Flow Simulation Ltd. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Время останова |
| ID | WA200001661 |
...
| Название партнерской компании | Flow Simulation Ltd. |
| Веб-сайт компании | [https://www.flosim.com](https://www.flosim.com) |
| Условия использования приложения | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| Основные функциональные возможности приложения | Быстрый способ сообщить всем, когда вы вернете, так как это время останова! |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
Эта информация предоставлена Flow Simulation Ltd. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
