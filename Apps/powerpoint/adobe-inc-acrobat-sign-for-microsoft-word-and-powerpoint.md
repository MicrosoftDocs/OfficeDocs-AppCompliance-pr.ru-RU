---
title: Сведения о приложениях для Adobe Acrobat Sign для Microsoft Word и PowerPoint Adobe Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Adobe Acrobat Sign для Microsoft Word и PowerPoint, политики обработки данных, сведения о каталоге Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64602657"
---
# <a name="adobe-acrobat-sign-for-microsoft-word-and-powerpoint"></a>Знак Adobe Acrobat для Microsoft Word и PowerPoint
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Знак Adobe Acrobat для Microsoft Word и PowerPoint |
| ID | WA104381155 |
