...
description: Все доступные сведения о безопасности и соответствия требованиям для SlideHub, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | NoMore предоставляет бизнес-PowerPoint и надстройки PowerPoint, чтобы сделать их более эффективными в PowerPoint. В рамках службы разработки NoMore преобразует черновые черновики в готовые слайды клиента всего за 8 часов. Надстройка помогает быстрее получать доступ к службе, а также позволяет пользователям получать доступ к заранее сделанным конструкциям слайдов и к конкретной библиотеке слайдов компании, а также к &#8220;инструментарию&#8221; с различными средствами повышения производительности. |
| Расположение штаб-квартиры компании | Дания |
| Страница информация о приложении | [https://nomorehours.com](https://nomorehours.com) |
