---
title: Сведения о приложении для SlideHub от nomorehours
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Все доступные сведения о безопасности и соответствии для SlideHub, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 8e5065d0990805c5c140d93ffd66f42ae2a2d192
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881066"
---
...
| Office 365 поддерживаемые клиенты | PowerPoint 2016 mac, PowerPoint в Интернете, PowerPoint 2013 или более поздней версии Windows |
| Название партнерской компании | nomorehours |
| Веб-сайт компании | [https://nomorehours.com](https://nomorehours.com) |
| Условия использования приложения | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| Основные функциональные возможности приложения | NoMore предоставляет бизнес-PowerPoint и надстройку PowerPoint надстройку, направленную на повышение их эффективности в PowerPoint. В рамках службы проектирования NoMore преобразует приблизительный черновик в готовые к работе слайды всего за 8 часов. Надстройка помогает быстрее получить доступ к службе, но также позволяет пользователям получать доступ к предварительно созданным макетам слайдов и корпоративной библиотеке слайдов, а также к &#8220;набора средств для&#8221;, который содержит различные средства повышения производительности. |
| Расположение компании | Дания |
| Страница сведений о приложении | [https://nomorehours.com](https://nomorehours.com) |
...
Эти сведения были предоставлены nomorehours о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | приложение | адрес электронной почты и имя. Сообщение электронной почты используется в качестве имени пользователя в приложении. Сбор электронной почты поможет быстрее зарегистрироваться и войти в приложение. Имя используется в случае события регистрации. | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
