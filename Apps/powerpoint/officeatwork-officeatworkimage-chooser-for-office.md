---
title: PowerPoint сведений о приложении для officeatwork | Выбор изображений для Office officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: PowerPoint корпорация Майкрософт проверяла на соответствие отраслевым стандартам и средствам контроля в отношении безопасности, соответствия требованиям и методов обработки данных. На этой странице перечислены все доступные сведения о безопасности и соответствии требованиям для officeatwork | Выбор изображений для Office.
...
ms.locfileid: "64784458"
---
# <a name="image-chooser-for-office"></a>Выбор изображений для Office
