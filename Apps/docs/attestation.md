...
**Publisher Заверение применяется к веб-приложениям (приложениям SaaS, опубликованным на коммерческой площадке в Центре партнеров) и ко всем приложениям, которые интегрируются со следующими продуктами Майкрософт:**
- Teams
- Word
- Excel
- PowerPoint 
