...
- Примеры рекомендаций по доказательствам. Доказательства могут быть предоставлены путем демонстрации подписок на списки рассылки, вручную проверки источников безопасности для вновь выпущенных уязвимостей (необходимо надлежащим образом отслеживать время действия, то есть с JIRA или Azure DevOps), инструменты, которые находят устарелое программное обеспечение (например, может быть Snyk при поиске устарели библиотеки программного обеспечения, или может быть Nessus с помощью проверки подлинности, которая идентифицирует  устарело программное обеспечение.).
