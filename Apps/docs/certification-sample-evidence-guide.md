...
1. [**Начальная отправка документов:**](https://docs.microsoft.com/en-us/microsoft-365-app-certification/docs/initialdocumentsubguide) небольшой набор документов высокого уровня, необходимых для проверки вашей оценки.
1. **Представление доказательств:** полный набор доказательств, необходимых для каждого контроля в области для оценки сертификации. Ниже приведены примеры доказательств для каждого управления.
...
![Изображение](../media/UserGuidePhotos/Control-No-1.png)
...
- Пример доказательства 1. Снимок экрана ниже взят из Центра безопасности Azure; это показывает, что расширение antimalware было развернуто в VM с именем &quot; MSPGPRODAZUR01 &quot; .

![Изображение](../media/UserGuidePhotos/Control-No-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-2-1.png)
...
- Пример доказательства. На следующем скриншоте показано обновление Microsoft Defender по крайней мере ежедневно, &#39;event 2000, Защитник Windows&#39; обновления. Показано имя хост-пользователя, показывая, что это было взято из системы в области &quot; CLARANET-SBU-WM &quot; .

![Изображение](../media/UserGuidePhotos/Control-No-3.png)
...
- Цель. Цель этого контроля состоит в том, чтобы обеспечить быстрое идентифицирование вредоносных программ, чтобы свести к минимуму влияние, которое это может иметь для среды. Если сканирование в доступе осуществляется и в сочетании с автоматической блокировкой вредоносных программ, это поможет остановить вредоносные программы, известные антивирусным программным обеспечением. В тех случаях, когда сканирование в доступе&#39;нежелательно из-за рисков ложных срабатывай, вызывающих срабатывания службы, необходимо внедрить подходящие ежедневные (или более) механизмы сканирования и оповещения, чтобы обеспечить вовремяе реагирование на вредоносные программы, чтобы минимизировать ущерб.
...
![Изображение](../media/UserGuidePhotos/Control-No-4.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-5.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-6.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-7.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-8.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-9.png)

На следующем скриншоте показана конфигурация в соответствии с вышеуказанным управлением.

![Изображение](../media/UserGuidePhotos/Control-No-9-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-9-2.png)

На этом окончательном скриншоте показан сервер &quot; DBServer1, на который был сделан снимок экрана &quot; выше.

![Изображение](../media/UserGuidePhotos/Control-No-9-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-10.png)
...
- Цель этого контроля состоит в том, чтобы убедиться в том, что этот процесс&#39;достаточно надежный, чтобы выявить новые уязвимости безопасности в среде. Это могут быть не только операционные системы; он может включать приложения, работающие в среде, и любые зависимостей кода.

- Примеры рекомендаций по доказательствам. Доказательства могут предоставляться путем демонстрации подписок на списки рассылки, вручную проверки источников безопасности для вновь выпущенных уязвимостей (необходимо надлежащим образом отслеживать с помощью периодов времени действий, то есть с JIRA или Azure DevOps), средствами, которые находят устарелое программное обеспечение (например, может быть Snyk при поиске устарели библиотеки программного обеспечения,  или может быть Nessus с помощью проверки подлинности, которые определяют устарели программное обеспечение.).
...
![Изображение](../media/UserGuidePhotos/Control-No-11.png)

![Изображение](../media/UserGuidePhotos/Control-No-11-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-13.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-14.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-15.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-15-1.png)

- Пример Доказательства 3

Следующий снимок экрана — это вывод [Trivy,](https://github.com/aquasecurity/trivy) в котором полный отчет не&#39;не перечислять неподтвердимые приложения.

![Изображение](../media/UserGuidePhotos/Control-No-15-2.png)
...
- В отчете Метрики безопасности под названием &quot; [2020 Security Metrics Guide to PCI DSS Compliance](https://info.securitymetrics.com/pci-guide-2020) говорится, что &#39;в среднем потребовалось 166 дней с того времени, когда у организации были замечены уязвимости для злоумышленника, чтобы скомпрометировать &quot; систему. После взлома злоумышленники имели доступ к конфиденциальным данным в среднем в течение 127 дней&#39; поэтому этот контроль направлен на выявление потенциальной слабости безопасности в среде в области.

- Пример рекомендаций по доказательствам: предоставление полного отчета о проверке (ы) для каждого квартала&#39;проверки уязвимости, которые были проведены в течение последних 12 месяцев. Отчеты должны четко указать целевые показатели для проверки того, что все общедоступные следы включены, и где это применимо, каждая внутренняя подсеть. Предоставление **всех** отчетов о проверке для **каждого** квартала.

- Пример доказательства. Примером может быть поставка отчетов о проверке из используемой сканирующей системы. Каждый&#39;отчеты о сканировании должны быть предоставлены для проверки. Сканирование должно включать все компоненты системы сред таким образом; каждая внутренняя подсеть и каждый общедоступный IP-адрес и URL-адрес, доступные для среды.
...
- Намерение. Неумение быстро выявлять, устранять и устранять уязвимости и неправильное определение может&#39;риск компрометации, что может привести к потенциальным утечкам данных. Правильное определение и исправление проблем рассматривается как важное значение для организации&#39;общей осанки и среды безопасности, которая в соответствии с лучшими практиками различных структур безопасности для; например, ISO 27001 и PCI DSS.
...
![Изображение](../media/UserGuidePhotos/Control-No-17.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-17-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-18.png)

![Изображение](../media/UserGuidePhotos/Control-No-18-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-18-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-19.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-20.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-21.png)
...
- Намерение. Поскольку брандмауэры являются защитным барьером между ненавязчивым трафиком и внутренними ресурсами, а также между сетями различных уровней доверия, брандмауэры должны быть надежно настроены и обеспечить, чтобы был включен только трафик, необходимый для бизнес-операций. Позволяя излишнему потоку трафика или чрезмерно допустимым потокам трафика, это может привести к недостатку защиты на границе этих различных сетевых зон. Благодаря созданию надежного процесса утверждения для всех изменений брандмауэра снижается риск введения правила, которое представляет значительный риск для среды. Verizon&#39;s [2020 Data Breach Investigation Report](https://enterprise.verizon.com/en-gb/resources/reports/dbir/) highlights that Error&#39;&quot; &quot; s, which includes misconfigurations, is the only action type that is consistently increasing year-to-year.
...
- Пример доказательства. На следующем скриншоте показано, как запрашивается и авторизуется изменение правила брандмауэра с использованием бумажного процесса. Этого можно добиться с помощью DevOps или Jira, например.

![Изображение](../media/UserGuidePhotos/Control-No-22.png)
...
- Намерение. Большинство брандмауэров обработать правила в верхней части подхода, чтобы попытаться найти соответствие правил. Если правило совпадает, действие этого правила будет применено, и вся дальнейшая обработка правил остановится. Если не найдены правила совпадения, по умолчанию трафик будет отказано. Цель этого управления состоит в том, что если брандмауэр не&#39;по умолчанию отключать трафик, если не найдено правила совпадения, то база правил должна включать правило Deny All в конце списков всех &quot; брандмауэров. &quot;  Это необходимо для того, чтобы брандмауэр не&#39;по умолчанию разрешить состояние при обработке правил, что позволяет трафику, который&#39;явно не определен.

- Примеры рекомендаций по доказательствам. Доказательства могут быть предоставлены путем настройки брандмауэра или скриншотами, на которых показаны все правила брандмауэра, показывающие правило Deny All в конце, или если брандмауэр сбрасывает трафик, который&#39;не соответствует правилу по умолчанию, затем поставляют скриншот всех правил брандмауэра и ссылку на руководство по администрированию поставщика, подчеркивающие, что по умолчанию брандмауэр отпадет весь трафик, не &quot; &quot; совпадающий.

- Пример доказательства. Ниже показан снимок экрана базы правил брандмауэра WatchGuard, который показывает, что для разрешения всего трафика не настроены никакие правила. В конце нет правила отказа, так как WatchGuard отпадет от трафика,&#39;не совпадает по умолчанию.

![Изображение](../media/UserGuidePhotos/Control-No-23.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-23-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-24.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-25.png)

На следующем скриншоте показаны свидетельства проверки брандмауэра, которая состоится в июле 2021 г.

![Изображение](../media/UserGuidePhotos/Control-No-25-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-26.png)

На приведенной ниже скриншоте показана конфигурация IP-адреса Frontend

![Изображение](../media/UserGuidePhotos/Control-No-26-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-26-2.png)

На следующем скриншоте показано, как contoso AppGW CoreRules показывает, что это для \_ \_ api.contoso.com службы.

![Изображение](../media/UserGuidePhotos/Control-No-26-3.png)
...
- Пример доказательства. В шлюзе приложений Azure конфигурация SSL-прослушиватель включена разгрузка SSL, см. в обзоре прекращения TLS и окончания TLS со страницей [docs](https://docs.microsoft.com/en-us/azure/application-gateway/ssl-overview) Microsoft Gateway application Gateway. На следующем скриншоте показан этот снимок, настроенный для шлюза приложений Contoso Production Azure.

![Изображение](../media/UserGuidePhotos/Control-No-27.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-28.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-29.png)
...
- Пример доказательства. На следующем скриншоте показана подписка Azure для&#39;среды TEST.

![Изображение](../media/UserGuidePhotos/Control-No-30.png)

На следующем скриншоте показана отдельная подписка Azure для&#39;&#39;PRODUCTION&#39; среде.

![Изображение](../media/UserGuidePhotos/Control-No-30-1.png)
...
**Примечание:** Вы можете использовать живые данные в средах разработки и тестирования, обеспечивая, чтобы разработка/тест были включены в область оценки, чтобы можно было оценить безопасность с помощью элементов Microsoft 365 сертификации.

- Пример рекомендаций по доказательствам. Доказательства могут быть предоставлены путем совместного использования скриншотов вывода одного и того же SQL запроса в производственную базу данных (отредактировать любую конфиденциальную информацию) и базу данных разработки и тестирования. Выход одной команды должен производить различные наборы данных. В тех случаях, когда хранятся файлы, просмотр содержимого папок в обеих средах также должен демонстрировать различные наборы данных.
...
![Изображение](../media/UserGuidePhotos/Control-No-32.png)

В билетах ниже покажут сведения, заданная или добавленная в билет на пути к разрешению.

![Изображение](../media/UserGuidePhotos/Control-No-32-1.png) ![Изображение](../media/UserGuidePhotos/Control-No-32-2.png)
...
![Picture ](../media/UserGuidePhotos/Control-No-32-3.png)
 ![ Picture](../media/UserGuidePhotos/Control-No-32-4.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-33.png)

В билете ниже вы можете увидеть, как изменение было подписано после завершения и показывает выполненную и закрытую работу.

![Изображение](../media/UserGuidePhotos/Control-No-33-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-33-2.png)
...
- Пример. Ниже приводится выдержка из&#39;contoso s Secure Software Development Procedure, которая демонстрирует безопасные методы разработки и кодирования.

![Изображение](../media/UserGuidePhotos/Control-No-34.png)

![Изображение](../media/UserGuidePhotos/Control-No-34-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-34-2.png)

![Изображение](../media/UserGuidePhotos/Control-No-34-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-35-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-35-2.png) На рисунке выше показано, что рассмотренный код был утвержден для реализации в живых производственных системах.

![Изображение](../media/UserGuidePhotos/Control-No-35-3.png) После того, как изменения кода были сделаны, окончательное задание отключается, как показано на изображении выше.
...
- Пример доказательства. Ниже приведено сообщение, в которое запрашиваются сотрудники группы DevOps, которые будут зачислены в OWASP Top Ten Training Annual Training

![Изображение](../media/UserGuidePhotos/Control-No-36.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-36-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-36-2.png)
...
- Намерение. Если субъект угрозы может получить доступ к базе кода&#39;программного обеспечения, он может ввести уязвимости, backdoors или вредоносный код в базу кода и, следовательно, в приложение. Уже было несколько случаев этого, и, вероятно, наиболее распространенным является атака вымогателей NotPetya, которая, как сообщается, заражена в результате взлома обновления украинского налогового программного обеспечения под названием M.E.Doc (см. в рублях [What is NotPetya).](https://www.itpro.co.uk/malware/34381/what-is-notpetya)
...
![Изображение](../media/UserGuidePhotos/Control-No-37.png)
...
- Пример доказательства: на следующем скриншоте показаны участники проекта &quot; Customers в GitLab, который является клиентской портал &quot; Contoso &quot; &quot; . Как видно на скриншоте, для ограничения доступа к проекту у пользователей есть разные &quot; &quot; роли.

![Изображение](../media/UserGuidePhotos/Control-No-38.png)

### <a name="account-management"></a>Управление учетными записями

Методы безопасного управления учетной записью важны, так как учетные записи пользователей являются основой для доступа к информационным системам, системным средам и данным. Учетные записи пользователей должны быть надлежащим образом защищены в качестве компромисса учетных данных пользователя&#39;что может обеспечить не только поддержку среды и доступ к конфиденциальным данным, но и может обеспечить административный контроль над всей средой или ключевыми системами, если учетные данные&#39;пользователей имеют административные привилегии.

**Контроль No 39:** Предоставление документации по политике, которая регулирует методы и процедуры управления учетной записью.

- Намерение. Учетные записи пользователей по-прежнему становятся объектом для субъектов угроз и часто являются источником компрометации данных. Настраивая чрезмерно разрешительные учетные записи, организации не только увеличивают пул &#39;привилегированных&#39; учетных записей, которые могут быть задейшены субъектом угроз для выполнения нарушения данных, но и могут повысить риск успешной эксплуатации уязвимости, для успешной эксплуатации которую потребуются определенные привилегии для успешного выполнения.

-  BeyondTrust каждый год создает отчет об уязвимостях Майкрософт, который анализирует уязвимости безопасности Майкрософт за предыдущий год, а также сведения о процентах этих уязвимостей, которые зависят от учетной записи пользователя с правами &quot; &quot; администратора. В недавнем блоге Новый отчет об уязвимостях Майкрософт показывает &quot; [48% &amp; ](https://www.beyondtrust.com/blog/entry/microsoft-vulnerabilities-report)г/г увеличение уязвимостей Как их можно уменьшить с помощью наименьших привилегий, 90% критических уязвимостей в Internet Explorer, 85% критических уязвимостей в Microsoft Edge и 100% критических уязвимостей в Microsoft Outlook были бы устранены путем удаления прав &quot; администратора. Чтобы обеспечить безопасное управление учетной записью, организациям необходимо обеспечить поддержку политик и процедур, которые способствуют распространению наилучшей практики безопасности, а затем для смягчения этих угроз.

- Примеры рекомендаций по доказательствам. Поставляем документированные политики и документы процедуры, которые охватывают методы управления учетной записью. По крайней мере, затронутые темы должны совпадать с элементами управления в рамках Microsoft 365 сертификации.

- Пример доказательства. На следующем скриншоте показан пример политики управления учетной записью для Contoso.

![Изображение](../media/UserGuidePhotos/Control-No-39.png)

![Изображение](../media/UserGuidePhotos/Control-No-39-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-40.png)

На следующем скриншоте показано, что учетная запись администратора отключена в компоненте системы в области &quot; КЛАРАНЕТ-SBU-WM. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-40-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-40-2.png)

На следующем скриншоте показано, что defaultAccount отключен в компоненте системы в области &quot; КЛАРАНЕТ-SBU-WM. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-40-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-41.png)

![Изображение](../media/UserGuidePhotos/Control-No-41-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-41-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-42.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-42-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-42-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-43.png)

![Изображение](../media/UserGuidePhotos/Control-No-43-1.png)

На скриншоте ниже показаны параметры блокировки учетной записи брандмауэра WatchGuard.

![Изображение](../media/UserGuidePhotos/Control-No-43-2.png)

Ниже приведен пример минимальной длины passphrase для брандмауэра WatchGaurd.

![Изображение](../media/UserGuidePhotos/Control-No-43-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-44.png)

На следующем скриншоте показано, что учетная запись администратора отключена в компоненте системы в области &quot; КЛАРАНЕТ-SBU-WM. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-44-1.png)

На следующем скриншоте показана отключенная учетная запись гостевой учетной записи в компоненте системы в области &quot; КЛАРАНЕТ-SBU-WM. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-44-2.png)

На следующем скриншоте показано, что defaultAccount отключен в компоненте системы в области &quot; КЛАРАНЕТ-SBU-WM. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-44-3.png)

**Контроль No 45:** Предоказательное доказательство того, что в среде следуют принципы наименьших привилегий.

- Намерение. Пользователям должны предоставляться только привилегии, необходимые для выполнения функции задания. Это необходимо для ограничения риска намеренного или непреднамеренного доступа к данным, которые он должен&#39;t или при выполнении вредоносного действия. Следуя этому принципу, он также уменьшает потенциальную поверхность атаки (например, привилегированные учетные записи), которые могут быть нацелены на злоумышленника с вредоносными угрозами.
...
На следующем скриншоте показано, &#39;учетная запись является конфиденциальной и соединится,&#39; параметр выбран в учетной записи службы &quot; \_ Prod SQL Service &quot; Account.

![Изображение](../media/UserGuidePhotos/Control-No-46.png)

На следующем скриншоте показано, что учетная запись &quot; \_ службы Prod SQL учетная запись службы заблокирована до SQL Server и может войти только &quot; на этот сервер.

![Изображение](../media/UserGuidePhotos/Control-No-46-1.png)

На следующем скриншоте показано, что учетная запись службы Prod SQL учетная запись службы разрешена только для &quot; \_ &quot; логотипа службы.

![Изображение](../media/UserGuidePhotos/Control-No-46-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-47.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-47-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-47-2.png)

Пример Доказательства 2. На следующих скриншотах покажите, что все пользователи Azure имеют доступ к MFA.

![Изображение](../media/UserGuidePhotos/Control-No-47-3.png)
...
- Пример доказательств. В представленных ниже доказательствах показано, как уровень шифрования RDP на веб-сервере &quot; Webserver01 настраивается с &quot; &#39;высокого уровня &quot; . Как показано в тексте справки, для этого используется мощное 128-битное шифрование (это самый высокий уровень для microsoft Windows RDP.

![Изображение](../media/UserGuidePhotos/Control-No-48.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-48-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-49-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-50.png)

Дополнительный скриншот ниже показывает, что IDPS включен во всех правилах брандмауэра WatchGuard&#39;s config.

![Изображение](../media/UserGuidePhotos/Control-No-50-1.png)
...
- Пример доказательства. Хотя этот скриншот&#39;не показывает, что подписи IDPS были обновлены в течение последних 24 часов, он показывает, что последняя версия установлена, которая была из неделю назад ( Доказательства, собранные в _18__th_ _мая_). Это в сочетании со следующим скриншотом показывает, что подписи будут работать в течение 24 часов.

![Изображение](../media/UserGuidePhotos/Control-No-51.png)

![Изображение](../media/UserGuidePhotos/Control-No-51-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-52.png)

На следующем скриншоте показано, что IDPS включен в этих правилах.

![Изображение](../media/UserGuidePhotos/Control-No-52-1.png)

На следующем скриншоте показано, как действие прокси применяется к правилу &#39;входящий бот-трафик&#39;, которое используется для &quot; &quot; \_ \_ включаемой проверки контента.

![Изображение](../media/UserGuidePhotos/Control-No-52-2.png)

На следующем скриншоте показана включена проверка контента.

![Изображение](../media/UserGuidePhotos/Control-No-52-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-53.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54-4.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-5.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-54-8.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-9.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-10.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-11.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-12.png)

![Изображение](../media/UserGuidePhotos/Control-No-54-13.png)

### <a name="security-event-logging"></a>Журнал событий безопасности

Ведение журнала событий безопасности является неотъемлемой частью&#39;программы безопасности. Адекватная ведение журнала событий безопасности в сочетании с настроенными процессами оповещения и проверки помогают организациям выявлять нарушения или попытки нарушений, которые могут быть использованы организацией для повышения стратегий безопасности и защиты. Кроме того, адекватная лесозаготовка будет иметь важное значение для возможностей реагирования на инциденты организаций, которые могут использовать другие действия, такие как возможность точно определить, какие и&#39;данные были скомпрометированы, период компрометации, предоставление подробных отчетов по анализу правительственным учреждениям и т. д.
...
![Изображение](../media/UserGuidePhotos/Control-No-55.png)
...
- Пример Доказательства 1. На следующем скриншоте показаны параметры конфигурации одного из примерных устройств &quot; VICTIM1-WINDOWS. &quot; В параметрах покажут различные параметры аудита, включенные в &#39;политики безопасности  локальных политик  аудита&#39; параметров.

![Изображение](../media/UserGuidePhotos/Control-No-56.png)

На следующем снимке экрана показано событие, в котором пользователь очистил журнал событий с одного из примерных устройств &quot; VICTIM1-WINDOWS. &quot;

![Изображение](../media/UserGuidePhotos/Control-No-56-1.png)

На этом окончательном скриншоте показано, как сообщение журнала появляется в центре решения ведения журнала.

![Изображение](../media/UserGuidePhotos/Control-No-56-2.png)

**Примечание.** Скриншоты необходимы во всех примерных  компонентах системы и **должны** быть подтверждены все события безопасности, которые описаны выше.
...
![Изображение](../media/UserGuidePhotos/Control-No-57.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-58-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-59.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-59-1.png)

Следующий URL-адрес для NXLog () показывает, что доставка журнала в режиме реального времени с помощью [https://nxlog.co/documentation/nxlog-user-guide/modes.html](https://nxlog.co/documentation/nxlog-user-guide/modes.html) следующего экстракта:

![Изображение](../media/UserGuidePhotos/Control-No-59-2.png)
...
- Пример доказательства. В soc contoso, переданном на аутсорсинг, используется AlienVault в качестве централизованного инструмента SIEM. AlienVault была выкуплена AT T в 2018 г. и теперь &amp; проходит через USM Anywhere. На следующей веб-странице () обсуждается, как USM Anywhere защищает данные от [https://cybersecurity.att.com/documentation/usm-anywhere/deployment-guide/admin/usm-anywhere-data-security.htm](https://cybersecurity.att.com/documentation/usm-anywhere/deployment-guide/admin/usm-anywhere-data-security.htm) несанкционированных фальсификаций. В следующей ссылке () подчеркивается, как продукт USM Anywhere также обеспечивает целостность [https://cybersecurity.att.com/documentation/usm-appliance/raw-logs/raw-log-management.htm](https://cybersecurity.att.com/documentation/usm-appliance/raw-logs/raw-log-management.htm) архивных журналов.
...
- Примеры рекомендаций по доказательствам. Как правило, доказательства отображаются с помощью централизованного решения ведения журнала&#39;параметры конфигурации, показывающие, как долго хранятся данные. Данные журнала событий безопасности в течение 30 дней должны быть немедленно доступны в решении, однако если данные архивироваться, это должно продемонстрировать, что 90days стоит доступны. Это может быть отображение архивных папок с датами экспортируемой информации.

- Пример Доказательства 1. На следующих скриншотах показано, что журналы 30days доступны в AlienVault.

![Изображение](../media/UserGuidePhotos/Control-No-61.png)

**Примечание.** Так как это общедоступный документ, серийный номер брандмауэра был отредактифицирован, однако мы не&#39;, чтобы поддерживать отредактируемые скриншоты, если он не содержит личные сведения.

На следующем скриншоте показано, что журналы доступны, показывая извлечение журнала, возвращаясь через 5 месяцев.

![Изображение](../media/UserGuidePhotos/Control-No-61-1.png)

**Примечание.** Так как это общедоступный документ, общедоступные IP-адреса были отредактировали, однако мы не&#39;, чтобы поддерживать отредактируемые скриншоты, если он не содержит личные сведения.
...
![Изображение](../media/UserGuidePhotos/Control-No-61-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-62.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-63.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-63-1.png)

На этом финальном снимке экрана определяется место изменения политики паролей, поэтому срок действия паролей&#39;не истекает.

![Изображение](../media/UserGuidePhotos/Control-No-63-2.png)

На следующем скриншоте показано, что билет автоматически повышается в инструменте SOC&#39;serviceNow, инициирует правило выше.

![Изображение](../media/UserGuidePhotos/Control-No-63-3.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-64.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-64-1.png)
...
![Picture ](../media/UserGuidePhotos/Control-No-65.png)
 ![ Picture](../media/UserGuidePhotos/Control-No-65-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-66.png)

На следующем скриншоте показано оповещение, полученное Дэном.
![Изображение](../media/UserGuidePhotos/Control-No-66-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-67.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-68.png)

![Изображение](../media/UserGuidePhotos/Control-No-68-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-69.png)

На этих двух скриншотах покажут протокол собрания из двух собраний по оценке рисков.

![Изображение](../media/UserGuidePhotos/Control-No-69-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-69-2.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-70.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-71.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-72.png)

**Примечание:** Вместо экрана экрана следует предоставить полную документацию по оценке рисков.

На следующем скриншоте демонстрируется план лечения риска.

![Изображение](../media/UserGuidePhotos/Control-No-72-1.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-73.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-74.png)
...
![Изображение](../media/UserGuidePhotos/Control-No-75.png)

![Изображение](../media/UserGuidePhotos/Control-No-75-1.png)

![Изображение](../media/UserGuidePhotos/Control-No-75-2.png)

**Примечание:** Полный отчет должен быть общим. Это упражнение также может быть выполнено внутренне, так как Microsoft 365 для этого не существует требования, необходимого для сторонних компаний.
...
![Изображение](../media/UserGuidePhotos/Control-No-76.png)

![Изображение](../media/UserGuidePhotos/Control-No-76-1.png)

Журнал изменений IRP показывает обновление, выполненное на задней части упражнения на столе, выполненного в июле 2021 г.

![Изображение](../media/UserGuidePhotos/Control-No-76-2.png)
...
**Контроль No 1:** Предоставление наглядного подтверждения того, что конфигурация TLS соответствует требованиям шифрования в требованиях конфигурации профилей TLS или превышает [их.](https://docs.microsoft.com/en-us/microsoft-365-app-certification/docs/certification-submission-guide#appendix-a)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1-1.png)

**Примечание.** Аналитики сертификации проверят полный выход, чтобы подтвердить, что все требования к конфигурации профилей TLS выполнены (пожалуйста, предосмотри скриншоты полного вывода сканирования). Depending_ данных __what,_ аналитики могут выполнить собственное сканирование Qualys.

- Пример Доказательства 2. На следующем скриншоте показано, что TLS 1.2 настроен на хранилище.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1-2.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1-3.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1-4.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-1-5.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-2.png)
...
- Цель: HTTP Strict Transport Security (HSTS) — это механизм безопасности, предназначенный для защиты веб-сайтов от атак человека в центре, заставляя TLS-подключения с помощью поля заголовки ответов HTTPS с именем &quot; Strict-Transport-Security &quot; .
...
- Пример доказательства. На следующем скриншоте показано, как это сделать с помощью надстройки веб-браузера &#39;http header Spy&#39; [веб-www.microsoft.com веб-сайте.](http://www.microsoft.com/)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-3.png)
...
- Примеры рекомендаций по доказательствам. Доказательства могут предоставляться с помощью скриншотов, показывающих шифрование, занятое для защиты данных M365 в базах данных и других хранилищах. Данные должны демонстрировать, что конфигурация [](https://docs.microsoft.com/en-us/microsoft-365-app-certification/docs/certification-submission-guide#appendix-b) шифрования соответствует требованиям конфигурации профилей шифрования Microsoft 365 сертификации.

- Пример. На следующем скриншоте показано, что TDE (прозрачное шифрование данных) включена в базе данных Contoso. На втором снимке экрана показана страница Microsoft doc &#39;прозрачное шифрование данных для База данных SQL, SQL управляемых экземпляров и [Azure Synapse Analytics](https://docs.microsoft.com/en-us/azure/azure-sql/database/transparent-data-encryption-tde-overview?view=sql-server-ver15&amp;tabs=azure-portal)&#39; с указанием того, что шифрование AES 256 используется для Azure TDE.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-4.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-4-1.png)

- Пример Доказательства 2. На следующем скриншоте служба хранилища Azure с шифрованием для blobs и файлов. На следующем скриншоте показана страница microsoft docs служба хранилища Azure шифрование для данных в служба хранилища Azure используется &quot; [](https://docs.microsoft.com/en-gb/azure/storage/common/storage-service-encryption) &quot; AES-256 для шифрования.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-4-2.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-4-3.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-5.png)
...
- Примеры рекомендаций по доказательствам. Доказательства должны предоставляться путем документа или экспорта из внутренней системы, например SharePoint или confluence, с подробным анализом всех потребляемых данных, всех мест хранения и уровня шифрования.

- Пример доказательства. На следующем скриншоте показан пример того, как может выглядеть документ с типами данных.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-6.png)
...
- Часто организации будут хранить данные просто потому, что&#39;приятно иметь на случай, однако, если организации&#39;не нужны данные для выполнения своей службы или бизнес-функции, то данные не должны храниться, так как это увеличивает риски организаций &quot; &quot; излишне.
...
- Пример доказательства. На приведенной ниже скриншоте показана&#39;contoso с политикой хранения данных.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-7.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-7-1.png)
...
- Пример рекомендаций по доказательствам: предоставление доказательств экрана (или с помощью screenshare), показывающих, что сохраненные данные (во всех различных расположениях данных, т.е. базах данных, файлах, архивах и т. д.) не превышают&#39;определенной политики хранения данных. Примерами могут быть снимки экрана записей баз данных с полем дат, которые ищутся в старейшем порядке записи, и/или расположения хранения файлов с указанием периодов времени хранения.

**Примечание:** Любые персональные и конфиденциальные данные клиента должны быть отредактировали на скриншоте.

- Пример доказательства. В следующих доказательствах показан SQL, показывающий содержимое таблицы баз данных, заказаное в порядке возрастания на поле &#39;DATE TRANSACTION&#39;, чтобы показать самые старые записи в базе \_ данных. Эти данные должны быть двухмесячные,&#39;не превышает определенный период хранения.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-8.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-9.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-9-1.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-9-2.png)

В окне ниже показано, как runbook был отредактирован для поиска записей и удаляет команды, не похожие на сценарий. Обратите внимание, что полный URL-адрес и имя пользователя должны быть в виду для этих снимков экрана, и&#39;isV будет обязан показать снимок экрана перед подсчетом записей удаления и снимок экрана после записи удаления. Эти скриншоты являются чисто примерами различных способов, к которым можно подойти.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-9-3.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-9-4.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-10.png)
...
- Намерение. Процесс предоставления доступа к данным и/или ключам шифрования должен включать утверждение, гарантирующее, что отдельные&#39;доступ необходим для их функции работы. Это гарантирует, что сотрудники, не имея подлинной причины для доступа,&#39;не получают ненужный доступ.
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-1.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-2.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-3.png)

На Project выше показывая, что для Sam Daily&#39;доступ к ключам шифрования. Ниже приведена неявка sam Daily&#39;утверждения запроса и лица, назначенного для работы.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-4.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-5.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-6.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-11-7.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-12.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-13.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-13-1.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-16.png)
...
- Примеры рекомендаций по доказательствам. Доказательства могут предоставляться путем создания списка всех местоположений данных и документированной процедуры поиска всех местоположений данных для поиска данных. Это включает все необходимые команды для поиска данных, то есть, если SQL расположения включены, то будут подробно описаны конкретные SQL для обеспечения правильного поиска данных.

- Пример доказательства. Следующий снимок экрана — фрагмент из процедуры&#39;sar, которая показывает, как будут найдены данные.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-17.png)

На четырех опубликованных ниже изображениях покажите, как расположения данных ISV, в которых запрашивались запросы, а затем служба хранилища исследователи, используемые для сверки до файлов или blob, которые необходимо удалить из хранилища, чтобы соответствовать запросу saRs.

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-17-1.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-17-2.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-17-4.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-17-5.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18-1.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18-2.png)
...
![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18-3.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18-4.png)

![Изображение](../media/UserGuidePhotos/Security-Domain-Control-No-18-5.png)

На вышеуказанном изображении Azure показано, как Azure была настроена для соответствия требованиям GDPR для данных, хранимых в задней среде. Политика (которая может быть настраиваемой или построена из _Azure Blueprints)_ позволяет isV обеспечить правильное хранение данных&#39;клиента и доступность их только по набору метрик и оповещений, которые должны обеспечить соответствие требованиям и будут показывать не совместимые данные или доступ пользователей на панели мониторинга диспетчера соответствия требованиям.
...
- NIST SP800-61r2: Руководство по обработке инцидентов компьютерной безопасности доступно по: (Доступ к [https://csrc.nist.gov/publications/detail/sp/800-61/rev-2/final](https://csrc.nist.gov/publications/detail/sp/800-61/rev-2/final) 24/01/21).
...
- [https://docs.microsoft.com/en-us/cloud-app-security/anomaly-detection-policy](https://docs.microsoft.com/en-us/cloud-app-security/anomaly-detection-policy)(Доступ к 16/02/21).
- [https://docs.microsoft.com/en-us/azure/azure-monitor/alerts/alerts-overview](https://docs.microsoft.com/en-us/azure/azure-monitor/alerts/alerts-overview) (Доступ к 17/02/21).
- [https://docs.microsoft.com/en-us/cloud-app-security/anomaly-detection-policy](https://docs.microsoft.com/en-us/cloud-app-security/anomaly-detection-policy) (Доступ к 22.02.21).
- [https://docs.microsoft.com/en-us/azure/security-center/security-center-managing-and-responding-alerts](https://docs.microsoft.com/en-us/azure/security-center/security-center-managing-and-responding-alerts) (Доступ к 24.02.21).
- [https://docs.microsoft.com/en-us/azure/security-center/security-center-managing-and-responding-alerts](https://docs.microsoft.com/en-us/azure/security-center/security-center-managing-and-responding-alerts) (Доступ к 24.02.21).
