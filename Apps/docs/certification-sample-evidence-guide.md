...
<a id="control-1"></a>[Элемент управления 1](#control-1). Предоставьте документацию по политике, которая управляет методиками и процедурами защиты от вирусов.
...
<a id="control-2"></a>[Элемент управления 2](#control-2). Предоставьте свидетельство того, что антивирусное программное обеспечение работает во всех примерах системных компонентов.
...
<a id="control-3"></a>[Элемент управления 3](#control-3). Предоставьте наглядное свидетельство того, что антивирусные подписи актуальны во всех средах (в течение 1 дня).
...
<a id="control-4"></a>[Элемент управления 4](#control-4). Предоставьте демонстрацию свидетельства того, что антивирусная программа настроена для проверки доступа или периодического сканирования во всех примерах системных компонентов.
...
<a id="control-5"></a>[Элемент управления 5](#control-5). Предоставьте демонстрацию свидетельства того, что антивирусная программа настроена для автоматического блокирования вредоносных программ, карантина и оповещений для всех компонентов системы с выборки.
...
<a id="control-6"></a>[Элемент управления 6](#control-6). Предоставьте демонстрацию свидетельства того, что приложения утверждены перед развертыванием.
...
<a id="control-7"></a>[Элемент управления 7](#control-7). Предоставьте наглядное свидетельство того, что полный список утвержденных приложений с бизнес-обоснованием существует и поддерживается.
...
<a id="control-8"></a>[Элемент управления 8](#control-8). Предоставьте вспомогательную документацию с подробными сведениями о том, что программное обеспечение для управления приложениями настроено для соответствия определенным механизмам управления приложениями.
...
<a id="control-9"></a>[Элемент управления No 9](#control-9). Предоставьте демонстрацию свидетельства того, что управление приложениями настроено как документированное из всех образцов системных компонентов.
...
<a id="control-10"></a>[Элемент управления No 10](#control-10). Документация по политике предоставления, которая определяет, как определяются новые уязвимости безопасности и назначается оценка риска.
...
<a id="control-11"></a>[Элемент управления No 11](#control-11). Предоставьте свидетельство обнаружения новых уязвимостей системы безопасности.
...
- Примеры рекомендаций по свидетельству. Свидетельство может быть предоставлено путем отображения подписок на списки рассылки, ручного просмотра источников безопасности на уязвимости (необходимо правильно отслеживать с помощью меток времени действий, т. е. с помощью JIRA или Azure DevOps), средства, которые находят устарелое программное обеспечение (например, может быть Snyk при поиске устарели библиотек программного обеспечения, или может быть Nessus using  проверки, прошедшие проверку подлинности, которые идентифицируют устарело программное обеспечение.)
...
<a id="control-12"></a>[Элемент управления No 12](#control-12). Предоставьте свидетельство, демонстрирующее, что всем уязвимостям назначается ранжирование риска после обнаружения.
...
<a id="control-13"></a>[Элемент управления No 13](#control-13). Предоставьте документацию по политике для исправления системных компонентов в области, которая включает подходящий минимальный интервал исправлений для критических, высокой и средней уязвимостей риска; и вывод из эксплуатации любых неподдерживаемых операционных систем и программного обеспечения.
...
<a id="control-14"></a>[Элемент управления No 14](#control-14). Предоставьте наглядное свидетельство того, что все образцы системных компонентов исправляются.
...
<a id="control-15"></a>[Элемент управления No 15](#control-15). Предоставьте наглядное свидетельство того, что все неподдерживаемые операционные системы и программные компоненты не используются в среде.
...
<a id="control-16"></a>[Элемент управления No 16](#control-16). Предоставление отчетов о ежеквартальной проверке уязвимостей инфраструктуры и веб-приложений. Сканирование должно выполняться для всего общедоступного места (IP-адресов и URL-адресов) и внутренних диапазонов IP-адресов.
...
<a id="control-17"></a>[Элемент управления No 17](#control-17). Предоставьте демонстрационное свидетельство того, что исправление уязвимостей, обнаруженных во время сканирования уязвимостей, исправлено в рамках задокументированного периода исправления.
...
<a id="control-18"></a>[Элемент управления No 18](#control-18). Предоставьте документацию по политике, которая управляет методиками и процедурами управления брандмауэром.
...
<a id="control-19"></a>[Элемент управления No 19](#control-19). Предоставьте подтверждение того, что все учетные данные администратора по умолчанию изменяются перед установкой в рабочие среды.
...
<a id="control-20"></a>Элемент [управления 20](#control-20). Предоставьте надежное свидетельство того, что брандмауэры устанавливаются на границе среды в области и устанавливаются между сетью периметра (сетью периметра, демилитаризованной зоной и экранируемой подсетью) и внутренними доверенными сетями.
...
<a id="control-21"></a>[Элемент управления 21](#control-21). Предоставьте подтверждение того, что весь открытый доступ завершается в демилитаризованной зоне (DMZ).
...
<a id="control-21"></a>[Элемент управления 22](#control-22). Предоставьте свидетельство того, что весь трафик, разрешенный через брандмауэр, проходит процесс утверждения.
...
- Пример рекомендаций по свидетельству. Свидетельство может быть в форме документации, в которой показан авторизованный запрос на изменение брандмауэра, который может быть в минутах от собрания CAB (Изменение Помощник Board) или системой управления изменениями, отслеживая все изменения.
...
<a id="control-23"></a>[Элемент управления 23](#control-23). Предоставьте свидетельство того, что база правил брандмауэра настроена для удаления трафика, не определенного явным образом.
...
<a id="control-24"></a>[Элемент управления 24](#control-24). Предоставьте свидетельство того, что брандмауэр поддерживает только надежное шифрование во всех административных интерфейсах, не включаемых в консоль.
...
<a id="control-25"></a>[Элемент управления 25](#control-25). Предоставьте демонстрацию свидетельства того, что вы выполняете проверки правил брандмауэра по крайней мере каждые 6 месяцев.
...
<a id="control-27"></a>[Элемент управления 27](#control-27). Предоставьте свидетельство того, что WAF поддерживает разгрузку SSL.
...
<a id="control-28"></a>[Элемент управления 28](#control-28): "Предоставьте демонстрацию свидетельства того, что WAF защищает от некоторых или всех следующих классов уязвимостей в соответствии с основным набором правил OWASP (3.0 или 3.1):
...
<a id="control-29"></a>[Элемент управления 29](#control-29). Предоставьте документацию по политике, которая управляет процессами управления изменениями.
...
<a id="control-30"></a>[Элемент управления 30](#control-30). Предоставьте наглядное свидетельство того, что среды разработки и тестирования обеспечивают разделение обязанностей с рабочей средой.
...
<a id="control-31"></a>[Элемент управления 31](#control-31). Предоставьте наглядное свидетельство того, что конфиденциальные рабочие данные не используются в средах разработки или тестирования.
...
- Пример рекомендаций по свидетельству. Свидетельство можно предоставлять, используя снимки экрана выходных данных того же SQL-запроса к рабочей базе данных (отладка любой конфиденциальной информации) и базе данных разработки и тестирования. Выходные данные тех же команд должны создавать разные наборы данных. Там, где хранятся файлы, при просмотре содержимого папок в обеих средах также должны отображаться различные наборы данных.
...
<a id="control-32"></a>[Элемент управления 32](#control-32). Предоставление демонстрации свидетельства того, что задокументированные запросы на изменение содержат влияние изменений, сведения о процедурах резервного копирования и тестировании, которые необходимо выполнить.
...
<a id="control-33"></a>[Элемент управления 33](#control-33). Предоставьте демонстрацию свидетельства того, что запросы на изменение проходят процесс авторизации и выхода.
...
<a id="control-35"></a>[Элемент управления 35](#control-35). Предоставьте демонстрацию свидетельства того, что изменения кода проходят проверку и авторизацию вторым рецензентом.
...
<a id="control-36"></a>[Элемент управления 36](#control-36). Предоставьте наглядное свидетельство того, что разработчики ежегодно проходят обучение безопасной разработке программного обеспечения.
...
<a id="control-37"></a>[Элемент управления 37](#control-37). Предоставьте демонстрацию свидетельства того, что репозитории кода защищены с помощью многофакторной проверки подлинности (MFA).
...
<a id="control-38"></a>[Элемент управления 38](#control-38). Предоставьте демонстрацию свидетельства того, что для защиты репозиториев кода используются элементы управления доступом.
...
<a id="control-39"></a>[Элемент управления 39](#control-39). Предоставьте документацию по политике, которая управляет методиками и процедурами управления учетными записями.
...
<a id="control-40"></a>[Элемент управления 40](#control-40). Предоставьте наглядное свидетельство того, что учетные данные по умолчанию либо отключены, удалены, либо изменены в компонентах системы с выборки.
...
<a id="control-41"></a>[Элемент управления 41](#control-41). Предоставьте демонстрационное свидетельство того, что создание, изменение и удаление учетной записи проходит через установленный процесс утверждения.
...
<a id="control-42"></a>[Элемент управления 42](#control-42). Предоставьте демонстрацию свидетельства того, что выполняется процесс отключения или удаления учетных записей, не используемых в течение 3 месяцев.
...
<a id="control-43"></a>[Элемент управления 43](#control-43). Предоставьте демонстрацию свидетельства того, что применяется политика надежных паролей или другие подходящие меры для защиты учетных данных пользователя.  Ниже приведены минимальные рекомендации.
...
<a id="control-44"></a>[Элемент управления 44](#control-44). Предоставьте наглядное свидетельство того, что уникальные учетные записи пользователей выданы всем пользователям.
...
<a id="control-45"></a>[Элемент управления 45](#control-45). Предоставьте наглядное свидетельство того, что в среде применяются принципы минимальных привилегий.
...
<a id="control-46"></a>[Элемент управления 46](#control-46). Предоставьте демонстрацию свидетельства того, что процесс выполняется для защиты или защиты учетных записей служб и за ним следует процесс.
...
![ Снимок экрана: в учетной записи службы "учетная запись является конфиденциальной и подключение делегировано" выбран параметр "_Prod учетной записи службы SQL".](../media/UserGuidePhotos/Control-No-46.png)

На следующем снимке экрана показано&quot;\_, что учетная запись службы Prod SQL Service Account&quot; заблокирована в SQL Server и может войти только на этот сервер.

![Снимок экрана: учетная запись службы "_Prod учетной записи службы SQL" заблокирована в SQL Server и может войти только на этот сервер.](../media/UserGuidePhotos/Control-No-46-1.png)

На следующем снимке экрана показано &quot;\_, что учетная запись службы Prod SQL Service Account&quot; разрешена только для входа в качестве службы.

![Снимок экрана: учетная запись службы "_Prod учетной записи службы SQL" может выполнять вход только в качестве службы.](../media/UserGuidePhotos/Control-No-46-2.png)

<a id="control-47"></a>[Элемент управления 47](#control-47). Предоставьте демонстрацию свидетельства того, что многофакторная проверка подлинности настроена для всех подключений удаленного доступа и всех неконсолейных административных интерфейсов.
...
<a id="control-48"></a>[Элемент управления 48](#control-48). Предоставьте наглядное свидетельство о том, что надежное шифрование настроено для всех подключений удаленного доступа и всех неконсолейных административных интерфейсов, включая доступ к репозиториям кода и интерфейсам управления облаком.
...
<a id="control-49"></a>[Элемент управления 49](#control-49). Предоставьте демонстрацию свидетельства того, что MFA используется для защиты портала администрирования, который используется для управления всеми записями службы DNS и управления ими.
...
<a id="control-50"></a>[Элемент управления 50](#control-50). Предоставьте демонстрационное свидетельство того, что системы обнаружения и предотвращения вторжений (IDPS) развернуты на периметре сред в области действия.
...
<a id="control-51"></a>[Элемент управления 51](#control-51). Предоставьте наглядное свидетельство того, что подписи IDPS хранятся в текущем виде (в течение 24 часов).
...
<a id="control-52"></a>[Элемент управления 52](#control-52). Предоставьте демонстрацию свидетельства того, что IDPS настроен для поддержки проверки TLS всего входящего веб-трафика.
...
<a id="control-53"></a>[Элемент управления 53](#control-53). Предоставьте демонстрацию свидетельства того, что IDPS настроен для мониторинга всех потоков входящего трафика.
...
<a id="control-54"></a>[Элемент управления 54](#control-54). Предоставьте демонстрацию свидетельства того, что IDPS настроен для мониторинга всех потоков исходящего трафика.
...
<a id="control-55"></a>[Элемент управления 55](#control-55). Предоставьте документацию по политикам для рекомендаций и процедур, параметров ведения журнала событий безопасности.
...
<a id="control-56"></a>[Элемент управления 56](#control-56). Предоставьте демонстрацию свидетельства, показывающая, что ведение журнала событий безопасности настроено во всех примерах системных компонентов для регистрации следующих событий:
...
<a id="control-57"></a>[Элемент управления 57](#control-57). Предоставьте демонстрацию свидетельства того, что зарегистрированные события безопасности содержат следующие минимальные сведения:
- User
- Тип события
- дата и время;
...
<a id="control-58"></a>[Элемент управления 58](#control-58). Предоставьте наглядное свидетельство того, что все образцы системных компонентов синхронизируются по времени с одинаковыми первичными и вторичными серверами.
...
<a id="control-59"></a>[Элемент управления 59](#control-59). Предоставьте демонстрацию свидетельства, когда используются общедоступные системы, которые отправляют журналы событий безопасности в централизованное решение для ведения журналов, которое не находится в сети периметра.
...
<a id="control-60"></a>[Элемент управления 60](#control-60). Предоставьте свидетельство с возможностью проверки подлинности, чтобы показать, что централизованное решение для ведения журнала защищено от несанкционированного незаконного изменения данных журнала.
...
<a id="control-61"></a>[Элемент управления 61](#control-61). Предоставьте свидетельство того, что немедленно доступно не менее 30 дней данных журнала событий безопасности, а журналы событий безопасности сохраняются в течение 90 дней.
...
<a id="control-62"></a>[Элемент управления 62](#control-62). Предоставьте документацию по политике, которая управляет методиками и процедурами проверки журналов.
...
<a id="control-63"></a>[Элемент управления 63](#control-63). Предоставьте доказывающее, что журналы ежедневно проверяются человеком или автоматизированным инструментарием для выявления потенциальных событий безопасности.
...
- Пример рекомендаций по свидетельству. Свидетельство обычно предоставляется на снимке экрана или на снимке экрана, демонстрируя, что выполняются проверки журналов. Это может быть форма, которая выполняется каждый день, или с помощью JIRA или DevOps запроса с соответствующими комментариями, которые показывают, что это выполняется ежедневно. Например, еженедельный запрос JIRA журналов может создаваться ежедневной проверкой журнала W/C 26 июня 2021&quot; г. каждый день кто-то &quot;публикует результаты ежедневной проверки журнала. Если помечены какие-либо аномалии, это можно задокументировать в этом же запросе, чтобы продемонстрировать следующий элемент управления в одном JIRA.
...
<a id="control-64"></a>[Элемент управления 64](#control-64). Предоставьте доказывающее, что потенциальные события безопасности и аномалии исследуются и устраняются.
...
- Пример рекомендаций по свидетельству. Свидетельство должно быть предоставлено с помощью снимка экрана, на котором показано, что отслеживаются аномалии, обнаруженные в ходе ежедневной проверки журнала. Как уже говориллось выше, это может быть JIRA с пометки аномалии, а затем с подробными сведениями о действиях, выполненных после этого. Это может предложить JIRA запрос на отслеживание всех выполняемых действий или просто задокументировать его в ежедневном запросе на проверку журнала. Если требуется действие по реагированию на инциденты, оно должно быть задокументировано как часть процесса реагирования на инциденты, и для демонстрации этого должны быть предоставлены свидетельства.
...
<a id="control-65"></a>[Элемент управления 65](#control-65). Предоставьте документацию по политике, которая управляет рекомендациями и процедурами оповещений о событиях безопасности.
...
<a id="control-66"></a>[Элемент управления 66](#control-66). Предоставьте свидетельство того, что оповещения активируются для немедленного рассмотрения следующих типов событий безопасности:
- Создание или изменение привилегированной учетной записи
...
- Пример рекомендаций по свидетельству. Свидетельство должно быть предоставлено с помощью снимков экрана конфигурации оповещений **и** свидетельства полученных оповещений. На снимках экрана конфигурации должна отображаться логика, которая активирует оповещения, и способ отправки оповещений. Оповещения можно отправлять через SMS, электронной почты, Teams каналов, каналов Slack и т. д.
...
<a id="control-67"></a>[Элемент управления 67](#control-67). Предоставьте свидетельство, показывающее, что сотрудники всегда доступны в течение всего дня и каждый день для реагирования на оповещения системы безопасности.
...
<a id="control-68"></a>[Элемент управления 68](#control-68). Предоставьте демонстрацию свидетельства того, что установлен формальный процесс управления рисками информационной безопасности.
...
<a id="control-69"></a>[Элемент управления 69](#control-69). Предоставьте доказывающее, что формальная оценка рисков выполняется как минимум ежегодно.
...
<a id="control-70"></a>[Элемент управления 70](#control-70). Предоставьте доказывающее, что оценка рисков информационной безопасности включает в себя угрозы, уязвимости или эквивалент.
...
<a id="control-71"></a>[Элемент управления 71](#control-71). Предоставьте доказывающее, что оценка рисков информационной безопасности включает в себя влияние, матрицу риска вероятности или эквивалент.
...
<a id="control-72"></a>[Элемент управления 72](#control-72). Предоставьте доказывающее, что оценка рисков информационной безопасности включает план регистрации и обработки рисков.
...
<a id="control-73"></a>[Элемент управления 73](#control-73). Укажите план реагирования на инциденты безопасности (IRP).
...
<a id="control-74"></a>Элемент [управления 74](#control-74). Предоставьте доказывающее, что IRP безопасности включает задокументированный процесс обмена данными, чтобы обеспечить получение уведомлений ключевым заинтересованным лицам, таким как торговые марки и заказчики платежей, нормативные органы, надзорные органы, директоры и клиенты.
...
<a id="control-75"></a>[Элемент управления 75](#control-75). Предоставьте свидетельство того, что все участники группы реагирования на инциденты завершили ежегодное обучение или упражнение по таблице.
...
<a id="control-76"></a>[Элемент управления 76](#control-76). Предоставьте свидетельство с возможностью проверки подлинности, чтобы показать, что IRP безопасности обновляется на основе полученных уроков или организационных изменений.
...
<a id="control-1b"></a>[Элемент управления 1](#control-1b). Предоставьте демонстрацию свидетельства того, что конфигурация TLS соответствует требованиям к шифрованию или превышает их требования к конфигурации профиля [TLS](../docs/certification-submission-guide.md#appendix-a).
...
<a id="control-2b"></a>[Элемент управления 2](#control-2b). Предоставьте демонстрационное свидетельство того, что сжатие TLS отключено во всех общедоступных службах, обрабатывающих веб-запросы.
...
<a id="control-3b"></a>[Элемент управления 3](#control-3b). Предоставьте демонстрацию подтверждения того, что протокол TLS http strict transport security включен и настроен на >= 15552000 на всех сайтах.
...
<a id="control-4b"></a>Элемент [управления 4](#control-4b). Предоставьте демонстрацию свидетельства того, что неактивные данные шифруются в виде встроенных требований к профилю шифрования с помощью алгоритмов шифрования, таких как AES,Как, TDES и 128-разрядный и 256-разрядный ключи шифрования.
...
<a id="control-5b"></a>[Элемент управления 5](#control-5b). Предоставьте демонстрационное свидетельство того, что хэш-функция или проверка подлинности сообщений (HMAC-SHA1) используется только для защиты неактивных данных с помощью требований к профилю шифрования.
...
<a id="control-6b"></a>[Элемент управления 6](#control-6b). Укажите инвентаризацию всех хранимых данных, включая расположение хранилища и шифрование, используемую для защиты данных.
...
<a id="control-7b"></a>[Элемент управления 7](#control-7b). Предоставление демонстрации свидетельства того, что утвержденный и задокументированный период хранения данных официально установлен.
...
<a id="control-8b"></a>[Элемент управления 8](#control-8b). Предоставьте демонстрацию свидетельства того, что сохраненные данные соответствуют определенному периоду хранения.
...
- Пример свидетельства. В следующем свидетельстве показан SQL-запрос, показывающий содержимое таблицы базы данных, упорядоченное по возрастанию в поле &#39;DATETRANSACTION\_&#39;, чтобы отобразить самые старые записи в базе данных. Это должны быть данные за два месяца,&#39;не превышает определенный период хранения.
...
<a id="control-9b"></a>[Элемент управления 9](#control-9b). Предоставьте демонстрацию свидетельства того, что процессы выполняются для безопасного удаления данных по истечении срока хранения.
...
<a id="control-10b"></a>[Контроль 10](#control-10b):P список всех лиц с доступом к данным или ключам шифрования, включая бизнес-обоснование.
...
<a id="control-11b"></a>[Элемент управления 11](#control-11b). Предоставьте демонстрационное свидетельство того, что выборка лиц, имеющих доступ к данным или ключам шифрования, была официально утверждена, с подробными сведениями о привилегиях, необходимых для их работы.
...
<a id="control-12b"></a>[Элемент управления 12](#control-12b). Предоставьте демонстрацию свидетельства того, что выборки лиц, имеющих доступ к данным или ключам шифрования, имеют только привилегии, включенные в утверждение.
...
<a id="control-13"></a>[Элемент управления 13](#control-13b). Укажите список всех сторонних поставщиков, которым предоставлен общий доступ к данным клиента.
...
<a id="control-14b"></a>[Элемент управления 14](#control-14b). Предоставьте демонстрационное свидетельство того, что все сторонние стороны, использующие данные клиента, имеют соглашения об общем доступе.
...
<a id="control-15b"></a>[Элемент управления 15](#control-15b). Предоставьте документированный процесс запроса на доступ субъекта (SAR) и предоставьте свидетельство, демонстрирующее, что субъекты данных могут создавать запросы saR.
...
<a id="control-16b"></a>[Элемент управления 16](#control-16b). Предоставьте демонстрацию свидетельства того, что вы можете определить все расположения данных субъектов данных при реагировании на САР.
...
- Примеры рекомендаций по свидетельству. Свидетельство может быть предоставлено путем получения списка всех расположений данных и задокументированного процесса поиска данных во всех расположениях данных. К ним относятся все необходимые команды для поиска данных, то есть если включены расположения SQL, то для правильного поиска данных будут подробно описаны конкретные инструкции SQL.
...
<a id="control-17b"></a>[Элемент управления 17](#control-17b). Укажите ссылку на уведомление о конфиденциальности, которое должно содержать все необходимые элементы следующим образом:
