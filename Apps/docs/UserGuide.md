...
|---|----|
|PC [(Центр партнеров)](https://partner.microsoft.com/)|Портал для всех партнеров Майкрософт. Партнер входит в Центр партнеров и Self-Assessment вопросник. [Центр партнеров](https://partner.microsoft.com/dashboard/home) по Microsoft 365 соответствия требованиям к приложениям|
...
-   Обновление и повторное Publisher аттестации ![ и повторное повторное тестирование](../media/UserGuidePhotos/09.png)
