...
> [!IMPORTANT]
> В настоящее Microsoft 365 сертификация ограничена:
...
1.  Просмотрите документацию Publisher проверки, чтобы убедиться, что она по-прежнему является точной в текущей среде.
2.  Просмотрите руководство Microsoft 365 сертификации, чтобы убедиться, что вы можете выполнить все элементы управления перед началом работы.
3.  Нажмите кнопку "Начало сертификации" в центре партнеров и отправьте первичок отправки документов. Ответы здесь помогут определить область оценки.
4.  Вам будет предоставлен полный список элементов управления, для которых вам потребуется предоставить доказательства для оценки.
5.  Отправьте доказательства, которые показывают, что все элементы Microsoft 365 сертификации были выполнены в 60-дневном окне.
6.  Часто проверяйте отправку, чтобы узнать, есть ли у вас какие-либо комментарии или невыполненые запросы, которые требуют вашего внимания. После утверждения доказательств для каждого управления вам будет вручается Microsoft 365 сертификации. 
