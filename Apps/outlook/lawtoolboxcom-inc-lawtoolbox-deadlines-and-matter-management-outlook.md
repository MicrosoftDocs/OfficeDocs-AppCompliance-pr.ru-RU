...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | приложение | Это разрешение используется для того, чтобы обычный пользователь не ограничивался и мог настроить более 250 групп | [2fa142be-31b5-4fda-bd37-591541b501aa](../azure/2fa142be-31b5-4fda-bd37-591541b501aa) |
>| User.ReadWrite.All | приложение | Это разрешение используется для чтения сведений, связанных с пользователем из каталога, и для того, чтобы разрешить конечным пользователям с доступом к порталу администрирования LawToolBox добавлять людей в группы, в которые они не являются членами. | [2fa142be-31b5-4fda-bd37-591541b501aa](../azure/2fa142be-31b5-4fda-bd37-591541b501aa) |
>| Calendars.ReadWrite | делегирована | Это разрешение позволяет пользователям получать собственные сведения о календаре.  Только конечный пользователь может использовать приложение для получения собственных данных календаря (те же сведения, которые он мог получить, открыв Outlook календаря) | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Contacts.ReadWrite | делегирована | Это разрешение используется для того, чтобы разрешить пользователю Microsoft 365 Outlook контакты и добавлять в систему управления контактами &#8211; никогда автоматически не добавляются контакты | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Contacts.ReadWrite.Shared | делегирована | Это разрешение используется для того, чтобы разрешить пользователю искать общие контакты M365 и добавлять в качестве контакта в нашу систему управления контактами, &#8211; контакты никогда не добавляются автоматически. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Files.ReadWrite | делегирована | LawToolBox считывает и записывает файлы из Teams, групп и OneDrive для собраний (если конечный пользователь отзывает это разрешение, это не позволит LTB создавать папки и файлы из шаблонов и перечислять файлы материи в наших приложениях) | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Group.ReadWrite.All | делегирована | Это разрешение необходимо для чтения API Teams, создания Teams, создания событий календаря, создания каналов, и это необходимо для нашей функции обмена внешними файлами одним щелчком мыши.  НЕОБХОДИМО УПРАВЛЯТЬ ГРУППАМИ. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Mail.Read | делегирована | Это разрешение используется для чтения писем PACER в надстройке Outlook для автоматического открытия этого значения, а также для чтения контактов из электронных писем.  Если конечный пользователь отменит это разрешение, он не сможет добавлять контакты электронной почты из электронных писем в почтовый ящик в нашу контактную систему. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Mail.Send | делегирована | Это разрешение используется для отправки сообщений электронной почты в качестве пользователя , например, пользователь может самостоятельно отправлять от себя диаграмму дедлайна. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| MailboxSettings.ReadWrite | делегирована | Это разрешение используется для штампа электронной почты с меткой, указывающей, что оно было сохранено в папке Group с помощью приложения | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| Notes.ReadWrite.All | делегирована | Это разрешение позволяет пользователям сохранять выбранные данные ( например, заметки о случае, графики крайних сроков или контакты по материи) в OneNote, связанных с этим вопросом. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| OnlineMeetings.ReadWrite | делегирована | Это разрешение используется для оптимизации создания и управления собраниями и для того, чтобы предложить участникам использовать роли участников | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| People.Read | делегирована | Это разрешение используется для того, чтобы разрешить пользователю использовать Microsoft AI для поиска общих контактов M365 и добавления в систему управления контактами LawToolBox и предложить пользователям добавлять в систему управления контактами приложения &#8211; мы не добавляем никаких контактов автоматически. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| User.Read | делегирована | Это разрешение требуется для чтения основных данных пользователя (например, имени, электронной почты, часового пояса), чтобы администратор может добавить точных пользователей в систему | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| email | делегирована | Это разрешение позволяет приложению читать сообщения электронной почты, чтобы позволить конечному пользователю собирать контактные данные электронной почты из электронных писем в их почтовом ящике, это разрешение также позволяет приложению читать сообщения электронной почты с данными PACER, чтобы приложение по умолчанию открывало соответствующий случай с помощью номера дока PACER. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
>| profile | делегирована | Это необходимо для проверки подлинности SSO (LawToolBox не просит разрешения на написание в вашем профиле) ЭТО РАЗРЕШЕНИЕ ТРЕБУЕТСЯ ДЛЯ ПОЛЬЗОВАТЕЛЕЙ, ЧТОБЫ ВОЙТИ В ПРИЛОЖЕНИЯ LAWTOOLBOX С ПОМОЩЬЮ ЕДИНОго ЗНАКА НА АВТОРИЗАЦИИ. | [6be25d92-7c0e-4b2f-829e-108766e095df](../azure/6be25d92-7c0e-4b2f-829e-108766e095df) |
