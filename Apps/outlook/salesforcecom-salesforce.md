...
description: Все доступные сведения о безопасности и соответствия требованиям для Salesforce, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Позволяет вам испытать Salesforce прямо в Outlook. Интеграция — это 100% облако на основе без программного обеспечения для нажима, установки или обслуживания. Просмотр всех контактов, лид, учетных записей, возможностей и случаев, связанных с электронной почтой и встречами без переключения между Salesforce и Outlook; данные Salesforce появляются непосредственно в Outlook. Создайте новые записи Salesforce, в том числе пользовательские записи объектов, непосредственно в Outlook. Добавление электронных писем и встреч в записи Salesforce одним щелчком мыши, даже при сочинении |
...
Эти сведения предоставлены salesforce.com о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
