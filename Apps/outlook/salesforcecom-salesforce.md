...
description: Вся доступная информация о безопасности и соответствии для Salesforce, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f847cbdb363a348778981cc48b3c8a68a8a2483a
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881456"
---
...
| Название партнерской компании | salesforce.com |
| Веб-сайт компании | [https://www.salesforce.com](https://www.salesforce.com) |
| Условия использования приложения | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| Основные функциональные возможности приложения | Позволяет использовать Salesforce прямо в Outlook. Интеграция на 100 % основана на облаке без программного обеспечения для отправки, установки или обслуживания. Просмотр всех контактов, потенциальных клиентов, учетных записей, возможностей и случаев, связанных с электронной почтой и встречами, без переключения между Salesforce и Outlook; данные Salesforce отображаются непосредственно в Outlook. Создайте новые записи Salesforce, включая пользовательские объекты, непосредственно в Outlook. Добавление сообщений электронной почты и встреч в записи Salesforce одним щелчком мыши даже при создании |
...
Эти сведения были предоставлены salesforce.com о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
