...
| Основные функции приложения | Позволяет вам испытать Salesforce прямо в Outlook. Интеграция — это 100% облако на основе без программного обеспечения для нажима, установки или обслуживания. Просмотр всех контактов, лид, учетных записей, возможностей и случаев, связанных с электронной почтой и встречами без переключения между Salesforce и Outlook; данные Salesforce появляются непосредственно в Outlook. Создайте новые записи Salesforce, в том числе пользовательские объектные записи, непосредственно в Outlook. Добавление электронных писем и встреч в записи Salesforce одним щелчком мыши, даже при сочинении |
