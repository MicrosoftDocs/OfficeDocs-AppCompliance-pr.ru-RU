...
description: Все доступные сведения о безопасности и соответствии для CI-Signature, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f40603ce1e2993314a4be7093741faed6ad5cbf2
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64875516"
---
...
| Основные функциональные возможности приложения | Добавьте видимые подписи в Outlook и OWA, созданные на сервере на стороне CI-Sign, а также предварительный просмотр, если подписи добавляются на стороне сервера CI-Disclaimer в соответствии с корпоративными требованиями к удостоверениям и юридически обязательным требованиям.  |
| Расположение компании | Германия |
| Страница сведений о приложении | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
