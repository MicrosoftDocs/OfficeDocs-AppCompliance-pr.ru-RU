...
ms.openlocfilehash: d27b884bb1f00621168de74a91a05706489bde5f
ms.sourcegitcommit: e61daaadc2921e59735e8952fe81e5a416b55fbf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/28/2022
ms.locfileid: "62251385"
---
...
| Основные функции приложения | Добавьте видимые подписи в Outlook и OWA, созданные на сервере рядом с CI-Sign, а также предварительный просмотр, если подписи добавляются на стороне сервера CI-Disclaimer для удовлетворения корпоративных требований удостоверений и юридически необходимых требований.  |
