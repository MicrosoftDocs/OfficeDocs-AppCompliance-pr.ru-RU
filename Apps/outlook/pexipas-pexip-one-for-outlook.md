---
title: Сведения о приложении Pexip One для Outlook PexipAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Все доступные сведения о безопасности и соответствии для Pexip One для Outlook, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые PexipAS корпорации Майкрософт:
...
| Название партнерской компании | PexipAS |
...
| Основные функциональные возможности приложения | Pexip One позволяет пользователям легко создавать безопасные собрания, используя существующие рабочие процессы организации собраний. Pexip one предоставляет возможности демонстрации экрана, голосовой связи и видеочата. |
...
Эти сведения были предоставлены PexipAS о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Делегированные | Данные о событиях для пользователей используются для планирования собраний на платформе и отслеживания изменений метаданных собраний | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
