---
title: Сведения о приложении Evernote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Вся доступная информация о безопасности и соответствии для Evernote, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64784008"
---
# <a name="evernote-application-information"></a>Сведения о приложении Evernote
...
Сведения, предоставляемые Evernote корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Evernote |
| ID | WA104379617 |
| Office 365 поддерживаемые клиенты | Outlook 2013 или более поздней версии на Windows, Outlook 2016 или более поздней версии на Mac, Outlook в iOS, Outlook на Android, Outlook в Интернете |
| Название партнерской компании | Evernote |
| Веб-сайт компании | [https://evernote.com](https://evernote.com) |
| Условия использования приложения | [https://evernote.com/legal/terms-of-service](https://evernote.com/legal/terms-of-service) |
| Основные функциональные возможности приложения | Примейте папку "Входящие". Сохранение важного сообщения электронной почты в Evernote  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://evernote.com/about-us](https://evernote.com/about-us) |
...
Эта информация была предоставлена Evernote о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
