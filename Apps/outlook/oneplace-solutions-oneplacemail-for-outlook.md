...
description: Все доступные сведения о безопасности и соответствии требованиям для OnePlaceMail для Outlook, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | OnePlaceMail позволяет сохранять электронную почту и вложения для SharePoint, OneDrive и Teams. Он также позволяет использовать контент из SharePoint, OneDrive и Teams при записи электронной почты. |
| Расположение штаб-квартиры компании | Австралия |
| Страница информация о приложении | [https://www.oneplacesolutions.com/oneplacemail-sharepoint-a...](https://www.oneplacesolutions.com/oneplacemail-sharepoint-app-for-outlook.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | делегирована | Требуется определить, Teams текущий пользователь является членом. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Mail.ReadWrite.Shared | делегирована | Требуется получить доступ к свойствам почты для SharePoint столбцов и добавить в SharePoint категорию в элементе почты | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| MailboxSettings.ReadWrite | делегирована | Данные, собранные или используемые, используются для добавления категории в список категорий в почтовом ящике пользователей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Sites.ReadWrite.All | делегирована | Необходимо установить свойства для элементов, загруженных приложением в SharePoint. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.Read | делегирована | Необходимые для проверки подлинности в microsoft Graph. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | делегирована | Требуется показать изображение профиля пользователя в поле выборщика людей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | делегирована | Требуется показать изображение профиля пользователя в поле выборщика людей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadWrite.All | делегирована | Необходимо определить, включена ли Teams служба в пользователях, Office 365 аренды. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
