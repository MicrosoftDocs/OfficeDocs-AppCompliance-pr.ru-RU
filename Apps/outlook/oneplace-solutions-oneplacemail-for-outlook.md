---
title: Сведения о приложении для OnePlaceMail для Outlook onePlace Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Все доступные сведения о безопасности и соответствии для OnePlaceMail для Outlook, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые решениями OnePlace для корпорации Майкрософт:
...
| Название партнерской компании | Решения OnePlace |
| Веб-сайт компании | [https://www.oneplacesolutions.com](https://www.oneplacesolutions.com) |
| Условия использования приложения | [https://www.oneplacesolutions.com/eula.html](https://www.oneplacesolutions.com/eula.html) |
| Основные функциональные возможности приложения | OnePlaceMail позволяет сохранять сообщения электронной почты и вложения в SharePoint, OneDrive и Teams. Он также позволяет использовать содержимое SharePoint, OneDrive и Teams при создании электронной почты. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://www.oneplacesolutions.com/oneplacemail-sharepoint-a...](https://www.oneplacesolutions.com/oneplacemail-sharepoint-app-for-outlook.html) |
...
Эти сведения предоставлены решениями OnePlace о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | Делегированные | Требуется для определения Teams текущий пользователь является членом. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Mail.ReadWrite.Shared | Делегированные | Требуется для доступа к свойствам почты для SharePoint столбцов и добавления категории "Передано SharePoint в почтовом элементе | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| MailboxSettings.ReadWrite | Делегированные | Данные не собираются и не используются. Они используются для добавления категории в список главных категорий в почтовом ящике пользователей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Sites.ReadWrite.All | Делегированные | Требуется для задания свойств элементов, отправленных приложением в SharePoint. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.Read | Делегированные | Требуется для проверки подлинности в microsoft Graph. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | Делегированные | Требуется для отображения изображения профиля пользователя в поле выбора людей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | Делегированные | Требуется для отображения изображения профиля пользователя в поле выбора людей. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadWrite.All | Делегированные | Требуется, чтобы определить, включена ли Teams в пределах пользователей, Office 365 клиента. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
