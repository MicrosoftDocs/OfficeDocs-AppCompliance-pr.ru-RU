---
title: Сведения о приложениях для Mailbutler по Mailbutler
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Mailbutler, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63540927"
---
# <a name="mailbutler"></a>Mailbutler

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 ноября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Mailbutler Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Mailbutler |
| ID | WA200001031 |
| Office 365 поддерживаемые клиенты | Outlook 2016 или более поздней Windows, Outlook 2016 или более поздней Outlook в Интернете |
| Имя компании-партнера | Mailbutler |
| Веб-сайт компании | [https://www.mailbutler.io](https://www.mailbutler.io) |
| Условия использования приложения | [https://www.mailbutler.io/terms-and-conditions](https://www.mailbutler.io/terms-and-conditions) |
| Основные функции приложения | Mailbutler — это плагин электронной почты, который предоставляет все необходимое для максимального повышения производительности и сохраняемой записи электронной почты. Mailbutler предлагает множество полезных функций, повышающих производительность, к которым можно получить доступ прямо в почтовом ящике. Его функции помогают улучшить взаимодействие с клиентами, оставаться на фирме, оптимизировать игру электронной почты и многое другое. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
Эта информация была предоставлена Mailbutler о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | ID-адреса электронной почты, метаданные электронной почты (Subject, Sender/Recipients, если клиент авторизирует), контактные данные (если импортируется пользователями) |
...
| URL-адрес политики конфиденциальности | https://www.mailbutler.io/privacy-policy-mailbutler/ |
