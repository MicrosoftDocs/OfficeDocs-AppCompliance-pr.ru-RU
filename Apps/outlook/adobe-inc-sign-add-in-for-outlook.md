...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Adobe Sign Add-In for Outlook |
| ID | WA104381158 |
| Поддерживаемые клиенты Office 365 | Outlook 2013 или более поздний для Windows, Outlook 2016 или более поздний на Mac, Outlook в Интернете |
...
>У нас нет взаимодействия администратора клиента в нашей системе для приложения Microsoft Outlook.
