---
title: Сведения о приложении achievers для Outlook от Achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Achievers для Outlook, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "67048399"
---
# <a name="achievers-for-outlook"></a>Achievers for Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 28 октября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381896" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Achievers for Outlook |
| ID | WA104381896 |
| Office 365 поддерживаемые клиенты | Outlook 2016 или более поздней версии в Windows, Outlook 2016 или более поздней версии на Mac, Outlook в Интернете |
...
| Какие данные хранятся в базах данных? | Идентификатор клиента, идентификатор пользователя, электронная почта пользователя |
