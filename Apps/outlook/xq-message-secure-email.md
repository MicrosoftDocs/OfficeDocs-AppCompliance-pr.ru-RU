---
title: Сведения о приложении для защищенной электронной почты XQ по сообщению XQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для XQ Secure Email, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: c76a902c2a85874aec8a397f50a730f4785d4766
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876606"
---
# <a name="xq-secure-email"></a>Защищенная электронная почта XQ
...
Сведения, предоставляемые сообщением XQ корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Защищенная электронная почта XQ |
| Идентификатор | WA20000090 |
...
| Название партнерской компании | Сообщение XQ |
| Веб-сайт компании | [https://xqmsg.co](https://xqmsg.co) |
| Условия использования приложения | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| Основные функциональные возможности приложения | Защитите все сообщения, &#8212; от сообщений электронной почты к файлам. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://xqmsg.co/about](https://xqmsg.co/about) |
...
Эта информация была предоставлена сообщением XQ о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
