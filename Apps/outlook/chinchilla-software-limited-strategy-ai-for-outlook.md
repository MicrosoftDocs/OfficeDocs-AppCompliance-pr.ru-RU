---
title: Сведения о приложениях для Strategy-AI для Outlook программного обеспечения Chinchilla Limited
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Strategy-AI для Outlook, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 34324aa7c379a3135bb3e3a5d74900fb75306f74
...
---
# <a name="strategy-ai-for-outlook"></a>Strategy-AI для Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 1 декабря 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003576" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт по программному обеспечению Chinchilla Software Limited:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Strategy-AI для Outlook |
| Идентификатор | WA200003576 |
...
| Имя компании-партнера | Шиншилла Software Limited |
| Веб-сайт компании | [https://www.strategy-ai.com](https://www.strategy-ai.com) |
| Условия использования приложения | [https://www.strategy-ai.com/terms](https://www.strategy-ai.com/terms) |
| Основные функции приложения | Обеспечение последовательной, межбюсной атрибуции данных на разных платформах |
...
Эта информация предоставлена программным обеспечением Шиншилла Лимитед о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| URL-адрес политики конфиденциальности | https://www.strategy-ai.com/privacy |
