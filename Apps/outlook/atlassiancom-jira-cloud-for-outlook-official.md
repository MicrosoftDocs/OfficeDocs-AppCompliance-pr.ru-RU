...
description: Все доступные сведения о безопасности и соответствии для Jira Cloud for Outlook (Official), политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 204bf4de2959ed1e8376f3b7e5f6e7f29dd6188e
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881506"
---
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Jira Cloud for Outlook (official) |
...
| Название партнерской компании | Atlassian.com |
...
| Основные функциональные возможности приложения | Планирование, отслеживание и выпуск программного обеспечения. Управление поддержкой, обслуживанием клиентов и проектами. |
...
Эти сведения были предоставлены Atlassian.com о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные электронной почты пользователя обрабатываются как часть функции приложений для отображения ссылок Jira. |
