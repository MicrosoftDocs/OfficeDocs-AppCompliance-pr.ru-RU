---
title: Сведения о приложении для Dynamo by Dynamo Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Вся доступная информация о безопасности и соответствии для Dynamo, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: a58c38aab0af5647c5b0c3c00709d9490cc2bdc1
ms.sourcegitcommit: 0c3ca169e16a6825888669d1e8ea14f66db725bf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 05/11/2022
ms.locfileid: "65312293"
---
# <a name="dynamo"></a>Динамо

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 9 мая 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые программным обеспечением Dynamo Software корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Динамо |
| ID | WA200004007 |
...
| Название партнерской компании | Dynamo Software |
| Веб-сайт компании | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| Условия использования приложения | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| Основные функциональные возможности приложения | Надстройка&#8217;Office Для Outlook — это вспомогательная программа, которая позволяет существующим пользователям Dynamo работать с Приложением Для Outlook для Windows и Outlook в Интернете (Office 365 и Outlook.com). Вы можете отправлять черновики слиянием, добавлять встречи и действия вместе с их вложениями в Dynamo, а также создавать новые элементы типа Contact, Company, Deal и Fund, не открывая Dynamo.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
Эта информация была предоставлена Программным обеспечением Dynamo Software о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет контролировать данные, собираемые приложением.
...
| Дата последней сертификации SOC1 | 2020-06-30 |
...
| Дата последней сертификации SOC2 | 2020-09-30 |
...
| URL-адрес политики конфиденциальности | https://www.dynamosoftware.com/privacy-policy/ |
