---
title: Сведения о приложениях для открепительных данных в GmbH решений BrainCore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
Сведения, предоставляемые GmbH решений BrainCore в Корпорацию Майкрософт:
...
| Имя компании-партнера | GmbH решений BrainCore |
...
Эта информация предоставлена GmbH решений BrainCore о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
