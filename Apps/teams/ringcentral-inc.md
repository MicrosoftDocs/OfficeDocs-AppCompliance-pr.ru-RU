...
description: Все доступные сведения о безопасности и соответствии требованиям для RingCentral, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Начните и присоединяйтесь к видео- или аудиозазвониям RingCentral с быстрыми командами ботов и функциями обмена сообщениями. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.ringcentral.com/apps/ringcentral-for-microsoft-...](https://www.ringcentral.com/apps/ringcentral-for-microsoft-teams) |
...
| Самая недавняя дата сертификации SOC2 |  2020-05-11 |
| Соответствует ли приложение средствам управления службами (SOC 3)? | Да |
| Самая недавняя дата сертификации SOC3 |  2020-05-11 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована |  Позволяет приложению отправлять приглашения на собрания через календарь | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | делегирована |  Позволяет приложению получать и обновлять маркер oauth | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | делегирована |  Позволяет приложению читать базовый профиль&#8217;пользователя (электронная почта, имя), чтобы связаться в конце. И позволяет пользователю войти и связать свою учетную запись O365 с учетной записью RingCentral | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | делегирована | Позволяет приложению считывать полный профиль пользователя с номерами телефонов, чтобы сделать телефонные звонки с помощью наших служб. | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
