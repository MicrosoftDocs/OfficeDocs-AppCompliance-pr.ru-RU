---
title: Сведения о приложении для Miro от Miro
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/22/2021
...
description: Вся доступная информация о безопасности и соответствии для Miro, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8216e453-3db5-48ee-a3d6-5122f505c8a3" target="_blank">Просмотр в Teams хранилище</a>
...
| Идентификатор | WA104381906 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Miro |
...
| Основные функциональные возможности приложения | Платформа доски для совместной работы в Интернете |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://miro.com/about/](https://miro.com/about/) |
...
Эта информация предоставлена Miro о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Последняя дата сертификации SOC3 | 2020-12-31 |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | SAML, 0Auth |
