---
title: Сведения о приложениях для Collaboard решениями IBV
ms.author: elmalova
author: elenamalova
ms.date: 01/24/2022
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Collaboard, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/28ed14b8-5625-40e6-a17a-b56fa04fc76f" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002549" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые решениями IBV для Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Collaboard |
| Идентификатор | WA200002549 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Решения для IBV |
| Веб-сайт компании | [https://www.collaboard.app](https://www.collaboard.app) |
| Условия использования приложения | [https://www.collaboard.app/terms](https://www.collaboard.app/terms) |
| Основные функции приложения | Collaboard — это прекрасная доска для совместной работы в Интернете для удаленной работы. |
...
| Какие поставщики облачных хостингов используют приложение? | Azure, IBMCloud, Aws, Other |
...
Эти сведения предоставлены решениями IBV о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| URL-адрес политики конфиденциальности | https://www.collaboard.app/dpa |
