---
title: Сведения о приложении для WorkInSync от MoveInSync
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Вся доступная информация о безопасности и соответствии для WorkInSync, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4e00663a-be72-4de1-a163-269a477a7a6e" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые MoveInSync в корпорацию Майкрософт:
...
| Название партнерской компании | MoveInSync |
...
| Основные функциональные возможности приложения | WorkInSync позволяет &amp; организациям легко планировать использование гибкой модели резервирования на рабочем столе для вашего офиса.  Как сотрудник вы можете: - &amp; Создание резервирования на рабочем месте и управление ими — время ожидания при работе с домашними часами в конце дня в качестве руководителя. &amp; Вы получаете уведомления о планах тактового и часового времени участников группы на вкладке "Действия группы", которые можно установить в контексте канала. &amp; Вы можете просмотреть, где работает вся команда из своего присутствия. Найдите определенного коллегу в организации. |
| Расположение компании | Индия |
| Страница сведений о приложении | [https://www.workinsync.io/teams-app-for-workinsync/](https://www.workinsync.io/teams-app-for-workinsync/) |
...
Эта информация была предоставлена MoveInSync о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Делегированные | 1. Получение сведений о транзитивных членах группы. Они используются на вкладке "Действия группы" при установке в контексте канала. 2. Чтобы войти в список сведений о профиле пользователя &amp;  в организации. Они используются при установке вкладки "Действия группы" в личном контексте в качестве отката для отображения предварительного просмотра участников команды в случае сбоя API людей (пользователи, не включались в Outlook). | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| People.Read | Делегированные | Чтобы пользователи, наиболее связанные с пользователем, выполнив вход, отображались на вкладке "Действия группы", устанавливаются в личном контексте. | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read | Делегированные | Получение сведений о присутствии списка пользователей на вкладке "Действия команды" в личном контексте и в контексте канала | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read.All | Делегированные | Получение сведений о присутствии списка пользователей на вкладке "Действия команды" в личном контексте и в контексте канала | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.Read.All | приложение | Используется для получения сведений о диспетчере отчетов любого пользователя для отправки уведомлений о резервировании и возврате. | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.ReadBasic.All | Делегированные | Используется для чтения фотографии профиля сотрудника | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| email | Делегированные | Требуется для получения маркера единого входа с Teams клиентской библиотеки | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| offline_access | Делегированные | Требуется для получения маркера единого входа с Teams клиентской библиотеки | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| openid | Делегированные | Требуется для получения маркера единого входа с Teams клиентской библиотеки | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| profile | Делегированные | Требуется для получения маркера единого входа с Teams клиентской библиотеки | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
