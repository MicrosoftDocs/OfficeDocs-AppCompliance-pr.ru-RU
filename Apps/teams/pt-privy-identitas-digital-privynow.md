---
title: Application Information for PrivyNow by PT Privy Identitas Digital
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: Вся доступная информация о безопасности и соответствии для PrivyNow, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66547260"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 2 марта 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые PT Privy Identitas Digital в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | PrivyNow |
| ID | WA200004229 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | PT Privy Identitas Digital |
| Веб-сайт компании | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| Условия использования приложения | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| Основные функциональные возможности приложения | Подписывание документов всех типов является важной частью вашей повседневной жизни и откладывает изменение всего. Быстро закройте сделки с PrivyNow. Отправьте документ и поделитесь документом за 1 минуту.   Чтобы использовать это приложение, пользователи должны иметь активные учетные записи PrivyNow, зарегистрироваться PrivyNow.com или обратитесь в службу поддержки за дополнительными сведениями. |
| Расположение компании | Индонезия |
| Страница сведений о приложении | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
Эта информация была предоставлена PT Privy Identitas Digital о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Полное имя, сообщения электронной почты |
...
| Какие данные хранятся в базах данных? | Полное имя, сообщения электронной почты |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Индонезия |
...
| URL-адрес политики конфиденциальности | https://privynow.com/terms-of-use/ |
