---
title: Сведения о приложении для Rezolve.ai по интерактивным обработке и анализу
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Rezolve.ai, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 9497abc8dccb250bc2ccc110d0c869fa3e133682
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64867084"
---
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт по обработке и анализу действий:
...
| Название партнерской компании | Actionable Science |
| Веб-сайт компании | [https://www.rezolve.ai](https://www.rezolve.ai) |
| Условия использования приложения | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| Основные функциональные возможности приложения | Приложение предоставляет комплексные функциональные возможности службы поддержки сотрудников, включая возможность а) создание и обновление билетов. Ответ на вопросы подпрограммы в) Автоматизация распространенных задач, таких как подготовка или подключение  |
...
Эта информация была предоставлена приложением Actionable Science о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемыми приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Вход и чтение профиля пользователя | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
