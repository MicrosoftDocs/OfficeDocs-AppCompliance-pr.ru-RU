...
>Да, мы внося персональные данные (имя пользователя, электронную почту и т.д.) для создания журнала аудита. Сведения хранятся в нашей базе данных в зашифрованном виде и могут быть доступны только при консультации с api аудита.
...
<iframe height='1020' title='Microsoft Cloud App Security Сведения' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35665' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35665" target="_blank">Просмотр на новой вкладке</a>
