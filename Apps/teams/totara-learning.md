---
title: Сведения о приложении для Totara от Totara Обучение
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/09/2021
...
description: Вся доступная информация о безопасности и соответствии для Totara, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f7f88b171348485f6b7289d97372f62313fc7a54
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879586"
---
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Totara Обучение корпорации Майкрософт:
...
| Название партнерской компании | Totara Learning |
| Веб-сайт компании | [https://www.totaralearning.com](https://www.totaralearning.com) |
| Условия использования приложения | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| Основные функциональные возможности приложения | Приложение Totara для Microsoft Teams предоставляет подписчикам Totara Cloud возможность доступа к обучению и совместной работы с другими пользователями в Microsoft Teams. Это приложение позволяет пользователям получать доступ к назначенному обучению, изучать обучающее содержимое и создавать, взаимодействовать с списками воспроизведения и ресурсами и делиться ими — все это в Microsoft Teams. |
| Расположение компании | Новая Зеландия |
| Страница сведений о приложении | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
...
Эта информация была предоставлена Totara Обучение о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Подключение пользователя Teams к локальному системному пользователю по адресу электронной почты | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
