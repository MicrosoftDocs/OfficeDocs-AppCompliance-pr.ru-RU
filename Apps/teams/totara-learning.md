...
| Основные функции приложения | Приложение Totara для Microsoft Teams предоставляет подписчикам Totara Cloud возможность доступа к обучению и совместной работе с другими Microsoft Teams. Это приложение позволяет пользователям получать доступ к назначенного обучения, изучению учебного контента и созданию, взаимодействию с плейлистами и ресурсами и их совместной Microsoft Teams. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Подключение пользователя teams к локальному пользователю системы с помощью адреса электронной почты | [5022e09d-d2f9-499f-8925-554c324ad23a](https://docs.microsoft.com/microsoft-365-app-certification/azure/5022e09d-d2f9-499f-8925-554c324ad23a) |
