...
description: Все доступные сведения о безопасности и соответствии требованиям для Totara, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Приложение Totara для Microsoft Teams предоставляет подписчикам Totara Cloud возможность доступа к обучению и совместной работе с другими Microsoft Teams. Это приложение позволяет пользователям получать доступ к назначенного обучения, изучению учебного контента и созданию, взаимодействию и совместному доступу к плейлистам и ресурсам — все это в Microsoft Teams. |
| Расположение штаб-квартиры компании | Новая Зеландия |
| Страница информация о приложении | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Подключение пользователя teams к локальному пользователю системы с помощью адреса электронной почты | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
