...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| email | делегирована | Данные собираются для авторизации конечных пользователей в Skillate | Мы храним адрес электронной почты только для создания учетной записи пользователя в приложении Skillate | ed4df345-c860-4ffe-b614-0460d9106f0f |
>| openid | делегирована | Мы используем API для ведения журнала пользователя в Microsoft в Skillate с помощью SSO | Мы храним имя и фамилию только конечного пользователя | ed4df345-c860-4ffe-b614-0460d9106f0f |
