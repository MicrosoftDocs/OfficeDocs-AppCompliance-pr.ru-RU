...
Эти сведения предоставлены Tendfor о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Список типов поддерживаемых политик | Все и все, поддерживаемые Azure |
