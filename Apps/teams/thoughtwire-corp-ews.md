...
| Основные функции приложения | Приложение ThoughtWire поддерживает EarlyWarning — средство раннего обнаружения и вмешательства, которое, как было доказано, снижает количество событий синего кода на 61%. Решение раннего предупреждения предназначено для обнаружения ухудшения состояния пациентов на основе жизненно важных условий пациентов, уведомления клиницистов о неблагоприятных событиях для здоровья и позволяют им принимать меры. Сотрудники группы реагирования имеют доступ к контексту пациентов и знают о состоянии и доступности группы реагирования, что позволяет оптимизировать процессы реагирования и ухода за пациентами. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | приложение | Позволяет приложению создавать группы и группы для больничных палат/подразделений. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | приложение | Необходимо, чтобы приложение определило, какие группы ему может потребоваться создать или повторно создать, а также управлять членством. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | приложение | Требуется так, чтобы приложение может управлять членством в группе. то есть добавление/удаление медсестер из группы по мере изменения смены. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | приложение | Требуется так, чтобы приложение может управлять членством в группе. то есть добавление/удаление медсестер из группы по мере изменения смены. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | приложение | Позволяет приложению автоматически устанавливать бот ThoughtWire в команды, которые он создает или управляет. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | приложение | Разрешить приложению получать AADID/имя пользователя по мере необходимости при управлении членством и/или извлечении имени пользователя для удостоверения пользователя в нашем приложении. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
