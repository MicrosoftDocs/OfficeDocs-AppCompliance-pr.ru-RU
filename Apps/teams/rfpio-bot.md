...
description: Все доступные сведения о безопасности и соответствия требованиям для бота RFPIO, его политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 9abd11980f77598157ded749fa2f28b6dfa4dba1
ms.sourcegitcommit: 58c50d1704196178455927329748485b40dd7880
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/17/2022
ms.locfileid: "63544257"
---
...
| Основные функции приложения | RFPIO является ведущим решением управления ответами RFP и первым в отрасли программным обеспечением RFP с поддержкой AI, которому доверяют некоторые из самых умных компаний в мире для управления ответами на ответы на ответы на RFPs, RFIs, вопросы безопасности и DDQ.  |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | Azure, AWS, GCP |
...
| Самая недавняя дата сертификации SOC2 |  2021-05-17 |
