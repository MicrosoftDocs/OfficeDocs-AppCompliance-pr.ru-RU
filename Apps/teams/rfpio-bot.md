---
title: Сведения о приложении для бота RFPIO от RFPIO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Все доступные сведения о безопасности и соответствии для бота RFPIO, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 1fb21262e0e95ad4f0f9d9d8087e0b80a85fd0ff
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879255"
---
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | RFPIO |
| Веб-сайт компании | [https://www.rfpio.com](https://www.rfpio.com) |
| Условия использования приложения | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| Основные функциональные возможности приложения | RFPIO — это ведущее решение для управления ответами RFP и первое в отрасли программное обеспечение RFP с поддержкой искусственного интеллекта, доверенное некоторыми самыми интеллектуальными компаниями мира для управления ответами на запросы RFP, RFIS, анкеты безопасности и DDQ.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Azure, AWS, GCP |
...
Эта информация была предоставлена RFPIO о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2021-05-17 |
...
| Перечисление поддерживаемых типов политик | Многофакторное ограничение IP-адресов |
