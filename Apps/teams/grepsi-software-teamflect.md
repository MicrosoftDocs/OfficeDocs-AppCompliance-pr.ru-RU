...
| Основные функции приложения | Teamflect — это решение по управлению производительностью и вовлечению сотрудников по одному, построенное для Microsoft Teams. Это делает людей более продуктивными и более занятыми с помощью модулей 1-на-1 Meeting, Goal/OKR, Feedback, Recognition and Tasks |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | приложение | Мы используем это разрешение для доступа к пользовательским календарям для определения собраний 1 на 1 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | делегирована | Каталог компании — мы используем это разрешение, чтобы показать конечным пользователям список своих коллег при выполнении поиска | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
