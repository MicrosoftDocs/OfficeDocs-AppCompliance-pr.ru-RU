---
title: Информация о приложениях для простых проектов от Logic Software Inc.
ms.author: elmalova
author: elenamalova
ms.date: 03/24/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для Easy Projects, ее политики обработки данных, Microsoft Cloud App Security информация каталога приложений и информация о безопасности/соответствии в реестре CSA STAR.
...
<p>Последнее обновление разработчиком на: 24 марта 2021</p>

* <a href="https://teams.microsoft.com/l/app/ee27dd0c-3a49-4c09-8faa-6c6e0163bae5" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002647" target="_blank">Посмотреть в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Информация, предоставленная Logic Software Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Easy Projects |
| ID | WA200002647 |
| Office 365 клиенты поддержали | Microsoft Teams |
| Название компании-партнера | Logic Software Inc. |
| URL-адрес веб-сайта партнера | [https://www.easyprojects.net](https://www.easyprojects.net) |
| URL-адрес Teams страницы информации о приложениях | [https://www.easyprojects.net](https://www.easyprojects.net) |
| URL политики конфиденциальности | [https://www.easyprojects.net/privacy/](https://www.easyprojects.net/privacy/) |
| URL условий использования | [https://www.easyprojects.net/hosting-agreement/](https://www.easyprojects.net/hosting-agreement/) |
...
Эта информация была предоставлена Logic Software Inc. о том, как это приложение собирает и хранит организационные данные и контроль, который ваша организация будет иметь над данными, которые собирает приложение.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/10134" target="_blank">Просмотр в новой вкладке</a>
...
Эта информация была предоставлена Logic Software Inc. о том, как это приложение обрабатывает аутентификацию, авторизацию, лучшие практики регистрации приложений и другие критерии идентификации.
...
| Использует ли ваше приложение MSAL (Библиотека аутентификации Майкрософт) для проверки подлинности? | Na |
