---
title: Сведения о приложении для OfficeAmp от Anaek Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
* <a href="https://teams.microsoft.com/l/app/b3f65e46-d08c-4ab9-a11d-20836a9dcdda" target="_blank">Просмотр в магазине Teams</a>
...
Сведения, предоставляемые Anaek Inc корпорации Майкрософт:
...
| Название партнерской компании | Anaek Inc |
...
| Основные функциональные возможности приложения | Внутренний бот службы технической поддержки, надежная система ITSM в Microsoft Teams и предоставляет канбан-панель мониторинга для отслеживания, назначения и разрешения запросов. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.officeamp.com](https://www.officeamp.com) |
...
Эта информация была предоставлена Anaek Inc о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://www.officeamp.com/adminbot/privacy/ |
