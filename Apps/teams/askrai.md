...
>не регистрируются данные, идентифицируемые конечным пользователем, ни сведения об организации

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Организационные элементы управления данными, хранимые партнером

Описание того, как администраторы организации могут управлять своими сведениями в партнерских системах? например, удаление, хранение, аудит, архивация, политика конечных пользователей и т. д.

>данные приложения хранятся и управляются клиентом. Когда эти данные находятся на наших облачных серверах, они шифруются и доступны только некоторым уполномоченным системным администраторам. Эти лица имеют проверку подлинности MFA на основе ключей ssh и VPN. Также активируется фильтрация диапазонов IP.
...
<iframe height='1020' title='Microsoft Cloud App Security Сведения' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36145' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36145" target="_blank">Просмотр на новой вкладке</a>
...
Эти сведения были предоставлены askR.ai о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.
