---
title: Сведения о приложениях для Schabi от Schule am Bildschirm GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Schabi, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003728" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Schule am Bildschirm GmbH в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Schabi |
| ID | WA200003728 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Schule am Bildschirm GmbH |
| Веб-сайт компании | [https://web.schabi.ch](https://web.schabi.ch) |
| Условия использования приложения | [https://www.schabi.ch/Info/AGB](https://www.schabi.ch/Info/AGB) |
| Основные функции приложения | Deine Schabi-Hausaufgaben und Schabi-Seiten direkt в Microsoft Teams! |
| Расположение штаб-квартиры компании | Швейцария |
| Страница информация о приложении | [https://web.schabi.ch](https://web.schabi.ch) |
...
Эта информация была предоставлена Schule am Bildschirm GmbH о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| URL-адрес политики конфиденциальности | https://www.schabi.ch/Info/Datenschutz |
