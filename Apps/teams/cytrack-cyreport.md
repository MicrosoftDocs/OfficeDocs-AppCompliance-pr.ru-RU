---
title: Сведения о приложении для CyReport от CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: Все доступные сведения о безопасности и соответствии для CyReport, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66549591"
---
# <a name="cyreport"></a>CyReport

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 9 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">Просмотр в AppSource</a>
...
| Основные функциональные возможности приложения | Рабочая аналитика и создание отчетов для бизнес-аналитики в вашей команде Майкрософт&#8217;производительности &amp; .  Простое в использовании аналитическое решение и решение для создания отчетов для бизнес-аналитики в вашей команде&#8217;производительности, взаимодействия с клиентами, тенденции, качество звонков, затраты на связь и многое другое. CyReport для Microsoft Teams улучшает совместную работу, производительность и эффективность бизнес-коммуникаций, что приводит к исключительному опыту клиентов. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
