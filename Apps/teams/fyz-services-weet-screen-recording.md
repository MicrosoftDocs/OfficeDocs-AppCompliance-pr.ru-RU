---
title: Сведения о приложении для записи экрана weet службами FYZ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для записи экрана Weet, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые службами FYZ корпорации Майкрософт:
...
| Название партнерской компании | FYZ SERVICES |
| Веб-сайт компании | [https://weet.co](https://weet.co) |
| Условия использования приложения | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| Основные функциональные возможности приложения | Weet, 1-й совместный &amp; видеозаписи экрана: простая, бесплатная и неограниченная запись экрана |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
...
Эти сведения предоставлены службами FYZ о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-12-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Делегированные | Разрешить обнаружение того, установлено ли приложение weet | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | Делегированные | Мы не собираем данные, но используем электронную почту только для помощи пользователю с функцией автозаполнения. | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | Делегированные | Мы не собираем данные, но используем электронную почту только для помощи пользователю с функцией автозаполнения. | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | Делегированные | Мы не собираем данные, но используем электронную почту только для помощи пользователю с функцией автозаполнения. | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | Делегированные | Мы не собираем данные, но используем электронную почту только для помощи пользователю с функцией автозаполнения. | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| profile | Делегированные | Мы не собираем данные, но используем электронную почту только для помощи пользователю с функцией автозаполнения. | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
