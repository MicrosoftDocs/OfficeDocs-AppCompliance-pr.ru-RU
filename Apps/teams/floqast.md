---
title: Сведения о приложении для FloQast от FloQast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Вся доступная информация о безопасности и соответствии для FloQast, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0516a91a2a93b2382f0119bdcf33263b271a43ad
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64878666"
---
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | FloQast |
...
| Основные функциональные возможности приложения | FloQast предоставляет решение для управления закрытием, а также автоматизацию рабочих процессов, предназначенную для помощи бухгалтерам в выполнении закрытия на конец месяца. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://floqast.com](https://floqast.com) |
...
Эта информация была предоставлена FloQast о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2/28/2021 |
