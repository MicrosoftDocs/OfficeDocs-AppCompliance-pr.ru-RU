---
title: Сведения о приложении для Orca от ORCA SECURITY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Вся доступная информация о безопасности и соответствии для Orca, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 96e82742f412cd7c6a5c90ec6f65b3fd107d159b
ms.sourcegitcommit: 4ceff6ef6aa0bae1075da646773b852970bb4049
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/03/2022
ms.locfileid: "65874288"
---
# <a name="orca"></a>Orca
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые ORCA SECURITY LTD корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Orca |
| ID | WA200004132 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | ORCA SECURITY LTD |
| Веб-сайт компании | [https://orca.security](https://orca.security) |
| Условия использования приложения | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| Основные функциональные возможности приложения | Orca Security for Microsoft Teams предоставляет представление о состоянии безопасности облачной среды в режиме реального времени. С помощью обоих средств, объединенных в одно представление, пользователи могут создать продуктивное обсуждение проблем безопасности в облачной среде Orca оповещений о конкретном облачном риске, который включает в себя результаты риска безопасности и подключенный облачный ресурс, который представляет риск. |
...
Эта информация была предоставлена ORCA SECURITY LTD о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Teams пользователя, идентификатор команды, имя команды |
...
| Какие данные хранятся в базах данных? | Teams пользователя, идентификатор команды, имя команды |
...
| Дата последней сертификации SOC2 | 2022-04-01 |
...
| URL-адрес политики конфиденциальности | https://orca.security/privacy-policy/ |
