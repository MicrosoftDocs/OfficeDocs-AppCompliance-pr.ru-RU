...
description: Все доступные сведения о безопасности и соответствия требованиям для Staple, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | приложение | Используется для сбора id клиента. Используется для обеспечения того, чтобы пользователи, которые с помощью нашей платформы сдают проверку подлинности, являются членами определенного клиента. | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | приложение | Teams приложение самостоятельно устанавливает команду пользователя | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | делегирована | Считывая каталог приложений пользователя, чтобы узнать, установлено ли приложение teams. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | делегирована | Используется для чтения id пользователя, чтобы убедиться, что сообщения отправляются правильному пользователю. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | делегирована | Вопишите в пользователя, чтобы прочитать его основные сведения о профиле | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
