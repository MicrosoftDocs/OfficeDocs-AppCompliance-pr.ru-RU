...
* <a href="https://teams.microsoft.com/l/app/589748de-ec98-4616-9063-e91c629bd1a4" target="_blank">Просмотр в Teams хранилище</a>
...
| Основные функциональные возможности приложения | SalesTim помогает каждой организации улучшить свои процессы совместной работы, не Microsoft Teams создания шаблонов и автоматизации управления в большом масштабе. |
...
| Перечисление поддерживаемых типов политик | Многофакторная проверка подлинности. Разрешение доступа только Intune зарегистрированным устройствам к определенным службам. Ограничение расположений пользователей и диапазонов IP-адресов |
...
>| Group.ReadWrite.All | Как | Мы&#8217;только идентификаторы групп и команд,&#8217;не будем хранить содержимое групп и команд. Позволяет приложению создавать группы, считывать все свойства группы и членство от имени вошедвшего пользователя. Кроме того, владельцы групп смогут управлять своими группами, а участники групп — обновлять содержимое групп. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Mail.Send | Делегированные | Идентификаторы пользователей. Мы&#8217;сохранить метаданные этого действия, такие как дата уведомления, получатели, идентификатор запроса. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| User.Read.All | Как | Идентификатор пользователя и данные профиля. Позволяет пользователю выбирать других пользователей в различных местах приложения, например выбирать утверждающих в рабочем процессе. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| offline_access | Делегированные | Маркер обновления. Позволяет приложению выполнять некоторые фоновые операции и действия в качестве пользователя. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
