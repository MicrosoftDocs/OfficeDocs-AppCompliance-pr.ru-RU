...
| Страница информация о приложении | [https://www.salestim.com](https://www.salestim.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.ReadWrite.All | делегирована | ID пользователей, приглашенных на канал по нашей политике членства | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Directory.AccessAsUser.All | делегирована | Пользовательский ID. Позволяет пользователю выбирать других пользователей в различных местах в приложении, таких как выбор одобрений в рабочего процесса. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Group.ReadWrite.All | оба | Мы&#8217;только для хранения ID групп и команд,&#8217;не храним содержимое групп и групп. Позволяет приложению создавать группы, читать все свойства группы и членство от имени подписанного пользователя. Кроме того, владельцы групп смогут управлять своими группами, а участники групп — обновлять содержимое групп. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Mail.Send | делегирована | Пользовательские ИД. Мы&#8217;хранение метаданных этого действия, таких как дата уведомления, получатели, ИД запроса. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| User.Read.All | оба | Пользовательский ID и данные профиля. Позволяет пользователю выбирать других пользователей в различных местах в приложении, таких как выбор одобрений в рабочего процесса. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| offline_access | делегирована | Обновление маркера. Позволяет приложению выполнять некоторые фоновые операции и действия в качестве пользователя. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
