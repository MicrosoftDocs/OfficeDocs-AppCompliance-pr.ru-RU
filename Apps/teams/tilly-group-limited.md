---
title: Application Information for tiLly by Tilly Group Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для tiLly, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 4781d79452a065c64d345254461bb092581552cb
ms.sourcegitcommit: 6df79f38ffe390e7339cd6ce5eb32641a9f4c1a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/15/2022
ms.locfileid: "66113053"
---
# <a name="tilly"></a>Тилли

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 6 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/9f9d64e3-e479-4b7b-9c5e-c4e049a732aa" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003825" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Tilly Group Limited корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Тилли |
| ID | WA200003825 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Tilly Group Limited |
| Веб-сайт компании | [https://tillygroup.co.uk](https://tillygroup.co.uk) |
| Условия использования приложения | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Til...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Terms-of-Use.pdf) |
| Основные функциональные возможности приложения | Привлечение, расширение возможностей и поддержка ваших сотрудников с помощью собственного Microsoft Teams BOT! |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT-Infographic-1.pdf) |
...
Эта информация была предоставлена Tilly Group Limited о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | идентификатор клиента, бизнес-имя, контактные данные. Для пользователя, имени пользователя, анонимного идентификатора пользователя, задаваемых вопросов и ответов, включая любые изображения и вложения |
...
| Какие данные хранятся в базах данных? | идентификатор клиента, бизнес-имя, контактные данные. Для пользователя, имени пользователя, анонимного идентификатора пользователя, задаваемых вопросов и ответов, включая любые изображения и вложения |
...
| URL-адрес политики конфиденциальности | https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Privacy-Statement.pdf |
...
| Перечисление поддерживаемых типов политик | Приложение выполняет федерацию с Azure AD, чтобы можно было использовать все политики условного доступа. |
