...
| Основные функции приложения | Интеграция BlackBerry AtHoc с Teams обеспечивает бесшовное управление критическими событиями в организации &#8211; из одного знакомого пользовательского интерфейса, в котором&#8217;проверку подлинности. Не покидая Teams, интеграция BlackBerry AtHoc позволяет диспетчерам чрезвычайных ситуаций и инцидентов: &#8226; Опубликовать оповещения одним щелчком мыши на любое устройство &#8226; Целевые предварительно установленные группы рассылки в Teams &#8226; Collaborate в Teams году для управления инцидентами в режиме реального времени |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.blackberry.com/us/en/products/blackberry-athoc](https://www.blackberry.com/us/en/products/blackberry-athoc) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | Azure, AWS, SelfHosted |
...
| Самая недавняя дата сертификации SOC3 |  2020-09-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| email | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| profile | делегирована | Для отправки карты оповещения в группы мы&#8217;основные сведения пользователя, такие как основное имя и ссылку на общий канал команд (для которого подписан пользователь. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
