---
title: Сведения о приложении для BlackBerry AtHoc от BlackBerry
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Все доступные сведения о безопасности и соответствии для BlackBerry AtHoc, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 2bbb551a2987b968a0676fc20c4ccf3199506420
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64866914"
---
...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | BlackBerry |
| Веб-сайт компании | [https://www.blackberry.com](https://www.blackberry.com) |
| Условия использования приложения | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| Основные функциональные возможности приложения | Интеграция BlackBerry AtHoc с Teams обеспечивает эффективное управление критическими событиями в организации &#8211; из одного знакомого пользовательского интерфейса, в котором&#8217;уже выполнили проверку подлинности. Не выходя из Teams, интеграция BlackBerry AtHoc позволяет диспетчерам экстренных служб и инцидентов публиковать оповещения &#8226; одним щелчком мыши на любом устройстве &#8226; Целевые предварительно установленные группы рассылки в Teams &#8226; Collaborate в Teams для управления инцидентами в режиме реального времени. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.blackberry.com/us/en/products/blackberry-athoc](https://www.blackberry.com/us/en/products/blackberry-athoc) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Azure, AWS, SelfHosted |
...
Эта информация была предоставлена BlackBerry о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Последняя дата сертификации SOC3 | 2020-09-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| email | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| profile | Делегированные | Мы переназначаем пользователю&#8217;основные сведения, такие как имя участника, и переназначаем ссылку на общий канал teams (для которого пользователь, выполнив вход, авторизован) для отправки карточки оповещения в команды. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
