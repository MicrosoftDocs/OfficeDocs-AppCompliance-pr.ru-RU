---
title: Сведения о приложении для DirectFax от etherFAX LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Все доступные сведения о безопасности и соответствии для DirectFax, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6530e8a1-213e-4847-ba53-5a36d8f4e20c" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002054" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые etherFAX LLC корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | DirectFax |
| ID | WA200002054 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | EtherFAX LLC |
| Веб-сайт компании | [https://www.etherfax.net](https://www.etherfax.net) |
| Условия использования приложения | [https://www.etherfax.net/terms-conditions/](https://www.etherfax.net/terms-conditions/) |
| Основные функциональные возможности приложения | DirectFax Messenger от EtherFAX позволяет отправлять и получать факсы и другие бизнес-документы. |
| Расположение компании | Estados Unidos Америки |
| Страница сведений о приложении | [https://www.etherfax.net/app-integrations/microsoft-teams/](https://www.etherfax.net/app-integrations/microsoft-teams/) |
...
Эти сведения предоставлены etherFAX LLC о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Тип или классификация данных, передаваемых через приложение, передаются по усмотрению пользователя команды и отвечают за нее. Идентификатор Пользователя Teams также сохраняется для маршрутизации содержимого, которое передается соответствующему получателю. |
...
| Какие данные хранятся в базах данных? | Маркер OAuth, маркер обновления, срок действия маркера, Azure AD идентификатор объекта пользователя  |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Estados Unidos Америки, Канада |
...
| URL-адрес политики конфиденциальности | https://www.etherfax.net/gdpr-privacy-notice/ |
...
| Перечисление поддерживаемых типов политик | Требование многофакторной идентификации |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | Делегированные | Чтение сообщений и интерпретация в виде инструкций для взаимодействия с ботом DirectFax | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| ChannelMessage.Send | Делегированные | Отправка сообщений от имени бота для уведомления пользователей об обновлениях состояния факса | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Chat.ReadWrite | Делегированные | Чтение и публикация сообщений чата для отправки и получения факсов | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Files.ReadWrite.All | Делегированные | Доступ к файлам для отправки и получения факсов | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Group.ReadWrite.All | Делегированные | Чтение и публикация сообщений чата для отправки и получения факсов в канале Teams | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Mail.Send | Делегированные | Делитесь факс-сообщениями по электронной почте с другими пользователями. | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| User.Read | Делегированные | Чтение профиля пользователя для заполнения сведений об устройстве | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| offline_access | Делегированные | Доступ к файлам для отправки изображений по факсу в электронном виде | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| openid | Делегированные | Вход пользователей | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| profile | Делегированные | Чтение профиля пользователя для заполнения сведений об устройстве | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
