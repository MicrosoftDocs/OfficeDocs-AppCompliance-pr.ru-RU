...
Сведения, предоставленные корпорацией Майкрософт по технологии CoffeePals Inc.
...
| Какие поставщики облачных хостингов используют приложение? | Aws, MongoDB, Heroku |
...
Эта информация предоставлена coffeePals Technologies Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Данные профилей пользователей, данные об использовании пользователей, адрес электронной почты пользователей, история совпадений пользователей, Параметры пользователей, Параметры организации, имя организации, имя команды, аватар организации, данные отчетов о совпадениях, фото профиля пользователя, членство в команде пользователей, отзывы пользователей |
...
| URL-адрес политики конфиденциальности | https://coffeepals.co/privacy |
