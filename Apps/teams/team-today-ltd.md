---
title: Application Information for Team Today by Team Today Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для Team Today, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66249792"
---
# <a name="team-today"></a>Группа сегодня

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 23 ноября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003572" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Team Today Ltd корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Группа сегодня |
| Идентификатор | WA200003572 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Team Today Ltd |
| Веб-сайт компании | [https://team-tracker.com](https://team-tracker.com) |
| Условия использования приложения | [https://team-tracker.com/terms-and-conditions.html](https://team-tracker.com/terms-and-conditions.html) |
| Основные функциональные возможности приложения | Team Tracker — это первое приложение пользователя для резервирования службы "Горячие столы" и просмотр работы |
...
Эта информация предоставлена Team Today Ltd о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Идентификаторы событий календаря |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Делегированные | Когда пользователь настраивает свои действия на ближайшие недели, Team Tracker обновляет календарь пользователей и их доступность в зависимости от их выбора.  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| MailboxSettings.Read | Делегированные | Используется для получения часового пояса для создания событий календаря | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| User.Read | Делегированные | Проверка сведений о пользователях по их профилю | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| email | Делегированные | Используется для проверки электронной почты пользователей | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| openid | Делегированные | Позволяет пользователям выполнять вход с помощью учетной записи Office 365. | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| profile | Делегированные | Проверяет основные сведения пользователей по их профилю. | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
