---
title: Сведения о приложениях для мест ti8m по tim&amp; AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для мест ti8m, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые tim&amp; AG в Корпорацию Майкрософт:
...
| Основные функции приложения | Places — это приложение для книги рабочих мест в гибридной настройке рабочего места. Мы предлагаем бронирование на картах или в представлении на основе календаря. Приложение полностью интегрировано в Microsoft Teams и использует всю проверку подлинности на основе Microsoft Services. |
| Расположение штаб-квартиры компании | Швейцария |
| Страница информация о приложении | [https://www.ti8m.ch/places](https://www.ti8m.ch/places) |
...
Эти сведения предоставлены&amp; tim AG о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | делегирована | Отмена событий в календарях рабочих мест и пользователей  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Directory.ReadWrite.All | делегирована | Установка и создание групп административных AAD — группы безопасности  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Place.ReadWrite.All | делегирована | Список рабочих мест и имен карт  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| User.Read | делегирована | Имя пользователя, имя электронной почты и имя отображения, необходимое для отображения пользовательских данных в приложении | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
