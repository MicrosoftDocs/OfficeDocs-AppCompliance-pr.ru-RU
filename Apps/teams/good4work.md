...
description: Вся доступная информация о безопасности и соответствия требованиям для Good4work, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Good4work — это средство взаимодействия с командой для распределенных групп для улучшения работы в команде. В то же время он предоставляет сведения о командах и людей. Он работает с того места, где вы находитесь, в том числе Microsoft Teams. Вы можете распознать сильные&#8217; и положительные последствия, отправив им слава. Good4work направлена на стимулирование виртуальной среды путем распространения культуры доверия и сопереживания. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://good4work.com/support/](https://good4work.com/support/) |
