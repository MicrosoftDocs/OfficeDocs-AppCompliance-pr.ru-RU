---
title: Сведения о приложении для Powow от Pow AI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Вся доступная информация о безопасности и соответствии для Powow, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64875356"
---
# <a name="powow"></a>Powow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 15 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002952" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Pow AI корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Powow |
| Идентификатор | WA200002952 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Powow AI |
| Веб-сайт компании | [https://www.powow.ai](https://www.powow.ai) |
| Условия использования приложения | [https://www.powow.ai/legal/tos.pdf](https://www.powow.ai/legal/tos.pdf) |
| Основные функциональные возможности приложения | Powow — это платформа SaaS, которая внедряет возможности ИИ в бизнес-собраниях. Она использует собственные алгоритмы ИИ для транскрибирования и анализа собраний, преобразуя их в практические аналитические сведения. Powow позволяет сотрудникам организации посетить меньше собраний, а также повысить производительность благодаря обнаружению собраний, аналитике и совместной работе. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://powow-ai.zendesk.com/hc/en-us](https://powow-ai.zendesk.com/hc/en-us) |
...
Эта информация была предоставлена Pow AI о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, электронная почта пользователя, события календаря |
...
| Какие данные хранятся в базах данных? | Данные профиля пользователя, электронная почта пользователя, события календаря |
...
| URL-адрес политики конфиденциальности | https://www.sembly.ai/wp-content/uploads/2021/09/privacy.pdf |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Microsoft Teams клиентского пакета SDK |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ExternalItem.ReadWrite.All | приложение | Используется для соединителя поиска (функция для отправки данных Powow в индексы Майкрософт для поиска по службы Майкрософт) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read | Делегированные | Вход и чтение профиля пользователя для регистрации и входа | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read.All | приложение | Используется для соединителя поиска (функция для отправки данных Powow в индексы Майкрософт для поиска по службы Майкрософт) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| email | Делегированные | Просмотр адреса электронной почты пользователя для регистрации и входа | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| offline_access | Делегированные | Доступ к данным пользователя в приложении (отслеживание обновлений календаря) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| openid | Делегированные | Вход пользователей | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| profile | Делегированные | Доступ к основным сведениям профиля пользователей для регистрации | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
