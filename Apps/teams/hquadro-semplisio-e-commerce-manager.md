---
title: Application Information for Semplisio e-commerce Manager by HQuadro
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
* <a href="https://teams.microsoft.com/l/app/9aa7a790-c743-4436-a4ba-1d540cbad3fe" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004286" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые HQuadro корпорации Майкрософт:
...
| Условия использования приложения | [https://www.semplisio.it/tc](https://www.semplisio.it/tc) |
| Основные функциональные возможности приложения | Gestisci il tuo ecommerce su Microsoft Teams: automatizza i processi, integrando i tuoi software e Microsoft 365 |
| Расположение компании | Италия |
| Страница сведений о приложении | [https://www.semplisio.it/ecommerce-manager](https://www.semplisio.it/ecommerce-manager) |
...
Эта информация была предоставлена HQuadro о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | email profile Channel.ReadBasic.All Files.ReadWrite.AppFolder Files.ReadWrite.All Files.Read.All User.Read Team.ReadBasic.All Sites.Read.All openid offline_access Contacts.ReadWrite |
...
| URL-адрес политики конфиденциальности | https://www.semplisio.it/privacy-policy/ |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | @microsoft/teamsfx |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Делегированные | мы используем его для отображения в приложении списка каналов | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Contacts.ReadWrite | Делегированные | мы используем его для записи контактов в Outlook | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.Read.All | Делегированные | мы используем его для чтения файлов на одном диске клиента | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.All | Делегированные | мы используем его для записи или создания файла на одном диске клиента. | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.AppFolder | Делегированные | мы используем его для чтения, записи и создания папки на одном диске клиента. | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Sites.Read.All | Делегированные | разрешить приложению считывать документы и список элементов с одного диска клиента; | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Team.ReadBasic.All | Делегированные | мы используем его для отображения в приложении списка команд | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| User.Read | Делегированные | мы используем его для создания маркеров от имени | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| email | Делегированные | мы используем его для единого входа. | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| offline_access | Делегированные | мы используем его для создания маркеров от имени | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| openid | Делегированные | мы используем его для создания маркеров от имени | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| profile | Делегированные | мы используем его для приветствия клиента | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
