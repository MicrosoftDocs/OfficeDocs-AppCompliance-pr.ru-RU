---
title: Application Information for Adobe Acrobat Sign by Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Все доступные сведения о безопасности и соответствии для Adobe Acrobat Sign, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 7f2d3773c98c0be54b362dfc2dc3fc4d42b3e9fb
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879846"
---
# <a name="adobe-acrobat-sign"></a>Знак Adobe Acrobat
...
* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">Просмотр в AppSource</a>
...
| Основные функциональные возможности приложения | Упростите рабочие процессы подписывания документов и создайте потрясающие возможности для сотрудников и клиентов при использовании возможностей Adobe Sign в Teams. Вы можете подписывать документы, отправлять их для юридической привязки электронных подписей и утверждений, а также отслеживать их состояние &#8212; с помощью Adobe Sign for Teams, предпочтительного решения для подписи электронной почты Корпорации Майкрософт. |
...
>| offline_access | Делегированные | Чтобы обновить маркер доступа, по истечении срока действия текущего маркера. Например, когда пользователь находится &quot;&quot; в окне отправки подписи и оставляет его неактивным слишком долго, нам нужно обновить новый маркер, чтобы пользователь был активным. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
