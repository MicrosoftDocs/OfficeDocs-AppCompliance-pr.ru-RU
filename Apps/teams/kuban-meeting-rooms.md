...
ms.openlocfilehash: 2a1ade4b60b8390816f85793394e32c908f04308
ms.sourcegitcommit: 3e68e819f21cd95aeb2abc018cd86af2a9dd0b1a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/27/2022
ms.locfileid: "67053053"
---
# <a name="kuban-meeting-rooms"></a>Кубанские комнаты для собраний

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 19 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/55df8703-59be-4925-bc57-df54f9369edf" target="_blank">Просмотр в магазине Teams</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Кубанские комнаты для собраний |
| ID | WA200004101 |
...
| Какие данные обрабатываются приложением? | Использование профиля пользователя чтения (graph/me) для Email и имени пользователя и хранения в нашей базе данных |
...
| Какие данные хранятся в базах данных? | Использование профиля пользователя чтения (graph/me) для Email и имени пользователя и хранения в нашей базе данных |
