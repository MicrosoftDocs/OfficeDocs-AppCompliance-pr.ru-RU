...
* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002599" target="_blank">Посмотреть в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Информация, предоставленная surviveF5 GmbH корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Kudozza |
| ID | WA200002599 |
| Office 365 клиенты поддержали | Microsoft Teams |
| Название компании-партнера | surviveF5 GmbH |
| URL-адрес веб-сайта партнера | [https://www.kudozza.com](https://www.kudozza.com) |
| URL-адрес Teams страницы информации о приложениях | [https://kudozza.com](https://kudozza.com) |
| URL политики конфиденциальности | [https://www.kudozza.com/privacy](https://www.kudozza.com/privacy) |
| URL условий использования | [https://www.kudozza.com/terms](https://www.kudozza.com/terms) |
...
Эта информация была предоставлена surviveF5 GmbH о том, как это приложение собирает и хранит организационные данные и контроль, который ваша организация будет иметь над данными, которые приложение собирает.
...
>|:-------------------|:--------------------------|:--------------------------|
>| AWS | userId, teamId, tenantId, имя пользователя | Служба и база данных размещаются в AWS.  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Слава направляется другим лицам, и сообщение должно быть обижено часто. Также предоставляется рейтинг, который делает необходимым хранить имена и идентификаторы пользователей с помощью приложения Kudozza. | userid, имя пользователя | Слава направляется другим лицам, и сообщение должно быть обижено часто. Также предоставляется рейтинг, который делает необходимым хранить имена и идентификаторы пользователей с помощью приложения Kudozza. |
...
>tenantId, teamId, userId. Политика удержания составляет 14 дней.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Организационный контроль за данными, хранящимися партнером

Опишите, как администраторы организации могут контролировать свою информацию в партнерских системах? например, удаление, удержание, аудит, архивирование, политика конечных пользователей и т.д.

>За DPA. Аудит и политика пользователей ent.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36547" target="_blank">Просмотр в новой вкладке</a>
...
Эта информация была предоставлена surviveF5 GmbH о том, как это приложение обрабатывает аутентификацию, авторизацию, лучшие практики регистрации приложений и другие критерии идентификации.
