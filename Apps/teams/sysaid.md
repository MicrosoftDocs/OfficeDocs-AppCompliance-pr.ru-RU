---
title: Сведения о приложении для SysА от SysА
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Все доступные сведения о безопасности и соответствии для SysView, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "64880518"
---
# <a name="sysaid"></a>SysAid

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 3 января 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/932c8be4-fac6-4df3-9e15-bc542f4ef88e" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые SysА в корпорацию Майкрософт:
...
| Название партнерской компании | SysAid |
| Веб-сайт компании | [https://www.sysaid.com](https://www.sysaid.com) |
| Условия использования приложения | [https://www.sysaid.com/wp-content/uploads/service-agreement...](https://www.sysaid.com/wp-content/uploads/service-agreement-cloud.pdf) |
| Основные функциональные возможности приложения | Использование бота для создания билетов SysА в Microsoft Teams |
...
Эта информация была предоставлена SysА о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
