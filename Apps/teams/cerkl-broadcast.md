...
| Основные функции приложения | Cerkl Broadcast соединяет аудиторию сотрудников с&#8217;важных коммуникаций. С помощью персонализации на основе поведения broadcast передает правильное сообщение нужному сотруднику в нужное время на нужном канале. Это&#8217;, где мы действительно стоим отдельно от нашей конкуренции - мы позволяем подкованным коммуникаторам общаться по каналам без дублирования усилий. Трансляция также предоставляет ведущие в отрасли показатели, которые помогают нашим клиентам узнать,&#8217;работает для своей аудитории. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
| Самая недавняя дата сертификации SOC2 |  2020-07-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Электронная почта пользователя собирается и используется для того, чтобы узнать, находится ли пользователь в настоящее время в нашей системе и был добавлен организацией. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
