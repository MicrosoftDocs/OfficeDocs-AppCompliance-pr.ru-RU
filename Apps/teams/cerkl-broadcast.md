---
title: Сведения о приложении для трансляции по Cerkl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Все доступные сведения о безопасности и соответствии для широковещательной рассылки, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 7589e0e09e89202edf8d4077574d2a8a3c6bc89c
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880296"
---
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Cerkl |
| Веб-сайт компании | [https://cerkl.com](https://cerkl.com) |
| Условия использования приложения | [https://cerkl.com/terms](https://cerkl.com/terms) |
| Основные функциональные возможности приложения | Cerkl Broadcast соединяет аудитории сотрудников с их организацией&#8217;важных коммуникаций. При использовании персонализации на основе поведения широковещательная рассылка доставляет правильное сообщение нужному сотруднику в нужное время на правом канале. Это&#8217;, где мы действительно изолированы от конкурентов. Мы разрешаем опытным коммуникациям обмениваться данными по каналам без дублирования усилий. Широковещательная рассылка также предоставляет ведущие в отрасли метрики, которые помогают нашим клиентам узнать,&#8217;работают для своей аудитории. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
Эта информация была предоставлена Cerkl о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-07-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Электронная почта пользователя собирается и используется для просмотра того, находится ли пользователь в системе и был ли он добавлен организацией. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
