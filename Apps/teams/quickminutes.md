---
title: Сведения о приложении для QuickMinutes от QuickMinutes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для QuickMinutes, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5f60fe53-d441-4320-8c26-13fdaee9b58a" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004414" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые QuickMinutes корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | QuickMinutes |
| ID | WA200004414 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | QuickMinutes |
| Веб-сайт компании | [https://quickminutes.com](https://quickminutes.com) |
| Условия использования приложения | [https://quickminutes.com/privacy#/terms_of_service](https://quickminutes.com/privacy#/terms_of_service) |
| Основные функциональные возможности приложения | Упростите рабочие процессы собраний в Интернете с помощью нашего интеллектуального цифрового помощника. |
| Расположение компании | Ирландия |
| Страница сведений о приложении | [https://support.quickminutes.com/portal/en-gb/kb/articles/m...](https://support.quickminutes.com/portal/en-gb/kb/articles/microsoft-teams-integration-22-4-2020-1) |
...
Эти сведения были предоставлены QuickMinutes о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Мы используем данные профиля пользователя для заполнения сведений о пользователях в базе данных QuickMinutes, когда пользователь регистрирует новую учетную запись в QuickMinutes с помощью единого входа Майкрософт. QuickMinutes извлекет данные календаря пользователей для отображения событий в пользовательском интерфейсе QuickMinutes. Мы не храним эти сведения в базе данных QuickMinutes. Мы просто извлекаем информацию из API Graph и отображаем ее для пользователя.  |
...
| Какие данные хранятся в базах данных? | Сведения о профиле пользователя, например имя, фамилия, Email и изображение профиля. Мы также храним для пользователей маркеры доступа и обновления MS. |
...
| URL-адрес политики конфиденциальности | https://quickminutes.com/privacy#/privacy_policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Делегированные | Область календаря используется QuickMinutes для чтения и записи собраний QuickMinutes в пользовательский календарь Майкрософт | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| People.Read | Делегированные | Область пользователей используется QuickMinutes для перечисления контактов пользователей Майкрософт при добавлении пользователей в организацию или группу QuickMinutes. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| email | Делегированные | Область электронной почты используется для предоставления QuickMinutes доступа к основному адресу электронной почты пользователя в форме утверждения электронной почты. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| openid | Делегированные | Область openid используется QuickMinutes в конечной точке платформа удостоверений Майкрософт маркера для получения маркеров идентификаторов. Это позволяет QuickMinutes использовать маркеры для доступа к API Graph от имени пользователей. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| profile | Делегированные | Область профиля используется QuickMinutes для доступа к профилю пользователей при их регистрации с помощью единого входа Майкрософт и создании учетной записи QuickMinutes. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
