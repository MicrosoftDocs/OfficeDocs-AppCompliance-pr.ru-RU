---
title: Сведения о приложении для Laduma от Laduma Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Все доступные сведения о безопасности и соответствии для Laduma, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3bcb0d8a-5ec8-4637-a946-958e5c0277fd" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003907" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Laduma Ltd. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Laduma |
| ID | WA200003907 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Laduma Ltd. |
| Веб-сайт компании | [https://laduma.com](https://laduma.com) |
| Условия использования приложения | [https://laduma.com/terms-of-service/](https://laduma.com/terms-of-service/) |
| Основные функциональные возможности приложения | Неограниченный общий доступ к доске, документам и приложениям для Microsoft Teams |
...
Эта информация была предоставлена Laduma Ltd. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, данные о событиях пользователя, маркеры доступа GraphAPI, Microsoft Teams каналов, календаря и ресурсов помещений |
...
| Какие данные хранятся в базах данных? | Данные профиля пользователя, данные о событиях пользователя, маркеры доступа GraphAPI, Microsoft Teams каналов, календаря и ресурсов помещений |
...
| URL-адрес политики конфиденциальности | https://laduma.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Application.Read.All | приложение | Убедитесь, что приложение установлено при попытке добавить собрание в календарь | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
>| Calendars.Read | Как | Нам нужно добавить собрания в календарь пользователя | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
