...
| Основные функции приложения | SuitePro-G est un outil collaboratif et intuitif pour la gestion de votre portefeuille de projets. Connectez votre outil de pilotage de projets en 3 cliques et gardez une &#233;quipe projet impliqu&#233;e, organise&#233;e et connect&#233;e.  SuitePro-G — это интуитивно понятное и совместное решение, которое позволяет управлять портфелем проектов. Подключение инструмент управления проектами в 3 щелчка мыши и сохраняйте участие, организованное и связанное с проектом.  |
| Расположение штаб-квартиры компании | Франция |
| Страница информация о приложении | [https://admin.suiteprog.com/Terms](https://admin.suiteprog.com/Terms) |
