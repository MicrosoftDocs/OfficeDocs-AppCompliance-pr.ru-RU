...
description: Все доступные сведения о безопасности и соответствия требованиям для Kanban Tool, политики обработки данных, сведения о каталоге Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Визуализация времени работы и отслеживания на доске kanban. |
| Расположение штаб-квартиры компании | Польша |
| Страница информация о приложении | [https://kanbantool.com](https://kanbantool.com) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | AWS, SelfHosted, GCP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | делегирована | Адрес электронной почты пользователя для связи, совпадения удостоверений и доставки уведомлений. | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | делегирована | Идентификаторы и имена команд, в которых пользователь является непосредственным участником. Они используются для автоматического назначения пользователей для исправления групп в Kanban Tool. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | делегирована | Основные сведения о компании пользователей, вписаных в нее. Он используется для заполнения сведений об учетных записях для новых учетных записей и распознавания пользователей, принадлежащих к вашей организации, для обеспечения единой Sign-On функций. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | делегирована | Позволяет входить в систему с помощью Microsoft и синхронизировать данные, к которые вы предоставили доступ к приложению, при входе пользователя. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | делегирована | Откройте маркеры ID, которые позволяют пользователям войти в приложение с помощью своей работы или учетных записей в школе с помощью кнопки "Вход с Microsoft". | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| profile | делегирована | Имя пользователя для автопопуляции в Kanban Tool и синхронизации с изменениями в Microsoft Teams. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
