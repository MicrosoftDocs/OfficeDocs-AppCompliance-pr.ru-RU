---
title: Сведения о приложении для матрицы принятия решений по кончику пальца
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для матрицы принятия решений по проверке пальца, ее политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
---
# <a name="fingertip-decision-matrix"></a>Матрица принятия решений для кончика пальца

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 6 октября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/9d9390bb-2d73-4c5e-9609-0ee86fc620ce" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004070" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт в службе "Кончик пальца":

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Матрица принятия решений для кончика пальца |
| Идентификатор | WA200004070 |
| Поддерживаемые клиенты Office 365 | Microsoft Teams |
| Название партнерской компании | Пальца |
| Веб-сайт компании | [https://www.fingertip.org](https://www.fingertip.org) |
| Условия использования приложения | [https://www.fingertip.org/terms-of-use/](https://www.fingertip.org/terms-of-use/) |
| Основные функциональные возможности приложения | Матрица принятия решений с помощью пальца помогает выбрать один из нескольких вариантов, если необходимо учитывать множество различных факторов. Это повышает четкость и прозрачность процесса и помогает определить приоритеты альтернативных вариантов, одновременно уменьшая влияние смещений. С помощью матрицы принятия решений по кончику пальца вы можете совместно принимать решения более точно с помощью Microsoft Teams. |
| Расположение компании | Финляндия |
| Страница сведений о приложении | [https://www.fingertip.org/solutions/fingertip-decision-matr...](https://www.fingertip.org/solutions/fingertip-decision-matrix/) |
...
Эта информация была предоставлена приложением "Кончик" о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собранными приложением.
...
| Какие данные обрабатываются приложением? | Сведения о профиле пользователя, идентификатор клиента |
...
| Какие данные хранятся в базах данных? | Сведения о профиле пользователя, идентификатор клиента |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Финляндия |
...
| Перечисление поддерживаемых типов политик | Многофакторная проверка подлинности, позволяющая только зарегистрированным устройствам Intune получать доступ к определенным службам, ограничивая расположения пользователей и диапазоны IP-адресов |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Основные сведения о профиле для создания пользователей | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| User.ReadBasic.All | Делегированные | Основные сведения о профиле для создания пользователей | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| email | Делегированные | Основные сведения о профиле для создания пользователей | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| offline_access | Делегированные | For if the user disconnects | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| openid | Делегированные | Войти | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| profile | Делегированные | Основные сведения о профиле для создания пользователей | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
