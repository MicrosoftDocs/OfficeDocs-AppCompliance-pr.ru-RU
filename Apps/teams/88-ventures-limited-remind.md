...
| Основные функции приложения | Напомните себе или членам вашей команды о важных собраниях, предметах для работы или даже днях рождения. Установите личные напоминания, напоминания группового чата или напоминания канала. Вы даже можете установить повторяющиеся напоминания (например, собрание группы каждый понедельник в 9 утра)! |
| Расположение штаб-квартиры компании | Гонконг, САР |
| Страница информация о приложении | [https://teamsreminder.app](https://teamsreminder.app) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | делегирована | Используется, когда администратор ищет пользователей, чтобы назначить их лицензиям. Использование этой функции является совершенно необязательным и не требуется во время нормального использования приложения. | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
>| People.Read.All | делегирована | Используется, когда пользователь хочет назначить пользователям лицензию | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
