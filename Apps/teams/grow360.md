---
title: Сведения о приложениях для grow360 by Grow360
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Grow360, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/042d26ab-41cc-4a88-920a-3125ebfd7944" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002324" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Grow360 Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Grow360 |
| Идентификатор | WA200002324 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Grow360 |
| Веб-сайт компании | [https://grow360.com](https://grow360.com) |
| Условия использования приложения | [https://grow360.com/terms](https://grow360.com/terms) |
| Основные функции приложения | GROW помогает профессионалам и командам добиться более высокой производительности с помощью лучших в своем классе решений по разработке лидерства. Мы считаем, что сильные команды создают добродетельный цикл как для членов команды, так и для организаций, которые они обслуживают. Когда команды здоровы, участники группы процветают. Когда участники группы процветают, команды работают лучше. |
| Расположение штаб-квартиры компании | Сингапур |
| Страница информация о приложении | [https://grow360.com/about](https://grow360.com/about) |
...
Эти сведения предоставлены grow360 о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Поддерживает ли приложение TLS 1.1 или выше? | Нет |
| Хранит ли приложение или инфраструктуру какие-либо данные о клиентах Майкрософт? | Да |
| Какие данные хранятся в базах данных? | имя и фамилия, адрес электронной почты |
...
| URL-адрес политики конфиденциальности | https://grow360.com/privacy |
