...
description: Все доступные сведения о безопасности и соответствия требованиям для Webex Call, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Сделайте голосовые и видеовызовы Cisco из Microsoft Teams с помощью приложения вызовов Webex. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://help.webex.com/en-US/article/ngmx08cb/Webex-Call-in...](https://help.webex.com/en-US/article/ngmx08cb/Webex-Call-integration-with-Microsoft-Teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | делегирована | Чтение участников канала teams, чтобы пользователь выбрал из них | [9a7ce614-bdc8-4640-aaea-d8c626c58966](../azure/9a7ce614-bdc8-4640-aaea-d8c626c58966.md) |
>| Contacts.Read | делегирована | Позволяет пользователю создавать наборы скорости из списка контактов | [9a7ce614-bdc8-4640-aaea-d8c626c58966](../azure/9a7ce614-bdc8-4640-aaea-d8c626c58966.md) |
