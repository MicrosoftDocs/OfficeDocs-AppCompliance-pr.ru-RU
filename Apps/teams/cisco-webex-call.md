...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Chat.Read | делегирована | Получите участников чата, чтобы можно было вызвать другого участника в частном чате с Cisco WebEx | Приложение не будет хранить данные в своих базах данных | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
>| Contacts.Read | делегирована | Получите контакты пользователей, чтобы пользователь мог вызывать контакты с Cisco WebEx | Приложение не будет хранить данные в своих базах данных | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
>| User.Read | делегирована | получить электронную почту пользователя, телефоны, чтобы они могли запустить Cisco WebEx для вызова электронной почты или телефонов | Приложение не будет хранить данные в своих базах данных | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
>| User.ReadBasic.All | делегирована | получить электронную почту пользователя, телефоны, чтобы они могли запустить Cisco WebEx для вызова электронной почты или телефонов | Приложение не будет хранить данные в своих базах данных | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
>| User.ReadWrite | делегирована | Это разрешение — хранение сведений о быстром наборе в расширение пользователя | Приложение не будет хранить данные в своих базах данных  | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
