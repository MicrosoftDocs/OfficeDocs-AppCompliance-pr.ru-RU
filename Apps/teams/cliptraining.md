...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| email | делегирована | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | af089bb5-48be-413d-ad34-53c32799da7d |
>| offline_access | делегирована | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | af089bb5-48be-413d-ad34-53c32799da7d |
>| openid | делегирована | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | af089bb5-48be-413d-ad34-53c32799da7d |
>| profile | делегирована | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | Адрес электронной почты, имя, фамилия для входа пользователя и переписки.  | af089bb5-48be-413d-ad34-53c32799da7d |
