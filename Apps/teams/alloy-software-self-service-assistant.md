...
ms.locfileid: "61176954"
---
# <a name="alloy-self-service-assistant"></a>Помощник Self-Service alloy
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Помощник Self-Service alloy |
| Идентификатор | WA200003492 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Программное обеспечение для alloy |
