---
title: Сведения о приложениях для Self-Service помощника по программному обеспечению Alloy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/19/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для alloy Self-Service Assistant, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64645910"
---
# <a name="alloy-self-service-assistant"></a>Помощник для самостоятельной помощи Alloy

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 17 июля 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003492" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые программным обеспечением Alloy Для Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Помощник для самостоятельной помощи Alloy |
| ID | WA200003492 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Программное обеспечение Alloy |
| Веб-сайт компании | [https://alloysoftware.com](https://alloysoftware.com) |
| Условия использования приложения | [https://www.alloysoftware.com/resources/eula/](https://www.alloysoftware.com/resources/eula/) |
| Основные функции приложения | Создание билетов службы, поиск база знаний и утверждение запросов. |
| Расположение штаб-квартиры компании | США Америки |
| Страница информация о приложении | [https://docs.alloysoftware.com/alloynavigator/2021/docs/int...](https://docs.alloysoftware.com/alloynavigator/2021/docs/integrations/topics/microsoft-teams-bot.htm) |
...
Эти сведения предоставлены программным обеспечением Alloy о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Обрабатывает ли приложение или инфраструктуру данные, относящиеся к клиенту Или устройству Майкрософт? | Да |
| Какие данные обрабатываются вашим приложением? | адреса электронной почты пользователей, клиенты |
...
| Какие данные хранятся в базах данных? | клиенты |
...
| Самая недавняя дата сертификации SOC2 |  2021-11-15 |
| Соответствует ли приложение средствам управления службами (SOC 3)? | Да |
| Самая недавняя дата сертификации SOC3 |  2021-11-09 |
...
| URL-адрес политики конфиденциальности | https://www.alloysoftware.com/resources/privacy/ |
