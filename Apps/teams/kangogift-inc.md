---
title: Application Information for KangoGift by KangoGift, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: Все доступные сведения о безопасности и соответствии для KangoGift, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 22d7bd22dd4ed25ea14afd216db6f48c0d076fc8
ms.sourcegitcommit: 238dca97a9cdafa78d63e74993ddfe91423fde4d
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/07/2022
ms.locfileid: "65938796"
---
# <a name="kangogift"></a>KangoGift

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 13 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые kangoGift, Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | KangoGift |
| Идентификатор | WA200004174 |
| Поддерживаемые клиенты Office 365 | Microsoft Teams |
| Название партнерской компании | KangoGift, Inc. |
| Веб-сайт компании | [https://www.kangogift.com](https://www.kangogift.com) |
| Условия использования приложения | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| Основные функциональные возможности приложения | Отправьте распознавание и благодарность. |
...
Эти сведения были предоставлены kangoGift, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Основные сведения о пользователях — имя, адрес электронной почты. Это обрабатывается в отдельном контракте, который у нас есть с клиентами.  |
...
| Какие данные хранятся в базах данных? | Основные сведения о пользователях — имя, адрес электронной почты. Это обрабатывается в отдельном контракте, который у нас есть с клиентами.  |
...
| URL-адрес политики конфиденциальности | https://www.kangogift.com/privacy |
