...
<p>Последнее обновление разработчика: 22 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Panopto Корпорации Майкрософт:
...
| Условия использования приложения | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| Основные функции приложения | Экспорт Teams в Panopto и поиск, совместное и просмотр видео Panopto без Teams.  Добавляет такие функции, как визуальный индекс каждой встречи и закрытые подписи, проверенные человеком. Access Panopto features without leaving Teams: Create a new channel tab mapped to a Panopto folder; search, and share Panopto videos; present Panopto videos in scheduled meetings; and receive notifications when a new Panopto video is ready. Нужен сайт Panopto? Посетите www.panopto.com/plans, чтобы начать работу. |
...
Эта информация предоставлена Panopto о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Самая недавняя дата сертификации SOC2 |  2021-08-19 |
| Соответствует ли приложение средствам управления службами (SOC 3)? | Да |
| Самая недавняя дата сертификации SOC3 |  2021-10-13 |
...
| URL-адрес политики конфиденциальности | https://www.panopto.com/privacy/ |
