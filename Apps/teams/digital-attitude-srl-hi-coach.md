...
description: Все доступные сведения о безопасности и соответствия требованиям для hi Digital Coach, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | привет цифровой тренер, который обучает людей, чтобы сделать большую часть Microsoft Teams. |
| Расположение штаб-квартиры компании | Италия |
| Страница информация о приложении | [https://www.habitinspiringplatform.com/coaching-plan](https://www.habitinspiringplatform.com/coaching-plan) |
