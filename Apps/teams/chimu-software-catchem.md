...
>| TeamsActivity.Send | оба | Отправка уведомлений пользователям при изменениях состояния присутствия контактов | Недоступно | fc686a41-3bd0-45b3-a56d-f278888fd694 |
