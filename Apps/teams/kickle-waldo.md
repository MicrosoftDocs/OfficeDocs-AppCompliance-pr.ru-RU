...
| Основные функции приложения | Бронирование стола, резервирование парковки. Flex office and homeworking made simple! |
| Расположение штаб-квартиры компании | Франция |
| Страница информация о приложении | [https://hellowaldo.app/takeatour/](https://hellowaldo.app/takeatour/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | делегирована | Основываясь на истории чата, Waldo идентифицирует ваших коллег. Этот список используется после этого, чтобы показать состояние в представлении календаря. | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.Read | делегирована | Это разрешение используется компонентом microsoft Graph набор средств | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.ReadBasic.All | делегирована | Это разрешение используется компонентом microsoft Graph набор средств | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| offline_access | делегирована | Используется приложением для выполнения фоновых задач от имени пользователя (обновление маркера для проверки подлинности) | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| openid | делегирована | Необходимые для проверки подлинности | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
