---
title: Сведения о приложениях для DataMiner с помощью Skyline Communications
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для DataMiner, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Skyline Communications в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | DataMiner |
| ID | WA200003501 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Skyline Communications |
| Веб-сайт компании | [https://www.skyline.be](https://www.skyline.be) |
| Условия использования приложения | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| Основные функции приложения | Skyline Communications — это глобальный ведущий поставщик решений для различных поставщиков NMS, OSS и оркестровки для средств массовой информации и широкополосной индустрии ИКТ. Наша флагманская платформа управления сетью DataMiner, которая получила различные престижные награды, позволяет комплексной интеграции самых сложных технических экосистем и была развернута ведущими операторами по всему миру. |
| Расположение штаб-квартиры компании | Бельгия |
| Страница информация о приложении | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
Эти сведения предоставлены skyline Communications о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| URL-адрес политики конфиденциальности | https://dataminer.services/terms/privacy.html |
