---
title: Application Information for CloudLabs by Spektra Systems LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для CloudLabs, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 2ff14aa43332597d249e107a72eeca062d5db8a3
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879176"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 14 октября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые spektra Systems LLC корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | CloudLabs |
| Идентификатор | WA200003273 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Spektra Systems LLC |
| Веб-сайт компании | [https://cloudlabs.ai](https://cloudlabs.ai) |
| Условия использования приложения | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| Основные функциональные возможности приложения | Подготовка к сертификации по основам облачных технологий Майкрософт с помощью тестов CloudLabs Practice |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
Эта информация была предоставлена spektra Systems LLC о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Перечисление поддерживаемых типов политик | Все политики ЦС для облачных приложений |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Имя, электронная почта, чтобы обеспечить персонализированный интерфейс и поддержку | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
