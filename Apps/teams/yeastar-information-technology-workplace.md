---
title: Сведения о приложении для окналярных рабочих мест по окналярным информационным технологиям
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
Сведения, предоставляемые корпорацией Майкрософт с использованием неавтных информационных технологий:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Yeastar Workplace |
| ID | WA200004339 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Информационные технологии Yeastar |
...
Эта информация была предоставлена по методу параметров сбора и хранения данных организации в приложении, а также о том, как ваша организация будет управлять данными, собираемые приложением.
