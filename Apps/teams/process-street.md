---
title: Сведения о приложении для process Street by Process Street
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Process Street, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64838820"
---
# <a name="process-street"></a>Обработка улицы

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 марта 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Корпорацией Майкрософт с помощью Process Street:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Обработка улицы |
| ID | WA200003933 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Обработка улицы |
| Веб-сайт компании | [https://www.process.st](https://www.process.st) |
| Условия использования приложения | [https://www.process.st/terms/](https://www.process.st/terms/) |
| Основные функциональные возможности приложения | Современная платформа управления процессами для создания, совместного использования и автоматизации основных процессов. |
...
Эта информация была предоставлена в Process Street о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://www.process.st/help/docs/gdpr-statement/ |
