...
| Основные функции приложения | Включить команду в Microsoft Teams для захвата и создания задач из транскрипции в режиме реального времени. Интеграция этих задач с существующим Project управления. |
| Расположение штаб-квартиры компании | Литва |
| Страница информация о приложении | [https://islucid.com](https://islucid.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | оба | С согласия пользователя для каждого вызова отдельно (инициированная транскрипция) он получает доступ к аудиопотоку. Аудиопоток отправляется в службу транскрипции, чтобы пользователи получат дополнительные функциональные возможности. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Calls.JoinGroupCall.All | оба | С согласия пользователя для каждого вызова отдельно (инициированная транскрипция) он получает доступ к аудиопотоку. Аудиопоток отправляется в службу транскрипции, чтобы пользователи получат дополнительные функциональные возможности. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Group.ReadWrite.All | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| OnlineMeetings.Read.All | оба | Приложение собирает названия собраний, чтобы пользователи позже (по завершению собрания) могли упростить поиск предыдущих стенограмм и задач. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Tasks.ReadWrite | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| User.ReadWrite.All | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| openid | оба | Пользовательский ID, ID клиента, собранный для Azure Active Directory функциональность входа для наших пользователей | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
