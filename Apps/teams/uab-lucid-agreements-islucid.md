...
| Основные функции приложения | Включить команду в Microsoft Teams для захвата и создания задач из транскрипции в режиме реального времени. Интеграция этих задач с существующим Project по управлению. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | оба | С согласия пользователя для каждого вызова отдельно (инициированная транскрипция) он получает доступ к аудиопотоку. Аудиопоток отправляется в службу транскрипции, чтобы пользователи получат дополнительные функциональные возможности. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| Calls.JoinGroupCall.All | оба | С согласия пользователя для каждого вызова отдельно (инициированная транскрипция) он получает доступ к аудиопотоку. Аудиопоток отправляется в службу транскрипции, чтобы пользователи получат дополнительные функциональные возможности. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| Group.ReadWrite.All | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| OnlineMeetings.Read.All | оба | Приложение собирает названия собраний, чтобы пользователи позже (по завершению собрания) могли упростить поиск предыдущих стенограмм и задач. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| Tasks.ReadWrite | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| User.ReadWrite.All | оба | Когда пользователь использует интеграцию с Microsoft Planner для создания задач из вызовов и автоматического хранения в MS Planner, isLucid собирает для этого пользователя доступные группы, планы, задатки. Без этого разрешения пользователь не сможет создать задачу из транскрипции с помощью isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
>| openid | оба | Пользовательский ID, ID клиента, собранный для Azure Active Directory функциональность входа для наших пользователей | [98b70422-b0b2-41bf-8673-60d85f5d38c7](https://docs.microsoft.com/microsoft-365-app-certification/azure/98b70422-b0b2-41bf-8673-60d85f5d38c7) |
