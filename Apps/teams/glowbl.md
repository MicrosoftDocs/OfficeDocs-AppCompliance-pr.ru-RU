---
title: Сведения о приложении для Glowbl от Glowbl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Все доступные сведения о безопасности и соответствии для Glowbl, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66892073"
---
# <a name="glowbl"></a>Свечение

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 20 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/4a32acb6-9163-4dfe-9427-d51a3f53ef42" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004368" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Glowbl корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Свечение |
| ID | WA200004368 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Свечение |
| Веб-сайт компании | [https://www.glowbl.com](https://www.glowbl.com) |
| Условия использования приложения | [https://www.glowbl.com/en/terms-of-use/](https://www.glowbl.com/en/terms-of-use/) |
| Основные функциональные возможности приложения | Используйте аутентификацию Microsoft Teams, чтобы без проблем перейти к Glowbl. Добавьте пространство Glowbl на вкладку команды, созданной для каждого сеанса обучения. Создайте события в календаре Outlook непосредственно из виртуальных пространств Glowbl. — Делитесь файлами диска SharePoint и проектами SharePoint или One (Microsoft Word, Microsoft Excel и Microsoft Powerpoint) в смарт-таблицах Glowbl, не открывая новое окно браузера или не делясь экраном |
...
Эта информация была предоставлена Glowbl о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Почта пользователя, имя, фамилия |
...
| Какие данные хранятся в базах данных? | Почта пользователя, имя, фамилия |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Франция |
...
| URL-адрес политики конфиденциальности | https://www.glowbl.com/en/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Делегированные | Только в том случае, если пользователям нужно показывать документы в сеансе Glowbl (средство выбора Sharepoint) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| Files.Read.All | Делегированные | Только в том случае, если пользователям нужно показывать документы в сеансе Glowbl (средство выбора Sharepoint) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| User.Read | Делегированные | Вход пользователя и чтение профиля пользователя | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| email | Делегированные | Получение электронной почты пользователя для правил доступа к пространству Glowbl на основе сообщений электронной почты | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| openid | Делегированные | Вход пользователя | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| profile | Делегированные | Просмотр базового профиля пользователя для перечисления участников в сеансах Glowbl | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
