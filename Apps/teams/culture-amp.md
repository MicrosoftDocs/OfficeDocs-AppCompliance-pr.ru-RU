---
title: Сведения о приложении для языка и региональных параметров amp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для culture amp, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: fb131544ed755035af4adc26321e2d2bf0fc51ff
ms.sourcegitcommit: 9f7e69c17034365cafea977da23961d4e934ad9f
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/07/2022
ms.locfileid: "64698983"
---
# <a name="culture-amp"></a>Язык и региональные параметры

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 6 апреля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/13a11229-3c3e-49d5-843b-71d204a5b5ee" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001744" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт по языку и региональным параметрам:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Язык и региональные параметры |
| ID | WA200001744 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Язык и региональные параметры |
| Веб-сайт компании | [https://www.cultureamp.com](https://www.cultureamp.com) |
| Условия использования приложения | [https://www.cultureamp.com/terms/](https://www.cultureamp.com/terms/) |
| Основные функциональные возможности приложения | Помогите сотрудникам делиться отзывами и получать доступ к сведениям о языке и региональных параметрах из Microsoft Teams |
...
Эти сведения были предоставлены в culture Amp о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные хранятся в базах данных? | адреса электронной почты для справки по беседам |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Ирландия, США Америки |
...
| URL-адрес политики конфиденциальности | https://www.cultureamp.com/terms/ |
