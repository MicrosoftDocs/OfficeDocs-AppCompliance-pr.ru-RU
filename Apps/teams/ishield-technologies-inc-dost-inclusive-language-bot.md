---
title: Application Information for Dost - Inclusive Language Bot by ishield Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Все доступные сведения о безопасности и соответствии для Dost — инклюзивного языкового бота, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66547287"
---
# <a name="dost---inclusive-language-bot"></a>Dost — инклюзивный языковой бот

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчиком: 5 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые ishield Technologies, Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Dost — инклюзивный языковой бот |
| ID | WA200004214 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | ishield Technologies, Inc. |
| Веб-сайт компании | [https://ishield.ai](https://ishield.ai) |
| Условия использования приложения | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| Основные функциональные возможности приложения | Рекламирование инклюзивного обмена сообщениями на рабочем месте, совместной работы и общения в ваших командах с помощью Dost. При добавлении Dost в рабочую область Microsoft Teams Dost поможет вам использовать инклюзивный язык в сообщениях с помощью предложений и учебных материалов.  Dost отображает моменты обучения в режиме реального времени, когда пользователь отправляет сообщения, содержащие нестрогую смещение, микроагрессию или язык без инклюзивности, с рекомендациями по изменению и повышению инклюзивности. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://getdost.com](https://getdost.com) |
...
Эта информация была предоставлена ishield Technologies, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Приложение обрабатывает сообщения MS Teams в Teams и области чата, но не хранит пользовательские сообщения или сведения |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | приложение | Чтение сообщений в области Teams для предоставления отзывов пользователю на языке, отличном от инклюзивного | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | приложение | Чтение сообщений в области чата для предоставления отзывов пользователю на языке, отличном от инклюзивного | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
