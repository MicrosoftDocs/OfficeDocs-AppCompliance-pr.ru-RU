---
title: Сведения о приложениях для Mia от MiHCM
ms.author: elmalova
author: elenamalova
ms.date: 12/20/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Mia, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0b48e71e-8f46-46d8-a545-608295f000ac" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002417" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые MiHCM Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Mia |
| Идентификатор | WA200002417 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | MiHCM |
| Веб-сайт компании | [https://mihcm.com](https://mihcm.com) |
| Условия использования приложения | [https://mia.work/terms-of-use](https://mia.work/terms-of-use) |
| Основные функции приложения | Mia Workplace Виртуальный помощник позволяет организации предоставлять персональный виртуальный помощник для всех Microsoft Teams пользователей. Этот помощник по рабочим Microsoft Teams помогает вашей организации повысить производительность, повысить вовлеченность сотрудников, выполнение множества запросов по персоналу, запросов на работу, фитнес-благополучия и &amp; других. Mia устанавливает вовлеченность сотрудников, бесперебойное взаимодействие сотрудников для мирской службы кадров и взаимодействий. |
| Расположение штаб-квартиры компании | Шри-Ланка |
...
Эта информация предоставлена MiHCM о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | События календаря пользователей, часовой пояс пользователя |
| Если в процессе infastructure или хранятся данные клиентов Microsoft, где эти данные географически хранятся? | Сингапур |
...
| URL-адрес политики конфиденциальности | https://mia.work/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | приложение | Чтение запланированных событий календаря пользователя | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| Group.Read.All | делегирована | Чтение задач microsoft Planner пользователя | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| MailboxSettings.Read | приложение | Чтение часового пояса пользователя | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| User.Read | делегирована | Уникальность идентификации пользователя | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
