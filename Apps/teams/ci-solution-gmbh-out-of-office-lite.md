...
description: Все доступные сведения о безопасности и соответствии требованиям для CI-Out-of-Office Lite, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | С помощью ci-Out-of-Office Lite уведомления об отсутствии можно стандартизировать и централизованно контролировать по всей компании. С помощью этого отмеченного наградами приложения (включая отраслевые награды, премии по инновациям и ИТ)вы можете обеспечить профессиональное, единообразное и корпоративное управление удостоверением вне офиса для вашей компании в Microsoft 365. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | делегирована | Просмотр электронных адресов пользователей | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](../azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da.md) |
