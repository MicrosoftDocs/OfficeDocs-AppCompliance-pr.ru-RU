...
>| email | делегирована | электронная почта используется в рамках регистрации пользователей в Neelix. После начальной регистрации для уведомлений используется электронная почта.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| offline_access | делегирована | Это используется для получения маркера обновления | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| profile | делегирована | Имя пользователя используется для создания учетной записи пользователя при регистрации в Neelix.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| User.Read | делегирована | Бот-приложение использует user.read, чтобы иметь возможность отправлять сведения пользователю, чтобы основная платформа Neelix смогла идентифицировать пользователя | [bed170ee-dbd7-4efa-b48e-b0937ded1689](https://docs.microsoft.com/microsoft-365-app-certification/azure/bed170ee-dbd7-4efa-b48e-b0937ded1689) |
