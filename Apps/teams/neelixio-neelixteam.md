...
| Основные функции приложения | Платформа Neelix управляет циклом обратной связи в качестве полного цикла. Пользователи могут канал текущего опыта, ретроспективных отзывов и настроений в журнал своей команды. |
| Расположение штаб-квартиры компании | Австралия |
| Страница информация о приложении | [https://www.neelix.team](https://www.neelix.team) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | делегирована | Приложение использует ids и имена каналов, чтобы обеспечить удобство для пользователей для управления своими предпочтениями по умолчанию при отправке отзывов от MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | делегирована | Приложение использует командные ids и имена для удобства пользователей для управления своими предпочтениями по умолчанию при отправке отзывов от MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| email | делегирована | электронная почта используется в рамках регистрации пользователей в Neelix. После начальной регистрации для уведомлений используется электронная почта.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | делегирована | Это используется для получения маркера обновления | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| profile | делегирована | Имя пользователя используется для создания учетной записи пользователя при регистрации в Neelix.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | делегирована | Бот-приложение использует user.read, чтобы иметь возможность отправлять сведения пользователю, чтобы основная платформа Neelix смогла идентифицировать пользователя | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
