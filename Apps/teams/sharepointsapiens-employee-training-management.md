---
title: Сведения о приложении для управления обучением сотрудников по SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Сведения на этой странице основаны на отчете о самостоятельной оценке, предоставленном разработчиком приложения, о рекомендациях по обеспечению безопасности, соответствия требованиям и обработке данных, за которыми следует это приложение.
...
* <a href="https://teams.microsoft.com/l/app/17b6b751-7463-4afd-a3ae-ad26a20c8904" target="_blank">Просмотр в Teams хранилище</a>
...
| Основные функциональные возможности приложения | Надстройка "Управление обучением сотрудников" упрощает упорядочение и администрирование профессиональной разработки сотрудников. От настройки и планирования обучающих мероприятий, управления обучающимися, их назначений и регистраций до отслеживания достижениях и отзывов — все рассматривается. Надстройка помогает выполнять нормативные требования и политики безопасности. Он позволяет назначать необходимые учебные курсы, отслеживать достижения, управлять сроками действия и многое другое. |
| Расположение компании | Австрия |
| Страница сведений о приложении | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/documentation/teams/) |
