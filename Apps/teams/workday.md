...
| Условия использования приложения | [https://nw.myworkday.com/microsoftteams/post-license/](https://nw.myworkday.com/microsoftteams/post-license/) |
| Основные функции приложения | Добавьте рабочий день в Teams для простых и не фрикционных кадровых и финансовых задач!  Дополнительные сведения о безопасности приложений и конфиденциальности данных клиенты Workday должны ссылаться на описание службы инноваций в естественных рабочих пространствах и группу пользователей natural Workspaces в рабочей среде Community. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://nw.myworkday.com/microsoftteams/](https://nw.myworkday.com/microsoftteams/) |
...
| Какие данные хранятся в базах данных? | ID клиента Майкрософт, пользовательский AAD объект, ID беседы |
...
| Самая недавняя дата сертификации SOC1 |  2021-09-30 |
