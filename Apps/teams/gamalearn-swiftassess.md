---
title: Сведения о приложении для SwiftAssess от GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Вся доступная информация о безопасности и соответствии для SwiftAssess, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: d770deb40400db769349c06a32740a7701d616ec
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64866891"
---
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые GamaLearn корпорации Майкрософт:
...
| Название партнерской компании | GamaLearn |
...
| Основные функциональные возможности приложения | Единое место для всех потребностей оценки, начиная от опробоваемых и истинных методологий и функций, которые обеспечивают разработку, доставку и отслеживание стратегии преобразования оценки на всех уровнях в организации. SwiftAssess предлагает несколько ключевых решений, функций и рабочих процессов, которые упрощают и автоматизируют реальные процессы оценки в разных учреждениях. Это охватывает отраслевые стандарты, когда речь идет о безопасности, специальных возможностях, аналитике, банках элементов и т. д. |
| Расположение компании | Объединенные Арабские Оаэ (сша) |
| Страница сведений о приложении | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
Эта информация была предоставлена GamaLearn о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
