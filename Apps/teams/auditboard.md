---
title: Сведения о приложениях для аудита по AuditBoard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для AuditBoard, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003600" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые АудитБордом Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | AuditBoard |
| ID | WA200003600 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | AuditBoard |
| Веб-сайт компании | [https://www.auditboard.com](https://www.auditboard.com) |
| Условия использования приложения | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| Основные функции приложения | Позволяет абонентам AuditBoard получать уведомления в Microsoft Teams. |
...
Эта информация предоставлена Аудиторской палатой о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Самая недавняя дата сертификации SOC2 |  2021-11-04 |
...
| URL-адрес политики конфиденциальности | https://www.auditboard.com/privacy-policy/ |
