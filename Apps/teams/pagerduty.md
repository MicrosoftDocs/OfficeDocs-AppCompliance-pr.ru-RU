---
title: Сведения о приложении для PagerDuty от PagerDuty
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
Сведения, предоставляемые PagerDuty корпорации Майкрософт:
...
| Название партнерской компании | PagerDuty |
...
Эта информация была предоставлена PagerDuty о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
