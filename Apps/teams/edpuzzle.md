---
title: Сведения о приложении для Edpuzzle от Edpuzzle
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/19/2022
...
description: Вся доступная информация о безопасности и соответствии для Edpuzzle, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9767c4fd-7319-4d64-8b6a-941b02d11ffd" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003736" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Edpuzzle корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Edpuzzle |
| ID | WA200003736 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Edpuzzle |
| Веб-сайт компании | [https://edpuzzle.com](https://edpuzzle.com) |
| Условия использования приложения | [https://edpuzzle.com/terms](https://edpuzzle.com/terms) |
| Основные функциональные возможности приложения | Создавайте интересные видеоучеты с помощью Edpuzzle и просматривайте видео от пассивного к активному!  Отправьте видео, повторно используйте видеокурс, созданный другим преподавателем, или запишите собственное видео с помощью собственного средства записи экрана.  Затем вставьте собственные вопросы, комментарии и звук, чтобы персонализировать видео для учащихся.  Получите данные о том, кто просмотрел видео в режиме реального времени, сколько вопросов они ответили правильно и многое другое! |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://edpuzzle.com](https://edpuzzle.com) |
...
Эта информация была предоставлена Edpuzzle о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Microsoft Id, email, first name, last name and Teams names |
...
| Какие данные хранятся в базах данных? | Microsoft Id, email, first name, last name and Teams names |
...
| URL-адрес политики конфиденциальности | https://edpuzzle.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| EduAssignments.ReadWrite | Делегированные | Он используется для создания назначений из нашего приложения. Преподаватель создает задание видео в Edpuzzle, а затем мы создадим его в Microsoft Teams с соответствующим вложением. | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| Team.ReadBasic.All | Делегированные | Он используется &quot;&quot; для импорта Microsoft Teams команд или аудиторий в Edpuzzle. Таким образом, преподавателям не нужно создавать классы в Edpuzzle, которые они уже создали в Microsoft Teams. | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| TeamMember.Read.All | Делегированные | Он используется, чтобы убедиться, что учащиеся, которые входят в систему с помощью Microsoft в Edpuzzle, принадлежат к команде в Microsoft Teams, прежде чем разрешить им просматривать задания в Edpuzzle. По сути, это используется по причинам авторизации. | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| User.Read | Делегированные | Он используется для проверки подлинности в Edpuzzle | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| email | Делегированные | Он используется для проверки подлинности в Edpuzzle. | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| offline_access | Делегированные | Чтобы сохранить маркеры доступа и маркеры обновления, чтобы использовать их для синхронизации Edpuzzle с Microsoft Teams, в частности синхронизировать оценки заданий по мере их завершения учащимися и избежать необходимости запрашивать разрешения каждый раз, когда преподаватель хочет перенести класс Microsoft Teams в Edpuzzle. | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| profile | Делегированные | Он используется для проверки подлинности в Edpuzzle | [3540209e-c425-4c2e-b3dc-be79e8c0abee](../azure/3540209e-c425-4c2e-b3dc-be79e8c0abee.md) |
>| email | Делегированные | Для проверки подлинности | [bffbcd4d-00b8-4375-9951-1928250b636e](../azure/bffbcd4d-00b8-4375-9951-1928250b636e.md) |
>| profile | Делегированные | Для проверки подлинности | [bffbcd4d-00b8-4375-9951-1928250b636e](../azure/bffbcd4d-00b8-4375-9951-1928250b636e.md) |
