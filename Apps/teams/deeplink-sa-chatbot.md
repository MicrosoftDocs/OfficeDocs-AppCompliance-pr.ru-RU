---
title: Application Information for Deeplink Chatbot by Deeplink SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Вся доступная информация о безопасности и соответствии для Чат-бота Deeplink, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: b55850879d88775ea71291a53bf32eef70e456b8
ms.sourcegitcommit: cede428f2a23bd3060f5506f270b40b327b02769
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66547367"
---
# <a name="deeplink-chatbot"></a>Чат-бот Deeplink

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 13 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Sa Deeplink в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Чат-бот Deeplink |
| ID | WA200004200 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Deeplink SA |
| Веб-сайт компании | [https://www.deeplink.ai](https://www.deeplink.ai) |
| Условия использования приложения | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| Основные функциональные возможности приложения | Deeplink позволяет настроить полностью настраиваемый чат-бот, также называемый агентом беседы, на базе ИИ и получить к нему доступ в Microsoft Teams в основе ваших ежедневных взаимодействий. С помощью Teams вы добавляете новую сенсорную точку в существующий помощник и предоставляете прямой доступ к расширенным службам, таким как ИТ-служба поддержки, бот учебника или агент конфигурации. |
| Расположение компании | Швейцария |
| Страница сведений о приложении | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
Эти сведения предоставлены SA Deeplink о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Швейцария |
