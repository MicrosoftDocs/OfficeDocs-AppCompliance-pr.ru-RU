...
description: Все доступные сведения о безопасности и соответствия требованиям для Eloops, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Платформа вовлечения сотрудников, которая работает,&#8217;не чувствует себя работой |
| Расположение штаб-квартиры компании | Израиль |
| Страница информация о приложении | [https://eloops.com/microsoft-teams-integration-help-center/](https://eloops.com/microsoft-teams-integration-help-center/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Мы используем имя пользователя&#8217;имя и фамилию для регистрации в потоке SSO | [431a9917-9c32-480e-a584-6c149e7b7213](../azure/431a9917-9c32-480e-a584-6c149e7b7213.md) |
