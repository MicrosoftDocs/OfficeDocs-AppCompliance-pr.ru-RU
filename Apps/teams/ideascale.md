---
title: Сведения о приложениях для IdeaScale по IdeaScale
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для IdeaScale, политики обработки данных, сведения о каталоге Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: bc9cd5f07cf7b091e818fde16b74745ead80fd12
ms.sourcegitcommit: af065aeee2812a85ead9e0de968fc474204a6e8a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/22/2022
ms.locfileid: "63698861"
---
# <a name="ideascale"></a>IdeaScale

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 29 января 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые IdeaScale корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | IdeaScale |
| ID | WA200003868 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | IdeaScale |
| Веб-сайт компании | [https://ideascale.com](https://ideascale.com) |
| Условия использования приложения | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| Основные функции приложения | IdeaScale является ведущей платформой управления идеями для инновационных групп. Любой человек в вашей организации может обмениваться идеями, которые видны другим в сообществе, а также собирать отзывы и ресурсы, чтобы превратить эти идеи в новые продукты или проекты. Теперь вы можете подключить свое сообщество IdeaScale к рабочей Microsoft Teams, чтобы управлять идеями, не Teams. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
Эта информация предоставлена IdeaScale о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| URL-адрес политики конфиденциальности | https://ideascale.com/privacy-policy |
