---
title: Сведения о приложениях для TagMyFav от Avishkaram Technologies Pvt Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: 'Все доступные сведения о безопасности и соответствии требованиям для TagMyFav, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставленные корпорацией Майкрософт avishkaram Technologies Pvt Ltd:
...
| Имя компании-партнера | Avishkaram Technologies Pvt Ltd |
...
| Основные функции приложения | TagMyFav для Microsoft 365 вам легкое решение закладок, чтобы упростить &amp; совместную связь. Сохраните &amp; ссылки на долю во время беседы в Microsoft Teams, при чтении электронной почты в Outlook, при создании документов в Word или при исследовании в браузере. TagMyFav подходит для всех отраслей, таких как поддержка клиентов, техническая поддержка, юрист, &amp; преподаватель, маркетинг, hr и т. д. Для организации и обмена ссылками, полезными для совместной работы или исследований. |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
Эта информация предоставлена Avishkaram Technologies Pvt Ltd о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Обрабатывает ли приложение или инфраструктуру данные, относящиеся к клиенту Или устройству Майкрософт? | Да |
| Какие данные обрабатываются вашим приложением? | Данные профилей пользователей, электронная почта |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | делегирована | Чтение контактов пользователя | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | делегирована | Чтение базовых сведений о профиле пользователей | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| email | делегирована | просмотр электронной почты пользователей | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | делегирована | Сохранение доступа к данным, к которым он был предоставлен | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | делегирована | signin the user | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| profile | делегирована | Просмотр профиля пользователей | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
