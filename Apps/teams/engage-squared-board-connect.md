...
| Основные функции приложения | Совет Подключение помогает организациям эффективнее запускать собрания. Приложение Microsoft Teams, связанное с командой Майкрософт, позволяет организациям создавать собрания, управлять повестками дня, опросами, документами и другими. Приложение также интегрируется с Outlook и группами Office 365 для создания новых событий календаря и оказания помощи в организации и управлении событием секретарей советов директоров. |
| Расположение штаб-квартиры компании | Австралия |
| Страница информация о приложении | [https://boardconnect.app](https://boardconnect.app) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | Чтобы разрешить приложению обновлять календари пользователей, чтобы они отражали ответы на собрания совета директоров, представленные через приложение. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Group.ReadWrite.All | делегирована | Разрешить приложению создавать, обновлять и удалять события группового календаря. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Sites.Manage.All | делегирована | Чтобы разрешить приложению создавать списки и библиотеки, управлять элементами списка и управлять документами в коллекции сайтов группы. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.Read | делегирована | Чтобы разрешить пользователям войти в приложение и разрешить приложению считывать профиль пользователя, подписанного в данный момент. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.ReadBasic.All | делегирована | Чтобы приложение считывало базовый набор свойств профилей других пользователей от имени подписанного пользователя, чтобы отобразить это в приложении. Это включает отображение имени, имени и фамилии, адреса электронной почты и фотографии. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| offline_access | делегирована | Чтобы включить приложение для получения маркера обновления, который он может использовать для получения нового маркера доступа по истечении текущего срока действия. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
