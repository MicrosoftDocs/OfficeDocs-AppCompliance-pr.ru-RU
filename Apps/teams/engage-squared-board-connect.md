---
title: Application Information for Board Подключение by Engage Squared
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Все доступные сведения о безопасности и соответствии для board Подключение, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: d4eee49174a0ed6cce9c78eaf7186cad36ad0e57
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881326"
---
...
* <a href="https://teams.microsoft.com/l/app/e8f06a4e-cefe-4b1e-a24b-c97bea471130" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт с помощью Engage Squared:
...
| Название партнерской компании | Engage Squared |
| Веб-сайт компании | [https://engagesq.com](https://engagesq.com) |
| Условия использования приложения | [https://boardconnect.app/terms](https://boardconnect.app/terms) |
| Основные функциональные возможности приложения | Доска Подключение помогает организациям более эффективно выполнять собрания. Приложение Microsoft Teams, связанное с командой Майкрософт, позволяет организациям создавать собрания, управлять повестками дня, опросами, документами и т. д. Приложение также интегрируется с Outlook календарями и группами Office 365 для создания новых событий календаря и помощи с досками, которые будут управлять этим событием. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://boardconnect.app](https://boardconnect.app) |
...
Эта информация была предоставлена в Engage Squared о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Делегированные | Чтобы разрешить приложению обновлять календари пользователей, чтобы они отражали ответы на собрания, отправленные через приложение. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Group.ReadWrite.All | Делегированные | Чтобы разрешить приложению создавать, обновлять и удалять события календаря группы. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Sites.Manage.All | Делегированные | Чтобы разрешить приложению создавать списки и библиотеки, управляйте элементами списков и документами в семействе веб-сайтов группы. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.Read | Делегированные | Чтобы разрешить пользователям входить в приложение и разрешить приложению считывать профиль текущего пользователя, выполнившего вход. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.ReadBasic.All | Делегированные | Позволяет приложению считывать базовый набор свойств профиля других пользователей от имени вошедвшего пользователя, чтобы отобразить его в приложении. К ним относятся отображаемое имя, имя и фамилия, адрес электронной почты и фотография. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| offline_access | Делегированные | Чтобы разрешить приложению получать маркер обновления, который можно использовать для получения нового маркера доступа по истечении срока действия текущего маркера. | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
