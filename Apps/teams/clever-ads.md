...
| URL-адрес веб-сайта-партнера | [https://cleverads.com](https://cleverads.com) |
| URL-адрес политики конфиденциальности | [https://cleverads.com/privacy-policy](https://cleverads.com/privacy-policy) |
| URL-адрес терминов использования | [https://cleverads.com/terms-conditions](https://cleverads.com/terms-conditions) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | делегирована | User.Read. Мы храним upN, AzureObjectId для идентификации пользователя. | User.Read позволяет пользователю войти в панель мониторинга приложений. Для регистрации пользователя мы используем upN, AzureObjectId. | [ac2b56c0-f2a5-4e90-b618-882f8d3596f0](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac2b56c0-f2a5-4e90-b618-882f8d3596f0) |
