...
><span data-ttu-id="6b61a-128">Это приложение не использует Microsoft Graph.</span><span class="sxs-lookup"><span data-stu-id="6b61a-128">This application does not use Microsoft Graph.</span></span>
