---
title: Сведения о приложении для ChurnZero от ChurnZero
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для ChurnZero, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 39f332352568d86392a98c77d18faff445deb7d0
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880686"
---
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые ChurnZero корпорации Майкрософт:
...
| Название партнерской компании | ChurnZero |
| Веб-сайт компании | [https://churnzero.net](https://churnzero.net) |
| Условия использования приложения | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Основные функциональные возможности приложения | ChurnZero — это платформа успешной работы клиентов в режиме реального времени, которая помогает компаниям подписок управлять оттоком, расширять текущие учетные записи, расширять внедрение продуктов и оптимизировать взаимодействие с клиентами. |
...
Эта информация была предоставлена ChurnZero о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Идентификатор объекта Azure делегированного пользователя для сопоставления с пользователем ChurnZero, чтобы определить и авторизовать этого пользователя во время будущего сеанса бота. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
