---
title: Информация о приложении для TeamMate от ChitChattr от ChitChattr
ms.author: elmalova
author: elenamalova
ms.date: 03/11/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для TeamMate от ChitChattr, ее политики обработки данных, ее Microsoft Cloud App Security информация каталога приложений и информация о безопасности/соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4c2dfafa-ecd7-495f-a2d6-fb115201daff" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002530" target="_blank">Посмотреть в AppSource</a>
...
| URL-адрес Teams страницы информации о приложениях | [https://www.chitchattr.com/teammate/](https://www.chitchattr.com/teammate/) |
| URL политики конфиденциальности | [https://www.chitchattr.com/privacy?p=teammate](https://www.chitchattr.com/privacy?p=teammate) |
| URL условий использования | [https://www.chitchattr.com/termsofuse?p=teammate](https://www.chitchattr.com/termsofuse?p=teammate) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| People.Read | Делегированные | Приложение позволяет администраторам выбирать пользователей для таргетинга на определенный опыт, поэтому ему необходимо хранить имя пользователя, электронную почту и Идентификатор объекта Azure AD | Приложение позволяет администраторам выбирать пользователей для таргетинга на определенный опыт, поэтому ему необходимо хранить имя пользователя, электронную почту и Идентификатор объекта Azure AD | a8e903c7-3b7f-4ec5-a474-b5d32e595f50 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| В случае каких-либо проблем, бот будет искать и показывать пользователю имена и контактные данные пользователей, зарегистрированных в качестве администраторов в приложении (по существу &quot; связаться с вашим администратором-это, кто &quot; они) | Имя, Электронная почта | Как описано в предыдущих разделах - чтобы иметь возможность идентифицировать пользователей для целевого опыта (на основе их администратора настройки его) и чтобы пользователи могли видеть, кто их внутренние администраторы компании для приложения. |
...
| Перечислите типы поддерживаемых политик | Требование многофакторной аутентификации для пользователей с административными ролями, требование членства пользователя или группы для пользователей с административными ролями |
