---
title: Сведения о приложениях для Fond by Fond Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/04/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для Fond, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63538157"
---
# <a name="fond"></a>Fond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 17 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/d25d7cc9-0a7e-41e2-ad98-f446141a8ffa" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003631" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные корпорацией Fond Technologies, Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Fond |
| ID | WA200003631 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Fond Technologies, Inc. |
| Веб-сайт компании | [https://fond.co](https://fond.co) |
| Условия использования приложения | [https://www.fond.co/tos/](https://www.fond.co/tos/) |
| Основные функции приложения | Отпразднуйте достижения коллег с помощью Fond |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://fond.co/products/features/fond-teams-integration/](https://fond.co/products/features/fond-teams-integration/) |
...
Эти сведения предоставлены фондом Fond Technologies, Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | ID клиента клиента, имя команды, имя канала, URL-адрес веб-страницы |
...
| Самая недавняя дата сертификации SOC2 |  2020-09-01 |
...
| URL-адрес политики конфиденциальности | https://www.fond.co/privacy/ |
