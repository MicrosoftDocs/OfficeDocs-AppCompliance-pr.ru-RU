---
title: Сведения о приложении adobe Creative Cloud Express от Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Все доступные сведения о безопасности и соответствии для Adobe Creative Cloud Express, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">Просмотр в Teams хранилище</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Adobe Creative Cloud Express |
| ID | WA200003946 |
...
| Основные функциональные возможности приложения | Adobe Spark позволяет создавать привлекательные визуальные истории, эффектные социальные рисунки, веб-страницы и короткие видео за несколько минут. Теперь вы можете легко делиться ими в Microsoft Teams |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.adobe.com/express](https://www.adobe.com/express) |
