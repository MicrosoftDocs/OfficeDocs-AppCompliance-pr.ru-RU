---
title: Application Information for Onsight Подключение by Librestream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Все доступные сведения о безопасности и соответствии для onsight Подключение, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 1a8159596c343596c74ed2590681caa552ad6d0e
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876336"
---
...
* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Librestream |
| Веб-сайт компании | [https://librestream.com](https://librestream.com) |
| Условия использования приложения | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| Основные функциональные возможности приложения | Усовершенствовайте стратегию цифрового преобразования, чтобы предоставить сотрудникам и клиентам непосредственный доступ к содержимому, людям, интеллектуальным данным и рекомендациям, необходимым для быстрого анализа и решения проблем. Развернутая глобально платформа дополненной реальности Onsight повышает эффективность эксплуатации в таких отраслях, как производство, энергию, интенсивное оборудование и выездное обслуживание. |
...
Эта информация была предоставлена Librestream о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
