...
description: Вся доступная информация о безопасности и соответствии требованиям для Myfone, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | H&#229;ndter dine telefonopkald i Teams, og f&#229; overblik over dine kolleger. |
| Расположение штаб-квартиры компании | Дания |
| Страница информация о приложении | [https://faq.flexfone.dk/da](https://faq.flexfone.dk/da) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | SelfHosted, Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | делегирована | Календари используются для того, чтобы пользователи могли показывать коллегам свою календару и использовать собрания для настройки телефонии | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| Contacts.Read | делегирована | Контакты пользователей можно хранить, если они хотят показать их в приложении, чтобы упростить набор контактов | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | делегирована | Чтение пользователя в этом приложении используется для идентификации. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | делегирована | Мы не храним данные. Приложение просто используется в целях authentification | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |
