---
title: Сведения о приложении для Myfone от Flexfone
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для Myfone, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: dc99692b41520d82ce37e4fac0677135a7894ef1
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879772"
---
...
* <a href="https://teams.microsoft.com/l/app/5f447fa4-da1f-4651-a0da-d2488a404c19" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Flexfone |
| Веб-сайт компании | [https://flexfone.dk](https://flexfone.dk) |
| Условия использования приложения | [https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf](https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf) |
| Основные функциональные возможности приложения | H&#229;ndter dine telefonopkald i Teams, og f&#229; overblik over dineleger. |
| Расположение компании | Дания |
| Страница сведений о приложении | [https://faq.flexfone.dk/da](https://faq.flexfone.dk/da) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | SelfHosted, Azure |
...
Эта информация была предоставлена Flexfone о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Перечисление поддерживаемых типов политик | Многофакторная аутентификация |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Делегированные | Календари используются для того, чтобы пользователи могли показывать своим коллегам свой кэшар и использовать собрания для настройки телефонии. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| Contacts.Read | Делегированные | Контакты пользователей могут храниться, если они хотят показать их в приложении, чтобы упростить набор контактов | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Делегированные | Чтение пользователя в этом приложении используется для идентификации. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Делегированные | Мы не храним данные. Приложение просто используется для проверки подлинности | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |
