---
title: Сведения о приложении для Wurqi от Wurqi
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Вся доступная информация о безопасности и соответствии для Wurqi, ее политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 17386753fed492c266a1acec2151ce6dcca443b6
ms.sourcegitcommit: 238dca97a9cdafa78d63e74993ddfe91423fde4d
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/07/2022
ms.locfileid: "65938808"
---
# <a name="wurqi"></a>Вураки (Wurqi)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 11 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Wurqi корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Вураки (Wurqi) |
| Идентификатор | WA200004161 |
| Поддерживаемые клиенты Office 365 | Microsoft Teams |
| Название партнерской компании | Вураки (Wurqi) |
| Веб-сайт компании | [https://wurqi.com](https://wurqi.com) |
| Условия использования приложения | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| Основные функциональные возможности приложения | Wurqi — это платформа управления работой, которая интегрирует все ваши рабочие, проекты и коммуникации. Приложение Teams предоставляет пользователям страницу только для просмотра, на которой будут отображаться все сведения о проекте, над которым они работают, что позволяет всем пользователям в команде видеть ход выполнения задач.  |
...
Эта информация была предоставлена Wurqi о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Многофакторная проверка подлинности (MFA) включена для: | DNSManagement, CodeRepositories |
...
| URL-адрес политики конфиденциальности | https://wurqi.com/privacy-policy/ |
