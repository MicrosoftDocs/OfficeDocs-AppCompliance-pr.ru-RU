---
title: Сведения о приложениях для доски Lucidspark от Lucidd Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
| Основные функции приложения | Lucidspark — это облачная виртуальная доска, в которой команды могут выводить свои лучшие идеи на свет. Brainstorm и совместное взаимодействие в режиме реального времени независимо от&#8217;удаленной или личной работы. Lucidspark помогает людям организовывать заметки и записи и превращать их в концепции, готовые к презентации. Когда&#8217;время для следующих действий, команды могут разрабатывать рабочий процесс и обрабатывать документы, чтобы превратить идеи в реальность. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | делегирована | Имя и адрес электронной почты. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | делегирована | Имя и адрес электронной почты. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| profile | делегирована | Имя и адрес электронной почты. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
