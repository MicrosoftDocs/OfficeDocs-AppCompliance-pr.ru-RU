...
| Основные функции приложения | Выровняйте совместную работу в организациях на следующий уровень, агрегируя контент и показывая сотрудникам, что важно. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | делегирована | В области Мои собрания мы получаем собрания пользователя сегодня &quot; &quot; и завтра. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| Sites.ReadWrite.All | делегирована | Мы получаем все последующие сайты SharePoint пользователя и отобразим их в области Моя работа в команде, и мы получаем все задачи SharePoint пользователя и отобразим их в области Мои задачи &quot; &quot; &quot; &quot; . | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| Tasks.ReadWrite | делегирована | Мы читаем планировщик пользователя и выполнение задач и отображаем их в области &quot; Мои &quot; задачи. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| Team.ReadBasic.All | делегирована | Мы получаем присоединяемую команду пользователя и отобразим их в области &quot; My &quot; Teamwork. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| User.ReadBasic.All | делегирована | В области &quot; Мои документы &quot; мы отображаем пользователя, которому было совместное | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| User.ReadWrite | делегирована | Последние документы пользователя отображаются в области &quot; Мои &quot; документы. Любимые приложения пользователя хранятся в качестве расширения схемы в ms Graph. Этот уровень разрешений необходим для чтения и записи данных на графике. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| email | делегирована | Получить электронную почту пользователей (стандартная область Teams MS) | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| offline_access | делегирована | Область стандартного Teams MS | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| openid | делегирована | Вход в пользователей. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
>| profile | делегирована | Вход в процесс MS Teams | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](https://docs.microsoft.com/microsoft-365-app-certification/azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953) |
