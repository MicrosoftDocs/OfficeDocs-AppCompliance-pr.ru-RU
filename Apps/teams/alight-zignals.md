...
description: Все доступные сведения о безопасности и соответствия требованиям для Zignals, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://zignals.eu/zignals-support/](https://zignals.eu/zignals-support/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | делегирована | В области &quot;Мои собрания&quot; мы получаем собрания пользователя сегодня и завтра. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Sites.ReadWrite.All | делегирована | Мы получаем &quot;&quot; &quot;&quot;все последующие сайты SharePoint пользователя и отобразим их в области Моя работа в команде, а также получаем все SharePoint и отображаем их в области Мои задачи. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Tasks.ReadWrite | делегирована | Мы читаем планировщик пользователя и задачи и отображаем их в области &quot;Мои задачи&quot;. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Team.ReadBasic.All | делегирована | Мы получаем присоединяемую команду пользователя и отобразим их в области &quot;My Teamwork&quot; . | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| User.ReadBasic.All | делегирована | В области &quot;Мои документы&quot; мы отображаем пользователя, которому было совместное | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| User.ReadWrite | делегирована | Последние документы пользователя &quot;отображаются в области Мои документы&quot;. Любимые приложения пользователя хранятся в качестве расширения схемы в ms Graph. Этот уровень разрешений необходим для чтения и записи данных на графике. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| email | делегирована | Получить электронную почту пользователей (стандартная область Teams MS) | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| offline_access | делегирована | Область стандартного Teams MS | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| openid | делегирована | Вход в пользователей. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| profile | делегирована | Вход в процесс MS Teams | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
