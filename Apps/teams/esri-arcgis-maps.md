...
| Условия использования приложения | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| Основные функции приложения | ArcGIS Online включает набор приложений, авторитетные карты и данные по тысячам тем, современные средства сопоставления, необходимые для визуализации данных, аналитики для обнаружения и обмена значимыми шаблонами в данных и административных средств для легкого управления людьми и контентом и расширения возможностей для создания и обмена картами. ArcGIS предоставляет всем в вашей организации возможность обнаруживать, использовать, создавать и обмениваться картами с любого устройства в любом месте и в любое время. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
