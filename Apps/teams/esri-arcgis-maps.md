...
* <a href="https://teams.microsoft.com/l/app/ba4eda44-cd55-4e15-855c-0debafb0490b" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Esri корпорации Майкрософт:
...
| Основные функциональные возможности приложения | ArcGIS Online включает в себя набор приложений, полномочные карты и данные по тысячам разделов, современные средства сопоставления, необходимые для визуализации данных, аналитики для обнаружения и передачи значимых закономерностей в данных, а также средства администрирования для легкого управления людьми и содержимым, а также позволяют всем создавать карты и делиться ими. ArcGIS предоставляет всем сотрудникам вашей организации возможность обнаруживать, использовать, создавать и совместно использовать карты с любого устройства, где угодно и в любое время. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
...
Эта информация была предоставлена Esri о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
