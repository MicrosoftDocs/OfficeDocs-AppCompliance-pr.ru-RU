---
title: Application Information for Priority Matrix HIPAA by Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для HIPAA матрицы приоритетов, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66547330"
---
# <a name="priority-matrix-hipaa"></a>Матрица приоритетов HIPAA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 15 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/2b248bdc-b79d-35eb-ece8-e81c1ba9fcef" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004259" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Матрица приоритетов HIPAA |
| ID | WA200004259 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Appfluence Inc |
| Веб-сайт компании | [https://appfluence.com](https://appfluence.com) |
| Условия использования приложения | [https://hipaa.prioritymatrix.com/eula](https://hipaa.prioritymatrix.com/eula) |
| Основные функциональные возможности приложения | Priority Matrix HIPAA — это полнокомпозиторное программное обеспечение для управления проектами, обслуживающий особые потребности в конфиденциальности офисов, медицинских учреждений, медицинских учреждений и других медицинских компаний и их партнеров. Матрица приоритетов тесно интегрируется в Outlook и Microsoft Teams, помогая командам расставить приоритеты, сосредоточиться и работать более интеллектуально без переключее контекста. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://appfluence.com/hipaa](https://appfluence.com/hipaa) |
