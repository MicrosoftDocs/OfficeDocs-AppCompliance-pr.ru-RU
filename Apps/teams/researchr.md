...
| Основные функции приложения | Консолидировать и делиться информацией о том, &quot;кто знает что&quot;. |
| Расположение штаб-квартиры компании | Япония |
| Страница информация о приложении | [https://app.researchr.work](https://app.researchr.work) |
