...
description: Вся доступная информация о безопасности и соответствии для ServiceDesk Plus Cloud, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Просмотр в Teams хранилище</a>
...
| Основные функциональные возможности приложения | ServiceDesk Plus — это программное обеспечение для управления ИТ-службами SaaS. Благодаря множеству функций для управления ИТ-службами это помогает ИТ-менеджерам эффективно упорядочивать операции службы технической поддержки в организации. По умолчанию ServiceDesk Plus (облако) работает с Azure AD. Чтобы приступить к работе, зарегистрируйтесь в ServiceDesk Plus (Cloud) с помощью учетной записи в экземпляре Azure AD. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Вход и чтение профиля пользователя | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | Делегированные | Сохранение доступа к данным, к которым он был предоставлен | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
