---
title: Сведения о приложениях для Startgrid от Startgrid
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Startgrid, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Startgrid корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Startgrid |
| ID | WA200003838 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Startgrid |
| Веб-сайт компании | [https://app.startgrid.com](https://app.startgrid.com) |
| Условия использования приложения | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| Основные функции приложения | Поиск, совместное и оценка технологических решений для более быстрого решения проблем. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
Эта информация предоставлена Startgrid о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| URL-адрес политики конфиденциальности | https://corp.startgrid.com/privacy-policy |
