...
description: Все доступные сведения о безопасности и соответствия требованиям для Appraisd, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Надстройку культуры производительности с помощью отзывов о производительности, целей и отзывов |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.appraisd.com](https://www.appraisd.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| People.Read | делегирована | Выборщик людей представляет пользователю список членов команды. Это необходимо для поддержки основных функций в Appraisd. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.Read | делегирована | Адрес электронной почты пользователя (upn) и пользовательский id используются для поиска пользователя в Appraisd и привязки его к Teams учетной записи. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.ReadBasic.All | делегирована | Выборщик людей представляет пользователю основные сведения о члене команды. Это необходимо для поддержки основных функций в Appraisd. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
