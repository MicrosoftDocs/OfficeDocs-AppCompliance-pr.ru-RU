---
title: Сведения о приложениях для Quadra Thankz по Quadrasystems.net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Quadra Thankz, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">Просмотр в Teams магазине</a>
...
| Имя компании-партнера | Quadrasystems.net |
...
| Основные функции приложения | Thankz — это ключ к построению более счастливых компаний. Построенный на Microsoft Teams интерфейсе, это совершенно новый способ подключения к людям, с помощью которых вы работаете каждый день.  Thankz — это средство, помогая людям распознавать друг друга в увлекательном способе.&#160; Он предоставляет богатые функции конечных пользователей и предприятий, которые позволяют использовать такие функциональные возможности, как доски лидеров, бюджетинг и элементы управления. Thankz помогает сотрудникам чувствовать связь, ценится и вознаграждается. |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://www.quadrasystems.net/what-we-do/intelligent-ip-sol...](https://www.quadrasystems.net/what-we-do/intelligent-ip-solution/thankz) |
...
Эти сведения предоставлены Quadrasystems.net о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Список типов поддерживаемых политик | Все AAD политики условного доступа  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | приложение | Получение сведений о менеджере пользователя  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
