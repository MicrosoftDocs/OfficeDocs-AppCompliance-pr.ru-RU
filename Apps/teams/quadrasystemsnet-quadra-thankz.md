...
| Основные функции приложения | Thankz — это ключ к построению более счастливых компаний. Построенный на Microsoft Teams интерфейсе, это совершенно новый способ подключения к людям, с помощью которых вы работаете каждый день.  Thankz — это средство, помогая людям распознавать друг друга в увлекательном способе.&#160; Он предоставляет богатые функции конечных пользователей и предприятий, которые позволяют использовать такие функции, как лидеров, бюджетов и элементов управления. Thankz помогает сотрудникам чувствовать связь, ценится и вознаграждается. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | приложение | Получение сведений о менеджере пользователя  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](https://docs.microsoft.com/microsoft-365-app-certification/azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3) |
