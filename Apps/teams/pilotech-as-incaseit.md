...
description: Все доступные сведения о безопасности и соответствия требованиям для InCaseIT, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Система управления кризисами. Система подготовки и обработки кризисов и инцидентов. |
| Расположение штаб-квартиры компании | Норвегия |
| Страница информация о приложении | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | Единственными используемыми данными является явное подтверждение пользователями, позволяя приложению использовать маркер доступа для вызова Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | делегирована | Единственными используемыми данными является явное подтверждение пользователями, позволяя приложению использовать маркер доступа для вызова Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | делегирована | Единственными используемыми данными является явное подтверждение пользователями, позволяя приложению использовать маркер доступа для вызова Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
