---
title: Информация о применении ava от AvePoint, Inc.
ms.author: elmalova
author: elenamalova
ms.date: 03/23/2020
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для AVA, ее политики обработки данных, ее Microsoft Cloud App Security информация каталога приложений и информация о безопасности/соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/93106045-6f96-41e3-8a9d-694b6bbcac60" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381883" target="_blank">Посмотреть в AppSource</a>
...
| URL-адрес Teams страницы информации о приложениях | [https://www.avepoint.com/support/](https://www.avepoint.com/support/) |
| URL политики конфиденциальности | [https://www.avepoint.com/privacy-policy](https://www.avepoint.com/privacy-policy) |
| URL условий использования | [https://www.avepoint.com/company/terms-of-use](https://www.avepoint.com/company/terms-of-use) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Mail.ReadWrite.Shared | Делегированные | Нет | Поиск сообщений электронной почты пользователя и перемещение электронной почты в указанную папку | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |
>| User.Read | Делегированные |  Токен доступа пользователя - используется для поиска и восстановления данных пользователя | Позволяет пользователю войти в приложение и дать ему токен доступа | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |
>| User.ReadWrite | Делегированные | DisplayName, UserPrincipalName, JobTitle, Организация, Страна, MySiteUrl - запись основной информации пользователя, который использовал приложение | Получить основную информацию о профиле пользователя | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| REST API SharePoint | Да | Поиск файла в личном сайте пользователя перерабатывать и восстанавливать эти файлы. Требуется разрешение allsites.manage. |  | Нет |  |
...
<iframe height='1020' title='Microsoft Cloud App Security информация' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35842' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35842" target="_blank">Просмотр в новой вкладке</a>
