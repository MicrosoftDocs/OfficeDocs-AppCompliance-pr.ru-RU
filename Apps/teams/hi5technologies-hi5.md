...
description: Вся доступная информация о безопасности и соответствии требованиям для Hi5, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://www.get5.io](https://www.get5.io) |
| Условия использования приложения | [https://www.get5.io/terms](https://www.get5.io/terms) |
| Основные функции приложения | Разблокировка культуры с непрерывным распознаванием и отзывами. Hi5 — это супер простое и веселое приложение для менеджеров и одноранговых коллег, чтобы получить &amp; признание. Кто&#8217;сделал большую работу? Это&#8217;просто — дайте им Привет5 и поделитесь праздником успеха! Члены группы могут придать одноранговую или командную оценку, просмотреть доску лидеров Hi5 и многое другое |
| Расположение штаб-квартиры компании | Южная Африка |
| Страница информация о приложении | [https://help.get5.io](https://help.get5.io) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Мы храним данные сеанса пользователей только из Teams, и пользователю необходимо утвердить это путем добавления уведомлений (они могут удалить это в любое время). Другие сведения не хранятся. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| email | делегирована | Мы храним данные сеанса пользователей только из Teams, и пользователю необходимо утвердить это путем добавления уведомлений (они могут удалить это в любое время). Другие сведения не хранятся. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| offline_access | делегирована | Мы храним данные сеанса пользователей только из Teams, и пользователю необходимо утвердить это путем добавления уведомлений (они могут удалить это в любое время). Другие сведения не хранятся. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| openid | делегирована | Мы храним данные сеанса пользователей только из Teams, и пользователю необходимо утвердить это путем добавления уведомлений (они могут удалить это в любое время). Другие сведения не хранятся. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| profile | делегирована | Мы храним данные сеанса пользователей только из Teams, и пользователю необходимо утвердить это путем добавления уведомлений (они могут удалить это в любое время). Другие сведения не хранятся. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
