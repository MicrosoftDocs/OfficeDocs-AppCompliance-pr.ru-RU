---
title: Сведения о приложении для Hi5 от Hi5Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Hi5, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ca334a56-72b5-4613-81d4-77b1148df03c" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Hi5Technologies |
...
| Основные функциональные возможности приложения | Разблокируйте язык и региональные параметры, используя постоянное распознавание и обратную связь. Hi5 — это очень простое и интересное приложение для руководителей и одноранговых пользователей, которое позволяет получить &amp; распознавание. Кто-&#8217;отлично совмешал работу? Это&#8217;просто — дайте им привет 5 и поделитесь с ними праздником успеха! Участники команды могут предоставлять одноранговое или командное распознавание, просматривать список лидеров Hi5 и многое другое. |
| Расположение компании | Южная Африка |
| Страница сведений о приложении | [https://help.get5.io](https://help.get5.io) |
...
Эти сведения предоставлены Hi5Technologies о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Мы храним сведения о сеансе пользователей только из Teams и пользователю необходимо утвердить их с помощью уведомлений о добавлении (они могут удалить их в любое время). Другие сведения не сохраняются. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| email | Делегированные | Мы храним сведения о сеансе пользователей только из Teams и пользователю необходимо утвердить их с помощью уведомлений о добавлении (они могут удалить их в любое время). Другие сведения не сохраняются. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| offline_access | Делегированные | Мы храним сведения о сеансе пользователей только из Teams и пользователю необходимо утвердить их с помощью уведомлений о добавлении (они могут удалить их в любое время). Другие сведения не сохраняются. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| openid | Делегированные | Мы храним сведения о сеансе пользователей только из Teams и пользователю необходимо утвердить их с помощью уведомлений о добавлении (они могут удалить их в любое время). Другие сведения не сохраняются. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| profile | Делегированные | Мы храним сведения о сеансе пользователей только из Teams и пользователю необходимо утвердить их с помощью уведомлений о добавлении (они могут удалить их в любое время). Другие сведения не сохраняются. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
