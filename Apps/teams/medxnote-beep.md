---
title: Сведения о приложении для Beep от Medxnote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">Просмотр в AppSource</a>
...
| Название партнерской компании | Medxnote |
| Веб-сайт компании | [https://medxnote.com](https://medxnote.com) |
| Условия использования приложения | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| Основные функциональные возможности приложения | Улучшение медицинской совместной работы с помощью интеграции задач EPR MedxPlanner в Microsoft Teams. |
...
Эти сведения были предоставлены Medxnote о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | оба варианта | Мы получаю сведения о организации пользователя | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | приложение | Это разрешение используется для отправки действий пользователю. Поэтому мы используем его для создания программного действия в веб-канале пользователя, чтобы он знал об обновлении задачи. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | приложение | Мы используем это разрешение для получения и создания тегов в командах в Microsoft Teams. Чтобы мы могли упомянуть их программными средствами. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | Делегированные | Используя это разрешение, мы будем получать основные сведения о пользователях, такие как displayName, mail, userPrincipalName, id и photo. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | приложение | С помощью этого мы получаем общие свойства. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | приложение | С помощью этого мы будем получать присоединенные команды пользователей. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
