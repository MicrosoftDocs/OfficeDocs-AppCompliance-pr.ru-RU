---
title: Сведения о приложениях для responsum от Responsum Inc.
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Responsum, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставленные Корпорацией Майкрософт в Responsum Inc.:
...
| Имя компании-партнера | Responsum Inc. |
...
| Основные функции приложения | Помощник по продажам ИИ, чтобы обновить сведения по средствам продаж и извлечь уроки из знаний вашей команды. |
...
Эти сведения предоставлены responsum Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, которые собирает приложение.
...
| Самая недавняя дата сертификации SOC2 |  2021-09-30 |
