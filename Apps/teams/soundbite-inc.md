---
title: Application Information for Soundbite&#8482; by Soundbite Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Все доступные сведения о безопасности и соответствии для Soundbite&#8482;, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "67057546"
---
# <a name="soundbite8482"></a>Звуковые&#8482;

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчиком: 5 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/da177017-fd24-4cac-bc27-8c9228e6234a" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004384" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Soundbite Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Звуковые&#8482; |
| ID | WA200004384 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Soundbite Inc. |
| Веб-сайт компании | [https://www.soundbite.ai](https://www.soundbite.ai) |
| Условия использования приложения | [https://soundbite.ai/terms-of-service/](https://soundbite.ai/terms-of-service/) |
| Основные функциональные возможности приложения | Soundbite — это платформа SaaS для записи, прослушивания и распространения текста, звука и видео в сценариях корпоративной коммуникации. Он&#8217;сочетание защищенной платформы (серверной части), клиентского пакета SDK (внешнего интерфейса) и приложений для связи по вертикали, которые обеспечивают встроенную ценность для наших клиентов. |
...
Эта информация была предоставлена Soundbite Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Чтение только данных профиля пользователя, только чтение данных каталога организации |
...
| Какие данные хранятся в базах данных? | Чтение только данных профиля пользователя, только чтение данных каталога организации |
...
| URL-адрес политики конфиденциальности | https://soundbite.ai/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | чтение расширенных данных профиля пользователя | [2274e9f2-89b3-4a1b-aa01-f7b0af1900cb](../azure/2274e9f2-89b3-4a1b-aa01-f7b0af1900cb.md) |
>| email | Делегированные | чтение электронной почты пользователя | [2274e9f2-89b3-4a1b-aa01-f7b0af1900cb](../azure/2274e9f2-89b3-4a1b-aa01-f7b0af1900cb.md) |
>| offline_access | Делегированные | обеспечение доступа к данным профиля пользователя; | [2274e9f2-89b3-4a1b-aa01-f7b0af1900cb](../azure/2274e9f2-89b3-4a1b-aa01-f7b0af1900cb.md) |
>| openid | Делегированные | включение входа oidc | [2274e9f2-89b3-4a1b-aa01-f7b0af1900cb](../azure/2274e9f2-89b3-4a1b-aa01-f7b0af1900cb.md) |
>| profile | Делегированные | чтение базового профиля пользователя | [2274e9f2-89b3-4a1b-aa01-f7b0af1900cb](../azure/2274e9f2-89b3-4a1b-aa01-f7b0af1900cb.md) |
>| Directory.Read.All | приложение | чтение только синхронизации каталогов AD и изменений | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
>| User.Read | Делегированные | чтение расширенного профиля пользователя | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
>| email | Делегированные | чтение основных пользовательских данных | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
>| offline_access | Делегированные | обеспечение доступа к базовым данным профиля пользователя; | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
>| openid | Делегированные | поддержка входа oidc | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
>| profile | Делегированные | чтение базового профиля пользователя | [e852716e-f657-42f1-b81b-f3c06d2b37c9](../azure/e852716e-f657-42f1-b81b-f3c06d2b37c9.md) |
