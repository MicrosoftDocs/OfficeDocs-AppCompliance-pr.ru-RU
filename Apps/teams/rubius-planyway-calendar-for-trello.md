---
title: Сведения о приложениях для календаря Planyway для Trello по Rubius
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Planyway Calendar для Trello, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63753768"
---
# <a name="planyway-calendar-for-trello"></a>Календарь Planyway для Trello
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Календарь Planyway для Trello |
| ID | WA200002712 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Rubius |
| Веб-сайт компании | [https://rubius.com](https://rubius.com) |
| Условия использования приложения | [https://planyway.com/legal/terms-of-use](https://planyway.com/legal/terms-of-use) |
| Основные функции приложения | Planyway — это средство отслеживания времени и календаря команд для Trello для управления расписанием, отслеживания проектов и планирования ресурсов. С Помощью Planyway вы можете визуально упорядочить и упорядочить работу всей команды в одном месте: спланировать и расставить приоритеты перед предстоящими задачами, назначить и запланировать задачи в календаре или временной шкале, отслеживать нагрузку группы по проектам, управлять доступностью группы, отслеживать время, затрачиваемое на задачи и проекты, синхронизировать работу и личное расписание. |
...
| Соответствует ли приложение средствам управления организацией служб (SOC 1)? | {
  &quot;&quot;CMP08_complianceSOC_1: &quot;Na&quot; } | | Самая недавняя дата сертификации SOC1 |   | | Соответствует ли приложение средствам управления организацией служб (SOC 2)? | Нет | | Какую сертификацию SOC 2 удалось добиться? | | | Самая недавняя дата сертификации SOC2 | | | Соответствует ли приложение средствам управления службами (SOC 3)? | Нет | | Самая недавняя дата сертификации SOC3 | | | Проводите ли вы ежегодные оценки PCI DSS для приложения и его поддерживающей среды? | Нет | | Сертифицировано ли приложение Международная организация стандартизации (ISO 27001) ? | Нет | | Соответствует ли приложение международной организации стандартизации (ISO 27018)? | { &quot;CMP16_complianceISO_27018&quot;: &quot;Na&quot; } | | Соответствует ли приложение международной организации стандартизации (ISO 27017)? | Нет | | Соответствует ли приложение международной организации стандартизации (ISO 27002)? | Нет | | Соответствует ли приложение Федеральной программе управления рисками и авторизациями (FedRAMP)? | Нет | | Соответствует ли приложение закону о семейных образовательных правах и конфиденциальности (FERPA)? | N/A | | Соответствует ли приложение Закону о защите конфиденциальности в Интернете для детей (COPPA)? | N/A | | Соответствует ли приложение закону Sarbanes-Oxley (SOX)? | N/A | | Соответствует ли приложение NIST 800-171? |  | | Сертифицировано ли приложение в Альянсе облачной безопасности (CSA Star) ? | Нет |
