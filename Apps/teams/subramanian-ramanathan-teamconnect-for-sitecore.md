---
title: Application Information for TeamConnect for Sitecore by Subramanian Ramanathan
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Все доступные сведения о безопасности и соответствии для TeamConnect для Sitecore, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66656327"
---
# <a name="teamconnect-for-sitecore"></a>TeamConnect для Sitecore
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | TeamConnect для Sitecore |
| ID | WA200003274 |
