...
| Основные функции приложения | Помогите вашей команде классифицировать свои беседы в каналах с помощью красочных тегов , поэтому они будут тратить меньше времени на поиск нужных сведений. Им особенно нравится иметь всю связанную информацию на кончиках пальцев всего за один клик. |
| Расположение штаб-квартиры компании | Австрия |
| Страница информация о приложении | [https://www.smarterbusiness.at/en/tagteam-help](https://www.smarterbusiness.at/en/tagteam-help) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | делегирована | Мы не собираем эти данные, а используем только для отображения бесед с тегами. Мы хотели бы изменить его на API поиска, но Graph API в настоящее время не поддерживает это.  | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](../azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b.md) |
>| User.Read | делегирована | Отображение User-Information (например, имя) на вкладке | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](../azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b.md) |
>| User.ReadBasic.All | делегирована | Отображение User-Avatars на вкладке | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](../azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b.md) |
>| openid | делегирована | Только для SignIn — данные не хранятся | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](../azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b.md) |
