---
title: Информация о применении для Centrical по Biz-Effective
ms.author: elmalova
author: elenamalova
ms.date: 01/12/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для Centrical, ее политики обработки данных, Microsoft Cloud App Security информация каталога приложений и информация о безопасности/соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">Посмотреть в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Информация, предоставленная Biz-Effective корпорацией Майкрософт:
...
| Название компании-партнера | Biz-Effective |
| URL-адрес веб-сайта партнера | [https://centrical.com](https://centrical.com) |
| URL-адрес Teams страницы информации о приложениях | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
| URL политики конфиденциальности | [https://centrical.com/privacy](https://centrical.com/privacy) |
| URL условий использования | [https://centrical.com/terms](https://centrical.com/terms) |
...
Эта информация была предоставлена Biz-Effective о том, как это приложение собирает и хранит организационные данные и контроль, который ваша организация будет иметь над данными, которые собирает приложение.
...
>Мы soC2 Тип 2 совместимы, ISO 27001 и GDPR совместимы. У нас есть несколько элементов управления, размещенных для обеспечения конфиденциальности и безопасности данных. Мы используем данные только для нашего приложения и не делимся ими с третьими лицами.
...
<iframe height='1020' title='Microsoft Cloud App Security информация' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36383' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36383" target="_blank">Просмотр в новой вкладке</a>
...
Эта информация была предоставлена группой Biz-Effective том, как это приложение обрабатывает аутентификацию, авторизацию, лучшие практики регистрации приложений и другие критерии идентификации.
