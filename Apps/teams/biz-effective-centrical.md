---
title: Сведения о приложении для Centrical by Biz-Effective
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Centrical, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0f26688ca115b9f174a0eddbf2fc81384e20be32
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880285"
---
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Biz-Effective |
| Веб-сайт компании | [https://centrical.com](https://centrical.com) |
| Условия использования приложения | [https://centrical.com/terms](https://centrical.com/terms) |
| Основные функциональные возможности приложения | Ориентированная платформа помогает сотрудникам сосредоточиться на работе, которую необходимо выполнить, и, что важно, о том, как с ней работать. Он использует данные из измеряемой работы для запроса микроуниверинга, который создает профилирование. Он использует искусственный интеллект для повышения вовлеченности сотрудников, повышения производительности, а также микроуниверинга. Centrical platform is available via a web application, mobile apps, Microsoft Teams app, Salesforce and SuccessFactors apps. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
Эти сведения предоставлены Biz-Effective о том, как это приложение собирает и хранит данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-02-03 |
