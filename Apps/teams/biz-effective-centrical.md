...
| Основные функции приложения | Платформа Centrical получает и держит сотрудников сосредоточенными на работе, которая должна быть сделана, и, что важно, как это сделать. Он использует данные из измеренной работы, чтобы подсказыть микроуровне, которое создает знания. Он использует искусственный интеллект для повышения вовлеченности сотрудников, повышения производительности, а также микроуза. Платформа Centrical доступна через веб-приложение, мобильные приложения, Microsoft Teams, приложения Salesforce и SuccessFactors. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
| Самая недавняя дата сертификации SOC2 |  2020-02-03 |
