...
description: Вся доступная информация о безопасности и соответствии требованиям для Employee Advocacy от DSMN8, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
<p>Последнее обновление разработчика: 26 ноября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003677" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые DSMN8 корпорации Майкрософт:
...
| Название партнерской компании | DSMN8 |
| Веб-сайт компании | [https://dsmn8.com](https://dsmn8.com) |
| Условия использования приложения | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| Основные функциональные возможности приложения |  DSMN8 — это платформа на основе приложений, которая позволяет сотрудникам стать сотрудниками влияния компании, совместно используя утвержденный компанией контент в своих каналах социальных сетей.  |
...
Эта информация была предоставлена DSMN8 о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | должность, имя, фамилия, адрес электронной почты |
...
| Какие данные хранятся в базах данных? | должность, имя, фамилия, адрес электронной почты |
...
| URL-адрес политики конфиденциальности | https://dsmn8.com/terms-and-conditions |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Как | Чтение названия задания, имени, фамилии и данных электронной почты во время входа в приложение для создания профиля | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](../azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c.md) |
