---
title: Application Information for Squadify by Squadify Holdings Pty Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для Squadify, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66765191"
---
# <a name="squadify"></a>Скайтифицировать

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые компании Squadify Holdings Pty Ltd корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Скайтифицировать |
| ID | WA200004349 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Squadify Holdings Pty Ltd |
| Веб-сайт компании | [https://www.squadify.net](https://www.squadify.net) |
| Условия использования приложения | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| Основные функциональные возможности приложения | Приложение Squadify для Microsoft Teams позволяет собирать отзывы, диалоги и практические сведения. С помощью Приложения Squadify для Microsoft Teams вы можете настроить команду create Squads одним щелчком мыши и сопоставить ее с командой в Microsoft Teams. Вы также можете запускать Приложение Squadifys, отслеживать ход их выполнения и создавать аналитические сведения о производительности команды, чтобы начать создавать правильные беседы. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
Эта информация была предоставлена Приложением Squadify Holdings Pty Ltd о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Полное имя пользователя и адрес электронной почты |
...
| Какие данные хранятся в базах данных? | Полное имя пользователя и адрес электронной почты |
...
| URL-адрес политики конфиденциальности | https://www.squadify.net/privacy-policy |
