---
title: Сведения о приложении для Moneypepepe от CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
description: Вся доступная информация о безопасности и соответствии для Moneypeview, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые CALLITECH LIMITED корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Moneypenny |
| Идентификатор | WA200003396 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | CALLITECH LIMITED |
| Веб-сайт компании | [https://www.moneypenny.com](https://www.moneypenny.com) |
| Условия использования приложения | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| Основные функциональные возможности приложения | Основная функциональность приложения предназначена для того, чтобы пользователи Teams свои организации для получения звонков от Moneypepepe via a Bot. |
...
Эта информация предоставлена CALLITECH LIMITED о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Идентификатор клиента Майкрософт, идентификатор объекта Майкрософт |
...
| Какие данные хранятся в базах данных? | Идентификатор клиента Майкрософт, идентификатор объекта Майкрософт |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Microsoft Identity Web |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | приложение | Потоковая передача мультимедиа из бота Teams пользователю | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | приложение | Вызов к пользователю Teams с помощью бота | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
