---
title: Сведения о приложениях для Moneypenny от CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставляемые корпорацией Майкрософт callITECH LIMITED:
...
| Имя компании-партнера | CALLITECH LIMITED |
...
| Основные функции приложения | Основная функциональность приложения — Teams пользователям на борту своих организаций для получения звонков из Moneypenny с помощью бота |
...
Эти сведения предоставлены CALLITECH LIMITED о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Microsoft Tenant Id, Microsoft Object Id |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | приложение | Для потоковой передачи мультимедиа с бота Teams пользователю | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | приложение | Чтобы сделать вызов пользователю Teams с помощью бота | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
