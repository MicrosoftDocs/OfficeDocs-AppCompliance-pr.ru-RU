---
title: Сведения о приложениях для Hugo от Hugo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Hugo, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e14ce411-84d7-4bb5-94e9-92536320f0b1" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003616" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Hugo Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Hugo |
| ID | WA200003616 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Hugo |
| Веб-сайт компании | [https://www.hugo.team](https://www.hugo.team) |
| Условия использования приложения | [https://www.hugo.team/terms](https://www.hugo.team/terms) |
| Основные функции приложения | Hugo — это одно место для собраний, заметок и задач, &#8211; для групп, Microsoft Teams. Платформа, ориентированная на календарь Hugo, предоставляет вам и вашей команде одно центральное место для собраний и заметок, задач и действий &#8211; все автоматически организованные контактами и компаниями, которые вы встречаете, и подключены к приложениям 20+, которые вы используете каждый день. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.hugo.team/teams](https://www.hugo.team/teams) |
...
Эта информация предоставлена Hugo о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Данные документа календаря и собрания |
...
| URL-адрес политики конфиденциальности | https://www.hugo.team/privacy |
