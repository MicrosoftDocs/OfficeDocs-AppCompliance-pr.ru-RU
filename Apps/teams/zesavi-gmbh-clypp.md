---
title: Сведения о приложениях для Clypp от Zesavi GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для Clypp, политики обработки данных, Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 775d24891dcc928bbc8511ae39af5cace22967e2
...
* <a href="https://teams.microsoft.com/l/app/34ed2c1e-bccf-463d-8fbc-0403e72e89fc" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003621" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Корпорацией Майкрософт в GmbH Zesavi:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Clypp |
| ID | WA200003621 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Zesavi GmbH |
| Веб-сайт компании | [https://getclypp.com](https://getclypp.com) |
| Условия использования приложения | [https://getclypp.com/en/terms-of-use/](https://getclypp.com/en/terms-of-use/) |
| Основные функции приложения | Clypp позволяет всем в вашей компании создавать и &amp; редактировать короткие видео документации непосредственно в своем интернет-браузере. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://getclypp.com/en/](https://getclypp.com/en/) |
...
Эта информация предоставлена Zesavi GmbH о том, как это приложение собирает и хранит организационные данные и контроль, который будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | ID объекта для каждого пользователя |
...
| URL-адрес политики конфиденциальности | https://getclypp.com/en/privacy-policy/ |
