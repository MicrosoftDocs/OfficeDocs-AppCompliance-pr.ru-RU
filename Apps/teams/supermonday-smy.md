---
title: Сведения о приложении для Smy by Supermonday
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Вся доступная информация о безопасности и соответствии для Smy, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2858d81b-9eb1-4ba1-a79b-b42390bb0015" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004190" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Supermonday корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Smy |
| ID | WA200004190 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Supermonday |
| Веб-сайт компании | [https://supermonday.io](https://supermonday.io) |
| Условия использования приложения | [https://supermonday.io/conditions-generales-de-vente](https://supermonday.io/conditions-generales-de-vente) |
| Основные функциональные возможности приложения | Smy l'application de Supermonday pour Microsoft Teams |
...
Эта информация была предоставлена Supermonday о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Пользователь Майкрософт, группы Майкрософт, доступность календаря Outlook |
...
| Какие данные хранятся в базах данных? | microsoft user, microsoft group |
...
| URL-адрес политики конфиденциальности | https://supermonday.io/politique-de-confidentialite |
