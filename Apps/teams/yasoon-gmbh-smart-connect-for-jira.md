---
title: Сведения о приложениях для Подключение Jira по yasoon GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Smart Подключение для Jira, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Yasoon фокусируется на обеспечении интеллектуальных и надежных &amp; интеграций между Atlassian и службы Майкрософт. Мы предлагаем инструменты, Outlook и Teams с Atlassian Jira. Наше приложение Jira для Microsoft Teams помогает программному обеспечению и бизнес-командам лучше работать вместе, подключив Teams чаты и беседы к вопросам Jira. |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://yasoon.com/microsoft-teams-for-jira/](https://yasoon.com/microsoft-teams-for-jira/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | делегирована | Разрешение используется для того, чтобы разрешить пользователю выбрать один из этих каналов в Jira. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Read.Group | приложение | Позволяет приложению показывать сообщения связанных каналов в Jira. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Send | делегирована | Данные не используются, этот API используется для того, чтобы позволить пользователю отвечать на сообщения каналов из Jira. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelSettings.Read.Group | приложение | Используется для получения подробных сведений о канале. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Chat.ReadWrite | делегирована | Используется для того, чтобы разрешить пользователю добавлять новые ответы в чаты и просматривать сообщения чата из Jira. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
...
>| Team.ReadBasic.All | делегирована | Разрешение используется, чтобы позволить пользователю выбрать одну из этих присоединились группы в Jira. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| TeamSettings.Read.Group | приложение | Позволяет приложению читать параметры Team для соблюдения определенных по умолчанию. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| User.ReadBasic.All | делегирована | Позволяет пользователю выбирать сотрудников для @-mention в сообщении канала | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
