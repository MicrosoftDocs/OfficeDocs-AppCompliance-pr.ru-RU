...
* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">Просмотр в Teams магазине</a>
...
>| offline_access | делегирована | Чтобы обновить маркер доступа, по истечении текущего срока действия. Например, когда пользователь находится в окне отправки подписи и оставляет его неактивным слишком долго, нам необходимо обновить новый маркер, чтобы сохранить &quot; &quot; активность пользователя. | Чтобы обновить маркер доступа, по истечении текущего срока действия. Например, когда пользователь находится в окне отправки подписи и оставляет его неактивным слишком долго, нам необходимо обновить новый маркер, чтобы сохранить &quot; &quot; активность пользователя.. | 72d5ac5d-a427-408b-907d-72da3f33ddd1 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Для настройки сообщений чата и проверки подлинности | UserPrincipalName, имя, электронная почта и objectId | Мы храним эти сведения для настройки асинхронных ответов и целей проверки подлинности. |
...
Эта информация предоставлена Компанией Adobe Systems Inc. о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.
