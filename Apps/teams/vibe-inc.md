---
title: Сведения о приложениях для Vibe от Vibe Inc
ms.author: elmalova
author: elenamalova
ms.date: 01/20/2022
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Vibe, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001721" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Корпорацией Майкрософт в Vibe Inc.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Vibe |
| Идентификатор | WA200001721 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Vibe Inc |
| Веб-сайт компании | [https://vibe.us](https://vibe.us) |
| Условия использования приложения | [https://vibe.us/term/](https://vibe.us/term/) |
| Основные функции приложения | Совместная работа в режиме реального времени на неограниченном холсте с простым доступом к OneDrive файлам. |
...
Эта информация была предоставлена Vibe Inc о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Имя отображения клиента, адрес электронной почты и изображение профиля |
...
| URL-адрес политики конфиденциальности | https://vibe.us/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Впишите основные сведения пользователя, такие как имя, электронная почта, изображение профиля. | [71a7c2ef-6e5f-4d3d-8665-119a2bef0035](https://docs.microsoft.com/microsoft-365-app-certification/azure/71a7c2ef-6e5f-4d3d-8665-119a2bef0035) |
