...
description: Все доступные сведения о безопасности и соответствия требованиям для Кармы, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
| Условия использования приложения | [https://karmabot.readme.io/docs/karma-end-user-license-agre...](https://karmabot.readme.io/docs/karma-end-user-license-agreement-eula) |
| Основные функции приложения | True bonding for remote teams. |
| Расположение штаб-квартиры компании | Новая Зеландия |
| Страница информация о приложении | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
...
| Какие данные хранятся в базах данных? | Адрес электронной почты, отдельные распознавания |
...
| URL-адрес политики конфиденциальности | https://karmabot.readme.io/docs/privacy-policy-for-microsoft-teams |
