---
title: Сведения о приложении для виртуального агента Tikit от Cireson
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Все доступные сведения о безопасности и соответствии для виртуального агента Tikit, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66564630"
---
# <a name="tikit-virtual-agent"></a>Виртуальный агент Tikit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/55f323bf-3622-4624-b3b5-0582d8be4ad5" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004288" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Cireson корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Виртуальный агент Tikit |
| ID | WA200004288 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Cireson |
...
| Основные функциональные возможности приложения | Tikit&#8217;виртуальный агент: конечные пользователи&#8217; решение для всех своих запросов в службу поддержки |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://tikit.ai](https://tikit.ai) |
...
Эти сведения были предоставлены Cireson о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя и почты пользователей |
...
| Какие данные хранятся в базах данных? | Профиль пользователя (сведения об Azure Active Directory — имя, название и т. д.) |
...
| Перечисление поддерживаемых типов политик | Многофакторная проверка подлинности, позволяющая только Intune зарегистрированным устройствам получать доступ к определенным службам, ограничивать расположения пользователей и диапазон IP-адресов |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | Делегированные | Используется для чтения назначений ролей для RBAC в приложении | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Directory.Read.All | Делегированные | Используется для чтения назначений ролей для RBAC в приложении | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Group.Read.All | оба варианта | Используется для чтения назначений ролей для RBAC в приложении | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read | Делегированные | Вход | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read.All | приложение | Вход | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.ReadBasic.All | Делегированные | Вход | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| email | Делегированные | Разрешения для входа | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| openid | Делегированные | Вход | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| profile | Делегированные | Входа | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
