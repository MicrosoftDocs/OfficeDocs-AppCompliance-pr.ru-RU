---
title: Сведения о приложении для Berry по Berryworks.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Все доступные сведения о безопасности и соответствии для Berry, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "65874249"
---
# <a name="berry"></a>Ягода

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 19 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/3694c470-c14b-11ec-97bc-6b8526f20a81" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004138" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Berryworks.ai корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Ягода |
| ID | WA200004138 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Berryworks.ai |
| Веб-сайт компании | [https://berryworks.ai](https://berryworks.ai) |
| Условия использования приложения | [https://www.berryworks.ai/tnc/](https://www.berryworks.ai/tnc/) |
| Основные функциональные возможности приложения | Взаимодействие с сотрудниками, интерпретация тональности в режиме реального времени и повышение ответственности |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://berryworks.ai/teams-integration/](https://berryworks.ai/teams-integration/) |
...
Эти сведения предоставлены Berryworks.ai о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
| Какие данные хранятся в базах данных? | Сведения о клиенте, такие как идентификатор клиента, идентификатор взаимодействия с пользователем |
