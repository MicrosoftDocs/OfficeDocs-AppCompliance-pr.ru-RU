---
title: Сведения о приложении для Beagle by Decision Point
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Все доступные сведения о безопасности и соответствии для Beagle, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 3acc41061272b478f83864b1b76ec4e0a7fc22a3
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт точкой принятия решений:
...
| Название партнерской компании | Точка принятия решений |
| Веб-сайт компании | [https://decisionpoint.ai](https://decisionpoint.ai) |
| Условия использования приложения | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| Основные функциональные возможности приложения | Beagle — это инструмент бизнес-аналитики на основе чата, интегрированный с такими платформами, как MS Teams. Beagle снижает барьеры внедрения и устраняет необходимость обучения (отдельных пользователей) путем передачи данных пользователям через приложение для совместной работы.  Beagle отображает соответствующие данные для пользователя в виде карточек аналитики и позволяет ему подробно изучить их с помощью фильтров и ускорить принятие решений.  |
| Расположение компании | Индия |
| Страница сведений о приложении | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
Эта информация была предоставлена точкой принятия решений о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
