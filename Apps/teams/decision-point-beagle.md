...
| Основные функции приложения | Beagle — это средство BI на основе чата, интегрированное с платформами, например MS Teams. Beagle снижает барьеры принятия и устраняет необходимость подготовки (отдельных лиц) путем передачи данных людям через приложение для совместной работы.  Бигль показывает пользователю соответствующие данные в виде карт Insight и позволяет им глубоко погрузиться в него с помощью фильтров и помогает быстрее принимать решения.  |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
