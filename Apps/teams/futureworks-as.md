---
title: Сведения о приложениях для Futureworks от Futureworks AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для Futureworks, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/80a90c8c-6199-454b-b0ff-bd5fba480275" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003510" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые службой Futureworks AS корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Futureworks |
| ID | WA200003510 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Futureworks AS |
| Веб-сайт компании | [https://app.futureworks.com](https://app.futureworks.com) |
| Условия использования приложения | [https://www.futureworks.com/terms-of-service](https://www.futureworks.com/terms-of-service) |
| Основные функции приложения | Платформа управления целями и производительностью, основанная на результатах OKR - Objectives and Key. |
| Расположение штаб-квартиры компании | Норвегия |
| Страница информация о приложении | [https://futureworks.no](https://futureworks.no) |
...
Эта информация была предоставлена Futureworks AS о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
