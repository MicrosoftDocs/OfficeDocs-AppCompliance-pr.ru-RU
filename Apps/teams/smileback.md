---
title: Сведения о приложении для SmileBack от SmileBack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Вся доступная информация о безопасности и соответствии для SmileBack, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 47a777c15fee21ef2d1ebea5f91a2de1323e0394
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880564"
---
...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Службой SmileBack корпорации Майкрософт:
...
| Название партнерской компании | SmileBack |
| Веб-сайт компании | [https://smileback.com](https://smileback.com) |
| Условия использования приложения | [https://smileback.com/terms](https://smileback.com/terms) |
| Основные функциональные возможности приложения | SmileBack — это платформа удовлетворенности клиентов, предназначенная для управляемых поставщиков услуг, служб технической поддержки и групп ИТ-поддержки. Наши средства CSAT и NPS&#174; помогают ИТ-специалистам собирать, сообщать и действовать на основе отзывов клиентов. CSAT (опрос об удовлетворенности клиентов) помогает вам понять текущую ставку удовлетворенности клиентов, предоставляя вам мгновенное и прямое измерение каждого взаимодействия с клиентом (запросы в службу поддержки). NPS&#174; (net Promoter Score) предоставляет аналитические сведения о ваших общих отношениях с клиентами. |
...
| Какие поставщики облачных служб используются приложением? | AWS, Heroku |
...
Эта информация была предоставлена с помощью SmileBack о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
