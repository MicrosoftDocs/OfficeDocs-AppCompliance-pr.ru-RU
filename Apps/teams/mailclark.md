...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Mail.ReadWrite | приложение |  | Читайте также: Подписаться на push-уведомления для входящих сообщений электронной почты. Write: Создание черновиков. |  |
>| Mail.Send | приложение |  | Отправка черновиков. |  |
>| User.Read | приложение | Сведения об учетной записи, например адрес электронной почты. | Определение учетной записи. |  |
>| offline_access | приложение | Маркер обновления | Возобновление проверки подлинности до отключения учетной записи. |  |
>| openid | приложение |  | Обязательное для проверки подлинности. |  |
