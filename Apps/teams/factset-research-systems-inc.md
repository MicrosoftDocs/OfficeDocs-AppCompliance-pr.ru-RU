...
description: Все доступные сведения о безопасности и соответствии требованиям для FactSet, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | С помощью factSet для Microsoft Teams вы получите кураторские сводки новостей из StreetAccount, чтобы вы могли оставаться на вершине ключевых историй, влияющих на глобальные рынки. Вы можете запрашивать&#8217;с ведущим в отрасли контентом для получения подробных сведений о компании и обмениваться ими с коллегами и группами, что позволяет без усилий сотрудничать без переключения между приложениями. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | приложение | Имя и электронная почта для проверки и ведения журнала, Код беседы для упреждающего отправки сообщений | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
