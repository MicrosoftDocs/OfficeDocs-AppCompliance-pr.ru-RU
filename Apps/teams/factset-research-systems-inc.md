---
title: Application Information for FactSet by FactSet Research Systems Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Все доступные сведения о безопасности и соответствии для FactSet, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 714ffef96a5c74747eb4c5ee7409baea23b7c166
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64878696"
---
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт в компании FactSet Research Systems Inc.
...
| Название партнерской компании | FactSet Research Systems Inc. |
| Веб-сайт компании | [https://www.factset.com](https://www.factset.com) |
| Условия использования приложения | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| Основные функциональные возможности приложения | С помощью FactSet для Microsoft Teams вы будете получать курированные сводки новостей из StreetAccount, чтобы вы могли оставаться на основе ключевых историй, влияющих на глобальные рынки. Вы можете запросить&#8217;factSet для ведущего в отрасли контента для получения подробных сведений о компании и поделиться ими с коллегами и группами, обеспечивая бесшаговую совместную работу без переключения между приложениями. |
...
Эта информация была предоставлена FactSet Research Systems Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | приложение | Имя и адрес электронной почты для проверки и ведения журнала, идентификатор беседы для упреждающего сообщения | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
