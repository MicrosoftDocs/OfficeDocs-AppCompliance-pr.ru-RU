...
description: Все доступные сведения о безопасности и соответствия требованиям для бизнес-коммуникаций Vonage, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Vonage Business Communications для Teams позволяет звонить, SMS и MMS с помощью прямой маршрутивки Vonage. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | С этим разрешением данные не хранятся | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | делегирована | Получение ид пользователя Azure и его клиента, чтобы позже мы могли отправлять уведомления этому пользователю. | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
