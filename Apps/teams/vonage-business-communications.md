...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | С этим разрешением данные не хранятся | [1d8a304e-ea67-4aa2-9345-2793419cf83f](https://docs.microsoft.com/microsoft-365-app-certification/azure/1d8a304e-ea67-4aa2-9345-2793419cf83f) |
>| User.Read | делегирована | Получение ид пользователя Azure и его клиента, чтобы позже мы могли отправлять уведомления этому пользователю. | [1d8a304e-ea67-4aa2-9345-2793419cf83f](https://docs.microsoft.com/microsoft-365-app-certification/azure/1d8a304e-ea67-4aa2-9345-2793419cf83f) |
