---
title: Сведения о приложении для iManage от iManage
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Все доступные сведения о безопасности и соответствии для iManage, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | iManage |
| Веб-сайт компании | [https://imanage.com](https://imanage.com) |
| Условия использования приложения | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| Основные функциональные возможности приложения | Совместная работа выполняется свободно, пока содержимое сохраняется и управляется в iManage. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
Эта информация была предоставлена iManage о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
