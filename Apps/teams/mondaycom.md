...
description: Все доступные сведения о безопасности и соответствия требованиям для monday.com, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | monday.com — это универсальная осмия Work, которая позволяет удаленно работать в команде, организовывать, структурировать и упорядочить все программы, проекты и процессы.  С monday.com вы можете использовать строительные блоки &#8211;, такие как доски, представления, диаграммы, автоматизации и интеграции , для создания настраиваемого приложения рабочего процесса для запуска процессов, проектов и повседневной работы. Создайте новую monday.com или добавьте в существующую из непосредственно Microsoft Teams и легко визуализируют работу&#8217;в одном рабочем пространстве. |
...
Эти сведения предоставлены monday.com о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
