---
title: Сведения о приложении для monday.com по monday.com
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для monday.com, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 4b7a675ccbf9b93a3b071985d08d218cac1023dd
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880146"
---
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | monday.com |
| Веб-сайт компании | [https://monday.com](https://monday.com) |
| Условия использования приложения | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| Основные функциональные возможности приложения | monday.com является универсальной рабочей ОС, которая поддерживает удаленную командную работу для организации, структурирования и оптимизации всех программ, проектов и процессов.  С помощью monday.com можно использовать стандартные блоки &#8211;, такие как доски, представления, диаграммы, автоматизация и интеграция, для создания пользовательских приложений рабочих процессов для выполнения процессов, проектов и повседневной работы. Создайте новую доску monday.com или добавьте ее в существующую непосредственно из Microsoft Teams и легко визуализуйте работу&#8217;в одной рабочей области для совместной работы. |
...
Эти сведения предоставлены monday.com о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
