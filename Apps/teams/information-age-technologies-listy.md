...
* <a href="https://teams.microsoft.com/l/app/db8361d3-ad4e-4005-8805-ad59ff4805f3" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000798" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт с помощью технологий информационного возраста:
...
| Имя компании-партнера | Технологии информационного возраста |
...
Эти сведения предоставлены информационными технологиями о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, собираемой приложением.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| TeamSettings.Read.Group | оба | Для создания учетной записи локального приложения пользователю не нужно заполнять данные вручную | Для создания учетной записи локального приложения пользователю не нужно заполнять данные вручную | 8aa22b64-9a2c-403b-83c1-feaf774c764c |
...
<iframe height='1020' title='Microsoft Cloud App Security Сведения' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36421' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36421" target="_blank">Просмотр на новой вкладке</a>
...
Эти сведения предоставлены технологиями информационного возраста о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.
