...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Когда члены группы нажимают кнопку Присоединиться к чату, мы используем электронную почту участников, чтобы определить, какой профиль агента принял чат. | Электронная почта и имя участника группы, который принял чат в прямом эфире, хранятся в базе данных истории чата. |  |
...
>Электронная почта и имя могут показываться в ежедневных журналах, которые удаляются или удаляются каждый день.
