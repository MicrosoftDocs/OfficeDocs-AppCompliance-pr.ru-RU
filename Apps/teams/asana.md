...
description: Все доступные сведения о безопасности и соответствия требованиям для Asana, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://asana.com](https://asana.com) |
| Условия использования приложения | [https://asana.com/terms#terms-of-service](https://asana.com/terms#terms-of-service) |
| Основные функции приложения | Следите за работой, переводя Teams в элементы действий в Asana, в том числе в Meetings |
| Расположение штаб-квартиры компании | США Америки |
| Страница информация о приложении | [https://asana.com/apps/microsoft](https://asana.com/apps/microsoft) |
...
| Самая недавняя дата сертификации SOC2 |  2021-03-15 |
| Соответствует ли приложение средствам управления службами (SOC 3)? | Да |
| Самая недавняя дата сертификации SOC3 |  2021-03-15 |
...
| URL-адрес политики конфиденциальности | https://asana.com/terms |
