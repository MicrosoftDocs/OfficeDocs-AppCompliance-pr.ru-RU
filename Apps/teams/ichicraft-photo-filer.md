---
title: Application Information for Photo Filer by Ichicraft
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Все доступные сведения о безопасности и соответствии для Photo Filer, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: ad26789923bd21cfe6b628ade0112e737d9da3f4
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879726"
---
# <a name="photo-filer"></a>Систематизатор фотографий

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 25 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Просмотр в Teams хранилище</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Систематизатор фотографий |
| Идентификатор | WA200003881 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Ichicraft |
...
| Основные функциональные возможности приложения | Самый простой способ поделиться фотографиями и архивировать их в Microsoft Teams. |
| Расположение компании | Нидерланды (the) |
| Страница сведений о приложении | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Эта информация была предоставлена Ichicraft о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Делегированные | Создание сообщения чата с небольшой сводкой фотографий, отправленных пользователем. | [e54fe734-код8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | Делегированные | Чтение структуры папок и отправка файлов в библиотеке SharePoint документов. | [e54fe734-код8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | Делегированные | Чтение из профиля пользователей. | [e54fe734-код8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
