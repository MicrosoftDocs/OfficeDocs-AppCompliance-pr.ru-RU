---
title: Информация о применении для гиперзащиты от Hyperproof
ms.author: elmalova
author: elenamalova
ms.date: 03/18/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для Hyperproof, ее политики обработки данных, Microsoft Cloud App Security информация каталога приложений и информация о безопасности/соответствии в реестре CSA STAR.
...
<p>Последнее обновление разработчиком на: 18 марта 2021</p>

* <a href="https://teams.microsoft.com/l/app/1683c88b-f5ca-4acc-a777-c1e3cf820ef5" target="_blank">Посмотреть в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002692" target="_blank">Посмотреть в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Информация, предоставленная Hyperproof корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Hyperproof |
| ID | WA200002692 |
| Office 365 клиенты поддержали | Microsoft Teams |
| Название компании-партнера | Hyperproof |
| URL-адрес веб-сайта партнера | [https://hyperproof.io/](https://hyperproof.io/) |
| URL-адрес Teams страницы информации о приложениях | [https://hyperproof.io/product](https://hyperproof.io/product) |
| URL политики конфиденциальности | [https://hyperproof.io/privacy-policy/](https://hyperproof.io/privacy-policy/) |
| URL условий использования | [https://hyperproof.io/terms-of-use/](https://hyperproof.io/terms-of-use/) |
...
Эта информация была предоставлена Hyperproof о том, как это приложение собирает и хранит организационные данные и контроль, который ваша организация будет иметь над данными, которые собирает приложение.
...
>Мы не контролируем данные партнеров.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/37868" target="_blank">Просмотр в новой вкладке</a>
...
Эта информация была предоставлена Hyperproof о том, как это приложение обрабатывает аутентификацию, авторизацию, лучшие практики регистрации приложений и другие критерии идентификации.
