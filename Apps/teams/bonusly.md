---
title: Сведения о приложении для Bonusly от Bonusly
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Вся доступная информация о безопасности и соответствии для Bonusly, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c06753b3-85de-4054-9a99-dcd869dc0836" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Bonusly корпорации Майкрософт:
...
| Название партнерской компании | Bonusly |
| Веб-сайт компании | [https://bonus.ly](https://bonus.ly) |
| Условия использования приложения | [https://bonus.ly/terms_of_service](https://bonus.ly/terms_of_service) |
| Основные функциональные возможности приложения | Частое и своевременные распознавание Spark путем интеграции Bonusly с Microsoft Teams |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://bonus.ly/integrations/teams](https://bonus.ly/integrations/teams) |
...
Эти сведения были предоставлены Bonusly о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Адрес электронной почты, имя, фамилия, дата рождения (если используется функция), дата приема на работу (если используется функция) |
...
| Дата последней сертификации SOC2 | 2022/4/28 |
...
| URL-адрес политики конфиденциальности | https://bonus.ly/privacy_policy |
