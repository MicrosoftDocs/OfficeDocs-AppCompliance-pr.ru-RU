---
title: Application Information for Ask Vizir by Vizir.co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Ask Vizir, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "65069701"
---
# <a name="ask-vizir"></a>Задайте вопрос Vizir

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 22 апреля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Vizir.co корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Задайте вопрос Vizir |
| Идентификатор | WA200003119 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Vizir.co |
| Веб-сайт компании | [https://www.vizir.co](https://www.vizir.co) |
| Условия использования приложения | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| Основные функциональные возможности приложения | Спросите, как бот Vizir помогает пользователям групп во Франции использовать Microsoft Office 365 продуктов. Выполнено в сотрудничестве с Корпорацией Майкрософт во Франции |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://www.vizir.co](https://www.vizir.co) |
| Какая среда размещения или модель службы используются для запуска приложения? | Paas |
| Какие поставщики облачных служб используются приложением? | OVH, Aws |
...
Эти сведения предоставлены Vizir.co о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | электронная почта пользователя, имя, фамилия |
...
| Какие данные хранятся в базах данных? | электронная почта пользователя, имя, фамилия |
...
| URL-адрес политики конфиденциальности | https://www.vizir.co/politique-confidentialite/ |
