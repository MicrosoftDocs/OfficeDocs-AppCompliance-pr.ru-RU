---
title: Сведения о приложении для Heedify от Heedify
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: Вся доступная информация о безопасности и соответствии для Heedify, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Heedify корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Heedify |
| Идентификатор | WA200003512 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Heedify |
| Веб-сайт компании | [https://heedify.io](https://heedify.io) |
| Условия использования приложения | [https://heedify.io/terms](https://heedify.io/terms) |
| Основные функциональные возможности приложения | Собственный помощник по приему и агент центра обработки вызовов для Microsoft Teams. |
...
Эта информация была предоставлена Heedify о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Сведения о присутствии и сведения о звонках (из центра обработки вызовов)  |
...
| Какие данные хранятся в базах данных? | Сведения о присутствии и сведения о звонках (из центра обработки вызовов)  |
...
| URL-адрес политики конфиденциальности | https://heedify.io/privacy |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Мы используем ADAL (Javascript), так как MSAL пока не поддерживает проверку подлинности с помощью ADFS.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Делегированные | Администратору необходимо проверить календарь пользователей перед передачей звонка или предоставлением сведений клиенту по телефону | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite | Делегированные | Приложение должно иметь возможность добавлять контакты к пользователю (агенту) и читать их контакты.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | Делегированные | Приложение  должно иметь возможность добавить общий контакт с другим пользователем (агентом) и прочитать их общие контакты  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | Делегированные | Сведения о присутствии необходимы агенту центра контактов для лучшего управления звонками и связи, особенно в случае передачи звонков.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | Делегированные | Чтобы управлять контактом, зарегистрированный пользователь должен иметь возможность просматривать пользователей и читать их сведения, включая их уход и руководителя (в случае приема)  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
