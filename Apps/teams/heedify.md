...
>|:------------------------|:--------------------|:------------------------------------|
>| Presence.Read.All | делегирована | Сведения о присутствии необходимы агенту контакт-центра для более эффективного управления вызовами и контактов, особенно в случае передачи вызовов.  |
>| User.Read.All | делегирована | чтобы управлять контактом, зарегистрированный пользователь должен иметь возможность просматривать пользователей и читать их сведения, включая их уход и менеджера (в случае администратора)  |
>| Calendars.Read | делегирована | Администратору необходимо проверить календарь пользователей перед передачей звонка или обменом информацией с клиентом по телефону |
>| Contacts.ReadWrite | делегирована | Приложение должно иметь возможность добавлять контакты к пользователю (агенту) и читать их контакты также  |
>| Contacts.ReadWrite.Shared | делегирована | приложение должно быть в состоянии добавить общий контакт с другим пользователем (агентом) и читать их общих контактов также  |
