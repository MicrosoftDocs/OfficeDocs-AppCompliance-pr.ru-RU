---
title: Сведения о приложениях для Heedify от Heedify
ms.author: elmalova
author: elenamalova
ms.date: 11/24/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Heedify, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставляемые Службой Heedify Корпорации Майкрософт:
...
| Основные функции приложения | Помощник администратора и агент центра обработки вызовов для Microsoft Teams. |
...
Эти сведения были предоставлены организацией Heedify о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Сведения о присутствии и сведения о вызове (из центра обработки вызовов)  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | делегирована | Администратору необходимо проверить календарь пользователей перед передачей звонка или обменом информацией с клиентом по телефону | [f3ad2154-7e10-4730-a055-8852ced42d47](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3ad2154-7e10-4730-a055-8852ced42d47) |
>| Contacts.ReadWrite | делегирована | Приложение должно иметь возможность добавлять контакты к пользователю (агенту) и читать их контакты также  | [f3ad2154-7e10-4730-a055-8852ced42d47](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3ad2154-7e10-4730-a055-8852ced42d47) |
>| Contacts.ReadWrite.Shared | делегирована | приложение должно быть в состоянии добавить общий контакт с другим пользователем (агентом) и читать их общих контактов также  | [f3ad2154-7e10-4730-a055-8852ced42d47](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3ad2154-7e10-4730-a055-8852ced42d47) |
>| Presence.Read.All | делегирована | Сведения о присутствии необходимы агенту контакт-центра для более эффективного управления вызовами и контактов, особенно в случае передачи вызовов.  | [f3ad2154-7e10-4730-a055-8852ced42d47](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3ad2154-7e10-4730-a055-8852ced42d47) |
>| User.Read.All | делегирована | чтобы управлять контактом, зарегистрированный пользователь должен иметь возможность просматривать пользователей и читать их сведения, включая их уход и менеджера (в случае администратора)  | [f3ad2154-7e10-4730-a055-8852ced42d47](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3ad2154-7e10-4730-a055-8852ced42d47) |
