---
title: Сведения о приложении для центра контактов CyCX от CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Все доступные сведения о безопасности и соответствии для центра контактов CyCX, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 2505f9232962ad4ff793adf961311eb4e0ea4be1
ms.sourcegitcommit: 0a0b39a4c1826c026c0d3c405a20209254ce7891
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/06/2022
ms.locfileid: "66656417"
---
# <a name="cycx--contact-centre"></a>Центр контактов CyCX

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 27 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Центр контактов CyCX |
| ID | WA200004350 |
...
| Основные функциональные возможности приложения | CyCX предназначен для бизнес-пользователей, которым требуется повысить уровень взаимодействия с клиентами с помощью голосовых звонков и контактов, помимо собраний, чатов и совместной работы.  CyCX — это платформа обмена данными и совместной работы для Microsoft Teams.  Чтобы обеспечить более глубокое взаимодействие, cyTrack CyCX предоставляет своим агентам единый единый интерфейс с целостным представлением клиентов по выбранному каналу в Microsoft Teams. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
