---
title: Сведения о приложениях для Skoach в Cultify, Lda
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для Skoach, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 88be38f8741335277e8f1446d6e602bdcce8a031
ms.sourcegitcommit: 3a1a78be9669a7b77528c1545698983c36bbec3a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/13/2021
ms.locfileid: "60954015"
---
# <a name="skoach"></a>Skoach

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 9 ноября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003455" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые службой Cultify, Lda для Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Skoach |
| Идентификатор | WA200003455 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Cultify, Lda |
| Веб-сайт компании | [https://skoach.com](https://skoach.com) |
| Условия использования приложения | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| Основные функции приложения | Skoach — это виртуальный тренер, который работает над тем, чтобы держать команды вместе, выравнивать и продуктивно, что подталкивает людей к принятию новых поведений на основе повторяющихся результатов опроса. Skoach не только увеличивает поток коммуникации команд, что приводит к принадлежности и выравниванию, но и помогает людям заботиться о себе, чтобы столкнуться с новыми проблемами, которые приходят с гибридной работой, увеличивая производительность &amp; хранения. |
| Расположение штаб-квартиры компании | Португалия |
...
Эти сведения были предоставлены в Cultify, Lda о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Имена клиентов и, при условии, сообщения электронной почты. |
...
| URL-адрес политики конфиденциальности | https://www.skoach.com/privacy-policy |
