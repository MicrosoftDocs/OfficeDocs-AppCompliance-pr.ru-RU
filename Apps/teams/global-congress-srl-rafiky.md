---
title: Сведения о приложении для Rafiky от GLOBALLR SRL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для Rafiky, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: c7a8c13b45993e43ec9fee42cc56ad1a809e95f3
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880666"
---
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые globalLR SRL для Корпорации Майкрософт:
...
| Название партнерской компании | GLOBAL CONGRESS SRL |
| Веб-сайт компании | [https://rafiky.net/en/](https://rafiky.net/en/) |
| Условия использования приложения | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| Основные функциональные возможности приложения | Rafiky — это очень гибкое и доступное облачное решение платформы, предназначенное для удаленной одновременной интерпретации ваших онлайн-событий. Он&#8217;уникальным и инновационным представлением о удаленной интерпретации. он позволяет профессиональным интерпретаторам работать из любого места в любое время. |
...
Эта информация была предоставлена global ИНСТРУКЦИЕЙ ПО SRL о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
