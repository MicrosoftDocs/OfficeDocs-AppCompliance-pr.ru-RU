...
| Основные функции приложения | LMS365 позволяет организации предоставлять и управлять обучением на платформе Microsoft 365 с помощью SharePoint, Teams и мобильных устройств, обеспечивая знакомую среду для сотрудников, партнеров и клиентов |
| Расположение штаб-квартиры компании | Дания |
| Страница информация о приложении | [https://www.elearningforce.com/teams](https://www.elearningforce.com/teams) |
...
| Какие данные обрабатываются вашим приложением? | Данные профилей пользователей — см. https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
...
| Какие данные хранятся в базах данных? | Отчеты по обучению &amp; данным профилей пользователей — см. https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| Если в процессе infastructure или хранятся данные клиентов Microsoft, где эти данные географически хранятся? | Нидерланды(), Германия, Великобритания Великобритании и Северной Ирландии (), Япония, Австралия, Канада, Ирландия |
...
| Предоставляет ли приложение людям возможность корректировать или обновлять свои персональные данные? | Недоступно |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | приложение | Позволяет приложению расширять членов группы AD для регистрации группы пользователей на обучение | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| Mail.Send | делегирована | Позволяет приложению отправлять уведомления по электронной почте. Разрешение запрашивается динамически при настройке учетной записи электронной почты для уведомления. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| OnlineMeetings.ReadWrite | делегирована | Позволяет приложению создавать, читать, обновлять и удалять события собраний в Интернете. Разрешение запрашивается динамически при настройке учетной записи электронной почты для уведомления. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| RoleManagement.Read.Directory | приложение | Приложение должно уметь читать роли пользователя и являются ли они глобальным администратором Office 365 и/или SharePoint администратором. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Invite.All | делегирована | Необязательная функция: разрешить администратору каталога приглашать гостевых пользователей в учебный каталог. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read | делегирована | Позволяет пользователям войти в приложение с помощью клиентского&#8217;Azure AD и позволяет приложению читать профиль и основные сведения о компании подписанного пользователя. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | делегирована | Позволяет приложению читать полный профиль пользователя. Это&#8217;, необходимые для чтения пользователей и&#8217; и построения иерархии для мониторинга диспетчера &amp; отчетов | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | приложение | Позволяет приложению читать полный профиль пользователя. Это&#8217;, необходимые для чтения пользователей и&#8217; и построения иерархии для мониторинга диспетчера &amp; отчетов | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| profile | делегирована | Чтобы показать пользователям, какая учетная запись использовалась для регистрации, LMS365 нуждается в этом разрешении, чтобы показать основные сведения о профиле, включая имя, имя и фамилию, адрес электронной почты и фотографию. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
