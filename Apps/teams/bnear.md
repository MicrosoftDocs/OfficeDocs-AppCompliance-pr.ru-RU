---
title: Сведения о приложении для bNear от bNear
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Все доступные сведения о безопасности и соответствии для bNear, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5d655b39-963c-465a-89ab-bdad7ab7af7f" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004271" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые bNear в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | bNear |
| Идентификатор | WA200004271 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | bNear |
| Веб-сайт компании | [https://bnear.io](https://bnear.io) |
| Условия использования приложения | [https://bnear.io/terms](https://bnear.io/terms) |
| Основные функциональные возможности приложения | bNear — это виртуальное пространство для вас и вашей команды. Оставайтесь на связи, как в реальном офисе! |
| Расположение компании | Германия |
| Страница сведений о приложении | [https://bnear.io](https://bnear.io) |
...
Эта информация была предоставлена bNear о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Отображаемое имя, адрес электронной почты, принадлежность к команде, текущее состояние пользователя Microsoft Teams, ежедневные встречи календаря (тема, описание, время, участники, ссылка на звонок) временно сохраняются в день встречи, пока собрание не будет больше, в настоящее время выполняются звонки (тема, описание, время, текущие участники, состояние отключения звука, ссылка на звонок) временно сохраняются во время звонка до завершения звонка. |
...
| Какие данные хранятся в базах данных? | Отображаемое имя, адрес электронной почты, принадлежность к команде, текущее состояние пользователя Microsoft Teams, ежедневные встречи календаря (тема, описание, время, участники, ссылка на звонок) временно сохраняются в день встречи, пока собрание не будет больше, в настоящее время выполняются звонки (тема, описание, время, текущие участники, состояние отключения звука, ссылка на звонок) временно сохраняются во время звонка до завершения звонка. |
...
| URL-адрес политики конфиденциальности | https://bnear.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | приложение | Создайте обзор собрания и взаимодействуйте с ними. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Calls.InitiateGroupCall.All | приложение | Запуск вызова из приложения. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Calls.JoinGroupCall.All | приложение | Присоединение к вызову из приложения. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Group.ReadWrite.All | Делегированные | Выведите список всех команд для пользователей, создайте группы. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| GroupMember.Read.All | приложение | Вывод списка всех участников команды. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| GroupMember.ReadWrite.All | Делегированные | Выведите список всех участников команды, их комнат и создайте новые группы. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Presence.ReadWrite.All | приложение | Отображение сведений о присутствии для всех пользователей в командах и настройка новых сведений о присутствии на основе взаимодействия с пользователем. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamMember.Read.All | приложение | Отображение всех участников команды в комнатах группы. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamMember.ReadWrite.All | Делегированные | Добавление или удаление участников из комнат команд. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Teams.Create | Делегированные | Создайте новые команды для новых комнат команд. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamsActivity.Send | приложение | Уведомлять пользователей о взаимодействии с приложением участников команды. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| User.Read.All | приложение | Получение динамических обновлений для пользователей. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
