---
title: Сведения о приложении для Tonkean от Tonkean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Все доступные сведения о безопасности и соответствии для Tonkean, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "65455059"
---
# <a name="tonkean"></a>Tonkean

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 16 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/b7391d00-e8e4-4dc9-970e-ba3386144114" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381749" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Tonkean корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Tonkean |
| ID | WA104381749 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Tonkean |
| Веб-сайт компании | [https://tonkean.com](https://tonkean.com) |
| Условия использования приложения | [https://tonkean.com/terms/](https://tonkean.com/terms/) |
| Основные функциональные возможности приложения | Tonkean позволяет организациям и рабочим группам быстро автоматизировать сложные бизнес-процессы. Tonkean предоставляет стандартные блоки для выполнения, мониторинга и управления любыми бизнес-процессами, созданными в нашей среде Solution Studio, полностью без кода.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://tonkean.com](https://tonkean.com) |
...
Эта информация была предоставлена Tonkean о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные хранятся в базах данных? | Имя, адрес электронной почты, идентификатор пользователя. Другие данные могут храниться по запросу пользователя или по запросу пользователя. |
...
| URL-адрес политики конфиденциальности | https://tonkean.com/privacy |
