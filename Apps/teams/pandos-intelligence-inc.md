---
title: Application Information for Pandos by Pandos Intelligence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/10/2022
...
description: Вся доступная информация о безопасности и соответствии для Pandos, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Pandos Intelligence Inc корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Pandos |
| ID | WA200003534 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Pandos Intelligence Inc |
| Веб-сайт компании | [https://pandos.io](https://pandos.io) |
| Условия использования приложения | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Основные функциональные возможности приложения | Pandos — это платформа для обучения и разработки с одним магазином для руководителей групп и людей, руководителей проектов, преподавателей и преподавателей. Он поддерживает такие фундаментальные функции, как формирование команды на основе критериев (включая доступность, личных данных, навыки или любые настраиваемые критерии), управление задачами группы и оценку одноранговых пользователей. Платформа автоматически создает профиль для мягких навыков участников, проверенных одноранговыми узлами.  |
| Расположение компании | Канада |
| Страница сведений о приложении | [https://pandos.io](https://pandos.io) |
...
Эта информация была предоставлена Pandos Intelligence Inc о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://pandos.io/gdpr/ |
