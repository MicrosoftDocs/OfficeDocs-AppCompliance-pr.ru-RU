---
title: Сведения о приложении для IQ по NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для IQ, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 4a833f98b2d35521d9ff6cfe4742774cc25125c7
...
* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые NLSQL корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | IQ |
| Идентификатор | WA200004126 |
| Поддерживаемые клиенты Office 365 | Microsoft Teams |
| Название партнерской компании | NLSQL |
| Веб-сайт компании | [https://nlsql.com](https://nlsql.com) |
| Условия использования приложения | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| Основные функциональные возможности приложения | IQ поддерживает руководителей для создания вопросов для собеседования и кандидатов для подготовки к собеседованию. Подготовка вопросов о собеседованиях — это программное обеспечение искусственного интеллекта, которое создает случайные вопросы на основе входных данных о должности, что дает идеальное представление о том, как правильно подготовиться к собеседованию. Кандидаты могут создавать вопросы о собеседованиях для лучшей подготовки. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
Эта информация была предоставлена NLSQL о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Вход и чтение профиля пользователя | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
