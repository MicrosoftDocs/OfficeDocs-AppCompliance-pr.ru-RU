---
title: Сведения о приложении для MindManager от Corel
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Все доступные сведения о безопасности и соответствии для MindManager, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 114106c2fff10ba63533397b3cafdce943293b01
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879406"
---
...
* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Corel корпорации Майкрософт:
...
| Название партнерской компании | Corel |
| Веб-сайт компании | [https://www.mindmanager.com](https://www.mindmanager.com) |
| Условия использования приложения | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| Основные функциональные возможности приложения | Совместное редактирование карт, управление панелей мониторинга групп, создание блок-схем и сохранение проектов в представлении. |
...
Эта информация была предоставлена Corel о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Делегированные | Сведения об изменениях, внесенных в файл MindManager, которые затем можно опубликовать как сообщение | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | Делегированные | Сведения об изменениях, внесенных в файл MindManager, которые затем можно опубликовать как сообщение | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | Делегированные | список сайтов, список папок, метаданные файлов, содержимое файла — для браузера файлов пользователь может просматривать свои файлы, чтобы открыть файлы MindManager (MMAP). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | Делегированные | список сайтов, список папок, метаданные файлов, содержимое файла — для браузера файлов пользователь может просматривать свои файлы, чтобы открыть файлы MindManager (MMAP). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | Делегированные | данные профиля: для идентификации пользователя и отображения его профиля | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | Делегированные | Это позволяет при необходимости сохранить файл обратно в исходное расположение от имени пользователя. | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
