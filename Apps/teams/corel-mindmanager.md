...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | делегирована | Сведения об изменениях, внесенных в файл MindManager, которые затем могут быть размещены в качестве сообщения | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | делегирована | Сведения об изменениях, внесенных в файл MindManager, которые затем могут быть размещены в качестве сообщения | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | делегирована | список сайтов, список папок, метаданные файлов, содержимое файлов — для браузера файлов пользователь может просматривать свои файлы, чтобы открыть файлы MindManager (.mmap). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | делегирована | список сайтов, список папок, метаданные файлов, содержимое файлов — для браузера файлов пользователь может просматривать свои файлы, чтобы открыть файлы MindManager (.mmap). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | делегирована | данные профиля: для идентификации пользователя и демонстрации его профиля | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | делегирована | Это позволяет при необходимости сохранить файл обратно в исходное расположение от имени пользователя. | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
