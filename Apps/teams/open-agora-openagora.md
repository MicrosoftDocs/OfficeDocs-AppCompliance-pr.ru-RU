...
ms.openlocfilehash: 328a2561a4a3c783be304cb99195be447f3bdea7
ms.sourcegitcommit: 983ed1755036e92d99745770f82f33417b21efec
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/18/2021
ms.locfileid: "60445221"
---
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | OpenAgora |
| Идентификатор | WA104381473 |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | делегирована | Пользовательский&#8217;s Azure Active Directory ID. | Идентификация пользователя для обеспечения того, чтобы пользователи могли видеть и управлять только видимыми для них данными. | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
