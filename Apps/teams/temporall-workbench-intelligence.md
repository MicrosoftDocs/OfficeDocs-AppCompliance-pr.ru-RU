...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | делегирована | Получает список командных приложений, установленных для получения локального id приложения для известного внешнего id. | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| Channel.ReadBasic.All | приложение | Имя id &amp; канала. Обоснование. Разрешить присоединение или выход из канала для синхронизации действий сообщений.  | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| ChannelMessage.Read.All | приложение | Тип активности &amp; сообщения, а также целевой &amp; адрес отправитель. Данные, полученные с этих маршрутов: /teams/${teamId}/channels/${channelId}/messages/teams/${teamId}/channels/${channelId}/messages/${messageId}. Обоснование. Чтобы иметь возможность вычислять метрики &amp; отчета о активности сообщений. Это создает ядро нашего модуля анализа организационных сетей, чтобы можно было нарисовать схему действий между группами &amp; пользователей. | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| Directory.Read.All | приложение | ClientId, Список пользователей, список организаций и подканалов. Обоснование: необходимо читать &amp; синхронизацию пользователей с височной workbench | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| Group.ReadWrite.All | приложение | Имя группового &amp; ид. Обоснование: установка приложения на каждую группу/канал | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| TeamMember.Read.All | приложение | Членство пользователя в команде. Обоснование. Позволяет синхронизировать всех пользователей в Teams с височной workbench | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| TeamsAppInstallation.ReadWriteForTeam.All | приложение | Ознакомьтесь со списком приложений, установленных для Team. Обоснование. Проверьте, установлено ли наше приложение в противном случае, чтобы получить сообщение с помощью API графа | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| TeamsAppInstallation.ReadWriteForUser.All | приложение | Чтение списка установленных приложений. Проверьте, установлено ли наше приложение в противном случае для его связи с пользователем с помощью анкеты | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
>| User.Read | делегирована | Основные сведения &amp; о компании-пользователе. Обоснование: используется для классификации активности сообщения пользователем, позволяет боту участвовать в активном обмене сообщениями. | [d5630318-189a-4912-abae-99b1f8f82cce](https://docs.microsoft.com/microsoft-365-app-certification/azure/d5630318-189a-4912-abae-99b1f8f82cce) |
