...
description: Все доступные сведения о безопасности и соответствия требованиям для Workbench Intelligence, политики обработки данных, сведения о каталоге Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Workbench Intelligence предоставляет сведения в режиме реального времени, которые помогут вам принимать более быстрые и более важные решения. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.temporall.com/teams_intelligence/](https://www.temporall.com/teams_intelligence/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | делегирована | Получает список командных приложений, установленных для получения локального id приложения для известного внешнего id. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Channel.ReadBasic.All | приложение | Имя id канала &amp; . Обоснование. Разрешить присоединение или выход из канала для синхронизации действий сообщений.  | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| ChannelMessage.Read.All | приложение | Тип активности сообщения &amp; , а также целевой адрес отправитель &amp; . Данные, полученные с этих маршрутов: /teams/${teamId}/channels/${channelId}/messages/teams/${teamId}/channels/${channelId}/messages/${messageId}. Обоснование. Чтобы иметь возможность вычислять метрики &amp; отчета о активности сообщений. Это создает ядро нашего модуля анализа организационных сетей, чтобы можно было нарисовать схему действий между группами &amp; пользователей. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Directory.Read.All | приложение | ClientId, Список пользователей, список организаций и подканалов. Обоснование: необходимо читать синхронизацию &amp; пользователей с височной workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Group.ReadWrite.All | приложение | Имя группового ид &amp; . Обоснование: установка приложения на каждую группу/канал | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamMember.Read.All | приложение | Членство пользователя в команде. Обоснование: позволяет синхронизировать всех пользователей в Teams с височной workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | приложение | Ознакомьтесь со списком приложений, установленных для Team. Обоснование. Проверьте, установлено ли наше приложение в противном случае, чтобы получить сообщение с помощью API графа | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | приложение | Чтение списка установленных приложений. Проверьте, установлено ли наше приложение в противном случае для его связи с пользователем с помощью анкеты | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| User.Read | делегирована | Основные сведения о &amp; компании-пользователе. Обоснование: используется для классификации активности сообщения пользователем, позволяет боту участвовать в активном обмене сообщениями. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
