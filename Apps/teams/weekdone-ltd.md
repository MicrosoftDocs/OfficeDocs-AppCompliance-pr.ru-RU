---
title: Сведения о приложениях для Weekdone by Weekdone Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Weekdone, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Weekdone Ltd Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Weekdone |
| ID | WA200003399 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Weekdone Ltd |
| Веб-сайт компании | [https://weekdone.com](https://weekdone.com) |
| Условия использования приложения | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| Основные функции приложения | Просмотр и обновление еженедельных проверок и ОКБ, а также уведомление об обновлениях |
| Расположение штаб-квартиры компании | Эстония |
| Страница информация о приложении | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
Эта информация была предоставлена Ооо Weekdone о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | IP-адрес устройства. Имя и адрес электронной почты клиента. |
...
| URL-адрес политики конфиденциальности | https://weekdone.com/privacy |
