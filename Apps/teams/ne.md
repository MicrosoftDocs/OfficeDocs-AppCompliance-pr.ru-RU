---
title: Сведения о приложении для NE от NE
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для NE, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 95fc109535a4a8d4586d8f55fcec4a6e809b3281
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые ne корпорации Майкрософт:
...
| Название партнерской компании | NE |
...
| Основные функциональные возможности приложения | Приложение teams, которое позволяет клиентам NE получать доступ к своим службам содержимого из команд. Он также добавляет расширение сообщений teams, позволяя пользователям выполнять поиск в encyclopedia NE, @ne в чате. |
| Расположение компании | Швеция |
| Страница сведений о приложении | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
...
Эта информация была предоставлена ne о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
