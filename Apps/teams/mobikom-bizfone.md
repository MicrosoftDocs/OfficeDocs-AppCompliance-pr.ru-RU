...
description: Все доступные сведения о безопасности и соответствии требованиям для Bizfone, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://mobikom.dk/faq/](https://mobikom.dk/faq/) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | Azure, SelfHosted |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | делегирована | Календари используются для того, чтобы пользователи могли показывать коллегам свою календару и использовать собрания для настройки телефонии | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| Contacts.Read | делегирована | Контакты пользователей можно хранить, если они хотят показать их в приложении, чтобы упростить набор контактов | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | делегирована | Чтение пользователя в этом приложении используется для идентификации. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | делегирована | Мы не храним данные. Приложение просто используется в целях authentification | [fc8f7563-e8ea-4b6d-9622-82775a21a35a](../azure/fc8f7563-e8ea-4b6d-9622-82775a21a35a.md) |
