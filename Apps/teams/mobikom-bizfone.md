---
title: Сведения о приложении для Bizfone от MobiKOM
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Вся доступная информация о безопасности и соответствии для Bizfone, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: eabb97402352434dcb95c3fea96c1edb9b4cd0a4
...
* <a href="https://teams.microsoft.com/l/app/5be25d59-35cd-4318-83b0-2a5d5668ddcd" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | MobiKOM |
| Веб-сайт компании | [https://mobikom.dk](https://mobikom.dk) |
| Условия использования приложения | [https://mobikom.dk/salgs-og-leveringsbetingelser/](https://mobikom.dk/salgs-og-leveringsbetingelser/) |
...
| Страница сведений о приложении | [https://mobikom.dk/faq/](https://mobikom.dk/faq/) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Azure, SelfHosted |
...
Эта информация предоставлена MobiKOM о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемыми приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Делегированные | Календари используются для того, чтобы пользователи могли показывать своим коллегам свой кэшар и использовать собрания для настройки телефонии. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| Contacts.Read | Делегированные | Контакты пользователей могут храниться, если они хотят показать их в приложении, чтобы упростить набор контактов | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | Делегированные | Чтение пользователя в этом приложении используется для идентификации. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | Делегированные | Мы не храним данные. Приложение просто используется для проверки подлинности | [fc8f7563-e8ea-4b6d-9622-82775a21a35a](../azure/fc8f7563-e8ea-4b6d-9622-82775a21a35a.md) |
