...
description: Вся доступная информация о безопасности и соответствия требованиям для знака Zoho, политики обработки данных, Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Zoho Sign — это безопасное облачное приложение цифровой подписи, которое позволяет подписывать, отправлять и управлять бизнес-документами юридически и электронно. Вы можете легко создавать рабочие процессы электронного знака для сбора подписей, проверки подлинности подписей, срабатываний напоминаний и отслеживания состояния подписи и утверждения в режиме реального времени. Zoho Sign также позволяет управлять всеми документами непосредственно из приложений Майкрософт из веб-браузера и в непосредственной работе с мобильными приложениями. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Если в процессе infastructure или хранятся данные клиентов Microsoft, где эти данные географически хранятся? | Индия, Япония, Австралия, Китай, Нидерланды (), Ирландия, Соединенные Штаты Америки |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Вход и чтение профиля пользователя | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
