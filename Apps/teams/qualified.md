...
description: Все доступные сведения о безопасности и соответствии требованиям для Qualified, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Qualified мгновенно оповещает продавцов, когда на ваш сайт поступают горячие перспективы |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.qualified.com/university-guide/microsoft-teams-...](https://www.qualified.com/university-guide/microsoft-teams-integration) |
...
>| Team.ReadBasic.All | приложение | Позволяет нам находить все каналы из всех групп, чтобы позволить нам выбирать каналы для уведомления | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
