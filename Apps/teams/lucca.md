...
| Основные функции приложения | Компания Lucca разрабатывает решения SaaS для оптимизации административных и HR-процессов. Мы проектим программные решения, которые предоставляют простые ответы на конкретные потребности: управление отпуском и отсутствием, отчеты о расходах, отслеживание времени... |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | делегирована | Данные не собираются. Мы использовали их для фильтрации планирования для отображения. Только у пользователей, которые находятся в канале, отображается их планирование | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| Chat.ReadWrite | приложение | Данные не собираются и не используются. Приложение только после сообщения, которое содержит открепительных дня | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| Group.Read.All | приложение | Мы собираем GroupId, чтобы узнать, в какой группе приложение должно отправлять сообщение с открепительными.  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| User.Read | делегирована | Используется для входов в пользователей | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| User.Read.All | приложение | Используется для чтения профилей пользователей | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| email | делегирована | Используется для отображения электронной почты пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| openid | делегирована | Используется для входа пользователя | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| profile | делегирована | Используется для отображения профиля пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
