---
title: Сведения о приложении для Lucca от Lucca
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Все доступные сведения о безопасности и соответствии для Lucca, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/53628f6a-ac66-4fde-8945-d639c8da4c0d" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Lucca корпорации Майкрософт:
...
| Название партнерской компании | Lucca |
| Веб-сайт компании | [https://www.lucca.fr](https://www.lucca.fr) |
| Условия использования приложения | [https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/Ter...](https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/TermsAndConditions.pdf) |
| Основные функциональные возможности приложения | Lucca разрабатывает решения SaaS для оптимизации административных процессов и процессов управления персоналом. Мы проектируете программные решения, которые предоставляют простые ответы на конкретные потребности: управление выходом и отсутствием, отчеты о расходах, отслеживание времени... |
...
Эта информация была предоставлена Lucca о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | Делегированные | Данные не собираются. Мы использовали их для фильтрации планирования отображения. Отображаются только пользователи, которые находятся в канале. | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Chat.ReadWrite | приложение | Данные не собираются и не используются. Приложение отправляет только сообщение, содержащее отсутствующее сообщение дня | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Group.Read.All | приложение | Мы собираем Идентификатор группы, чтобы узнать, в какую группу приложение должно отправить сообщение с отсутствуют.  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read | Делегированные | Используется для входа пользователей | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read.All | приложение | Используется для чтения профилей пользователей | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| email | Делегированные | Используется для отображения электронной почты пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| openid | Делегированные | Используется для входа пользователя | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| profile | Делегированные | Используется для отображения профиля пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
