...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | делегирована | Данные не собираются. Мы использовали их для фильтрации планирования для отображения. Только у пользователей, которые находятся в канале, отображается их планирование | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Chat.ReadWrite | приложение | Данные не собираются и не используются. Приложение только после сообщения, которое содержит открепительных дня | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Group.Read.All | приложение | Мы собираем GroupId, чтобы узнать, в какой группе приложение должно отправлять сообщение с открепительными.  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read | делегирована | Используется для входов в пользователей | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
...
>| email | делегирована | Используется для отображения электронной почты пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| openid | делегирована | Используется для входа пользователя | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| profile | делегирована | Используется для отображения профиля пользователя на вкладке приложения | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
