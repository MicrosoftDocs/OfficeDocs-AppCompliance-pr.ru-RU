---
title: Сведения о приложении для Висята от Nimbella
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
ms.openlocfilehash: 196d33c18fed6b9b2f8826b7d273fac47c973db9
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877626"
---
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Nimbella |
...
| Основные функциональные возможности приложения | Создание, запуск и совместное использование пользовательских команд. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Azure, GCP, DigitalOcean |
...
Эти сведения были предоставлены Nimbella о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
