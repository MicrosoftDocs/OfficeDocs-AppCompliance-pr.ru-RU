---
title: Сведения о приложениях для GoLinks от GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для GoLinks, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: d57970d6b77882e1227d2af3e29fe131c4379d38
ms.sourcegitcommit: af065aeee2812a85ead9e0de968fc474204a6e8a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/22/2022
ms.locfileid: "63698910"
---
# <a name="golinks"></a>GoLinks

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 1 октября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые GoLinks в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | GoLinks |
| ID | WA200003853 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | GoLinks |
| Веб-сайт компании | [https://www.golinks.io](https://www.golinks.io) |
| Условия использования приложения | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Основные функции приложения | GoLinks, известные как ссылки на go, golinks, go/links или go-links, являются интуитивно понятными, легко запоминаются короткими ссылками, общими для групп. Он преобразует длинные, уродливые URL-адреса в понятные для человека ссылки, которые можно использовать непосредственно в браузерах, сообщениях электронной почты, чатах и в беседах. GoLinks позволяет компаниям эффективно и эффективно получать доступ к сведениям о работе и ресурсам в масштабе и обмениваться ими. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
Эти сведения предоставлены goLinks о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Мы храним только ID клиента от Microsoft. |
...
| Самая недавняя дата сертификации SOC2 |  2021-10-31 |
...
| URL-адрес политики конфиденциальности | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | приложение | Нам нужен доступ к сообщениям в общедоступных каналах, чтобы проверить, содержит ли сообщение ссылку go/link. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
