...
description: Все доступные сведения о безопасности и соответствии требованиям для PlayQuiz - Aprende &amp; Juega, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | PlayQuiz — это приложение для геймификации, в котором пользователь может отвечать на 3 вопроса каждый день из Microsoft 365 экосистемы, чтобы &#8220;зарабатывать&#8221; цифровых точек знаний. Пользователь сможет просмотреть лидеров компании, чтобы узнать, кто является лучшим чемпионом M365 компании. Включив геймификацию в компанию, пользователи получают представление о лучших практиках использования Microsoft 365 средств. Кроме того, администратор сможет добавлять свои настраиваемые вопросы в систему для строительных кампаний, ориентированных на определенную тему. |
| Расположение штаб-квартиры компании | Испания |
| Страница информация о приложении | [https://www.teamsquiz.com](https://www.teamsquiz.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Имя, электронная почта и изображение профиля пользователя | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| User.ReadBasic.All | делегирована | Имя, электронная почта и изображение профиля | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| openid | делегирована | просмотр базового профиля пользователя | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| profile | делегирована | Чтение базового профиля пользователя | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
