...
description: Все доступные сведения о безопасности и соответствии для AtBot, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0c8c0737f19c6ebbeefaceeab5a5fdf5bdfe58f8
...
* <a href="https://teams.microsoft.com/l/app/7c01af81-ae7d-416e-98a3-c139cae8cfb0" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые H3 Solutions, Inc. корпорации Майкрософт:
...
| Название партнерской компании | H3 Solutions, Inc. |
...
| Основные функциональные возможности приложения | Быстро создавайте пользовательские интерфейсы для общения, и вам не нужно писать код. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://admin.atbot.io/Docs/GettingStarted](https://admin.atbot.io/Docs/GettingStarted) |
...
Эта информация была предоставлена H3 Solutions, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | приложение | AAD группы, AAD GUID группы, имя участника-пользователя | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| Directory.Read.All | Делегированные | AAD группы, AAD GUID группы, имя участника-пользователя | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| People.Read | Делегированные | Нет | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| User.Read | Делегированные | Идентификатор клиента, имя участника-пользователя | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| email | Делегированные | Адреса электронной почты используются для связи в службе поддержки через нашу систему поддержки. | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| offline_access | Делегированные | Маркеры доступа и обновления. | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| openid | Делегированные | Имя участника-пользователя, идентифицирует пользователя в системе | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| profile | Делегированные | Имя участника-пользователя | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
