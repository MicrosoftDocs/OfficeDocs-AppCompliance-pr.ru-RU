...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Directory.Read.All | приложение | AAD Имя группы, AAD GUID группы, UPN | Переумейте AAD групп, чтобы обеспечить безопасность и уравновешение навыков бота. Переуметь пользователей, чтобы иметь возможность применять лицензии. Переумейте пользователей, которые будут добавляться в качестве администраторов и участников | [066a6b3a-f7a0-450a-98c7-34db1da31594](https://docs.microsoft.com/microsoft-365-app-certification/azure/066a6b3a-f7a0-450a-98c7-34db1da31594) |
>| Directory.Read.All | делегирована | AAD Имя группы, AAD GUID группы, UPN | Переумейте AAD групп, чтобы обеспечить безопасность и уравновешение навыков бота. Переуметь пользователей, чтобы иметь возможность применять лицензии. Переумейте пользователей, которые будут добавляться в качестве администраторов и участников | [066a6b3a-f7a0-450a-98c7-34db1da31594](https://docs.microsoft.com/microsoft-365-app-certification/azure/066a6b3a-f7a0-450a-98c7-34db1da31594) |
...
>Администраторы могут удалять конфигурации ботов, которые могут содержать AAD групп или GUID.
