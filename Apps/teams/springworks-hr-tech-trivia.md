...
description: Вся доступная информация о безопасности и соответствии требованиям для Trivia, политики обработки данных, Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Условия использования приложения | [https://trivia.springworks.in/tnc](https://trivia.springworks.in/tnc) |
| Основные функции приложения | Команда, которая играет вместе, лучше объединяется. С Помощью Trivia играйте в режиме реального времени викторины и головоломки со своими товарищами по команде, вовлекайте их и связывайте социальные перерывы на работе. Trivia&#8217;s Suite of Features: Quizzes - Compete against your teammates in MCQ format quizzes, Word Puzzles - Solve puzzles by simply rearranging letters to form meaningful word and (Un)Popular Opinions - Stir up some controversy in your team with fun polls |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.springworks.in/trivia](https://www.springworks.in/trivia) |
...
| Какие данные хранятся в базах данных? | name,email |
...
| URL-адрес политики конфиденциальности | https://www.springworks.in/privacy-policy/ |
