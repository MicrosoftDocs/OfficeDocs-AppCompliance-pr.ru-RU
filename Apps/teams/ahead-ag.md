---
title: Сведения о приложении для упреждающей группы доступности
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям заранее, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66549628"
---
# <a name="ahead"></a>Вперед

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 20 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/53360535-c93f-497f-b2a1-95bd9aa34283" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004202" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые ahead AG в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Вперед |
| ID | WA200004202 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | упреждающее группу доступности |
| Веб-сайт компании | [https://www.aheadintranet.com](https://www.aheadintranet.com) |
| Условия использования приложения | [https://www.aheadintranet.com/terms-and-conditions](https://www.aheadintranet.com/terms-and-conditions) |
| Основные функциональные возможности приложения | Приложение вовлечения сотрудников для информирования и вовлечения сотрудников. |
...
Эти сведения были предоставлены упреждающей группы доступности о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные, относящиеся к правильной функции упреждающего продукта интрасети. Это относится, но не ограничивается новостями, историями, сведениями, связанными с целевым содержимым для определенных групп пользователей, навигации и уведомлений. |
...
| Какие данные хранятся в базах данных? | Данные, относящиеся к правильной функции упреждающего продукта интрасети. Это относится, но не ограничивается новостями, историями, сведениями, связанными с целевым содержимым для определенных групп пользователей, навигации и уведомлений. Данные, связанные с пользователем, являются копиями файлов, доступных только для Azure AD. Это ограничение ограничивается идентификатором и именем пользователя и его членством в группах Azure AD, которые были помечены как релевантные заранее. |
...
| URL-адрес политики конфиденциальности | https://www.aheadintranet.com/data-security |
...
| Перечисление поддерживаемых типов политик | Клиентское приложение |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Делегированные | Целевые новости в соответствии с группами AD | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Directory.Read.All | приложение | Целевые новости в соответствии с группами AD для принудительной отправки | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| ExternalItem.Read.All | Делегированные | Поиск контента из сторонних источников (ServiceNow) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Sites.Read.All | Делегированные | Поиск контента на сайтах SharePoint | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Делегированные | Чтение профиля пользователя | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Делегированные | Чтение профиля пользователя (рисунок и т. д.) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | Делегированные | Чтение профиля пользователя | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | приложение | Чтение сведений о профиле в поиске | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
