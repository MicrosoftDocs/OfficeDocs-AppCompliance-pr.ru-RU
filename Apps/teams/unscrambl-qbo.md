---
title: Сведения о приложении для qbo от Unscrambl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Все доступные сведения о безопасности и соответствии для qbo, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: aab302fc0fe72335d205477b8ed422d4c5940a24
ms.sourcegitcommit: ef767e1079411056cb3ca86d6b29084e31b0ef1c
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 05/26/2022
ms.locfileid: "65688564"
---
# <a name="qbo"></a>qbo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 25 ноября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые unscrambl корпорации Майкрософт:
...
| Название партнерской компании | Unscrambl |
| Веб-сайт компании | [https://unscrambl.com](https://unscrambl.com) |
| Условия использования приложения | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| Основные функциональные возможности приложения | Qbo, на базе Unscrambl qbo Insights, делает аналитику диалоговой с использованием лучшей в классе NLP. Пользователи введите вопрос, а qbo предоставляет наиболее важные аналитические сведения и визуализации в оснастке. Пользователи могут активно сотрудничать с коллегами, принимать решения и записывать результаты на досках, готовых к презентации. qbo позволяет всем сотрудникам организации принимать решения на основе данных. QBO напрямую подключается к диапазону облачных или локальных источников и может быть Microsoft Teams или через браузер. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://qbo.ai](https://qbo.ai) |
...
Эта информация была предоставлена Unscrambl о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Имя и адрес электронной почты используются для создания учетной записи |
...
| URL-адрес политики конфиденциальности | https://qbo.ai/legal/ |
