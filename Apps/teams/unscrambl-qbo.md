...
description: Все доступные сведения о безопасности и соответствии требованиям для QBO, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Условия использования приложения | [https://qbo.ai/legal/#service](https://qbo.ai/legal/#service) |
| Основные функции приложения | QBO, на питание от аналитики unscrambl qbo, делает аналитику разговорной с помощью лучших в своем классе НЛП. Пользователи введите вопрос и qbo поверхности наиболее релевантные идеи и визуализации в оснастке. Пользователи могут активно сотрудничать с коллегами, принимать решения и фиксировать результаты на досках, готовых к презентации. qbo предоставляет всем в организации возможность принимать решения, управляемые данными. qbo непосредственно подключается к ряду облачных или локального источников и может быть доступ к Microsoft Teams или браузера. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://qbo.ai](https://qbo.ai) |
