---
title: Сведения о приложениях для интерпретации Akouo от Akouo Technologies Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/25/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Akouo Interpretation, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64480604"
---
# <a name="akouo-interpretation"></a>Интерпретация Akouo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 8 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/d863a24b-7cdd-46c9-8309-a15878f4f7bf" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003814" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт akouo Technologies Inc.:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Интерпретация Akouo |
| Идентификатор | WA200003814 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Akouo Technologies Inc. |
| Веб-сайт компании | [https://akouo.io](https://akouo.io) |
| Условия использования приложения | [https://akouo.io/terms](https://akouo.io/terms) |
| Основные функции приложения | Сделайте собрания многоязычными с одновременным толкованием. |
| Расположение штаб-квартиры компании | Объединенные Арабские Эмираты (the) |
| Страница информация о приложении | [https://akouo.io](https://akouo.io) |
...
Эти сведения предоставлены akouo Technologies Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Адрес электронной почты пользователя. |
...
| URL-адрес политики конфиденциальности | https://akouo.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.Read | делегирована | Используется для получения сведений о собраниях, таких как время начала и т.д. Только запрашивается для организатора собрания. | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| offline_access | приложение | Автоматически требуется от Microsoft&#8217;единого входного фреймворка. https://docs.microsoft.com/en-us/graph/permissions-reference#remarks-15  | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| openid | приложение | Проверка подлинности пользователей с помощью сеанса входа в Microsoft/Azure | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
