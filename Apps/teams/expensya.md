---
title: Сведения о приложении для Expensya от Expensya
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Вся доступная информация о безопасности и соответствии для Expensya, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Expensya корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Expensya |
| ID | WA200003924 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Expensya |
| Веб-сайт компании | [https://www.expensya.com](https://www.expensya.com) |
| Условия использования приложения | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| Основные функциональные возможности приложения | Expensya автоматизирует бизнес-расходы от обработки счетов до корпоративных карточек |
...
Эта информация была предоставлена Expensya о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Профиль компании, профили пользователей (сотрудников) и элементы расходов на бизнес |
...
| Какие данные хранятся в базах данных? | Маркеры Graph Майкрософт (по мере интеграции с Teams!) |
...
| URL-адрес политики конфиденциальности | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | приложение | Нам нужны полное имя пользователя и адрес электронной почты | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
