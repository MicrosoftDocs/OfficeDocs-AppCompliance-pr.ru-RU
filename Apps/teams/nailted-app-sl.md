---
title: Сведения о приложениях для пригвоздки с помощью NAILTED APP S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставляемые NAILTED APP S.L. в Корпорацию Майкрософт:
...
| Имя компании-партнера | NAILTED APP S.L. |
...
| Основные функции приложения | Платформа привлечения сотрудников для современных hr-групп people &amp; . |
| Расположение штаб-квартиры компании | Испания |
| Страница информация о приложении | |
| Какова среда размещения или модель службы, используемая для запуска приложения? | Paas |
| Какие поставщики облачных хостингов используют приложение? | Heroku |
...
Эти сведения были предоставлены в NAILTED APP S.L. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
...
>| TeamsAppInstallation.ReadWriteForUser | приложение | Пользователь может выбрать, для каких пользователей он хочет установить приложение. Таким образом, мы используем это разрешение для иссу- | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
...
>| email | приложение | Доступ к электронной почте сотрудников, чтобы синхронизировать их | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | приложение | Мы используем это разрешение, чтобы иметь доступ к API, когда пользователь не находится в сети, чтобы синхронизировать сотрудников и установить приложение | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
