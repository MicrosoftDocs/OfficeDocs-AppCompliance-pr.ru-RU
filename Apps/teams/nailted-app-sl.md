---
title: Сведения о приложении для приложения, разделенного ИНСТРУКЦИЕЙ ПО ИНСТРУКЦИИ ПО S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Службы хранилища Azure, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые ПРИЛОЖЕНИЕМ СЛВМЕХ в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Nailted |
| Идентификатор | WA200003375 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | NAILTED APP S.L. |
| Веб-сайт компании | [https://nailted.com](https://nailted.com) |
| Условия использования приложения | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| Основные функциональные возможности приложения | Платформа привлечения сотрудников для современных отделов кадров &amp; людей. |
...
| Какие поставщики облачных служб используются приложением? | Heroku |
...
Эти сведения предоставлены ПРИЛОЖЕНИЕм С.L. о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | tenantId и электронная почта |
...
| Какие данные хранятся в базах данных? | tenantId и электронная почта |
...
| URL-адрес политики конфиденциальности | https://nailted.com/legal/privacy |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Мы используем последнюю версию библиотеки проверки подлинности Майкрософт |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | приложение | Используется для доступа к группам. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| TeamsAppInstallation.ReadWriteForUser | приложение | Пользователь может выбрать, для каких пользователей требуется установить приложение. Поэтому мы используем это разрешение для установки приложения. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | приложение | Используется для чтения сведений о пользователях | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| email | приложение | Доступ к электронной почте сотрудников для их синхронизации | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | приложение | Это разрешение используется для доступа к API, если пользователь не подключен к сети для синхронизации сотрудников и установки приложения. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
