...
description: Все доступные сведения о безопасности и соответствия требованиям для сотрудников, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Fellow — это место, где группы собираются, чтобы иметь продуктивные собрания и значимые 1:1, создавать совместные программы собраний, записывать решения и держать друг друга подотчетными. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://fellow.app/integrations/microsoft-teams/](https://fellow.app/integrations/microsoft-teams/) |
...
Эти сведения предоставлены сотрудником Аналитика Inc о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Данные профилей пользователей (имя, электронная почта, аватар и т.д....), данные календаря (список календарей, события, участники и т.д....), Teams Data (имена команд, членство в команде).. |
...
| Самая недавняя дата сертификации SOC2 |  2022-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | оба | Fellow — это приложение для управления собраниями, поэтому для эффективной работы ему необходим доступ для чтения и записи в календари пользователей. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Channel.ReadBasic.All | делегирована | Позволяет пользователям размещать заметки о собраниях в заданный канал, который указан в Fellow. Обратите внимание, что это позволяет только видеть, какие каналы существуют. Он не обеспечивает возможность чтения сообщений. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Directory.Read.All | приложение | (Только для грантов приложений) Позволяет fellow синхронизировать сведения о каталогах пользователей, включая всех пользователей. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Group.Read.All | приложение | (Только для грантов приложений) Позволяет fellow синхронизировать пользователей и группы. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| People.Read | делегирована | Разрешить пользователям находить Microsoft Teams для отправки заметок. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| People.Read.All | приложение | (Только для грантов приложений) Позволяет получить доступ к данным профиля для всех пользователей. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Team.ReadBasic.All | делегирована | Разрешить коллегам получать основные сведения о командах, чтобы иметь возможность отправлять заметки и добавлять вкладку Fellow. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| User.Read | делегирована | Разрешить пользователям войти в Fellow и получить основные сведения о профиле. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| User.Read.All | приложение | (Только для грантов приложений) Позволяет получить доступ к данным профиля для всех пользователей. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| offline_access | делегирована | Fellow требует автономного &quot;доступа&quot; к данным календаря для фоновой синхронизации. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
