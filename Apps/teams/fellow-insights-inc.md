...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | оба | Сотрудник подключается к календарям пользователей, чтобы предоставить им возможность делать заметки на данных. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Channel.ReadBasic.All | делегирована | Мы собираем имена каналов, членом которых является пользователь, чтобы показать им список каналов, на которые они могут отправлять заметки. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
...
>| Team.ReadBasic.All | делегирована | Собран список групп, в которые входит пользователь. Это используется в коллеге для того, чтобы разрешить пользователю отослать заметки из fellow в команду. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| User.Read | делегирована | Собираются основные сведения о пользователях. Имя пользователя, электронная почта, название задания. Эти сведения используются в fellow для создания учетных записей пользователей и учетных записей компании. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
...
>| offline_access | делегирована | Маркер обновления пользователя для поддержания доступа к данным, собранным в других сферах. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
