...
description: Все доступные сведения о безопасности и соответствия требованиям для Smartnotation, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Smartnotation — это простое в использовании решение минут собраний с включенной голосовой поддержкой. Ваши заметки, действия и решения просты в управлении, и ваша информация всегда доступна. Прежде всего, это отнимает ненужные накладные расходы, позволяя вам и вашей команде сосредоточиться на основной бизнес. Вы можете полностью интегрировать Smartnotation с ms Teams. Добавьте соединители, чтобы получить уведомления о всех важных обновлениях, новых заметках, действиях и решениях для конкретного проекта, настройте вкладку или используйте Smartnotation напрямую. |
| Расположение штаб-квартиры компании | Нидерланды (the) |
| Страница информация о приложении | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | Totaaldomein B.V. |
