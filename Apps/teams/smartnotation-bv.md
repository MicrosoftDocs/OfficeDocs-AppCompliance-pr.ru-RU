---
title: Сведения о приложении для Smartnotation от Smartnotation B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для Smartnotation, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: e3316ff1dd822898bc41321282e40835fe13deb4
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876246"
---
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Smartnotation B.V. |
| Веб-сайт компании | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| Условия использования приложения | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| Основные функциональные возможности приложения | Smartnotation — это простое в использовании решение для минут собраний с поддержкой голосовой связи. Заметками, действиями и решениями легко управлять, и ваша информация всегда доступна. Кроме того, это позволяет вам и вашей команде сосредоточиться на своей основной деятельности. Smartnotation можно полностью интегрировать с MS Teams. Добавьте соединитель, чтобы получать уведомления о всех важных обновлениях, новых заметках, действиях и решениях для конкретного проекта, настраивать вкладку или напрямую использовать Smartnotation. |
| Расположение компании | Нидерланды (the) |
| Страница сведений о приложении | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Totaaldomein B.V. |
...
Эти сведения предоставлены smartnotation B.V. о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
