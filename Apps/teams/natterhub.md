...
description: Все доступные сведения о безопасности и соответствии требованиям для Natterhub, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые Natterhub Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Natterhub |
| ID | WA200003420 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Natterhub |
| Веб-сайт компании | [https://natterhub.com](https://natterhub.com) |
| Условия использования приложения | [https://natterhub.com/legal](https://natterhub.com/legal) |
| Основные функции приложения | Natterhub — это центр безопасности в Интернете и информационной грамотности. Разработанный для обучения учащихся в возрасте от 5 до 11 лет безопасности и смекалки в Интернете, Natterhub использует закрытой, иммерсивной платформы стиле социальных средств массовой информации, на складе с эффектными интерактивными уроками и действиями. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://natterhub.com](https://natterhub.com) |
...
Эта информация была предоставлена Natterhub о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | id клиента, имя пользователя, фамилия пользователя, электронная почта пользователя |
...
| URL-адрес политики конфиденциальности | https://natterhub.com/legal#privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| EduAssignments.ReadWrite | делегирована | Необходимые для создания отправки назначений | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| User.Read | делегирована | Обязательное чтение имени и фамилии пользователя | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| email | делегирована | Мы требуем этого разрешения, чтобы пользователь был в получении транзакционной электронной почты | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| offline_access | делегирована | Необходимые для отправки отправки заданий | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| openid | делегирована | Необходимо идентифицировать пользователя | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| profile | делегирована | Обязательное чтение имени и фамилии пользователя | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
