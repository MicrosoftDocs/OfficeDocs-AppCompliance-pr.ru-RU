...
| Основные функции приложения | Brightcove Video Подключение поддерживает варианты совместной работы с видео- и медиаактивами непосредственно в Microsoft Teams |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
