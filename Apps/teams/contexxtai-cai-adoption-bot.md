...
| Использует ли среда традиционные средства защиты от вредоносных программ или элементы управления приложениями? | Традиционные средства борьбы с вредоносными программами, элементы управления приложениями |
...
| Многофакторная проверка подлинности (MFA) включена для: | Репозитории кода, DNS Management, Credential/Key Stores |
