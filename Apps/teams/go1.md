...
description: Все доступные сведения о безопасности и соответствия требованиям для Go1, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | ПРИЛОЖЕНИЕ GO1 Teams помогает находить, потреблять, делиться и обсуждать учебные ресурсы из Microsoft Teams |
...
>| Group.ReadWrite.All | приложение | Teams и имя канала и уникальный id хранятся для поддержки среды обучения, управляющей приложением | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | приложение | имена пользователей, электронная почта и UPN, хранимые для предоставления непосредственного личного опыта для пользователя | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
