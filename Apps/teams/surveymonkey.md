---
title: Сведения о приложении для SurveyMonkey от SurveyMonkey
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Вся доступная информация о безопасности и соответствии для SurveyMonkey, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 2e93b95471150480ceca9e8ca3bb24af1063c9dd
...
* <a href="https://teams.microsoft.com/l/app/0fd925a0-357f-4d25-8456-b3022aaa41a9" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые SurveyMonkey корпорации Майкрософт:
...
| Название партнерской компании | SurveyMonkey |
...
| Основные функциональные возможности приложения | Совместная работа и запись отзывов и тональности сотрудников с помощью опросов и быстрых опросов. Фиксируйте результаты в одном месте, чтобы поддерживать команду в актуальном состоянии с новыми ответами. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
...
Эта информация была предоставлена SurveyMonkey о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
