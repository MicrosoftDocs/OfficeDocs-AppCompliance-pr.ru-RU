---
title: Сведения о приложении для SHL по SHL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для SHL, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: faf63dec59aa0f3098a08ef8acd4405776ed18a3
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879196"
---
# <a name="shl"></a>SHL
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые SHL корпорации Майкрософт:
...
| Название партнерской компании | SHL |
| Веб-сайт компании | [https://shl.com](https://shl.com) |
| Условия использования приложения | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| Основные функциональные возможности приложения | SHL — это глобальный лидер в области технологий отдела кадров и биометрических наук, который позволяет получить глубокие аналитические сведения о сотрудниках, помогая компаниям создавать эффективные решения для сотрудников, которые помогают получить бизнес-результаты. SHL предоставляет мощные и прозрачные технологии ИИ, обработку и анализ данных и объективность, чтобы помочь компаниям привлечь, разработать и расширить персонал, необходимый для достижения успеха в цифровой эре. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
Эта информация была предоставлена SHL о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | Делегированные | Доступные общие слоты Calander | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
