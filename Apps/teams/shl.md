...
description: Все доступные сведения о безопасности и соответствии требованиям для SHL, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | SHL является глобальным лидером в области hr-технологий и психометрических наук, что позволяет глубоко понять людей, помогая компаниям разработать мощные решения для рабочей силы, которые будут водить бизнес-результаты. SHL обеспечивает мощную и прозрачную технологию ИИ, науку о данных и объективность, чтобы помочь компаниям привлекать, развивать и увеличивать рабочую силу, необходимую для достижения успеха в цифровую эпоху. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | делегирована | Доступные общие слоты Calander | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
