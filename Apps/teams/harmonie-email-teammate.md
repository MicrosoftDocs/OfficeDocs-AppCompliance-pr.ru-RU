...
| Основные функции приложения | Добавление сообщений электронной почты Microsoft Teams беседы с командой электронной почты  |
| Расположение штаб-квартиры компании | Израиль |
| Страница информация о приложении | [https://harmon.ie](https://harmon.ie) |
...
Эти сведения были предоставлены harmon.ie о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | делегирована | Требуется teamMate для получения участников чата определенной беседы, чтобы обмениваться файлами, SharePoint/One диска с участниками беседы. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Files.ReadWrite.All | делегирована | Требуется teamMate для сохранения &amp; вложений электронной почты в SharePoint / Teams / OneDrive | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Mail.ReadWrite | делегирована | Требуется teamMate, чтобы показать сообщения электронной почты пользователя и ответить на сообщения электронной почты, сохраненные Teams | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| People.Read | делегирована | Требуется teamMate для поиска сообщений электронной почты от людей, а также для того, чтобы предложить людям, с которых вы часто обращались. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.Read | делегирована | позволяет пользователям войти в TeamMate со своей учетной записью и позволяет TeamMate видеть основные сведения о профиле пользователя | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.ReadBasic.All | делегирована | Требуется teamMate для решения адресов электронной почты участников чата, чтобы сохранить файлы OneDrive с ними  | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
