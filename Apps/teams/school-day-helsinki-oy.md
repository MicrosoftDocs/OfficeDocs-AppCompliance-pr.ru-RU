---
title: Сведения о приложении для учебного дня по учебному дню
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Учебного дня, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7caaa66b-34b0-4c15-a65d-dba6edf0c8fd" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт по учебному дню.
...
| Название партнерской компании | School Day Helsinki Oy |
...
| Основные функциональные возможности приложения | Улучшите безопасность учащихся и Social-Emotional Обучение (SEL) с помощью Дня учебы в Microsoft Teams! |
| Расположение компании | Финляндия |
| Страница сведений о приложении | [https://www.schoolday.com/en/resources/faq](https://www.schoolday.com/en/resources/faq) |
...
Эта информация была предоставлена организацией School Day Вай о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | Делегированные | Имя группы и членство в группах. Пользователь, который является преподавателем, может добавлять учащихся в Учебный день из своих групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| Team.ReadBasic.All | Делегированные | Имя команды используется, когда пользователь преподавателя хочет добавить учащихся из команд и групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.Read | Делегированные | Электронная почта пользователя, имя и маркер идентификатора используются для управления пользователями и проверки подлинности. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.ReadBasic.All | Делегированные | Изображения профилей пользователей, которые будут использоваться в аватарах пользователей. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| email | Делегированные | Электронная почта пользователя собирается для проверки подлинности учетной записи. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| offline_access | Делегированные | Проверка подлинности — обновление маркера доступа. Более плавное взаимодействие с пользователем. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| openid | Делегированные | Уникальный идентификатор пользователя для входа в OpenID.  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| profile | Делегированные | Предпочтительное имя пользователя и идентификатор объекта для управления пользователями и проверки подлинности. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
