...
description: Вся доступная информация о безопасности и соответствии требованиям для Учебного дня, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://www.schoolday.com/en/resources/faq](https://www.schoolday.com/en/resources/faq) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | делегирована | Имя группы и членство в группе. Пользователь, который является преподавателем, может добавлять учащихся в День школы из своих групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| Team.ReadBasic.All | делегирована | Имя группы используется, когда пользователь-преподаватель хочет добавить учащихся из своих групп и групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.Read | делегирована | Для управления и проверки подлинности используются электронная почта, имя и маркер пользователя. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.ReadBasic.All | делегирована | Изображения профилей пользователей, которые будут использоваться в аватарах пользователей. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| email | делегирована | Электронная почта пользователя собирается для проверки подлинности учетной записи. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| offline_access | делегирована | Проверка подлинности . Обновление маркера доступа. Более плавное пользовательское впечатление. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| openid | делегирована | Уникальный идентификатор пользователя для входной записи OpenID.  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| profile | делегирована | Предпочтительное имя пользователя и код объекта для управления пользователями и проверки подлинности. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
