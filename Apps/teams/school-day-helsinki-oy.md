---
title: Сведения о приложениях для дня школы в день школы Хельсинки Oy
ms.author: elmalova
author: elenamalova
ms.date: 10/12/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для Дня школы, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | School Day |
| Идентификатор | WA200001430 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | School Day Helsinki Oy |
| Веб-сайт компании | [https://www.schoolday.com](https://www.schoolday.com) |
| Условия использования приложения | [https://www.schoolday.com/eula](https://www.schoolday.com/eula) |
| Основные функции приложения | Повышение благосостояния учащихся и Social-Emotional Обучение (SEL) с днем школы в Microsoft Teams! |
| Расположение штаб-квартиры компании | Финляндия |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | делегирована | Имя группы и членство в группе. Пользователь, который является преподавателем, может добавлять учащихся в День школы из своих групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| Team.ReadBasic.All | делегирована | Имя группы используется, когда пользователь-преподаватель хочет добавить учащихся из своих групп и групп. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| User.Read | делегирована | Для управления и проверки подлинности используются электронная почта, имя и маркер пользователя. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| User.ReadBasic.All | делегирована | Изображения профилей пользователей, которые будут использоваться в аватарах пользователей. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| email | делегирована | Электронная почта пользователя собирается для проверки подлинности учетной записи. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| offline_access | делегирована | Проверка подлинности . Обновление маркера доступа. Более плавное пользовательское впечатление. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| openid | делегирована | Уникальный идентификатор пользователя для входной записи OpenID.  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| profile | делегирована | Предпочтительное имя пользователя и код объекта для управления пользователями и проверки подлинности. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
