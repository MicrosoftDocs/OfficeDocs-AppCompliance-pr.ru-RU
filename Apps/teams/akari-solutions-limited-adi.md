...
description: Все доступные сведения о безопасности и соответствии требованиям для ADI, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | ADI здесь, чтобы помочь вам со всеми вашими потребностями в доступности и увеличить ваши программы управления изменениями. Вы можете попросить ADI дать вам ответы, советы и сведения о том, как использовать функции доступности в Microsoft Teams, вы можете узнать о скрытых и сиюмитных ограничениях, а также о том, какие средства и советы могут помочь. ADI ответит вам смесью текстовых разговорных ответов, видео размером в byte и концептуальных ссылок из различных источников. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://akari.io/adi](https://akari.io/adi) |
