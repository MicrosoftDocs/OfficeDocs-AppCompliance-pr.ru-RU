---
title: Сведения о приложении для Perflo от Perflo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Вся доступная информация о безопасности и соответствии для Perflo, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/374c7844-f88a-43f3-b6d5-5cf58b5b293e" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004251" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Perflo корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Perflo |
| Идентификатор | WA200004251 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Perflo |
...
| Основные функциональные возможности приложения | Конечное решение для диагностики команды, которое позволяет командам постоянно улучшаться. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.perflo.co](https://www.perflo.co) |
...
Эта информация была предоставлена Perflo о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Идентификатор MS Teams, изображение профиля |
...
| Какие данные хранятся в базах данных? | Идентификатор MS Teams, изображение профиля |
