...
ms.openlocfilehash: 3ea0c163c7d7ca9660bc3db6ddecb5fa4d95497f
...
| Основные функции приложения | WorkJam — это лидеры отрасли решений для цифровых рабочих мест, которые выбирают для оркестровки своих рабочих &#8212; в качестве платформы производительности передовой линии или в рамках решения для сотрудников на переднем фронте. WorkJam, доступный на более чем 37 языках и развернутый в более чем 38 странах, обеспечивает общую оркестровка рабочей силы с помощью передовых на рынке средств управления задачами, управления сменами, опросов и микроучений.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | Отправка уведомлений конечным пользователям. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
>| User.Read | делегирована | Для идентификации и проверки подлинности | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
