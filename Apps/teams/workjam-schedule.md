---
title: Application Information for WorkJam Schedule by WorkJam
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для workJam Schedule, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f95f0f07e9d560f7f9c52082383f90ef465c57c1
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880120"
---
...
* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | WorkJam |
| Веб-сайт компании | [https://www.workjam.com](https://www.workjam.com) |
| Условия использования приложения | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| Основные функциональные возможности приложения | WorkJam — это лидеры отрасли решений digital Workplace, которые выбирают оркестрацию своих сотрудников переднего плана &#8212; в качестве платформы для повышения производительности или в рамках решения для сотрудников без компьютеров. WorkJam, доступный более чем на 37 языках и развернутый в более чем 38 странах, обеспечивает общую оркестрацию сотрудников с помощью ведущих на рынке средств управления задачами, управления сменами, опросов и микроу обучений.  |
| Расположение компании | Канада |
| Страница сведений о приложении | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
Эта информация была предоставлена WorkJam о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-08-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | Отправка уведомлений конечным пользователям. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | Делегированные | Для идентификации и проверки подлинности | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
