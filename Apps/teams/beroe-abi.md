---
title: Сведения о приложении для ABI от Beroe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Все доступные сведения о безопасности и соответствии для ABI, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Beroe корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Abi |
| ID | WA200003862 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Beroe |
| Веб-сайт компании | [https://www.beroeinc.com](https://www.beroeinc.com) |
| Условия использования приложения | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| Основные функциональные возможности приложения | Abi &#8211; помощника по цифровым закупкам на основе ИИ |
| Расположение компании | Индия |
| Страница сведений о приложении | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
Эта информация была предоставлена Beroe о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | First name, Last name &amp; Work email ID |
...
| Какие данные хранятся в базах данных? | Имя, фамилия, идентификатор беседы с рабочим идентификатором &amp; электронной почты |
...
| URL-адрес политики конфиденциальности | https://www.beroeinc.com/privacy-policy/ |
