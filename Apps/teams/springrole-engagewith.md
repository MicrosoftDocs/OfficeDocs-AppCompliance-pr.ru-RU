...
description: Все доступные сведения о безопасности и соответствия требованиям для EngageWith, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://www.springworks.in](https://www.springworks.in) |
| Условия использования приложения | [https://engagewith.springworks.in/terms-and-conditions](https://engagewith.springworks.in/terms-and-conditions) |
| Основные функции приложения | EngageWith — это платформа одноранговых вознаграждений и распознавания сотрудников, которая способствует развитию культуры распознавания, повышает вовлеченность сотрудников и помогает организации отмечать достижения как больших, так и малых. Сотрудники могут распознавать коллег, юниоров или менеджеров, предоставляя им kudos или Shoutouts для хорошо проделаной работы. Kudos и Shoutouts имеют набор пунктов, связанных с ними, которые со временем складываются в значимые награды.  |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.springworks.in/engagewith/](https://www.springworks.in/engagewith/) |
...
| Какие данные хранятся в базах данных? | имя, электронная почта |
...
| URL-адрес политики конфиденциальности | https://www.springworks.in/gdpr |
