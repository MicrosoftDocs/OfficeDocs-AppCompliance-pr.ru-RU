...
| Страница информация о приложении | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | Azure, облако OVH (Франция) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | делегирована | Список каталогов для отправки задач планировщика в документы Sharepoint | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | делегирована | Список групп для отправки задач планировщика в документы Sharepoint в существующих или созданных группах | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | делегирована | Заметки содержимого для записи в OneNote | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | делегирована | Задачи, назначения, сроки | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | делегирована | Электронная почта пользователя для идентификации пользователя | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | делегирована | Нет данных, собранных, только для seemlessly обновить маркер | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
