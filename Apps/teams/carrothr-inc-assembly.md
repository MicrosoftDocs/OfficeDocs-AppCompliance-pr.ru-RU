...
description: Все доступные сведения о безопасности и соответствия требованиям для Assembly, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://www.joinassembly.com/about](https://www.joinassembly.com/about) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | делегирована | Разрешить пользователю назначать приложение только что созданному каналу из нашего приложения | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | приложение | Синхронизируйте наши профили, чтобы участники были надлежащим образом искать в Assembly | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | делегирована | Мы наблюдаем за данными, чтобы убедиться, что они могут назначить наше приложение правильной группе | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams.ReadBasic.All | приложение | Возможность назначить наше приложение на правильную вкладку группы | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | приложение | Мы используем это, чтобы позволить приложению правильно примкироваться к каналу или команде | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| email | делегирована | Электронная почта пользователя, чтобы мы могли предоставить ему доступ к определенной учетной записи | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| profile | делегирована | Имя пользователя для автопопуляции сборки и синхронизации с изменениями в Microsoft Teams | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
