...
| Основные функции приложения | Сборка — это платформа взаимодействия и распознавания сотрудников. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | делегирована | Разрешить пользователю назначать приложение только что созданному каналу из нашего приложения | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Directory.Read.All | приложение | Синхронизируйте наши профили, чтобы участники были надлежащим образом искать в Assembly | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Group.Read.All | делегирована | Мы наблюдаем за данными, чтобы убедиться, что они могут назначить наше приложение правильной группе | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Teams.ReadBasic.All | приложение | Возможность назначить наше приложение на правильную вкладку группы | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| TeamsTab.Create | приложение | Мы используем это, чтобы позволить приложению правильно примкироваться к каналу или команде | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| email | делегирована | Электронная почта пользователя, чтобы мы могли предоставить ему доступ к определенной учетной записи | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| profile | делегирована | Имя пользователя для автопопуляции сборки и синхронизации с изменениями в Microsoft Teams | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
