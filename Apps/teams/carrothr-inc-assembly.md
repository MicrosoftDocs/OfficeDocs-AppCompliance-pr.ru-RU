...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Channel.Create | делегирована | Разрешить пользователю назначать приложение только что созданному каналу из нашего приложения | Мы храним id канала, чтобы наше приложение синхронизировало с правильным каналом | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Directory.Read.All | приложение | Синхронизируйте наши профили, чтобы участники были надлежащим образом искать в Assembly | Любые дополнительные сведения о профиле, которые могут быть доступны для сохраняемого поиска участников в Assembly | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Group.Read.All | делегирована | Мы наблюдаем за данными, чтобы убедиться, что они могут назначить наше приложение правильной группе | Мы не храним группы | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Teams.ReadBasic.All | приложение | Возможность назначить наше приложение на правильную вкладку группы | Мы не храним команды, которые ожидают, что к нам будет придана  | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| TeamsTab.Create | приложение | Мы используем это, чтобы позволить приложению правильно примкироваться к каналу или команде | Мы не собираем и не храним данные вкладок | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| email | делегирована | Электронная почта пользователя, чтобы мы могли предоставить ему доступ к определенной учетной записи | Электронная почта пользователя, чтобы мы могли предоставить ему доступ к определенной учетной записи и соответствовать удостоверениям | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| profile | делегирована | Имя пользователя для автопопуляции сборки и синхронизации с изменениями в Microsoft Teams | Полное имя пользователя | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
