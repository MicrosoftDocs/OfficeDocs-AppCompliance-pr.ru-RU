---
title: Сведения о приложениях для помощника summize by Summize (Ltd)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/11/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Summize Assistant, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Summize (Ltd) Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Summize Assistant |
| ID | WA200003577 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Summize (Ltd) |
| Веб-сайт компании | [https://www.summize.com](https://www.summize.com) |
| Условия использования приложения | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| Основные функции приложения | Summize упрощает обзор и создание контракта. Summize меняет понимание и взаимодействие бизнеса с контрактами. С помощью нашего интеллектуального, разговорного программного обеспечения мы перезагружаем процессы контракта и разблокироваем сведения о контракте.  Summize Assistant app within Teams позволяет пользователям загружать контракты (форматы PDF и docx) для просмотра.  Пользователи также могут создавать контракты с помощью шаблонов, созданных в приложении Summize.   |
...
Эта информация предоставлена Summize (Ltd) о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Исходные документы и отзывы клиентов о документах |
...
| URL-адрес политики конфиденциальности | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
