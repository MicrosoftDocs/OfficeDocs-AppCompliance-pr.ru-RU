---
title: Сведения о приложении для Eva от OutThink Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Eva, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые OutThink Ltd корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Ева |
| ID | WA200004345 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | OutThink Ltd |
| Веб-сайт компании | [https://www.outthink.io](https://www.outthink.io) |
| Условия использования приложения | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| Основные функциональные возможности приложения | Eva — это помощник по искусственному интеллекту, предлагая виртуальную поддержку клиентам OutThink, которые управляют кибербезопасностью в организации.  Она предоставляет сотрудникам регулярные обновления о ходе обучения и дает эффективную обратную связь об их производительности, помогая повысить уровень знаний о кибербезопасности. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
Эта информация была предоставлена OutThink Ltd о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные электронной почты пользователя, сведения о доступности и доступности календаря пользователя |
...
| URL-адрес политики конфиденциальности | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Делегированные | Поиск следующих доступных бесплатных слотов в календаре пользователя, чтобы разрешить ему резервировать слот для обучения кибербезопасности через приложение Teams. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | Делегированные | Идентификация пользователей по адресу электронной почты для отправки сообщений пользователю с указанным корпоративным адресом электронной почты. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
