...
ms.locfileid: "63459824"
---
# <a name="ena-smartuc-connector"></a>Соединитель ENA SmartUC
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Соединитель ENA SmartUC |
| ID | WA200003354 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | делегирована | Имена пользователей и имена участников текущего канала/чата. Приложение использует это, чтобы представить пользователю список участников канала или чата для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e) |
>| Chat.ReadBasic | делегирована | Пользовательские ИД и отображают имена участников текущего чата. Приложение использует это, чтобы представить пользователю список участников чата для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e) |
>| People.Read.All | делегирована | Пользовательские ИД и отображение имен членов текущей команды. Приложение использует это, чтобы представить пользователю список участников группы для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e) |
>| User.Read.All | делегирована | Номера бизнес-и мобильных телефонов пользователей. Это необходимо для того, чтобы можно было инициировали телефонные звонки на эти номера. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e) |
>| offline_access | делегирована | Маркер авторизации для пользователя, разрешающий приложению доступ к Graph конечным точкам API, перечисленным от их имени. Эти разрешения доступа необходимы для работы приложений платформы Microsoft Identity. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e) |
