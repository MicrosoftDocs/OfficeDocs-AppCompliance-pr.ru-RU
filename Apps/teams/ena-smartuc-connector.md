...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | Делегированные | Идентификаторы пользователей и отображаемые имена участников текущего канала или чата. Приложение использует его для представления пользователю списка участников канала или чата для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e.md) |
>| Chat.ReadBasic | Делегированные | Идентификаторы пользователей и отображаемые имена участников текущего чата. Приложение использует его для представления пользователю списка участников чата для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e.md) |
>| People.Read.All | Делегированные | Идентификаторы пользователей и отображаемые имена участников текущей команды. Приложение использует его для представления пользователю списка участников команды для вызова. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e.md) |
>| User.Read.All | Делегированные | Номера бизнес-телефонов и мобильных телефонов пользователей. Это необходимо для того, чтобы можно было инициировать телефонные звонки на эти номера. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e.md) |
>| offline_access | Делегированные | Маркер авторизации для пользователя, который разрешает приложению доступ к другим конечным точкам API Graph, указанным от его имени. Эти разрешения доступа необходимы для работы приложений платформы удостоверений Майкрософт. | [029cfd5a-4413-499d-bda6-a2a0a3f5e70e](../azure/029cfd5a-4413-499d-bda6-a2a0a3f5e70e.md) |
