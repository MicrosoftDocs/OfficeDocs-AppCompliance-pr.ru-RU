---
title: Сведения о приложении для CyDesk от CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Вся доступная информация о безопасности и соответствии для CyDesk, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66547320"
---
# <a name="cydesk"></a>CyDesk

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 26 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/14888773-cbfd-439f-91e3-227947655a47" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004281" target="_blank">Просмотр в AppSource</a>
...
| Основные функциональные возможности приложения | CyDesk предназначен для бизнес-пользователей, которым требуется интеграция Телефонная система Microsoft Teams System с их решением CRM.  CyDesk интегрирует программное обеспечение, на которое уже полагается ваш бизнес, в систему обмена данными.  Интегрируйте более 100 ведущих бизнес-приложений&#8211; а также&#8217;имеющихся собственных решений &#8211; непосредственно из окна. Или создайте настраиваемые интеграции и приложения в соответствии с&#8217;в соответствии с уникальными потребностями.  |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://web.cytrack.com/microsoft-teams/crm-integration-for...](https://web.cytrack.com/microsoft-teams/crm-integration-for-microsoft-teams/) |
