...
description: Все доступные сведения о безопасности и соответствии требованиям для Cyberday, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 3e09532217ec30d46ffb0b3d0ef369a6e60a8837
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880236"
---
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Digiturvamalli корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Cyberday |
| Идентификатор | WA200001774 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Digiturvamalli |
| Веб-сайт компании | [https://cyberday.ai](https://cyberday.ai) |
| Условия использования приложения | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| Основные функциональные возможности приложения | Cyberday — это система управления информационной безопасностью, которая поможет клиенту обеспечить соответствие выбранным платформам безопасности. |
| Расположение компании | Финляндия |
| Страница сведений о приложении | [https://cyberday.ai](https://cyberday.ai) |
...
Эта информация была предоставлена Digiturvamalli о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Используйте электронную почту для идентификации пользователя и отображения администраторов приложений, которыми является этот пользователь | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | Делегированные | Использование идентификатора пользователя для идентификации пользователя | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
