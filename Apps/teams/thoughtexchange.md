...
description: Все доступные сведения о безопасности и соответствия требованиям для ThoughtExchange, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | &#8220;ThoughtExchange помогает лидерам получать откровенный и объективный вклад от всех сотрудников или сообщества независимо от их расположения. Независимо от&#8217;групп по 10 или 10 000, ThoughtExchange упрощает процесс важных обсуждений и принятия решений по шкале.&#8221; |
