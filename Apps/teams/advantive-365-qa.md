---
title: Сведения о приложении для 365-QA от Advantive
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для 365-QA, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 14cce168a5ac536a976e0f80759b3837b009c51d
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881026"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 28 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Advantive корпорации Майкрософт:
...
| Название партнерской компании | Advantive |
| Веб-сайт компании | [https://www.advantive.be](https://www.advantive.be) |
| Условия использования приложения | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| Основные функциональные возможности приложения | Advantive — это команда специалистов, которые используют технологии Майкрософт для разработки и реализации инновационных решений. Мы предлагаем высококачественные советы, продукты и службы на основе стандартных функций Майкрософт. Это позволяет клиентам с&#8217;повысить эффективность и воспользоваться преимуществами быстро изменяющихся условий. Наша основная задача — предоставлять услуги, которые включают рекомендации, разработку, реализацию, поддержку проектов и обслуживание. |
| Расположение компании | Бельгия |
| Страница сведений о приложении | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
...
Эта информация была предоставлена Advantive о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
