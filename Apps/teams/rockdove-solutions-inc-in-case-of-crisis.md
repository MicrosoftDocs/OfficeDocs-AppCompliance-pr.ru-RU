...
| Страница информация о приложении | [https://www.rockdovesolutions.com/in-case-of-crisis/in-case...](https://www.rockdovesolutions.com/in-case-of-crisis/in-case-of-crisis-platform) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | Это дает полный доступ к календарю пользователя. Наше приложение отображает описание, ссылку на конференцию и даты начала и окончания. Наше приложение также позволяет пользователю создавать событие в календаре outlook | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Channel.ReadBasic.All | делегирована | Предоставляет доступ к каналу пользователей.  Список каналов пользователей используется для выбора канала для отправки файла в | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite | делегирована | Н/Д | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite.All | делегирована | Мы разрешаем пользователям загружать файлы из управления вопросами в Teams | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Sites.ReadWrite.All | делегирована | Это необходимо для загрузки на частный канал | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Team.ReadBasic.All | делегирована | Список групп необходим для получения списка каналов, к которые принадлежит пользователю. Это позволяет просматривать список доступных каналов загрузки. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| email | делегирована | Необходимо получить электронную почту пользователя после проверки подлинности для сравнения с электронными письмами в нашей базе данных. Если у пользователя нет учетной записи в нашей системе, мы создадим ее. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| offline_access | делегирована | Это позволяет обновить маркер доступа к графу | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| openid | делегирована | Необходимое разрешение на проверку подлинности с помощью openid | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
