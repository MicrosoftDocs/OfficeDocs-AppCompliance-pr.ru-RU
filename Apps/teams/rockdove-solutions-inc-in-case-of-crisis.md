...
| Основные функции приложения | В случае кризиса является специально разработанной платформой для динамического жизненного цикла управления проблемой и кризисным управлением. Наше приложение позволяет организациям легко обмениваться и активировать доступные для действий книги, включающие протоколы ответов и лучшие практики по мере развертывания ситуации.  Вы также можете управлять и захватывать весь жизненный цикл проблем, которые влияют на ваш бизнес, начиная от первоначальной отчетности и до разрешения.   |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | Это дает полный доступ к календарю пользователя. Наше приложение отображает описание, ссылку на конференцию и даты начала и окончания. Наше приложение также позволяет пользователю создавать событие в календаре outlook | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| Channel.ReadBasic.All | делегирована | Предоставляет доступ к каналу пользователей.  Список каналов пользователей используется для выбора канала для отправки файла в | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| Files.ReadWrite | делегирована | Недоступно | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| Files.ReadWrite.All | делегирована | Мы разрешаем пользователям загружать файлы из управления вопросами в Teams | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| Sites.ReadWrite.All | делегирована | Это необходимо для загрузки на частный канал | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| Team.ReadBasic.All | делегирована | Список групп необходим для получения списка каналов, к которые принадлежит пользователю. Это позволяет просматривать список доступных каналов загрузки. | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| email | делегирована | Необходимо получить электронную почту пользователя после проверки подлинности для сравнения с электронными письмами в нашей базе данных. Если у пользователя нет учетной записи в нашей системе, мы создадим ее. | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| offline_access | делегирована | Это позволяет обновить маркер доступа к графу | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
>| openid | делегирована | Необходимое разрешение на проверку подлинности с помощью openid | [6b4a2fee-5642-41a7-b452-d555fac690b0](https://docs.microsoft.com/microsoft-365-app-certification/azure/6b4a2fee-5642-41a7-b452-d555fac690b0) |
