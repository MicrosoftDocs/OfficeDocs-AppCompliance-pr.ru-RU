...
description: Вся доступная информация о безопасности и соответствии требованиям для in Case of Crisis, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0eec135c559239e02214ce61cbd8932982f059cd
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879236"
---
...
* <a href="https://teams.microsoft.com/l/app/cf430644-447e-4572-8467-3892596d05c7" target="_blank">Просмотр в Teams хранилище</a>
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Делегированные | Это обеспечивает полный доступ к календарю пользователя. Наше приложение отображает описание, ссылку на конференцию, даты начала и окончания. Наше приложение также позволяет пользователю создавать события в календаре Outlook. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Channel.ReadBasic.All | Делегированные | Предоставляет доступ к каналу пользователей.  Список пользователей каналов используется для выбора канала для отправки файла в | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite | Делегированные | Недоступно | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite.All | Делегированные | Мы разрешаем пользователям отправлять файлы из управления Teams | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Sites.ReadWrite.All | Делегированные | Это необходимо для отправки в частный канал | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Team.ReadBasic.All | Делегированные | Список команд необходим для получения списка каналов, к которым принадлежит пользователь. Это позволяет просматривать список доступных каналов отправки. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| email | Делегированные | Необходимо получить сообщение электронной почты пользователя после проверки подлинности, чтобы сравнить его с электронной почтой в нашей базе данных. Если у пользователя нет учетной записи в нашей системе, мы создадим ее. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| offline_access | Делегированные | Это позволяет обновить маркер доступа графа. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| openid | Делегированные | Необходимое разрешение для проверки подлинности с помощью openid | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
