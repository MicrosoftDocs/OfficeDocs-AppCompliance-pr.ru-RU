...
description: Все доступные сведения о безопасности и соответствии требованиям для классификации списка, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "67053121"
---
# <a name="classified-listing"></a>Classified Listing
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Classified Listing |
| ID | WA200004155 |
...
| Основные функциональные возможности приложения | Приложение teams для создания и размещения внутренних продуктов Marketplace для вашей организации...  |
