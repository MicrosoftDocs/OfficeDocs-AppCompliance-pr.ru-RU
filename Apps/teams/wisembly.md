---
title: Сведения о приложении для Wisembly от Wisembly
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Вся доступная информация о безопасности и соответствии для Wisembly, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 1fd301c44b30d3537e3bef6cb18c1dbfb5e3b1b9
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881226"
---
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые wisembly корпорации Майкрософт:
...
| Название партнерской компании | Wisembly |
| Веб-сайт компании | [https://wisembly.com](https://wisembly.com) |
| Условия использования приложения | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| Основные функциональные возможности приложения | Создание простых и привлекательных виртуальных и гибридных мероприятий, конференций, семинаров... Wisembly поможет вам выполнить проект событий от начала до конца, независимо от ваших потребностей: настраиваемую домашнюю страницу, регистрацию, организацию семинаров и сеансов, видеоинтерам, интерактивные функции и многое другое. |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://wisembly.com](https://wisembly.com) |
...
Эта информация была предоставлена Wisembly о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
