---
title: Сведения о приложениях для SmartDraw от SmartDraw Software, LLC
ms.author: elmalova
author: elenamalova
ms.date: 11/29/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для SmartDraw, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт по программному обеспечению SmartDraw, LLC:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | SmartDraw |
| Идентификатор | WA200003505 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | SmartDraw Software, LLC |
| Веб-сайт компании | [https://www.smartdraw.com](https://www.smartdraw.com) |
| Условия использования приложения | [https://www.smartdraw.com/support/terms-of-service.pdf](https://www.smartdraw.com/support/terms-of-service.pdf) |
| Основные функции приложения | Простой &amp; мощный инструмент, чтобы сделать flowcharts, UML, ERD, технические схемы и другие. |
...
Эти сведения предоставлены ооо SmartDraw Software, llc о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Самая недавняя дата сертификации SOC2 |  2020-11-30 |
