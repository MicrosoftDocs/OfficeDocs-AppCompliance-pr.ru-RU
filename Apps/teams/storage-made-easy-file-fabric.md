---
title: Сведения о приложениях для файловой ткани служба хранилища Made Easy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для File Fabric, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Поиск, просмотр, редактирование и совместное использование файлов, хранимых в Azure Files, Azure Blob служба хранилища и других хранилищах. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | SelfHosted, Azure, AWS, GCP, IBMCloud, Пользователи могут подключаться к службам Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3-Compatible, FTP и WebDAV |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | приложение | Данные файлов читают или пишутся, когда пользователь скачивает, загружает или редактирует указанные файлы через приложение. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | приложение | Метаданные, собранные для всех пользовательских&#8217;файлов и папок, предоставляющих федератный просмотр во всех службах файлов. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
