---
title: Application Information for File Fabric by служба хранилища Made Easy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для File Fabric, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 06062990680a786f5472c4c969182090655ef469
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые служба хранилища для корпорации Майкрософт:
...
| Название партнерской компании | Хранение данных без проблем |
| Веб-сайт компании | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| Условия использования приложения | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| Основные функциональные возможности приложения | Поиск, просмотр, изменение и совместное использование файлов, хранящихся в Файлы Azure, Хранилище BLOB-объектов Azure и другом хранилище. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | SelfHosted, Azure, AWS, GCP, IBMCloud, Пользователи могут подключаться к службам Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3-Compatible, FTP и WebDAV. |
...
Эти сведения были предоставлены служба хранилища о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | приложение | Данные файлов считывания или записи, когда пользователь скачивает, загружает или изменяет указанные файлы через приложение. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | приложение | Метаданные, собранные для всех пользовательских&#8217;файлов и папок, обеспечивая федеративное представление во всех файловых службах. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
