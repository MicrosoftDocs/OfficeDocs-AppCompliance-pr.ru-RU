...
| Основные функции приложения | Olive VLE помогает репетиторам и образовательным поставщикам создавать и управлять курсами, программами обучения и обучающимися. Администраторы образовательных учреждений могут создавать собственные онлайн-курсы, тесты, назначения, программы и назначать их для обучения. Microsoft Teams интегрирован с Graph API, чтобы администраторы также могли создавать видео-класс в Teams и приглашать учащихся в видео-класс. Вы можете увидеть и принять участие в своих курсах, программах и управлять доказательствами портфеля. Администраторы также могут размещать ленты новостей. |
