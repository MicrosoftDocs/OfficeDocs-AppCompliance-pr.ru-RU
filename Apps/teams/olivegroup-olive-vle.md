---
title: Сведения о приложении для ИНСТРУКЦИИ ПО VLE отGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для ИНСТРУКЦИИ ПО ИНСТРУКЦИИ VLE, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 75d9b4219c698c722061c6fa574506509fe3dd08
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877616"
---
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые в Корпорацию Майкрософт в ПриложениеММайлGroup:
...
| Название партнерской компании | OliveGroup |
| Веб-сайт компании | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Условия использования приложения | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Основные функциональные возможности приложения | Этот VLE помогает преподавателям и поставщикам образовательных учреждений создавать курсы, программы для учеников и учащихся и управлять ими. Администраторы образовательных учреждений могут создавать собственные онлайн-курсы, тесты, задания, программы и назначать их для учащихся. Microsoft Teams интегрирована с API Graph, чтобы администраторы также могли создавать видеоконтейеры в Teams приглашать обучающихся в класс видео. Пользователи могут просматривать свои курсы, программы и управлять свидетельствами портфеля. Администраторы также могут публиковать каналы новостей. |
...
Эта информация была предоставлена в Приложении Записная группа о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
