...
description: Все доступные сведения о безопасности и соответствии требованиям для OLIVE VLE, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Olive VLE помогает репетиторам и образовательным поставщикам создавать и управлять курсами, программами обучения и обучающимися. Администраторы образовательных учреждений могут создавать собственные онлайн-курсы, тесты, назначения, программы и назначать их для обучения. Microsoft Teams интегрирована с Graph API, чтобы администраторы также могли создавать видео-класс в Teams и приглашать учащихся в видео-класс. Вы можете увидеть и принять участие в своих курсах, программах и управлять доказательствами портфеля. Администраторы также могут размещать ленты новостей. |
