---
title: Application Information for Funtivity by Hermis by Hermis, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Funtivity от Hermis, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
<p>Последнее обновление разработчика: 19 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные корпорацией Майкрософт от Hermis, Inc.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Funtivity by Hermis |
| Идентификатор | WA200004244 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Hermis, Inc. |
| Веб-сайт компании | [https://www.herm.is](https://www.herm.is) |
| Условия использования приложения | [https://www.herm.is/terms](https://www.herm.is/terms) |
| Основные функциональные возможности приложения | Funtivity by Hermis has a varietya of activities &amp; content for a wide variety of events including Team building, Conference breakout sessions, Cultural events and more. С более чем десятком различных действий и новых тщательно созданных событий каждую неделю вы можете&#8217;что-то для всех. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
Эта информация была предоставлена Hermis, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Идентификатор клиента и имя электронной &amp; почты используются для регистрации пользователя в Hermis. |
...
| Какие данные хранятся в базах данных? | Сообщение электронной почты &amp; с именем пользователя хранится в нашей базе данных. Электронная почта пользователя шифруется с помощью AES-256-CBC |
...
| URL-адрес политики конфиденциальности | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Мы используем сведения о профиле пользователя для регистрации пользователя на нашей платформе. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| email | Делегированные | Мы используем сведения о профиле пользователя для регистрации пользователя на нашей платформе. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | Делегированные | Мы используем сведения о профиле пользователя для регистрации пользователя на нашей платформе. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| profile | Делегированные | Мы используем сведения о профиле пользователя для регистрации пользователя на нашей платформе. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
