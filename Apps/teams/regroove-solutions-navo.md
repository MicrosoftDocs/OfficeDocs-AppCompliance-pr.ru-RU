...
>Да, в Application Insights мы храним идентификацию пользователя с проверкой подлинности и ID учетной записи пользователя (Tenancy Id).

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Организационные элементы управления данными, хранимые партнером

Описание того, как администраторы организации могут управлять своими сведениями в партнерских системах? например, удаление, хранение, аудит, архивация, политика конечных пользователей и т. д.

>Все данные, которые мы храним сами (не через службу, например Stripe или Application Insights), хранятся в базе данных Azure Cosmos. Все администраторы используют 2FA, и доступ ограничен подмножество наших сотрудников.
