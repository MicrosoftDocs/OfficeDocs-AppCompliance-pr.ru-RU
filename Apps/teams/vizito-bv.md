...
description: Вся доступная информация о безопасности и соответствии требованиям для Vizito, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Регистрация посетителей SaaS с Teams уведомлениями о прибытии посетителей. |
| Расположение штаб-квартиры компании | Бельгия |
| Страница информация о приложении | [https://www.vizito.be](https://www.vizito.be) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | оба | Извлечение и хранение ID клиента, чтобы мы знали, для кого Teams установлен наш бот. | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
