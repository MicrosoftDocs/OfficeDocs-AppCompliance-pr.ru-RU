---
title: Сведения о приложении для ForceManager CRM от Tritium Software SL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Все доступные сведения о безопасности и соответствии для ForceManager CRM, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f429eb71-607a-4e12-9467-209276404047" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Tritium Software SL корпорации Майкрософт:
...
| Название партнерской компании | Tritium Software SL |
...
| Основные функциональные возможности приложения | ForceManager — это ведущее приложение CRM с полным веб-приложением и мобильным приложением, созданным для различных стилей работы, включая домашнюю, офисную или поле. Приложение предназначено для торговых представителей, которые должны управлять своей ежедневной повесткой дня и действиями с помощью удобного для пользователя интерфейса и простого в использовании приложения. |
...
Эта информация была предоставлена Tritium Software SL о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
