---
title: Сведения о приложении для NewCOS от Newtech
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для NewCOS, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Просмотр в магазине Teams</a>
...
| Название партнерской компании | Newtech |
| Веб-сайт компании | [https://newtech.com.ar](https://newtech.com.ar) |
| Условия использования приложения | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| Основные функциональные возможности приложения | Быстрое, простое и в режиме обслуживания развертывание интеллектуального решения для обмена данными. Платформа NewCOS позволяет запускать, отслеживать и поддерживать установку быстро, легко и без вмешательства ИТ-служб.  Мы перейти к вам, чтобы процесс внедрения технологии был успешным. Мы упрощаем адаптацию изменений в современных рабочих областях для совместной работы. Благодаря внедрению Microsoft 365 мы можем ускорить процесс цифровой трансформации в вашей организации.  |
| Расположение компании | Аргентина |
| Страница сведений о приложении | [https://newtech.com.ar/newcosnt/](https://newtech.com.ar/newcosnt/) |
...
Эта информация была предоставлена Newtech о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, запись вызова |
...
| Какие данные хранятся в базах данных? | Данные профиля пользователя, запись вызова |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Бразилия |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Вход и чтение профиля пользователя | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| offline_access | Делегированные | Сохранение доступа к данным, к которым он был предоставлен | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | Делегированные | Вход пользователей | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| profile | Делегированные | Просмотр базовых профилей пользователей | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
