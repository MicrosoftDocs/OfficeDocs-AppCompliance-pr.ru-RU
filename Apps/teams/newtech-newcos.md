...
| Основные функции приложения | Развертывание решения интеллектуальных коммуникаций быстро, легко и в режиме обслуживания. Платформа NewCOS позволяет быстро, легко и без вмешательства ИТ-служб запускать, контролировать и поддерживать установку.  Мы идем с вами, чтобы процесс принятия технологии был успешным. Мы облегчаем адаптацию изменений в современных пространствах совместной работы. Благодаря принятию Microsoft 365 мы можем ускорить процесс цифровой трансформации в вашей организации.  |
| Расположение штаб-квартиры компании | Аргентина |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | оба | Эти данные используются для проверки подлинности в разрешениях приложений | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](https://docs.microsoft.com/microsoft-365-app-certification/azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e) |
>| openid | оба | Microsoft Teams, для отчета и управления | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](https://docs.microsoft.com/microsoft-365-app-certification/azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200) |
