...
description: Все доступные сведения о безопасности и соответствия требованиям для Standuply, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Standuply автоматизирует процессы управления и предоставляет внутреннюю систему QA&amp; для повышения производительности вашей команды. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://standuply.com](https://standuply.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | приложение | Отправка отчетов о отдельных зонах времени пользователей | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
>| User.Read | делегирована | Авторизации пользователей в продукте | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
