---
title: Сведения о приложениях для двигателя Trivia с помощью EnableUC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для Trivia Engine, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставляемые EnableUC в Корпорацию Майкрософт:
...
| Имя компании-партнера | EnableUC |
...
| Основные функции приложения | Улучшение существующей подготовки и совершенствование хранения знаний с &#8220;&#8221;. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
Эта информация предоставлена EnableUC о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
