---
title: Сведения о приложении для Подключение+ от Reward Gateway
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Подключение+, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: b0855bc77fb0405781df3d9e7f5706dd23205e0d
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880586"
---
...
* <a href="https://teams.microsoft.com/l/app/feb4e7cc-eb28-483e-a1ac-31bfead47e92" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Reward Gateway корпорации Майкрософт:
...
| Название партнерской компании | Reward Gateway |
| Веб-сайт компании | [https://www.rewardgateway.com](https://www.rewardgateway.com) |
| Условия использования приложения | [https://policies.rewardgateway.net/ms-teams-connect-plus/te...](https://policies.rewardgateway.net/ms-teams-connect-plus/terms-of-use/) |
| Основные функциональные возможности приложения | Возможность для наших клиентов совместно использовать одноранговое распознавание и глобальное распознавание. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://success.rewardgateway.com/hc/en-us/articles/3600158...](https://success.rewardgateway.com/hc/en-us/articles/360015834078-Installing-the-MS-Teams-Integration) |
...
Эти сведения были предоставлены Reward Gateway о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Делегированные | Данные не собираются | [5e4dadf5-9f90-449b-9e39-934fd10b7c23](../azure/5e4dadf5-9f90-449b-9e39-934fd10b7c23.md) |
