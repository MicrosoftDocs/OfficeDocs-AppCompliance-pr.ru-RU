...
description: Все доступные сведения о безопасности и соответствия требованиям для службы Alvao, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://www.alvao.com/en/](https://www.alvao.com/en/) |
| Условия использования приложения | [https://doc.alvao.com/cs/10.4/alvao_service_desk/License%20...](https://doc.alvao.com/cs/10.4/alvao_service_desk/License%20terms%20for%20the%20software%20product%20ALVAO%20Service%20Desk%2010.4.pdf) |
| Основные функции приложения | Дружественный передовой для пользователей, мощный инструмент для внутренних групп служб. Служба ALVAO предоставляет единую точку контакта для всех запросов в компании. Команда поставщиков решений получает обзор рабочей нагрузки, четкие приоритеты и улучшенную связь. |
| Расположение штаб-квартиры компании | Czechia |
| Страница информация о приложении | [https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alv...](https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alvao_teams_addin/default.aspx) |
...
| URL-адрес политики конфиденциальности | https://www.alvao.com/en/privacystatement |
