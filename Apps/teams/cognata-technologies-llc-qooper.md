...
description: Все доступные сведения о безопасности и соответствии требованиям для Qooper, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: c81a7a135cc2663f0556da97fea7ad631379a808
ms.sourcegitcommit: 58c50d1704196178455927329748485b40dd7880
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/17/2022
ms.locfileid: "63549717"
---
...
| Основные функции приложения | Достижение целей с помощью контента значимых подключений &amp; . Окружайте людей значимыми подключениями и контентом посредством наставничества, одноранговой коучинг, обучения в сообществе и сетевых сетей. Qooper является партнером компаний, университетов и некоммерческих организаций всех размеров для автоматизации работы по управлению программами наставничества, подключения людей на интерактивной платформе обучения наставничеству и аналитики программ отображения. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://qooper.io](https://qooper.io) |
