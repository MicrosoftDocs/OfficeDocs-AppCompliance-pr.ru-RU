...
ms.openlocfilehash: 4ac76d007fa7c76e356acc748a34f781e455bb40
ms.sourcegitcommit: 983ed1755036e92d99745770f82f33417b21efec
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/18/2021
ms.locfileid: "60428556"
---
...
* <a href="https://teams.microsoft.com/l/app/3c9fd7ca-5386-4179-9bb7-7fcdcc373017" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001604" target="_blank">Просмотр в AppSource</a>
...
| URL-адрес страницы Teams приложения | [https://www.moveworkforward.com/product/microsoft-teams-con...](https://www.moveworkforward.com/product/microsoft-teams-confluence-connector) |
| URL-адрес политики конфиденциальности | [https://moveworkforward.com/privacy-policy](https://moveworkforward.com/privacy-policy) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Channel.ReadBasic.All | делегирована | Имя и id канала используются для отправки уведомлений из Jira в Microsoft Teams. | ID канала и имя хранятся для настройки уведомлений от Jira до Microsoft Teams. | [f3943662-e828-40ed-9c6e-369680fe421f](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3943662-e828-40ed-9c6e-369680fe421f) |
>| Teams.ReadBasic.All | делегирована | Разрешение используется, чтобы позволить пользователю выбрать одну из этих присоединились группы в Jira. | Командный именем, отображаемой на экране Конфигурация в Jira. | [f3943662-e828-40ed-9c6e-369680fe421f](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3943662-e828-40ed-9c6e-369680fe421f) |
>| TeamsAppInstallation.ReadForTeam | делегирована | Чтение установленных Teams в командах. При настройке доставки Microsoft Teams приложение может отправлять Teams с установленным ботом. | Отсутствует | [f3943662-e828-40ed-9c6e-369680fe421f](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3943662-e828-40ed-9c6e-369680fe421f) |
>| User.Read | делегирована | Позволяет пользователю создавать канал обсуждения с сотрудниками и использовать @-mention в сообщении канала | Отсутствует | [f3943662-e828-40ed-9c6e-369680fe421f](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3943662-e828-40ed-9c6e-369680fe421f) |
>| email | делегирована | Электронная почта используется для совпадения пользователей Atlassian и Microsoft | Электронная почта не хранится. Используется только в процессе совпадения. | [f3943662-e828-40ed-9c6e-369680fe421f](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3943662-e828-40ed-9c6e-369680fe421f) |
