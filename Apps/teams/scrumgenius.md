...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.Read | делегирована | Даты отпуска в календаре пользователя. | Чтобы пользователи синхронизировали свой отпуск со ScrumGenius. |  |
>| User.Read | делегирована | Имя пользователя и адрес электронной почты. | Чтобы разрешить пользователю войти в Microsoft Login. |  |
