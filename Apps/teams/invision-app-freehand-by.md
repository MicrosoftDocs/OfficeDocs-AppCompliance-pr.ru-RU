...
description: Все доступные сведения о безопасности и соответствия требованиям для freehand by InVision, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Просмотр в магазине Teams</a>
...
Сведения, предоставляемые приложением InVision в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Freehand by InVision |
| ID | WA104381362 |
| Возможности | Tab |
| Поддерживаемые клиенты Office 365 | Microsoft Teams |
| Имя компании-партнера | Приложение InVision |
| URL-адрес веб-сайта-партнера | [https://www.invisionapp.com/](https://www.invisionapp.com/) |
| URL-адрес страницы info приложения Teams | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
| URL-адрес политики конфиденциальности | [https://www.invisionapp.com/privacy](https://www.invisionapp.com/privacy) |
| URL-адрес терминов использования | [https://www.invisionapp.com/terms](https://www.invisionapp.com/terms) |
...
Эта информация предоставлена приложением InVision о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
<iframe height='1020' title='Сведения о безопасности облачных приложений Майкрософт' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/20788' frameborder='no' style='width: 100%;'></iframe>
...
Эта информация предоставлена приложением InVision о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Интеграция с платформой Microsoft Identify Platform (Azure AD)?  | Да |
| Рассмотрели ли вы и выполнили все применимые методы, описанные в списке интеграции платформы удостоверений Майкрософт?  | Нет |
