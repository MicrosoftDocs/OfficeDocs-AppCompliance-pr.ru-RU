...
description: Все доступные сведения о безопасности и соответствия требованиям для WorkplaceBuddy, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | WorkplaceBuddy помогает вам стать более продуктивными |
| Расположение штаб-квартиры компании | Нидерланды (the) |
| Страница информация о приложении | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | делегирована | Мы синхронизируйте эти данные, чтобы позволить вкладки WorkplaceBuddy Teams и нацелить определенных пользователей с помощью чат-бота | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| Group.Read.All | делегирована | Мы синхронизируйте эти данные, чтобы позволить вкладки WorkplaceBuddy Teams и нацелить определенных пользователей с помощью чат-бота | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.Read | делегирована | Мы синхронизируйте эти данные, чтобы пользователи могли войти в систему | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.ReadBasic.All | делегирована | Мы синхронизируйте эти данные, чтобы пользователи могли войти в систему | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
