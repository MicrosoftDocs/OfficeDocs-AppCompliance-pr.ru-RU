---
title: Сведения о приложении для задач WorkJam от WorkJam
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/15/2021
...
description: Вся доступная информация о безопасности и соответствии для задач WorkJam, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a8a5779-52a9-4400-989a-b0284ea78557" target="_blank">Просмотр в Teams хранилище</a>
