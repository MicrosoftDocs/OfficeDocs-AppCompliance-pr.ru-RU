---
title: Application Information for PagerDuty by PagerDuty, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: Вся доступная информация о безопасности и соответствии для PagerDuty, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: d57b97f0a6c6d1e4468849a2d06abf2e193a86c5
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876266"
---
...
* <a href="https://teams.microsoft.com/l/app/c8c302dc-4e77-4536-890d-0c2bffbef9cc" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | PagerDuty, Inc. |
...
| Основные функциональные возможности приложения | Создание операций в режиме реального времени: триггер, просмотр, подтверждение и разрешение инцидентов непосредственно из Teams. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.pagerduty.com/integrations/microsoft-teams](https://www.pagerduty.com/integrations/microsoft-teams) |
...
Эта информация была предоставлена PagerDuty, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.ReadWrite | Делегированные | При создании собрания или получении ответа мы используем такие поля: join_web_url, audioConferencing. Эти поля необходимы для отображения пользователем ссылки на собрание или альтернативных способов подключения к собранию. | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| TeamsAppInstallation.ReadForTeam | Делегированные | Используется для добавления приложения pagerduty в чат. | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | Делегированные | Используется для добавления приложения pagerduty в чат. | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| TeamsTab.ReadWrite.All | Делегированные | Использование для добавления приложения pagerduty в качестве вкладки на собрании | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| User.Read | Делегированные | Используются данные: id, userPrincipalName. Он используется для того, чтобы пользователи Microsoft Teams добавляли их на собрание в качестве участников | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| User.ReadBasic.All | Делегированные | Используются данные: id, userPrincipalName. Он используется для того, чтобы пользователи Microsoft Teams добавляли их на собрание в качестве участников | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| email | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| offline_access | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| openid | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
>| profile | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [05ffe668-5b27-45ff-a64d-b2ed6c475d7a](../azure/05ffe668-5b27-45ff-a64d-b2ed6c475d7a.md) |
...
>| TeamsAppInstallation.ReadForTeam | Делегированные | Используется для добавления приложения pagerduty в чат. | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| TeamsAppInstallation.ReadForTeam.All | Делегированные | Используется для добавления приложения pagerduty в чат. | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| TeamsTab.ReadWrite.All | Делегированные | Использование для добавления приложения pagerduty в качестве вкладки на собрании | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| User.Read | Делегированные | Используются данные: id, userPrincipalName. Он используется для того, чтобы пользователи Microsoft Teams добавляли их на собрание в качестве участников | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| User.ReadBasic.All | Делегированные | Используются данные: id, userPrincipalName. Он используется для того, чтобы пользователи Microsoft Teams добавляли их на собрание в качестве участников | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| email | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| offline_access | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| openid | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
>| profile | Делегированные | Используется для авторизации и запросов маркеров. Используются данные: access_token, refresh_token, expires_in, область | [8f79a561-d2f1-4a1e-8092-c2039043a40e](../azure/8f79a561-d2f1-4a1e-8092-c2039043a40e.md) |
