...
| Веб-сайт компании | [https://vacationtracker.io](https://vacationtracker.io) |
| Условия использования приложения | [https://vacationtracker.io/terms-of-service/](https://vacationtracker.io/terms-of-service/) |
| Основные функции приложения | Отслеживание отпусков — это средство, которое позволяет компаниям отслеживать листья в своих организациях. Администраторам установлена веб-панель мониторинга для настройки параметров организации. Сотрудники также могут делать запросы и пересматривать квоты на панели мониторинга. Кроме того, сотрудники могут делать запросы, а одобрители могут утверждать или отказывать в запросах через Microsoft Teams или вкладку. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://vacationtracker.io/vacation-calendar-tracker-featur...](https://vacationtracker.io/vacation-calendar-tracker-features/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | делегирована | Мы читаем общедоступные ИД и имена каналов, когда пользователи задают свои еженедельные или ежедневные уведомления. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| Team.ReadBasic.All | делегирована | Мы перечисляем Microsoft Teams групп, присоединились во время регистрации, чтобы позволить пользователям выбрать команду, которую они хотят зарегистрироваться для отслеживания отпусков. Кроме того, они могут зарегистрироваться во всей организации. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| User.Read | делегирована | Мы собираем основные сведения пользователя, включая их имя, ID и ID клиента. Эти данные используются для подключения зарегистрированных пользователей к их организации в журнале Vacation Tracker. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| User.Read.All | делегирована | Наши пользователи могут импортировать всех пользователей из Microsoft 365 организации или Microsoft Teams группы. Мы используем это разрешение для импорта только лицензированных пользователей для выбранной Microsoft Teams или организации. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| User.ReadBasic.All | делегирована | Мы разрешаем пользователям импортировать других пользователей из их организации или Microsoft Teams группы. Мы используем это разрешение для списка доступных пользователей и их адресов электронной почты в всплывающее всплывающее сообщение импорта. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| email | делегирована | Когда пользователь входит в систему с AAD Microsoft, мы храним его адрес электронной почты в качестве уникального идентификатора. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| offline_access | делегирована | Мы не собираем данные с этого разрешения. Он используется для поддержания доступа к данным, к данным, к которые мы можем получить доступ. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| openid | делегирована | Мы используем это разрешение для регистрации или регистрации пользователей в Vacation Tracker. С этим разрешением мы не собираем какие-либо конкретные данные. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
>| profile | делегирована | Мы собираем основные сведения пользователя, включая их имя, ID и ID клиента. Эти данные используются для подключения зарегистрированных пользователей к их организации в журнале Vacation Tracker. | [eab5463e-8168-40ee-887a-7ac78de1d266](../azure/eab5463e-8168-40ee-887a-7ac78de1d266.md) |
