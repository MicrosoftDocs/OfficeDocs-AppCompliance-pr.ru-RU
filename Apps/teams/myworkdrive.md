---
title: Сведения о приложении для MyWorkDrive от MyWorkDrive
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: Вся доступная информация о безопасности и соответствии для MyWorkDrive, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: a8fb4019c9cbf2e3bee45a35b4dba8c60aa37d2a
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64878606"
---
# <a name="myworkdrive"></a>MyWorkDrive

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 3 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/f4170c12-ec5c-47b9-834a-a4186cf27ec1" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые MyWorkDrive корпорации Майкрософт:
...
| Название партнерской компании | MyWorkDrive |
| Веб-сайт компании | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| Условия использования приложения | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| Основные функциональные возможности приложения | Приложение MyWorkDrive позволяет получить доступ к папкам общих папок в Microsoft Teams с возможностью удаленного редактирования, совместного использования и доступа к файлам компании, хранящимся в общих папках.   |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.myworkdrive.com/support/myworkdrive-teams-integ...](https://www.myworkdrive.com/support/myworkdrive-teams-integration/) |
...
Эта информация была предоставлена MyWorkDrive о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Перечисление поддерживаемых типов политик | Политики устройств |
