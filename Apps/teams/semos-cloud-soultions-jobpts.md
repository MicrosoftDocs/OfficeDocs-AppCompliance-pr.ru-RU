---
title: Сведения о приложении для JobPts от Semos Cloud Recoverys
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для JobPts, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Semos Cloud Recoverys корпорации Майкрософт:
...
| Название партнерской компании | Semos Cloud Soultions |
| Веб-сайт компании | [https://semoscloud.com](https://semoscloud.com) |
| Условия использования приложения | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| Основные функциональные возможности приложения | Легко распознайте коллег для правильной работы, не выходя из MsTeams |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://semoscloud.com/product/jobpts](https://semoscloud.com/product/jobpts) |
...
Эта информация была предоставлена Semos Cloud Recoverys о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Перечисление поддерживаемых типов политик | Многофакторная проверка подлинности, ограничение расположений пользователей и диапазонов IP-адресов |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Чтение основных сведений о компании | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| email | Делегированные | Используется для сопоставления пользователей AzureAD с пользователями в средстве JobPts | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | Делегированные | Поддержка доступа к данным | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| openid | Делегированные | Возможность входа пользователей с помощью рабочей учетной записи | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| profile | Делегированные | Возможность jobPts просматривать основные сведения о пользователе (имя пользователя) | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
