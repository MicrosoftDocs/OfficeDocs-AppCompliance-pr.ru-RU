---
title: Сведения о приложении для Сейф Spaces от eCare Vault Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Все доступные сведения о безопасности и соответствии для Сейф Spaces, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ec321cf7-ae3e-4ed4-a707-ff5c18e77313" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые eCare Vault Inc. корпорации Майкрософт:
...
| Название партнерской компании | eCare Vault Inc. |
| Веб-сайт компании | [https://ecarevault.com](https://ecarevault.com) |
| Условия использования приложения | [https://downloads.ecarevault.com/downloads/eCare+Vault+-+Te...](https://downloads.ecarevault.com/downloads/eCare+Vault+-+Terms+of+Service.pdf) |
| Основные функциональные возможности приложения | Сейф Spaces обеспечивает совместимый обмен данными и совместную работу за пределами предприятия. Защищенные платформой eCare Vault пользователи Сейф Spaces могут делиться документами и участвовать в обсуждениях с гарантией соответствия HIPAA и FERPAA.  Бот Сейф Spaces позволяет пользователям быстро узнать о важных обновлениях и ожидающих действиях. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://ecarevault.com/ecare-vault-for-teams](https://ecarevault.com/ecare-vault-for-teams) |
...
Эта информация была предоставлена eCare Vault Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| EduRoster.Read | Делегированные | Имя и дата рождения используются для предварительного заполнения полей ввода | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| Group.Read.All | Делегированные | Используется для получения сведений о каналах, доступных для отображения в приложении | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| GroupMember.Read.All | Делегированные | AAD идентификатора участников группы, используемых для создания списка команд eCare Vault | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| User.Read | Делегированные | адрес электронной почты и AAD идентификатор&amp;, используемый для регистрации пользователей и их связывания с учетными записями пользователей eCare Vault. | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| User.Read.All | Делегированные | Имя и AAD и адрес электронной почты только для пользователей, которые являются членами канала, в котором Сейф Spaces | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| email | Делегированные | Только адрес электронной почты | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| openid | Делегированные | адрес электронной почты и AAD идентификатор&amp;, используемый для регистрации пользователей и их связывания с учетными записями пользователей eCare Vault. | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
>| profile | Делегированные | Имя пользователя используется для заполнения экрана регистрации пользователя. | [6919164d-b678-4c3d-a268-e6fbecc1e68d](../azure/6919164d-b678-4c3d-a268-e6fbecc1e68d.md) |
