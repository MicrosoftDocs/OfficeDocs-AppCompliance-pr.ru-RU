---
title: Сведения о приложении для Stack Overflow для Teams от Stack Overflow
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Вся доступная информация о безопасности и соответствии для Stack Overflow для Teams, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 28c6c422835cc3f6f3665581b954af68740787f6
ms.sourcegitcommit: 0a0b39a4c1826c026c0d3c405a20209254ce7891
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/06/2022
ms.locfileid: "66656411"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 11 октября 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Просмотр в магазине Teams</a>
...
Сведения, предоставляемые Stack Overflow корпорации Майкрософт:
...
| Название партнерской компании | Stack Overflow |
| Веб-сайт компании | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| Условия использования приложения | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| Основные функциональные возможности приложения | Stack Overflow для Teams — это частный безопасный домашний сайт для&#8217;вопросов и ответов. Больше не нужно перенабывать устаревшие вики-сайты и потерянные сообщения электронной почты,&#8212;вернуть команде время, необходимое для создания улучшенных продуктов. Интеграция Stack Overflow для Teams&#8217; с Microsoft Teams подключает чат Microsoft Teams и внутренний репозиторий знаний. Будьте в курсе уведомлений о новых сведениях, найдите существующие ответы и даже начните свой вопрос прямо с платформы Microsoft Teams. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
Эта информация была предоставлена Stack Overflow о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Сведения о MS Teams собираются и обрабатываются приложением, которое будет отображаться, и ссылки в среде Stack Overflow для Teams клиента. |
...
| Какие данные хранятся в базах данных? | Сведения о доступе к API MS Teams |
...
| URL-адрес политики конфиденциальности | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
