...
| Основные функции приложения | Совместное Microsoft Teams &amp; проектов
Создание Project, подключение к существующему и новому каналу |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Tasks.ReadWrite | делегирована | задачи планирования чтения и обновления | [99a0a9b1-5d28-45df-9f99-792aa32795f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/99a0a9b1-5d28-45df-9f99-792aa32795f4) |
>| User.Read | делегирована | чтение электронной почты пользователя | [99a0a9b1-5d28-45df-9f99-792aa32795f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/99a0a9b1-5d28-45df-9f99-792aa32795f4) |
