---
title: Сведения о приложении для GitHub корпорацией Майкрософт
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для GitHub, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 9a17dcb8665d1afb4a8da3afc6e96dbbecd20f8e
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877646"
---
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Корпорация Майкрософт |
| Веб-сайт компании | [https://github.com](https://github.com) |
| Условия использования приложения | [https://github.com/site/terms](https://github.com/site/terms) |
| Основные функциональные возможности приложения | GitHub — это платформа размещения кода для совместной работы и управления версиями. Это позволяет разработчикам совместно работать над проектами, от планирования и написания кода до доставки программного обеспечения. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://teams.github.com](https://teams.github.com) |
...
Корпорация Майкрософт предоставила эти сведения о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
