---
title: Сведения о приложении для FireHydrant от FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Все доступные сведения о безопасности и соответствии для FireHydrant, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "64878676"
---
# <a name="firehydrant"></a>FireHydrant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 10 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые FireHydrant корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | FireHydrant |
| Идентификатор | WA200003794 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | FireHydrant |
| Веб-сайт компании | [https://firehydrant.io](https://firehydrant.io) |
| Условия использования приложения | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| Основные функциональные возможности приложения | Управление инцидентами с помощью FireHydrant.io. |
...
Эта информация была предоставлена FireHydrant о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Удостоверение пользователя (имя, электронная почта), данные об инцидентах из каналов teams |
...
| Какие данные хранятся в базах данных? | team id, tenant id, messages, username |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Делегированные | FireHydrant создает каналы от имени наших пользователей для управления инцидентами | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
