...
| Основные функции приложения | Desk365 — это современная справка для Microsoft 365 рабочего места. С помощью приложения Desk365 Teams вы можете с легкостью сотрудничать с другими агентами в вашей группе поддержки. Вы можете отвечать на билеты, добавлять заметки, проверять состояния, изменять свойства билетов, не покидая Microsoft Teams. Desk365 является бесплатным для до 4 агентов. |
