---
title: Сведения о приложении для DBit от Diamondsoft Solutions, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Все доступные сведения о безопасности и соответствии для DBit, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 513d2651c80bd2e205a6bd66bcafef7c2fd11e69
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876436"
---
# <a name="dbit"></a>DBit
...
* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Diamondsoft Solutions, LLC |
| Веб-сайт компании | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Условия использования приложения | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Основные функциональные возможности приложения | Решения для управления паролями DBit с меньшими сложностями. DBit — это средство управления паролями для небольших и крупных команд. С помощью DBit вы можете безопасно делиться паролями между участниками команды. Срок действия созданных общих паролей и паролей автоматически истекает через несколько минут. Ваши пароли шифруются в памяти на наших серверах и никогда не сохраняются в хранилище дисков. По истечении срока действия паролей они удаляются из памяти сервера. Это приложение разработано компанией Diamondsoft Solutions, LLC |
...
Эти сведения предоставлены компанией Diamondsoft Solutions, LLC, о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | TenantId |
