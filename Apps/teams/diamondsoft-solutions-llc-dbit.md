...
description: Все доступные сведения о безопасности и соответствия требованиям для DBit, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Решения по управлению паролями DBit с меньшим количеством проблем. DBit — это средство управления паролями для малых и больших групп. С помощью DBit можно безопасно обмениваться паролями между членами группы. Созданные общие пароли и пароли автоматически истекают по истечении определенной продолжительности минут. Пароли шифруются в памяти на наших серверах и никогда не хранятся в хранилище дисков. По истечении срока действия паролей они удаляются из памяти нашего сервера. Это приложение разработано компанией Diamondsoft Solutions, LLC |
