...
| Основные функции приложения | SmartWork — это робот-диалог, который может отвечать на вопросы, связанные с Microsoft Office 365 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Использование userPrincipalName для определения того, является ли почта пользователя действительной AAD или нет. | [a938ae1e-a791-4751-9e6a-178c991fa0fafa](https://docs.microsoft.com/microsoft-365-app-certification/azure/a938ae1e-a791-4751-9e6a-178c991fa0fa) |
