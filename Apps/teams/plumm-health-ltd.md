...
description: Все доступные сведения о безопасности и соответствии требованиям для Приложения Plumm, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d66da813-3337-4f88-8e08-f01c0bbb8f34" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Компании Plumm Health LTD корпорации Майкрософт:
...
| Название партнерской компании | Plumm Health LTD |
| Веб-сайт компании | [https://www.plummhealth.com](https://www.plummhealth.com) |
| Условия использования приложения | [https://www.plummhealth.com/terms-of-use](https://www.plummhealth.com/terms-of-use) |
| Основные функциональные возможности приложения | Компания Plumm предоставляет сотрудникам поддержку, необходимую для их менталейного здоровья. Каждый участник Plumm имеет доступ к высококачественной поддержке ментальной работоспособности с глобальной сетью из более чем 150 экспертов, цифровой библиотекой курсов по безопасности, чатом и интерактивными посредниками, &#8211; в одном месте. Пользователи могут подключаться с помощью личных видеофайлов или общаться с ними в закрытом режиме о своих требованиях. Онлайн-курсы и учебные курсы под руководством инструктора обеспечивают самостояальную поддержку. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.plummhealth.com/about-us](https://www.plummhealth.com/about-us) |
...
Компания Plumm Health LTD предоставила эти сведения о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | В этом разрешении используется идентификатор пользователя. Он используется для отправки пользователю необходимых уведомлений в зависимости от их использования нашей службы. Это важно для того, чтобы пользователь получать соответствующие уведомления для своей учетной записи в нашем приложении. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | приложение | Мы получаем идентификатор установки, используя это разрешение. Это важно для нас, чтобы иметь возможность отправлять соответствующее и правильное уведомление для каждого отдельного пользователя. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read | Делегированные | Мы собираем имя, рисунок и электронную почту для наших пользователей с помощью этого разрешения. Это необходимо для того, чтобы мы могли идентифицировать отдельных пользователей, и эти точки данных должны отображаться везде, где это необходимо, например на странице отдельного профиля и при обмене данными по электронной почте или уведомлению. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read.All | приложение | Это разрешение позволяет нашему приложению считывать профили пользователей без необходимости входа пользователя. В настоящее время мы собираем только имя, изображение профиля и электронную почту. Это необходимо для того, чтобы мы могли идентифицировать отдельных пользователей, и эти точки данных должны отображаться везде, где это необходимо, например на странице отдельного профиля и при обмене данными по электронной почте или уведомлению. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| email | Делегированные | Собираются идентификаторы электронной почты пользователя. Эти данные необходимы для предоставления пользователю доступа к нашим службам, входа в приложение и получения уведомлений об их учетных записях и службах по этому идентификатору электронной почты.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| openid | Делегированные | Для этого разрешения мы не собираем данные.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| profile | Делегированные | Мы собираем имя, рисунок и электронную почту для наших пользователей с помощью этого разрешения. Это необходимо для того, чтобы мы могли идентифицировать отдельных пользователей, и эти точки данных должны отображаться везде, где это необходимо, например на странице отдельного профиля и при обмене данными по электронной почте или уведомлению. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
