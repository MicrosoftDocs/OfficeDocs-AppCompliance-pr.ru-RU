...
| Основные функции приложения | Plumm предоставляет сотрудникам необходимую поддержку для их психического благополучия. Каждый член Plumm имеет доступ к высококачественной поддержке психического здоровья с глобальной сетью аккредитованных терапевтов более 150, цифровой библиотекой курсов хорошего самочувствия под руководством терапевта, терапии чатов и управляемых посредников &#8211; все в одном месте. Пользователи могут связаться с терапевтами для онлайн-видеотерапии 1:1 или пообщаться с ними в частном порядке об их требованиях. Онлайн-курсы и медитации под руководством терапевта предоставляют поддержку самостоятельной помощи. |
...
>| email | делегирована | Собирается ID электронной почты пользователя. Мы требуем этих данных, чтобы предоставить пользователю доступ к нашим службам и войти в наше приложение и получать уведомления об их учетных записях и наших службах в этом почтовом ИД.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](https://docs.microsoft.com/microsoft-365-app-certification/azure/b1d1c038-a1f3-4802-be93-0f4a66589e73) |
>| openid | делегирована | Для этого разрешения мы не собираем никаких данных.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](https://docs.microsoft.com/microsoft-365-app-certification/azure/b1d1c038-a1f3-4802-be93-0f4a66589e73) |
