---
title: Сведения о приложении для DoctorOnline от NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для DoctorOnline, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | DoctorOnline |
| ID | WA200004082 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | NLSQL |
| Веб-сайт компании | [https://nlsql.com](https://nlsql.com) |
| Условия использования приложения | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| Основные функциональные возможности приложения | Закуйте бесплатную поддержку в сфере здравоохранения в Интернете. Более 500 авторизованных юных врача с разными категориями. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |
