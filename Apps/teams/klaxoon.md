...
description: Все доступные сведения о безопасности и соответствии для Klaxoon, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: d9827ded720bd9f215becfd2eb9949c4e611215b
ms.sourcegitcommit: cede428f2a23bd3060f5506f270b40b327b02769
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66548108"
---
...
* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Просмотр в магазине Teams</a>
...
Сведения, предоставляемые Приложением Klaxoon корпорации Майкрософт:
...
| Название партнерской компании | Klaxoon |
| Веб-сайт компании | [https://klaxoon.com](https://klaxoon.com) |
| Условия использования приложения | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| Основные функциональные возможности приложения | Компания Klaxoon предоставляет доступ к полному набору средств для совместной работы (доска, опрос, тест, опрос и т. д.), предназначенных для повышения эффективности командной работы. Набор Klaxoon доступен в виде веб-приложения, мобильных приложений (Apple или Android) или непосредственно из Microsoft Teams (через интеграцию с tab). |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://klaxoon.com](https://klaxoon.com) |
| Какая среда размещения или модель службы используются для запуска приложения? | Гибридную |
| Какие поставщики облачных служб используются приложением? | Azure, Aws, Other |
...
Эта информация была предоставлена в Кодексуне о том, как это приложение собирает и хранит данные организации, а также о том, как ваша организация будет контролировать данные, собираемые приложением.
...
| Какие данные обрабатываются приложением? | электронная почта, имя, фамилия, аватар |
...
| Какие данные хранятся в базах данных? | электронная почта, имя, фамилия, аватар |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | США Америки, Франции, Германии |
...
| URL-адрес политики конфиденциальности | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
| Перечисление поддерживаемых типов политик | Запросить дополнительные сведения |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Идентификация пользователя и создание учетной записи | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| email | Делегированные | Идентификация пользователя и создание учетной записи | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | Делегированные | Идентификация пользователя и создание учетной записи | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | Делегированные | Идентификация пользователя и создание учетной записи | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| profile | Делегированные | Идентификация пользователя и создание учетной записи | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
