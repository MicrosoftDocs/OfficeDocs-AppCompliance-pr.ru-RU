...
ms.openlocfilehash: 8070d753fe67f4c090526b4d7c3ddfecdb987b82
ms.sourcegitcommit: 58c50d1704196178455927329748485b40dd7880
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/17/2022
ms.locfileid: "63544437"
---
...
| Основные функции приложения | Klaxoon предоставляет доступ к полному набору средств совместной работы (доска, опрос, викторина, живые опросы и т.д.), предназначенных для повышения эффективности совместной работы. Пакет Klaxoon доступен в качестве веб-приложения, мобильных приложений (Apple/Android) или непосредственно из Microsoft Teams (с помощью интеграции Tab) |
| Расположение штаб-квартиры компании | Франция |
| Страница информация о приложении | [https://klaxoon.com](https://klaxoon.com) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | AWS, Azure, claranet |
...
| Самая недавняя дата сертификации SOC2 |  2019-10-28 |
