---
title: Сведения о приложении для PerformYard от PerformYard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Вся доступная информация о безопасности и соответствии для PerformYard, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ae947de1-da03-4e37-a420-3c5316f01e73" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004215" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые PerformYard в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | PerformYard |
| ID | WA200004215 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | PerformYard |
| Веб-сайт компании | [https://performyard.com](https://performyard.com) |
| Условия использования приложения | [https://www.performyard.com/master-subscription-agreement](https://www.performyard.com/master-subscription-agreement) |
| Основные функциональные возможности приложения | PerformYard упрощает управление производительностью для всех. Гибкая система управления персоналом &amp; , простая для сотрудников. |
...
Эта информация была предоставлена PerformYard о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | идентификационные данные клиента, имена всех команд и все каналы в них; события установки и удаления. |
...
| Какие данные хранятся в базах данных? | Идентификационные данные клиента, имена всех команд и все каналы в них. |
...
| Дата последней сертификации SOC2 | 2022-06-01 |
...
| URL-адрес политики конфиденциальности | https://www.performyard.com/privacy |
