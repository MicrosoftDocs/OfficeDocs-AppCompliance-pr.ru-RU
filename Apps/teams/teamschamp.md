...
description: Все доступные сведения о безопасности и соответствии требованиям для TeamsChamp, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | TeamsChamp повышает использование и внедрение информационных систем организации (в которые она была инвестирована) с помощью геймификации цифровых компетенций сотрудников.  Re-energize Microsoft 365 принятие с глоток свежего воздуха и культуры, которая облегчает его цифровой трансформации. |
| Расположение штаб-квартиры компании | Испания |
| Страница информация о приложении | [https://www.teamschamp.com](https://www.teamschamp.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Вход и чтение профиля пользователей | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| User.ReadBasic.All | делегирована | Чтение базового профиля всех пользователей | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| profile | делегирована | Просмотр базовых профилей пользователей | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
