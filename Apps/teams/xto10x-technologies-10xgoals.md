---
title: Сведения о приложении для 10xGoals от xto10x Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для 10xGoals, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: dca05b31c35b37f63711d62bfe388e1e90ad84d9
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877046"
---
...
* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые xto10x Technologies корпорации Майкрософт:
...
| Название партнерской компании | xto10x Technologies |
| Веб-сайт компании | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| Условия использования приложения | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| Основные функциональные возможности приложения | 10xGoals — это средство для реализации стратегий с фокусом на уровне команды, согласованием, совместной работой и видимостью. Интеграция 10xGoals &lt;&gt; Microsoft Teams позволяет управлять всем выполнением. Для начала пользователи могут принимать, отклонять или примечания к назначенным им целям, чтобы лучше управлять своим временем. Чтобы использовать это приложение, у пользователей должна быть активная подписка 10xGoals. |
| Расположение компании | Индия |
| Страница сведений о приложении | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
Эти сведения предоставлены xto10x Technologies о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | приложение | Пользователь получает электронную почту и идентификатор Azure, чтобы приложение можно было установить упреждающим образом для всех пользователей организации.  | [950aa4fb-0583-4b13-9b5f-же92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | приложение | Это необходимо для того, чтобы приложение можно было получить установленный teamsAppDefinition для администратора, а затем установить его упреждающим образом для всех пользователей организации.  | [950aa4fb-0583-4b13-9b5f-же92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
