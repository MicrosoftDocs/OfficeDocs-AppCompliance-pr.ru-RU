...
| Основные функции приложения | 10xGoals — это средство для выполнения стратегий с учетом фокуса, выравнивания, совместной работы и видимости. С помощью 10xGoals &lt;&gt; Microsoft Teams интеграции можно управлять всем выполнением здесь. Для начала пользователи могут принимать / откло соглашаться и комментировать поставленные перед ними задачи, чтобы лучше управлять своим временем. Чтобы использовать это приложение, пользователи должны иметь активную подписку на 10xGoals. |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | приложение | Пользователи электронной почты и azure id извлекли, чтобы приложение можно было установить приложение активно для всех пользователей организации.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | приложение | Это необходимо для того, чтобы приложение можно было получить установленные teamsAppDefinition для администратора и затем установить себя активно для всех пользователей организации.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
