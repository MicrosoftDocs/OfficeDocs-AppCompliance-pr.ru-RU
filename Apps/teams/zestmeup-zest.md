---
title: Сведения о приложении для Zest от Zestmeup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/28/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Zest, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0ada2a4511e208ff0e9c171369a883c4bd4d47d6
ms.sourcegitcommit: 878a7b7e9c6fe787c6dfc9c95d4d46268562f84c
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/30/2022
ms.locfileid: "67096698"
---
# <a name="zest"></a>Изюминка

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 30 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/2ce8e701-c302-47ff-9061-2bb819681f96" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004458" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Zestmeup корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Изюминка |
| ID | WA200004458 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Zestmeup |
| Веб-сайт компании | [https://zestmeup.com](https://zestmeup.com) |
| Условия использования приложения | [https://zestmeup.com/en/terms-of-use](https://zestmeup.com/en/terms-of-use) |
| Основные функциональные возможности приложения | От опросов отдела кадров до ежегодных проверок производительности — оцифруйте опыт сотрудников с помощью простого и эффективного решения Zest. Интеграция с Microsoft Teams позволяет получать уведомления о выполняемых действиях или выполнять их в приложении Zest. |
...
| Какие поставщики облачных служб используются приложением? | OVH |
...
Эта информация была предоставлена Zestmeup о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://zestmeup.com/en/privacy-policy/ |
