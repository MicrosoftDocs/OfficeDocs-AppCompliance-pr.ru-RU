---
title: Application Information for Grytics Companion by 1339 SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Все доступные сведения о безопасности и соответствии для Grytics Companion, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 3e5974e274bc59db4e1e60dcddb344b6c394dae3
ms.sourcegitcommit: cede428f2a23bd3060f5506f270b40b327b02769
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66547453"
---
# <a name="grytics-companion"></a>Сопутствующего пользователя Grytics

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 3 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые 1339 SAS корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Сопутствующего пользователя Grytics |
| ID | WA200004217 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | 1339 SAS |
| Веб-сайт компании | [https://grytics.com](https://grytics.com) |
| Условия использования приложения | [https://grytics.com/terms](https://grytics.com/terms) |
| Основные функциональные возможности приложения | Пользователи могут сравнить &amp; анализ тенденций &amp; активности бизнес-социальных сетей, добавленных в свои учетные записи Grytics |
...
Эта информация предоставлена saS 1339 о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Электронная почта, имя |
...
| Какие данные хранятся в базах данных? | Имя, электронная почта для пользователей приложения.  |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Ирландия, Франция |
...
| URL-адрес политики конфиденциальности | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | приложение | Требуется, чтобы разрешить администраторам Grytics авторизовать пользователей Grytics на использование приложения в Teams и сопоставить их идентификатор пользователя в AAD. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | Делегированные | Требуется для потока проверки подлинности единого входа | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | приложение | Требуется, чтобы разрешить администраторам Grytics авторизовать пользователей Grytics на использование приложения в Teams и сопоставить их идентификатор пользователя в AAD. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| email | Делегированные | Требуется для потока проверки подлинности единого входа | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | Делегированные | Требуется для потока проверки подлинности единого входа | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| profile | Делегированные | Требуется для потока проверки подлинности единого входа | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
