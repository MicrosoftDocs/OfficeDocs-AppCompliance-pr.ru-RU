---
title: Application Information for Timeneye by DM Digital SRL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: Вся доступная информация о безопасности и соответствии для Timeneye, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: c1d0558bce315ada3f3a7c9d27d8a0163e754ac2
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64876416"
---
...
* <a href="https://teams.microsoft.com/l/app/015bf4ec-bc37-4931-9862-ef8686da652b" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые DM Digital SRL корпорации Майкрософт:
...
| Название партнерской компании | DM Digital SRL |
...
| Основные функциональные возможности приложения | Отслеживайте время, затраченное на выполнение задач непосредственно из Microsoft Teams! |
...
Эта информация была предоставлена DM Digital SRL о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Делегированные | Event Start/End DateTime, Event Subject, Event ID, Event Web URI. Создание предложений на основе событий календаря. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Calendars.Read.Shared | Делегированные | Event Start/End DateTime, Event Subject, Event ID, Event Web URI. Эти сведения используются для создания предложений на основе событий календаря. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Directory.Read.All | Делегированные | Идентификаторы групп пользователей. Мы используем эти сведения для проверки групп, участником которых является пользователь, чтобы синхронизировать планировщики его групп. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Group.Read.All | Делегированные | Имя группы, идентификатор группы. Эти сведения используются при синхронизации проектов планировщика. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Tasks.Read | Делегированные | имя списка задач, идентификатор списка задач; Эти сведения используются при синхронизации проектов планировщика. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.Read | Делегированные | адрес электронной почты, имя. Эти сведения используются для входа пользователя или создания учетной записи пользователя. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.ReadBasic.All | Делегированные | имя пользователя, адрес электронной почты. Мы используем эти сведения, чтобы пользователь может импортировать других пользователей из Планировщика или Майкрософт в нашу службу. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| email | Делегированные | Отправить по электронной почте. Эти сведения используются для входа пользователя или создания учетной записи пользователя. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| offline_access | Делегированные | Разрешение, необходимое для синхронизации планировщика или календаря, пока пользователь не подключен к сети. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| openid | Делегированные | id_token. Вход пользователя с помощью единого входа Майкрософт | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| profile | Делегированные | адрес электронной почты, имя. Эти сведения используются для входа пользователя или создания учетной записи пользователя. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
