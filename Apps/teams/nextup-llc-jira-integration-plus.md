---
title: Сведения о приложениях для Jira Integration Plus by Nextup, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставленные корпорацией Nextup, LLC корпорации Майкрософт:
...
| Основные функции приложения | Найдите существующие проблемы Jira для редактирования или обсуждения Teams или создания новых проблем. Отправляет проблемы в сообщении. Комментарий по проблеме или сведения. Измените состояние, назначьте его и другие. Использование Jira через интерфейс командной строки (CLI). Комментарий, работа журнала и другие. Получать уведомления о проблемах на канале (соединители). Создание новых проблем из сообщений с расширением обмена сообщениями. Управление вопросами с помощью платы (Tabs). Поиск проблем, щелкнув значок ниже любого сообщения в Teams. |
...
Эта информация предоставлена в Nextup, LLC о том, как это приложение собирает и хранит организационные данные и контроль, который будет иметь ваша организация над данными, которые собирает приложение.
...
| Самая недавняя дата сертификации SOC1 |  2021-04-01 |
