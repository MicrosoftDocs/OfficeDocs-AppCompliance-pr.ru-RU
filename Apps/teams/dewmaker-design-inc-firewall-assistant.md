...
* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставленные корпорацией Майкрософт dewMaker Design, Inc.
...
Эти сведения предоставлены dewMaker Design, Inc. о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Адрес электронной почты (для логинов MS) и конечная точка подписки Azure |
