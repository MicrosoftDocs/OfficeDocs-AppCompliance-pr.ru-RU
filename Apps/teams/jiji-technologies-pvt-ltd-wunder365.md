...
### <a name="general-information"></a><span data-ttu-id="c9a2c-107">Общие сведения</span><span class="sxs-lookup"><span data-stu-id="c9a2c-107">General information</span></span>
...
#### <a name="data-access-using-other-microsoft-apis"></a><span data-ttu-id="c9a2c-157">Доступ к данным с помощью других API Майкрософт</span><span class="sxs-lookup"><span data-stu-id="c9a2c-157">Data access using other Microsoft APIs</span></span>
...
><span data-ttu-id="c9a2c-174">Доступ к EUII не имеется.</span><span class="sxs-lookup"><span data-stu-id="c9a2c-174">No EUII is accessed.</span></span>
...
><span data-ttu-id="c9a2c-186">Нет</span><span class="sxs-lookup"><span data-stu-id="c9a2c-186">No</span></span>
...
<span data-ttu-id="c9a2c-187">Сведения из [Microsoft Cloud App Security](https://www.microsoft.com/enterprise-mobility-security/cloud-app-security) ниже.</span><span class="sxs-lookup"><span data-stu-id="c9a2c-187">Information from the [Microsoft Cloud App Security](https://www.microsoft.com/enterprise-mobility-security/cloud-app-security) catalog appears below.</span></span>

<iframe height='1020' title='<span data-ttu-id="c9a2c-188">Microsoft Cloud App Security Сведения</span><span class="sxs-lookup"><span data-stu-id="c9a2c-188">Microsoft Cloud App Security Information</span></span>' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36250' frameborder='no' style='width: 100%;'></iframe><span data-ttu-id="c9a2c-189">

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36250" target="_blank">Просмотр на новой вкладке</a></span><span class="sxs-lookup"><span data-stu-id="c9a2c-189">
...
### <a name="identity-information"></a><span data-ttu-id="c9a2c-190">Сведения о удостоверениях</span><span class="sxs-lookup"><span data-stu-id="c9a2c-190">Identity information</span></span>

<span data-ttu-id="c9a2c-191">Эта информация предоставлена JiJi Technologies Pvt Ltd о том, как это приложение обрабатывает проверку подлинности, авторизацию, лучшие практики регистрации приложений и другие критерии удостоверения.</span><span class="sxs-lookup"><span data-stu-id="c9a2c-191">This information has been provided by JiJi Technologies Pvt Ltd about how this app handles authentication, authorization, application registration best practices, and other Identity criteria.</span></span>

| <span data-ttu-id="c9a2c-192">**Information**</span><span class="sxs-lookup"><span data-stu-id="c9a2c-192">**Information**</span></span> | <span data-ttu-id="c9a2c-193">**Отклик**</span><span class="sxs-lookup"><span data-stu-id="c9a2c-193">**Response**</span></span> |
|:----------------|:-------------|
| <span data-ttu-id="c9a2c-194">Интеграция с платформой Microsoft Identify Platform (Azure AD)?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-194">Do you integrate with Microsoft Identify Platform (Azure AD)?</span></span>  | <span data-ttu-id="c9a2c-195">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-195">Yes</span></span> |
| <span data-ttu-id="c9a2c-196">Рассмотрели ли вы и выполнили все применимые методы, описанные в платформа удостоверений Майкрософт списке интеграции?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-196">Have you reviewed and complied with all applicable best practices outlined in the Microsoft identity platform integration checklist?</span></span>  | <span data-ttu-id="c9a2c-197">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-197">Yes</span></span> |
| <span data-ttu-id="c9a2c-198">Использует ли ваше приложение MSAL (Microsoft Authentication Library) для проверки подлинности?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-198">Does your app use MSAL (Microsoft Authentication Library) for authentication?</span></span> | <span data-ttu-id="c9a2c-199">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-199">Yes</span></span> |
| <span data-ttu-id="c9a2c-200">Поддерживает ли ваше приложение политики условного доступа?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-200">Does your app support Conditional Access policies?</span></span> | <span data-ttu-id="c9a2c-201">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-201">Yes</span></span> |
| <span data-ttu-id="c9a2c-202">Список типов поддерживаемых политик</span><span class="sxs-lookup"><span data-stu-id="c9a2c-202">List the types of policies supported</span></span> | <span data-ttu-id="c9a2c-203">Требование многофакторной проверки подлинности для пользователей с административными ролями, требование многофакторной проверки подлинности для задач управления Azure, блокировка входных входов для пользователей, пытающихся использовать устаревшие протоколы проверки подлинности, требование надежных местоположений для регистрации многофакторной проверки подлинности Azure AD, блокировка или предоставление доступа из определенных местоположений, блокировка рискованного поведения при входе</span><span class="sxs-lookup"><span data-stu-id="c9a2c-203">Requiring multi-factor authentication for users with administrative roles, Requiring multi-factor authentication for Azure management tasks, Blocking sign-ins for users attempting to use legacy authentication protocols, Requiring trusted locations for Azure AD Multi-Factor Authentication registration, Blocking or granting access from specific locations, Blocking risky sign-in behavior</span></span> |
| <span data-ttu-id="c9a2c-204">Запрашивает ли ваше приложение наименьшие разрешения на привилегии для вашего сценария?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-204">Does your app request least privilege permissions for your scenario?</span></span> | <span data-ttu-id="c9a2c-205">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-205">Yes</span></span> |
| <span data-ttu-id="c9a2c-206">Точно ли статически зарегистрированные разрешения вашего приложения отражают разрешения, которые ваше приложение запрашивает динамически и постепенно?</span><span class="sxs-lookup"><span data-stu-id="c9a2c-206">Does your app's statically registered permissions accurately reflect the permissions your app will request dynamically and incrementally?</span></span> | <span data-ttu-id="c9a2c-207">Да</span><span class="sxs-lookup"><span data-stu-id="c9a2c-207">Yes</span></span> |
