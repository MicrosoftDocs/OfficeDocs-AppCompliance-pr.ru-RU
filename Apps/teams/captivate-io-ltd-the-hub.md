...
description: Вся доступная информация о безопасности и соответствия требованиям для Концентратора Captivate, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "61537921"
---
# <a name="the-captivate-hub"></a>Концентратор Captivate
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Концентратор Captivate |
| Идентификатор | WA200003575 |
...
| Какие данные хранятся в базах данных? | ID клиента, Teams группы, группы каналов и пользователей, включенных в группу групп, подключенных к приложению |
