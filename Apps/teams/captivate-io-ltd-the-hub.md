---
title: Сведения о приложениях для концентратора Captivate by Captivate IO Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для центра Captivate, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0ea8ef28-454a-4796-84dc-06c775639565" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003575" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Корпорацией Майкрософт с помощью Captivate IO Ltd:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | The Captivate Hub |
| ID | WA200003575 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Captivate IO Ltd |
| Веб-сайт компании | [https://captivat.io](https://captivat.io) |
| Условия использования приложения | [https://captivat.io/tos](https://captivat.io/tos) |
| Основные функции приложения | Концентратор Captivate — это разнонастройная система без кода, которая предназначена для поддержки разговоров между людьми и машинами по нескольким каналам. Он поддерживает цифровых помощников нескольких поставщиков, а также множество решений чата в прямом эфире. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://manual.captivat.io/docs/teams](https://manual.captivat.io/docs/teams) |
| Какова среда размещения или модель службы, используемая для запуска приложения? | Iaas |
| Какие поставщики облачных хостингов используют приложение? | IBMCloud |
...
Эти сведения предоставлены организацией Captivate IO Ltd о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | ID клиента, Teams группы, группы каналов и пользователи, включенные в группу групп, подключенных к приложению |
...
| URL-адрес политики конфиденциальности | https://www.captivat.io/privacy-policy/ |
