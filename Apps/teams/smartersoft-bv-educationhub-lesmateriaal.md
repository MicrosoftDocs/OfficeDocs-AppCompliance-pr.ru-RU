---
title: Сведения о приложении для EducationHUB Lesmateriaal от Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для EducationHUB Lesmateriaal, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Smartersoft B.V. в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Smartersoft B.V. |
| Веб-сайт компании | [https://smartersoft.nl](https://smartersoft.nl) |
| Условия использования приложения | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| Основные функциональные возможности приложения | Разрешите учебным заведениям предоставлять прямой доступ к предоставляемому учебным заведением цифровому содержимому, а не принудительным доступом учащихся к другому веб-сайту. |
| Расположение компании | Нидерланды (the) |
| Страница сведений о приложении | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Эти сведения предоставлены компанией Smartersoft B.V. о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Идентификатор пользователя, членство в группах, добавленное в приложение личное содержимое |
...
| Какие данные хранятся в базах данных? | Идентификатор пользователя, идентификатор группы, предоставленные пользователем ссылки на содержимое цифрового учебного заведения |
...
| Перечисление поддерживаемых типов политик | Вся платформа Майкрософт отвечает за предоставление маркера для пользователя. Администратор решает, как пользователь проверяется или принудительно использует MFA. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Делегированные | Доступ к сведениям, сохраненным в атрибутах расширения группы | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | Делегированные | Сведения о командах пользователей | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | Делегированные | Вход | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
