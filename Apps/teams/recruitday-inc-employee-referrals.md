...
| Основные функции приложения | Обратитесь к друзьям, чтобы открыть рабочие места в вашей компании и отслеживать ваши награды с помощью Microsoft Teams. |
| Расположение штаб-квартиры компании | Филиппины (the) |
| Страница информация о приложении | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
