---
title: Сведения о приложениях для Amber по inFeedo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Amber, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a4d418db-2e4a-4fe7-978c-5f28e85d6307" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003432" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые в inFeedo Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Amber |
| ID | WA200003432 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | inFeedo |
| Веб-сайт компании | [https://infeedo.com](https://infeedo.com) |
| Условия использования приложения | [https://infeedo.com/terms-and-conditions](https://infeedo.com/terms-and-conditions) |
| Основные функции приложения | Платформа для работы сотрудников |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://help.infeedo.com/docs](https://help.infeedo.com/docs) |
...
Эти сведения предоставлены в inFeedo о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Самая недавняя дата сертификации SOC2 |  2021-05-19 |
...
| URL-адрес политики конфиденциальности | https://infeedo.com/privacy-policy |
