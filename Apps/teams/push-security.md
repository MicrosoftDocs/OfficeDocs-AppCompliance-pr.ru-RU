---
title: Сведения о приложении для принудительной защиты путем принудительной защиты
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для принудительной защиты, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66817732"
---
# <a name="push-security"></a>Принудительная безопасность

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 12 июля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые push-безопасностью в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Принудительная безопасность |
| ID | WA200002833 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Принудительная безопасность |
| Веб-сайт компании | [https://pushsecurity.com](https://pushsecurity.com) |
| Условия использования приложения | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| Основные функциональные возможности приложения | Мы помогаем компаниям более эффективно работать с SaaS, помогая сотрудникам безопасно использовать приложения. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
Эти сведения предоставлены службой Push Security о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собранными приложением.
...
| Какие данные обрабатываются приложением? | Принудительная обработка рабочего времени клиента для предоставления оповещений при работе клиента.  |
...
| Какие данные хранятся в базах данных? | Принудительное хранение рабочих часов клиента для предоставления оповещений о работе клиента.  |
...
| URL-адрес политики конфиденциальности | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | приложение | Перечисление каналов для упрощения установки бота  | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | приложение | Запрос рабочего времени клиента, чтобы не отправлять ему сообщения в нерабочее время | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | приложение | Перечисление команд для упрощения установки бота  | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | приложение | Разрешить боту устанавливать себя для команды | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | приложение | Разрешить боту устанавливать себя для пользователя | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | приложение | Перечисление пользователей, чтобы мы могли отправлять им сообщения | [4ed8651a-5a01-44f0-веб-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
