...
description: Все доступные сведения о безопасности и соответствия требованиям для отслеживания времени Chronoscope, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Chronoscope — это интеллектуальная платформа управления временем, которая повышает точность данных и уменьшает ошибки входа во времени. С помощью интеллектуального помощника, который интегрируется с существующей экосистемой, Chronoscope упрощает вход во времени и обеспечивает видимость данных для принятия более важных бизнес-решений. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://www.chronoscope.app](https://www.chronoscope.app) |
