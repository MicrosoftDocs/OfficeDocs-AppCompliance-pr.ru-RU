---
title: Сведения о приложении для отслеживания времени Chronoscope от Chrono Innovation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для отслеживания времени Chronoscope, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: b5b30af08deb7ffd2ad51a850bcc9c6c16eaeebc
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880696"
---
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт в Chrono Innovation:
...
| Название партнерской компании | Chrono Innovation |
| Веб-сайт компании | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| Условия использования приложения | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| Основные функциональные возможности приложения | Chronoscope — это интеллектуальная платформа управления временем, которая повышает точность данных и сокращает количество ошибок ввода времени. Благодаря интеллектуальному помощнику, который интегрируется с существующей экосистемой, Chronoscope упрощает ввод времени и обеспечивает видимость данных для принятия более обоснованных бизнес-решений. |
| Расположение компании | Канада |
| Страница сведений о приложении | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
Эта информация была предоставлена Chrono Innovation о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | приложение | tenantId teams, teams addObjectId и сведения об учетной записи пользователя Teams. При связывание пользователей Chronoscope мы проверяем, соответствует ли сообщение электронной почты учетной записи Teams, чтобы можно было связать учетную запись без ручного шага от пользователя. | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
