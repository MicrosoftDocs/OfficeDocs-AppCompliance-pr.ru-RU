---
title: Сведения о приложении для управления событиями по SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Все доступные сведения о безопасности и соответствии для управления событиями, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64784258"
---
# <a name="event-management"></a>Управление событиями

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 22 марта 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/2b8b9b59-d595-46b3-ba0a-602024bab0cc" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые SharePoint| Из Sapiens в корпорацию Майкрософт:
...
| Название партнерской компании | \|SharePoint Sapiens |
| Веб-сайт компании | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| Условия использования приложения | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| Основные функциональные возможности приложения | Надстройка "Управление событиями" помогает упорядочивать различные типы событий. События можно запланировать в течение нескольких простых шагов. Участники могут зарегистрироваться в Интернете одним щелчком мыши. Организатор также может регистрировать внутренних или внешних пользователей от имени или отправлять приглашения по электронной почте. Участники получают приглашения на собрания и обновления по электронной почте, чтобы убедиться, что у них всегда есть последние сведения в Outlook календаре. Надстройка отслеживает всех участников в одном месте. |
| Расположение компании | Австрия |
| Страница сведений о приложении | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/documentation/teams/) |
...
Эти сведения предоставлены SharePoint| Sapiens о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://addins.sharepointsapiens.com/licensing/data-processing-agreement.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | Делегированные | Чтение основных сведений о пользователе, чтобы включить Exchange номеров | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
