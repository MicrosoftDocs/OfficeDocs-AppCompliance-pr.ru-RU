...
| Основные функции приложения | Надстройка Event Management помогает организовывать различные типы событий. События могут быть запланированы в течение нескольких простых действий. Участники могут зарегистрироваться в Интернете одним щелчком мыши. В качестве организатора вы также можете записать внутренних или внешних пользователей от имени или отправить приглашения по электронной почте. Участники получают запросы на собрания и обновления по электронной почте, чтобы убедиться, что они всегда имеют последнюю информацию в Outlook календаря. Надстройка отслеживает всех участников в одном месте. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | делегирована | Адрес электронной почты и имя Exchange и ресурсов для обеспечения резервирования номеров и ресурсов | [9e8e113c-8a08-4606-b08a-de4decc7252f](https://docs.microsoft.com/microsoft-365-app-certification/azure/9e8e113c-8a08-4606-b08a-de4decc7252f) |
