---
title: Application Information for Squadcast by Squadcast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Вся доступная информация о безопасности и соответствии для Squadcast, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 6aa29656b0deac425e15abd4928e158a3fd8baeb
ms.sourcegitcommit: f020743c27bd5ba69e4f74e8fff3f82b2571c408
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/20/2022
ms.locfileid: "66892077"
---
# <a name="squadcast"></a>Откадровка

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 10 января 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Приложением Squadcast корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Откадровка |
| ID | WA200004390 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Откадровка |
| Веб-сайт компании | [https://www.squadcast.com](https://www.squadcast.com) |
| Условия использования приложения | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| Основные функциональные возможности приложения | Эффективное управление инцидентами непосредственно из MS Teams. |
| Расположение компании | Estados Unidos Америки |
| Страница сведений о приложении | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Эта информация предоставлена Приложением Squadcast о сборе и хранилище данных организации, а также о том, как ваша организация будет контролировать данные, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя — только имя пользователя, Email |
...
| Какие данные хранятся в базах данных? | Идентификатор группы, имя команды, идентификатор канала, имя канала, идентификатор клиента |
...
| URL-адрес политики конфиденциальности | https://www.squadcast.com/privacy |
