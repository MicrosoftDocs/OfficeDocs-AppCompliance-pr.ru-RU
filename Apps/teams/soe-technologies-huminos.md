...
description: Вся доступная информация о безопасности и соответствии требованиям для huminos, политики обработки данных, Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
>| offline_access | делегирована | Azure active directory id of user | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](https://docs.microsoft.com/microsoft-365-app-certification/azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e) |
>| openid | делегирована | Для входа пользователя в приложение myOKR с помощью проверки подлинности Майкрософт мы используем пользовательский id-объект Azure. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](https://docs.microsoft.com/microsoft-365-app-certification/azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e) |
