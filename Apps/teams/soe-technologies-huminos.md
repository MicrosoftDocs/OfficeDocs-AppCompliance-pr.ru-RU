---
title: Сведения о приложениях для huminos от SOE Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для huminos, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Ускорение производительности |
| Расположение штаб-квартиры компании | Индия |
| Страница информация о приложении | [https://www.myokr.co](https://www.myokr.co) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | Получите сведения о календаре пользователей, чтобы создать собрание 1:1 в пользовательском календаре, обновить или удалить созданные платформой myOKR и показать свободные интервалы времени | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read | делегирована | Для входа пользователя в приложение myOKR с помощью проверки подлинности Майкрософт по электронной почте используется пользовательский id-объект Azure. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
...
>| offline_access | делегирована | Azure active directory id of user | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| openid | делегирована | Для входа пользователя в приложение myOKR с помощью проверки подлинности Майкрософт мы используем пользовательский id-объект Azure. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
