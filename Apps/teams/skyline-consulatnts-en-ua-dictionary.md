---
title: Сведения о приложении для словаря EN-UA от Skyline Consulatnts
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Все доступные сведения о безопасности и соответствии для словаря EN-UA, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66564627"
---
# <a name="en-ua-dictionary"></a>Словарь EN-UA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 24 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Skyline Consulatnts корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Словарь EN-UA |
| ID | WA200004310 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Skyline Consulatnts |
| Веб-сайт компании | [https://skylineconsultants.com](https://skylineconsultants.com) |
| Условия использования приложения | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| Основные функциональные возможности приложения | English-Ukrainian приложения словаря от Skyline Consultants полностью организовано, чтобы пользователи могли искать неизвестные слова во время работы в Microsoft Teams. |
...
Эти сведения были предоставлены Skyline Consulatnts о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные хранятся в базах данных? | Наша база данных хранит сведения о том, где пользователь остановился в приложении и восстанавливает это расположение при следующем входе пользователя в приложение. Идентификатор пользователя Graph |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Microsoft.Graph; Microsoft.TeamsFx; |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Доступ к профилю пользователя | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |
