...
| Какие данные хранятся в базах данных? | данные профилей пользователей (email /name / aad object id / user profile image) |
...
| URL-адрес политики конфиденциальности | https://communitio.jp/privacy |
