---
title: Сведения о приложении для RowShare от RowShare
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Вся доступная информация о безопасности и соответствии для RowShare, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/88508c59-07a8-42e3-985d-ff0cc4148c85" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые RowShare корпорации Майкрософт:
...
| Название партнерской компании | RowShare |
...
| Основные функциональные возможности приложения | Упростите процессы администрирования с помощью совместных, защищенных и визуальных электронных таблиц. |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://www.rowshare.com/features](https://www.rowshare.com/features) |
...
Эта информация была предоставлена RowShare о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
