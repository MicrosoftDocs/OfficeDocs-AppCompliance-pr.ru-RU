---
title: Application Information for MeasureUp by Media Interactiva Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для MeasureUp, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: aefc418a00cf1c8ed882e1e150b01250a49d4a30
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881276"
---
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Media Interactiva Solutions |
| Веб-сайт компании | [https://www.measureup.com](https://www.measureup.com) |
| Условия использования приложения | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| Основные функциональные возможности приложения | Оцените навыки своей команды более эффективно с помощью MeasureUp! |
| Расположение компании | Испания |
| Страница сведений о приложении | [https://docs.measureup.com](https://docs.measureup.com) |
...
Эти сведения предоставлены решениями Media Interactiva о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Сведения профиля для регистрации и разрешения входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | Делегированные | Сведения профиля для регистрации и разрешения входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| profile | Делегированные | Сведения профиля для регистрации и разрешения входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
