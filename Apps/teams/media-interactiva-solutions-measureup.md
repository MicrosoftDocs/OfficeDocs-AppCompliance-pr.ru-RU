...
| Основные функции приложения | Оцените навыки вашей команды более эффективно с помощью MeasureUp! |
| Расположение штаб-квартиры компании | Испания |
| Страница информация о приложении | [https://docs.measureup.com](https://docs.measureup.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Сведения о профиле для регистрации и допуска входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | делегирована | Сведения о профиле для регистрации и допуска входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| profile | делегирована | Сведения о профиле для регистрации и допуска входа. При доступе пользователей к приложению данные из профиля Майкрософт необходимы для создания профиля пользователя на нашей платформе. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
