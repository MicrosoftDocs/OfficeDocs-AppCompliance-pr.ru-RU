---
title: Application Information for Cuckoo by Cuckoo Networks Oy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Вся доступная информация о безопасности и соответствии для Cuckoo, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 911bbea2a84f5601b83a189b649277a885d9b391
ms.sourcegitcommit: 3e68e819f21cd95aeb2abc018cd86af2a9dd0b1a
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/27/2022
ms.locfileid: "67053097"
---
# <a name="cuckoo"></a>Cuckoo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 20 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Просмотр в магазине Teams</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Cuckoo |
| ID | WA200002750 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Cuckoo Networks Oy |
| Веб-сайт компании | [https://cuckoo.fi](https://cuckoo.fi) |
| Условия использования приложения | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
...
| Страница сведений о приложении | [https://cuckoo.fi](https://cuckoo.fi) |
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, идентификатор клиента, имя клиента |
...
| Какие данные хранятся в базах данных? | Сведения о действиях пользователей и их идентификации |
...
| URL-адрес политики конфиденциальности | https://cuckoo.fi/en/privacy-policy/ |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Проверка подлинности пользователя в службе с помощью имени входа Майкрософт | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| email | Делегированные | Связывание клиентов с информацией о событиях приложений, доступных конкурсах и поддержке клиентов | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | Делегированные | Проверка подлинности пользователя в службе с помощью имени входа Майкрософт | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | Делегированные | Проверка подлинности пользователя в службе с помощью имени входа Майкрософт | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| profile | Делегированные | Проверка подлинности пользователя в службе с помощью имени входа Майкрософт | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
