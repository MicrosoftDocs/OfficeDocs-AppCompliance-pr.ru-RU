...
description: Все доступные сведения о безопасности и соответствия требованиям для ИИ Fireflies, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "60954018"
---
# <a name="fireflies-ai"></a>ИИ светлячков
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | ИИ светлячков |
| Идентификатор | WA200002618 |
...
| Основные функции приложения | Светлячки — это помощник собрания, который записывает, переписывает и принимает заметки из собраний.
 ...
 | | Расположение штаб-квартиры | Соединенные Штаты Америки | | Страница info приложения | | | Какова среда размещения или модель службы, используемая для запуска приложения? | Paas | | Какие поставщики облачных хостингов используют приложение? | GCP |
