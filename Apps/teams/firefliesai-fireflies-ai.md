...
| Основные функции приложения | Светлячки — это помощник собрания, который записывает, переписывает и принимает заметки из собраний.
 ...
 | | Расположение штаб-квартиры | Соединенные Штаты Америки | | Страница info приложения | [https://app.fireflies.ai/integrations/collaboration/microso...](https://app.fireflies.ai/integrations/collaboration/microsoft-teams) | | Какова среда размещения или модель службы, используемая для запуска приложения? | Paas | | Какие поставщики облачных хостингов используют приложение? | GCP |
