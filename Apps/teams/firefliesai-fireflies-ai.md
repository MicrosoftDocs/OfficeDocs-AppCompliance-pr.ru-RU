---
title: Сведения о приложении для ИИ fireflies by Fireflies.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/12/2021
...
description: 'Все доступные сведения о безопасности и соответствии требованиям для ИИ Fireflies, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/685d9120-feba-4cb0-934c-efcc69b85fc6" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002618" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Fireflies.ai Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Fireflies AI |
| ID | WA200002618 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Fireflies.ai |
| Веб-сайт компании | [https://fireflies.ai](https://fireflies.ai) |
| Условия использования приложения | [https://fireflies.ai/terms-of-service.pdf](https://fireflies.ai/terms-of-service.pdf) |
| Основные функции приложения | Светлячки — это помощник собрания, который записывает, переписывает и принимает заметки из собраний. |
| Расположение штаб-квартиры компании | США Америки |
| Страница информация о приложении | [https://app.fireflies.ai/integrations/collaboration/microso...](https://app.fireflies.ai/integrations/collaboration/microsoft-teams) |
...
Эти сведения предоставлены Fireflies.ai о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Данные профилей пользователей, метданные календаря пользователей |
...
| Самая недавняя дата сертификации SOC2 |  2021-08-18 |
...
| URL-адрес политики конфиденциальности | https://fireflies.ai/privacy_policy.pdf |
