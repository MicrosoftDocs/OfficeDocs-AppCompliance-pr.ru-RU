...
| Страница информация о приложении | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | адрес электронной почты и ids пользователей.  Он используется для картографии пользователя с id пользователя WorkBoard | [User.Read](../azure/User.Read.md) |
