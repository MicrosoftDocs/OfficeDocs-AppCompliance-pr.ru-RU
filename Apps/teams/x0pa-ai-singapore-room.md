---
title: Сведения о приложении для X0PA ROOM от X0PA AI Singapore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для X0PA ROOM, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые X0PA AI Singapore корпорации Майкрософт:
...
| Название партнерской компании | X0PA AI Singapore |
...
| Основные функциональные возможности приложения | Возможности видеоинтервьев Smart On Demand и аналитика с помощью X0PA ROOM |
| Расположение компании | Сингапур |
| Страница сведений о приложении | [https://x0paroom.com](https://x0paroom.com) |
...
Эти сведения были предоставлены X0PA AI Singapore о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
