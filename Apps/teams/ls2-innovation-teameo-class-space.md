---
title: Сведения о приложениях для пространства класса Teameo с помощью инноваций LS2
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Teameo Class Space, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт по инновациям LS2:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Teameo Class Space |
| Идентификатор | WA200003630 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | LS2 Innovation |
| Веб-сайт компании | [https://teameo.io](https://teameo.io) |
| Условия использования приложения | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| Основные функции приложения | Пространство класса Teameo позволяет преподавателям показывать сведения о курсе, приложения и ссылки. |
...
Эта информация предоставлена LS2 Innovation о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Сведения о пользователях (имя, электронная почта), сведения о клиентах (id, name) |
...
| URL-адрес политики конфиденциальности | https://teameo.io/legal/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.ReadWrite.All | приложение | Gestion de Teams App pour Espace Num&#233;rique | [05525b77-8ca6-462f-8902-15788cb405c6](https://docs.microsoft.com/microsoft-365-app-certification/azure/05525b77-8ca6-462f-8902-15788cb405c6) |
