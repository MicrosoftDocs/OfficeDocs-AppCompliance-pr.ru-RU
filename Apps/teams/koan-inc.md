...
description: Все доступные сведения о безопасности и соответствии для Koan, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 1d3568e30e633aec05de57d7d3fb81edaa9d7c42
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877216"
---
# <a name="koan"></a>Koan
...
* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Koan, Inc. корпорации Майкрософт:
...
| Название партнерской компании | Koan, Inc. |
| Веб-сайт компании | [https://www.koan.co](https://www.koan.co) |
| Условия использования приложения | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| Основные функциональные возможности приложения | Используйте функции управления и отслеживания состояния Microsoft Teams, чтобы отслеживать ход выполнения и поддерживать соответствие команд. Интеграция&#8217;Koan позволяет сотрудникам сосредоточиться на работе, которая наиболее важна, не выходя из Microsoft Teams. Легко создавайте положительные привычки к совместному использованию состояния, распознаванию выигрышей и выявлению проблем на раннем этапе, вызывая планку для всех остальных вокруг них. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
Эта информация была предоставлена Koan, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2021-01-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Делегированные | Используются идентификатор канала и имя канала. Мы используем эти данные, чтобы пользователи могли выбрать, куда они хотят доставить уведомления отражения. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | Как | Идентификатор команды и имя команды собираются и используются. Мы используем эти данные, чтобы пользователи могли выбрать, куда они хотят доставить уведомления отражения. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | Делегированные | Используются имя пользователя, идентификатор пользователя, адрес электронной почты пользователя. Эти данные используются для связывания учетных записей пользователей между Microsoft Teams и Koan. Он применяется только для упоминаний. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
