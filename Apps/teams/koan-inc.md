...
description: Все доступные сведения о безопасности и соответствия требованиям для Koan, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Принесите управление и отслеживание состояния целей непосредственно в Microsoft Teams, чтобы увидеть прогресс и сохранить соответствие команд. Интеграция koan&#8217;позволяет сотрудникам сосредоточиться на работе, которая имеет наибольшее значение, не покидая Microsoft Teams. Легко создайте положительные привычки совместной работы, распознавая победы и выявляя проблемы на ранних стадиях, повышая планку для всех окружающих. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
| Самая недавняя дата сертификации SOC2 |  2021-01-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | делегирована | Используется id канала и имя канала. Мы используем данные, чтобы пользователи могли выбрать, куда они хотят доставить уведомления reflection. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | оба | Ид команды, и имя команды собираются и используются. Мы используем данные, чтобы пользователи могли выбрать, куда они хотят доставить уведомления reflection. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | делегирована | Используется имя пользователя, пользовательский id, адрес электронной почты пользователя. Эти данные используются для связи учетных записей пользователей между Microsoft Teams и Koan. Применяется только для упоминаний. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
