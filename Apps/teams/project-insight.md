---
title: Application Information for Project Insight by Project Insight
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Вся доступная информация о безопасности и соответствии для Project Insight, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Project Insight для Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Project Insight |
| Идентификатор | WA200003171 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Project Insight |
...
| Основные функциональные возможности приложения | Project Insight позволяет вашей команде управлять работой, проектами, временем и расходами непосредственно из Teams. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
Эти сведения предоставлены Project insight о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Основные сведения о профиле пользователя |
...
| Какие данные хранятся в базах данных? | Идентификатор учетной записи пользователя |
...
| Дата последней сертификации SOC1 | 2022-01-18 |
...
| Дата последней сертификации SOC2 | 2022-01-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | Делегированные | Чтобы разрешить установку приложения для пользователей в Microsoft Teams клиента | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | Делегированные | Сопоставление пользователей между нашей системой и клиентом Microsoft Teams клиента | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | Делегированные | Используется для запроса маркера обновления | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
