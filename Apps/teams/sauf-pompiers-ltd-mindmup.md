...
description: Все доступные сведения о безопасности и соответствия требованиям для MindMup, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | MindMup позволяет пользователям легко визуализировать идеи с помощью карт разума, схем пауков, карт концепции, визуализации аргументов и иерархических диаграмм. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams.ReadBasic.All | делегирована | идентификаторы и имена команд для пользователей | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | делегирована | Идентификатор пользователя, адрес электронной почты для отображения после проверки подлинности | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
