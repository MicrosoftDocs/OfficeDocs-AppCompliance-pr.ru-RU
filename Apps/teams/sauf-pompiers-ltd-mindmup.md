...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Системы хранения AWS, используемые для сохраняемой базовой информации профилей пользователей, для поддержки обмена документами и обеспечения доступа к документам пользователей в MindMup |  | Недоступно |
