---
title: Application Information for MindMup by SaufCodeiers Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Вся доступная информация о безопасности и соответствии для MindMup, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 308dbcd4c0773c89f90e3913f4ffbaebed2d46d3
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879656"
---
...
* <a href="https://teams.microsoft.com/l/app/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставленные SaufCodeiers Ltd корпорации Майкрософт:
...
| Название партнерской компании | Sauf Pompiers Ltd |
| Веб-сайт компании | [https://www.mindmup.com](https://www.mindmup.com) |
| Условия использования приложения | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| Основные функциональные возможности приложения | MindMup позволяет пользователям легко визуализировать идеи с помощью карт с виду, схем, схем концепций, визуализаций аргументов и иерархических диаграмм. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
Эта информация была предоставлена SaufCodeiers Ltd о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams.ReadBasic.All | Делегированные | идентификаторы команд и имена команд для пользователей; | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | Делегированные | Идентификатор пользователя, адрес электронной почты для отображения после проверки подлинности | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
