---
title: Сведения о приложении для HitHorizons от FinStat s.r.o.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/18/2022
...
| Основные функциональные возможности приложения | Доступ к базе данных HitHorizons более чем 75 млн компаний из Европы и других Microsoft Teams |
| Расположение компании | Словакия |
| Страница сведений о приложении | [https://www.hithorizons.com/services/microsoft/teams](https://www.hithorizons.com/services/microsoft/teams) |
...
Эти сведения предоставлены finStat s.r.o. о том, как это приложение собирает и сохраняет данные организации, а также о том, как ваша организация будет управлять данными, собираемые приложением.
