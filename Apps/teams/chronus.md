---
title: Сведения о приложении для Chronus by Chronus
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Все доступные сведения о безопасности и соответствии для Chronus, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb32d4e5-ae29-4c59-ba7e-a11611ca9710" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Chronus корпорации Майкрософт:
...
| Название партнерской компании | Chronus |
| Веб-сайт компании | [https://chronus.com](https://chronus.com) |
| Условия использования приложения | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| Основные функциональные возможности приложения | Программное обеспечение Chronus предоставляет тысячи успешных программ наставничества для некоторых&#8217;крупных организаций. Мы упрощаем запуск, управление и измерение влияния на наставничества.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://chronus.com/services](https://chronus.com/services) |
...
Эти сведения предоставлены Chronus о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
