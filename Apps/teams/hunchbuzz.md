...
<span data-ttu-id="e0cd5-108">Сведения, предоставляемые Корпорацией Майкрософт hunchBuzz:</span><span class="sxs-lookup"><span data-stu-id="e0cd5-108">Information provided by HunchBuzz to Microsoft:</span></span>
