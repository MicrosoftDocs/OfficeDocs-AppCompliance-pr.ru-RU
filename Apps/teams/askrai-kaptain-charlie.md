---
title: Application Information for Luctain Чтобы askR.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для Пользователем, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 7ce562169eb60e58f40b252badafea4a7497e161
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64881416"
---
...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | askR.ai |
...
| Основные функциональные возможности приложения | Чат с данными! askR.ai ваш помощник по персональным данным. У вас есть данные, но вам не нравится технический процесс для доступа к ним? Используйте помощник по обработке данных, чтобы ответить на свои вопросы и помочь вам в изучении! Что askR.ai первый помощник по обработке данных на Microsoft Teams? - Помощник по персональным данным на основе искусственного интеллекта. Предоставляет мгновенные ключевые показатели эффективности и данные в viz. Общие сведения об определенном бизнес-словаре . Отправка оповещений — предложить дополнительный анализ |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://en.askr.ai](https://en.askr.ai) |
...
Эти сведения были предоставлены askR.ai о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://en.askr.ai/terms-of-use-askr-ai |
...
| Если приложение не использует одну из указанных выше библиотек, какую библиотеку или библиотеки проверки подлинности оно использует? | Библиотека OAuth |
