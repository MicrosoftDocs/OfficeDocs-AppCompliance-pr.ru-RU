...
description: Вся доступная информация о безопасности и соответствии требованиям для Geekbot, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://geekbot.com](https://geekbot.com) |
| Условия использования приложения | [https://geekbot.com/tos/](https://geekbot.com/tos/) |
| Основные функции приложения | Запустите асинхронные стендапы, ретроспективы и опросы, делясь знаниями группы по часовым поясам. |
| Расположение штаб-квартиры компании | Кипр |
| Страница информация о приложении | [https://help.geekbot.com/en/](https://help.geekbot.com/en/) |
...
| Какие данные хранятся в базах данных? | Данные профилей пользователей, данные электронной почты пользователей, Microsoft Teams командные данные (ID группы, данные каналов), отчеты |
...
| URL-адрес политики конфиденциальности | https://geekbot.com/privacy/ |
