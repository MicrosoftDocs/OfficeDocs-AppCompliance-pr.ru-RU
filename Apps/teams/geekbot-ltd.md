...
| Какие данные хранятся в базах данных? | Данные профилей пользователей, данные почты пользователей, Microsoft Teams командные данные (ID группы, данные каналов), отчеты |
