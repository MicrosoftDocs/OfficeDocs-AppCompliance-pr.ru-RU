---
title: Сведения о приложениях для командного трекера от Team Tracker Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Team Tracker, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставленные Team Tracker Ltd в Корпорацию Майкрософт:
...
| Имя компании-партнера | Team Tracker Ltd |
...
| Основные функции приложения | Team Tracker — это первое приложение пользователя для бронирования горячих столов и отслеживание рабочих |
...
Эта информация предоставлена Team Tracker Ltd о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | После того как пользователь задает свои действия на ближайшие недели, Team Tracker обновляет календарь пользователей и их доступность в зависимости от их выбора.  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| MailboxSettings.Read | делегирована | Используется для получения пояса времени для создания событий календаря | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| User.Read | делегирована | Проверяет сведения пользователей по их профилю | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| email | делегирована | Используется для проверки электронной почты пользователей | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| openid | делегирована | Позволяет пользователям войти со своей Office 365 учетной записью | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| profile | делегирована | Проверяет основные сведения пользователей по их профилю | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
