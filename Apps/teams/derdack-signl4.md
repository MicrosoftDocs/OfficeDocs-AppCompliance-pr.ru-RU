---
title: Сведения о приложении для SIGNL4 от Derdack SIGNL4
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Все доступные сведения о безопасности и соответствии для SIGNL4, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "66845021"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 15 июля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">Просмотр в магазине Teams</a>
...
Сведения, предоставляемые Derdack SIGNL4 корпорации Майкрософт:
...
| Название партнерской компании | Derdack SIGNL4 |
| Веб-сайт компании | [https://www.derdack.com](https://www.derdack.com) |
| Условия использования приложения | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| Основные функциональные возможности приложения | Derdack SIGNL4 позволяет оповещений мобильных устройств и реагирование на инциденты в любом месте для операционной критической инфраструктуры. Он поддерживает операции и команды по включению. |
| Расположение компании | Германия |
| Страница сведений о приложении | [https://www.signl4.com](https://www.signl4.com) |
...
Эта информация была предоставлена Derdack SIGNL4 о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | адрес электронной почты; |
...
| Какие данные хранятся в базах данных? | адрес электронной почты |
...
| URL-адрес политики конфиденциальности | https://www.signl4.com/privacy-policy/ |
