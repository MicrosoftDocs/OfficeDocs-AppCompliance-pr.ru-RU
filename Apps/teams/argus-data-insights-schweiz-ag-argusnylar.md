---
title: Сведения о приложении ДЛЯ ИНСТРУКЦИИ ПО БЕЗОПАСНОСТИ ИИ СЛУЖБЫ БЕЗОПАСНОСТИ AZURE DATA INSIGHTS Schweiz
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Вся доступная информация о безопасности и соответствии требованиям для СЛУЖБЫ ИНСТРУКЦИЙ ПО, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 7fccaf2f01c43fe774ea272e38e5d338c526d13f
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879826"
---
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые ГРУППЕ доступности SCHweiz DATA INSIGHTS ДЛЯ СЛУЖБЫ ШИФРОВАНИЯ ДЛЯ Майкрософт:
...
| Название партнерской компании | ARGUS DATA INSIGHTS Schweiz AG |
| Веб-сайт компании | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| Условия использования приложения | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| Основные функциональные возможности приложения | ИНСТРУКЦИЯ ИНСТРУКЦИЯ ПОВМЕХ является полезным расширением для вашей учетной записи. |
| Расположение компании | Швейцария |
| Страница сведений о приложении | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
Эти сведения предоставлены в ГРУППЕ доступности ИНСТРУКЦИИ ПО ПО DATA INSIGHTS Schweiz о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | приложение | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
