---
title: Сведения о приложении для отсутствующих решений BrainCore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для отсутствующих данных, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Просмотр в Teams хранилище</a>
...
| Название партнерской компании | Решения BrainCore |
...
| Основные функциональные возможности приложения | Самый простой способ обработки отгулов сотрудников — в Microsoft Teams |
| Расположение компании | Швейцария |
| Страница сведений о приложении | [https://absentify.com](https://absentify.com) |
...
Эти сведения предоставлены решениями BrainCore о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Microsoft User ID,Email,DisplayName |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | приложение | Необязательное. Отправка уведомлений в Microsoft Teams. | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | Делегированные | Необязательно. Автоматическое создание записи Outlook для отсутствия. | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | Делегированные | Для входа | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | Делегированные | Необязательно. Чтобы просмотреть изображения пользователей в профиле Майкрософт. | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
