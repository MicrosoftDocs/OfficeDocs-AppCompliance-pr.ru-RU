...
description: Все доступные сведения о безопасности и соответствия требованиям для DELTAoverC, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | DELTAoverC предназначен для поддержки организационных изменений и преобразований, предоставляя внутренним лидерам эффективные данные уровня команды во время инициативы изменений, что позволяет им эффективно решать проблемы устойчивости к изменениям или низкой вовлеченности. Максимальное вовлечение — отслеживание результатов взаимодействия в режиме реального времени для обеспечения процветания групп во время сбоя. Уменьшение риска и усилий — анализ данных уровня персонала, чтобы предугадать проблемы, прежде чем эти спирали будут вылиться в серьезные проблемы. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://DELTAoverC.info/change-application](https://DELTAoverC.info/change-application) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | оба | Чтение всех групп | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | оба | Чтение и запись всех групп | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read | делегирована | Вход и чтение профиля пользователя | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
...
>| User.ReadWrite | делегирована | Доступ для чтения и записи к профилю пользователя | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite.All | оба | Чтение и написание полных профилей всех пользователей | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
