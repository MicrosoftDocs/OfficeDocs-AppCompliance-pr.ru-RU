---
title: Application Information for Micromate by Paixon GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии для Micromate, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: db7d54237f2d74fef14e404f3d1d9a94d8975920
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880616"
---
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Paixon GmbH корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Micromate |
| Идентификатор | WA200002981 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Paixon GmbH |
| Веб-сайт компании | [https://paixon.ch](https://paixon.ch) |
| Условия использования приложения | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| Основные функциональные возможности приложения | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausspielung von Quizzes in Form von Adaptive Cards. Die pers&#246;nliche Ansprache des Lernenden, ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Natzung. |
| Расположение компании | Швейцария |
| Страница сведений о приложении | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | Cloudscale |
...
Эти сведения предоставлены Paixon GmbH о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
