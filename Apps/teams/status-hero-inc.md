---
title: Application Information for Status Hero by Status Hero, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Все доступные сведения о безопасности и соответствии для имиджевого баннера о состоянии, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 64d376be4639d9da663483748e34638df0d79ec7
ms.sourcegitcommit: cede428f2a23bd3060f5506f270b40b327b02769
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66549596"
---
# <a name="status-hero"></a>Главный имиджевый баннер состояния

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 3 мая 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые status Hero, Inc. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Главный имиджевый баннер состояния |
| ID | WA200004205 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Status Hero, Inc. |
| Веб-сайт компании | [https://statushero.com](https://statushero.com) |
| Условия использования приложения | [https://statushero.com/terms](https://statushero.com/terms) |
| Основные функциональные возможности приложения | Главный имиджевый баннер состояния преобразует асинхронные возвраты и данные из средств вашей команды в краткие аналитические отчеты. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Эта информация была предоставлена status Hero, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2021-11-01 |
...
| URL-адрес политики конфиденциальности | https://statushero.com/privacy |
