---
title: Сведения о приложениях для помощника по обучению с помощью платформы Bot
ms.author: elmalova
author: elenamalova
ms.date: 12/07/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для помощника по обучению, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "62148837"
---
# <a name="training-assistant"></a>Помощник по обучению

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 2 августа 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые платформой Бот в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Помощник по обучению |
| Идентификатор | WA200003547 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Платформа ботов |
| Веб-сайт компании | [https://thebotplatform.com](https://thebotplatform.com) |
| Условия использования приложения | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| Основные функции приложения | Этот цифровой помощник принимает вас на ряд учебных модулей, которые охватывают все, что вам нужно знать, чтобы настроить и работать над Teams. Каждый модуль содержит отдельные обучающие видео и обучающие материалы, чтобы убедиться, что сотрудники полностью осведомлены о широте функций, доступных в Microsoft Teams, и о том, как их использовать. |
...
Эта информация была предоставлена платформой Бот о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Имя |
...
| URL-адрес политики конфиденциальности | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
