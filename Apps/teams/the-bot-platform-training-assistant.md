...
description: Все доступные сведения о безопасности и соответствия требованиям для training Assistant, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Этот цифровой помощник принимает вас на ряд учебных модулей, которые охватывают все, что вам нужно знать, чтобы настроить и работать над Teams. Каждый модуль содержит определенные обучающие видео и обучающие материалы, чтобы убедиться, что сотрудники полностью осведомлены о широте функций, доступных в Microsoft Teams, а также о том, как их использовать. |
