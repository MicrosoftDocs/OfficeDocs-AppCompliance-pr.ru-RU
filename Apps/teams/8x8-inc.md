...
description: Все доступные сведения о безопасности и соответствия требованиям для 8x8, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | 8x8 Voice — это облачная служба прямой маршрутивки для звонков PSTN. Родной опыт работы с корпоративной телефонией + возможностями контакт-центра. Неограниченные планы звонков в 47 странах + служба замены PSTN в 43 странах, аналитика, SMS, MMS и факс. Получите экономические планы звонков на местном или международном уровне и расширяйте вызовЫ PSTN в страны, в которых Корпорация Майкрософт еще&#8217;пока не предлагает планы, чтобы получить больше всего от Microsoft 365. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | AWS, OracleCloud |
