---
title: Сведения о приложении для 8x8 на 8x8, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для версии 8x8, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 2c22bc4d9751d16a282e922af68ad33bc5ba7bbb
...
* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые 8x8, Inc корпорации Майкрософт:
...
| Название партнерской компании | 8x8, Inc |
| Веб-сайт компании | [https://www.8x8.com](https://www.8x8.com) |
| Условия использования приложения | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| Основные функциональные возможности приложения | Голосовая связь 8x8 — это облачная служба прямой маршрутизации для выполнения и получения вызовов ТСОП. Собственный опыт работы с телефонией корпоративного уровня и возможностями центра контактов. Неограниченные планы звонков в 47 странах + служба замены ТСОП в 43 странах, аналитика, SMS, MMS и факс. Получите экономичные планы звонков локально или на международной основе и расширите звонки по ТСОП в страны, в которых корпорация Майкрософт еще&#8217;пока не предлагает планы, чтобы максимально эффективно использовать Microsoft 365. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | AWS, OracleCloud |
...
Эти сведения предоставлены корпорацией 8x8, Inc о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
