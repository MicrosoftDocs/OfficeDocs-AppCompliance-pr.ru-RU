---
title: Сведения о приложениях для Ideanote по ApS Ideanote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Вся доступная информация о безопасности и соответствия требованиям для Ideanote, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые службой ApS Ideanote в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Ideanote |
| Идентификатор | WA200003876 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Ideanote ApS |
| Веб-сайт компании | [https://ideanote.io](https://ideanote.io) |
| Условия использования приложения | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Основные функции приложения | Сбор, разработка и управление идеями с помощью целеуправляемой инновации. |
| Расположение штаб-квартиры компании | Дания |
| Страница информация о приложении | [https://ideanote.io](https://ideanote.io) |
...
Эта информация предоставлена ApS Ideanote о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Сведения о маркере JWT, полученном от пользователя. Имя пользователя, электронная почта пользователя. |
...
| URL-адрес политики конфиденциальности | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | делегирована | Нам нужны сведения о пользователе, чтобы автоматически войти в его учетную запись Ideanote. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
