---
title: Application Information for MyCheckins by Cloud Catalogs LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Все доступные сведения о безопасности и соответствии для MyCheckins, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 0a73dd69ea5cf4a58312bb4bc83797281a590646
ms.sourcegitcommit: 9e5c6c3b4885bc6fa0a4af61432c86a232bc7ec9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/15/2022
ms.locfileid: "66819049"
---
# <a name="mycheckins"></a>MyCheckins

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 7 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт в cloud Catalogs LLC:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | MyCheckins |
| ID | WA200004375 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Cloud Catalogs LLC |
| Веб-сайт компании | [https://mycheckins.io](https://mycheckins.io) |
| Условия использования приложения | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Основные функциональные возможности приложения | Запустите асинхронные резервные копии, ретроспективы и т. д. в Microsoft Teams. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://mycheckins.io](https://mycheckins.io) |
...
Эти сведения были предоставлены LLC облачных каталогов о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, Email, сообщения пользователя, отправляемые боту |
...
| Какие данные хранятся в базах данных? | Данные профиля пользователя, Email, сообщения пользователя, отправляемые боту |
...
| URL-адрес политики конфиденциальности | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | приложение | Получение сведений о пользователе, таких как имя, фамилия и адрес электронной почты | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
