---
title: Сведения о приложении skyPoint Cloud от SkyPoint Cloud Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/21/2022
...
description: Вся доступная информация о безопасности и соответствии для SkyPoint Cloud, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 529374422a831716157d3c894fe032e4ab624c91
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64880566"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 21 февраля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые SkyPoint Cloud Inc. корпорации Майкрософт:
...
| Название партнерской компании | SkyPoint Cloud Inc. |
| Веб-сайт компании | [https://skypointcloud.com](https://skypointcloud.com) |
| Условия использования приложения | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| Основные функциональные возможности приложения | SkyPoint помогает торговых марок узнать своих клиентов, принимать стратегические решения и последовательно принимать правильные меры, чтобы лучше обслуживать своих потребителей и продолжать расти их бизнес. Мы — это платформа данных клиента, которая предоставляет интеллектуальные возможности для управления данными и объединения, обеспечения соответствия конфиденциальности, аналитики и аналитики, а также активации.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
Эта информация была предоставлена SkyPoint Cloud Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
