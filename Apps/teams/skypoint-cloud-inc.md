...
description: Все доступные сведения о безопасности и соответствия требованиям для SkyPoint Cloud, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: aa874bae0dafde0dcdf486c62460f445c42e018f
ms.sourcegitcommit: 58c50d1704196178455927329748485b40dd7880
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/17/2022
ms.locfileid: "63542117"
---
...
| Основные функции приложения | SkyPoint помогает брендам узнать своих клиентов, принять стратегические решения и последовательно принимать правильные меры, чтобы лучше обслуживать своих потребителей и продолжать развивать свой бизнес. Мы клиентская платформа данных, которая предоставляет интеллектуальные возможности по управлению данными и объединению, соблюдению конфиденциальности, аналитике и аналитике, а также активации.  |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
