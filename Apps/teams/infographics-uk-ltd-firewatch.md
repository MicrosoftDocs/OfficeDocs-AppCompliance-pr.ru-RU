...
| Основные функции приложения | FireWatch Подключение позволяет службам пожарной и спасательной службы интегрировать приложение FireWatch с Microsoft Teams, чтобы пользователи могли выполнять задачи непосредственно Microsoft Teams. В настоящее время она предоставляет поддержку и помощь пользователям с помощью Microsoft Teams бота для записи на учет и отключение непосредственно в Microsoft Teams пользовательской среде. Будущие выпуски будут включать поддержку дальнейших действий с помощью ботов и карт, включая запросы на праздник FireWatch, напоминания о задачах и т. д. |
