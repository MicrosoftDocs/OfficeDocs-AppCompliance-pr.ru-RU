...
| Основные функции приложения | FireWatch Подключение позволяет службам пожарной и спасательной службы интегрировать приложение FireWatch с Microsoft Teams, чтобы пользователи могли выполнять задачи непосредственно в Microsoft Teams. В настоящее время он предоставляет поддержку и помощь пользователям с помощью Microsoft Teams бота для записи on/off duty непосредственно в Microsoft Teams пользовательской среде. Будущие выпуски будут включать поддержку дальнейших действий с помощью ботов и карт, включая запросы на праздник FireWatch, напоминания о задачах и т. д. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
