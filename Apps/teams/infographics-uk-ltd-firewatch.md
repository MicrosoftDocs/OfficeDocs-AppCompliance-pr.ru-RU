---
title: Application Information for FireWatch by Infographics UK Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Вся доступная информация о безопасности и соответствии для FireWatch, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 4d0bd23086ef4decd8c88bcd49168a787f84f6b2
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64879326"
---
...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые infographics UK Ltd. корпорации Майкрософт:
...
| Название партнерской компании | Infographics UK Ltd. |
| Веб-сайт компании | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| Условия использования приложения | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| Основные функциональные возможности приложения | FireWatch Подключение позволяет службам аварийного восстановления интегрировать приложение FireWatch с Microsoft Teams, чтобы пользователи могли выполнять задачи непосредственно в Microsoft Teams. В настоящее время он предоставляет поддержку и помощь пользователей через Microsoft Teams Bot для регистрации и отключения обязанностей непосредственно в Microsoft Teams пользовательской среде. В будущих выпусках будет включена поддержка дальнейших действий с помощью ботов и карточек, включая запросы на праздники FireWatch, напоминания о задачах и т. д. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
Эта информация была предоставлена infographics UK Ltd. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
