---
title: Application Information for Coachello by Coachello SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/29/2022
...
description: Вся доступная информация о безопасности и соответствии для Coachello, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f24e948ecd0c74481a7ef1dced44bbda699d837d
ms.sourcegitcommit: 878a7b7e9c6fe787c6dfc9c95d4d46268562f84c
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/30/2022
ms.locfileid: "67096678"
---
# <a name="coachello"></a>Coachello

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 4 марта 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/b6b8f190-e24d-4387-937f-8683cc78a6d4" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003997" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые SaS Для Coachello корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Coachello |
| ID | WA200003997 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | Coachello SAS |
| Веб-сайт компании | [https://coachello.io](https://coachello.io) |
| Условия использования приложения | [https://www.coachello.io/terms-and-conditions](https://www.coachello.io/terms-and-conditions) |
| Основные функциональные возможности приложения | Помогая актерам развиваться за счет высококачественного обучения по запросу через MS Teams. В приложении Coachello можно выполнить оценку, выбрать своего руководителя и работать с ним во время 1:1 сеансов обучения. |
| Расположение компании | Франция |
| Страница сведений о приложении | [https://resources.coachello.io/teams-client-manual](https://resources.coachello.io/teams-client-manual) |
| Какая среда размещения или модель службы используются для запуска приложения? | Paas |
| Какие поставщики облачных служб используются приложением? | Aws, netlify |
...
Эта информация была предоставлена SaS в Coachello о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Имена пользователей, оценка удовлетворенности сеанса, результаты оценок |
...
| Какие данные хранятся в базах данных? | Имена пользователей, оценка удовлетворенности сеанса, результаты оценок |
...
| URL-адрес политики конфиденциальности | https://coachello.io/privacy-policy/ |
...
| Перечисление поддерживаемых типов политик | Планы Freemium + Premium |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.ReadWrite | приложение | Чтобы позволить ему запланировать собрания непосредственно в своем календаре с помощью выбранного им организатора по выбранной теме | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| User.Read | приложение | Чтобы адаптировать интерфейс приложения к языку и расположению пользователя  | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| email | приложение | Чтобы упростить сеансы обучения 1:1 с нашими тренерами (подтверждение резервирования) | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| openid | приложение | Для безопасного входа пользователя в Coachello | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| profile | приложение | Чтобы персонализировать взаимодействие с пользователем в приложении Coachello | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
