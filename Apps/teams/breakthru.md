---
title: Сведения о приложении для breakthru by Breakthru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Breakthru, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "65152096"
---
# <a name="breakthru"></a>Breakthru

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 28 апреля 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/693aa4f0-e16c-11ea-ab9b-11514b3de7ae" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые корпорацией Майкрософт breakthru:
...
| Название партнерской компании | Breakthru |
| Веб-сайт компании | [https://breakthru.me](https://breakthru.me) |
| Условия использования приложения | [https://breakthru.me/terms](https://breakthru.me/terms) |
| Основные функциональные возможности приложения | Небольшие разрывы для совместного использования и воспроизведения, встроенные прямо в ваш день. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://breakthru.me](https://breakthru.me) |
...
Эта информация была предоставлена breakthru о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные хранятся в базах данных? | Адрес электронной почты. Microsoft Teams идентификатор клиента. Microsoft Teams идентификатора. Мы ведите журнал выбранных разрывов и разрешаем вам настраивать напоминания для участия в разрыве. |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | США Америки, Германии, Соединенного Королевства, Северной Ирландии и Северной Ирландии |
...
| URL-адрес политики конфиденциальности | https://breakthru.me/privacy#h.wc7yv5k6csnq |
