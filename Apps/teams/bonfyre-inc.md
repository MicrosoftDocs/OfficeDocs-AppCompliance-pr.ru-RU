...
| Страница сведений о приложении | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Эта информация была предоставлена Bonfyre, Inc о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Пользователь отправил содержимое и данные профиля пользователя. |
...
| Какие данные хранятся в базах данных? | Имена пользователей, адреса электронной почты и изображения профилей.  Эти сведения могут быть предварительно предоставлены во время подключения клиентов, но мы синхронизируются с профилями пользователей, чтобы поддерживать информацию в актуальном состоянии. |
