...
Сведения, предоставленные Bao Le Duc Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Standup Alice |
| Идентификатор | WA200000758 |
| Возможности | Bot |
...
Эта информация предоставлена Bao Le Duc о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
>|:-------------------|:--------------------------|:--------------------------|
>| Облако Google — мы хозяймы бота в облаке Google |  | Н/Д |
...
>Он хранится в облаке Google, и у нас есть 2FA для доступа к облаку Google.
...
<iframe height='1020' title='Microsoft Cloud App Security Сведения' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35837' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35837" target="_blank">Просмотр на новой вкладке</a>
