---
title: Сведения о приложении для Mentimeter by Mentimeter
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Все доступные сведения о безопасности и соответствии для Mentimeter, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые Mentimeter корпорации Майкрософт:
...
| Название партнерской компании | Mentimeter |
| Веб-сайт компании | [https://www.mentimeter.com](https://www.mentimeter.com) |
| Условия использования приложения | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| Основные функциональные возможности приложения | Привлечение участников с помощью опросов, тестов, облаков Word, QA&amp; и других функций для сбора входных данных в режиме реального времени.  |
| Расположение компании | Швеция |
| Страница сведений о приложении | [https://www.mentimeter.com/features](https://www.mentimeter.com/features) |
...
Эти сведения были предоставлены Mentimeter о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
