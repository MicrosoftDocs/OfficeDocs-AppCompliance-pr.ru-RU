---
title: Сведения о приложениях для quitch by Quitch
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для Quitch, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f2125454-678c-4f97-90cc-dfe4742f4711" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003683" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Quitch в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Quitch |
| ID | WA200003683 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Quitch |
| Веб-сайт компании | [https://quitch.com](https://quitch.com) |
| Условия использования приложения | [https://quitch.com/user-terms-of-service/](https://quitch.com/user-terms-of-service/) |
| Основные функции приложения | Интерактивные викторины для Microsoft Teams собраний |
| Расположение штаб-квартиры компании | Австралия |
| Страница информация о приложении | [https://quitch.com/microsoft-teams/](https://quitch.com/microsoft-teams/) |
...
Эта информация была предоставлена quitch о том, как это приложение собирает и хранит организационные данные и контроль, который будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Собираются только сообщения электронной почты пользователей |
...
| URL-адрес политики конфиденциальности | https://quitch.com/privacy-policy/ |
