...
description: Все доступные сведения о безопасности и соответствия требованиям для workhub BRAVO, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Имя компании-партнера | GmbH решений Coeus |
...
| Какие данные хранятся в базах данных? | Мы храним Microsoft Teams и team Id в нашей базе данных. |
