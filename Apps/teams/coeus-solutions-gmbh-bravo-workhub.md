---
title: Сведения о приложениях для workhub BRAVO от Coeus Solutions GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для workhub BRAVO, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/53ab3c45-3531-47a8-b524-fe8b5fd539ef" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003694" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые GmbH coeus Solutions для Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | BRAVO Workhub |
| ID | WA200003694 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | Coeus Solutions GmbH |
| Веб-сайт компании | [https://getbravo.io](https://getbravo.io) |
| Условия использования приложения | [https://getbravo.io/terms-and-conditions](https://getbravo.io/terms-and-conditions) |
| Основные функции приложения | Легко даем одноранговую награду с Microsoft Teams с BRAVO. |
...
Эти сведения предоставлены GmbH Coeus Solutions о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Мы храним Microsoft Teams пользователя и team Id в нашей базе данных. |
...
| URL-адрес политики конфиденциальности | https://getbravo.io/privacy-policy |
