---
title: Сведения о приложениях для PayaFy от NimbleSoft Inc.
ms.author: elmalova
author: elenamalova
ms.date: 10/28/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для PayaFy, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Просмотр в Teams магазине</a>
...
Сведения, предоставляемые корпорацией Майкрософт компанией NimbleSoft Inc.
...
| Имя компании-партнера | NimbleSoft Inc. |
...
| Основные функции приложения | PayaFy позволяет предприятиям принимать платежи. Можно связать существующую учетную запись Stripe или зарегистрировать новую. |
...
Эти сведения предоставлены компанией NimbleSoft Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | оба | Он будет читать основные сведения, используемые для регистрации пользователей. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](https://docs.microsoft.com/microsoft-365-app-certification/azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b) |
