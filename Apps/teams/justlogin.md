---
title: Сведения о приложении для JustLogin от JustLogin
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для JustLogin, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
ms.locfileid: "66564638"
---
# <a name="justlogin"></a>JustLogin

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчиком: 28 июня 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/cfbb8888-3227-45fc-a4b7-423af170defa" target="_blank">Просмотр в магазине Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004314" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые justLogin корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | JustLogin |
| ID | WA200004314 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | JustLogin |
| Веб-сайт компании | [https://justlogin.com](https://justlogin.com) |
| Условия использования приложения | [https://justlogin.com/terms/](https://justlogin.com/terms/) |
| Основные функциональные возможности приложения | JustLogin — понятное для сотрудников программное обеспечение для управления персоналом. |
...
Эта информация была предоставлена JustLogin о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| URL-адрес политики конфиденциальности | https://justlogin.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Делегированные | требуется электронная почта для входа в JustLogin через единый вход | [af5883db-bda9-4d1a-b1ce-022bea20f021](../azure/af5883db-bda9-4d1a-b1ce-022bea20f021.md) |
