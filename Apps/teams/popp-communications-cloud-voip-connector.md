...
description: Вся доступная информация о безопасности и соответствии требованиям для соединитетеля popp Cloud VoIP, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Вызовы из Microsoft Teams с помощью клиента MaxUC |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | делегирована | Пользовательские ИД и отображают имена участников текущего канала. Приложение использует это, чтобы представить пользователю список участников канала для вызова. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| Chat.Read | делегирована |  Какие данные собираются или используются? Добавьте обоснование для сбора или использования данных. Пользовательские ИД и отображают имена участников текущего чата. Приложение использует это, чтобы представить пользователю список участников чата для вызова. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| TeamMember.Read.All | делегирована | Пользовательские ИД и отображение имен членов текущей команды. Приложение использует это, чтобы представить пользователю список участников группы для вызова. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| User.Read.All | делегирована |  Какие данные собираются или используются? Добавьте обоснование для сбора или использования данных. Номера бизнес-и мобильных телефонов пользователей. Это необходимо для того, чтобы можно было инициировали телефонные звонки на эти номера. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| openid | делегирована | Маркер авторизации для пользователя, разрешающий приложению доступ к Graph конечным точкам API, перечисленным от их имени. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
