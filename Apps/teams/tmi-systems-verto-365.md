---
title: Сведения о приложении для Verto 365 по системам TMI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/14/2021
...
description: Вся доступная информация о безопасности и соответствии для Verto 365, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b27c082b-9d45-490a-b8bb-8dcda46c73f3" target="_blank">Просмотр в Teams хранилище</a>
...
Сведения, предоставляемые системами TMI корпорации Майкрософт:
...
| Название партнерской компании | TMI Systems |
| Веб-сайт компании | [https://www.vertocloud.co.uk](https://www.vertocloud.co.uk) |
| Условия использования приложения | [https://vertocloud.co.uk/terms-and-conditions/](https://vertocloud.co.uk/terms-and-conditions/) |
| Основные функциональные возможности приложения | Verto365 позволяет Microsoft Teams стать полным средством управления проектами |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.vertocloud.com](https://www.vertocloud.com) |
...
Эти сведения предоставлены системами TMI о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Делегированные | Общие сведения о пользователе, имя, фамилия электронной почты &amp; . Используется для создания учетной записи. | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| email | Делегированные | Общие сведения о пользователе, имя, фамилия электронной почты &amp; . Используется для создания учетной записи. | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| offline_access | Делегированные | Используется для получения маркеров обновления и сохранения имени входа | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| openid | Делегированные | Общие сведения о пользователе, имя, фамилия электронной почты &amp; . Используется для создания учетной записи. | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| profile | Делегированные | Общие сведения о пользователе, имя, фамилия электронной почты &amp; . Используется для создания учетной записи. | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
