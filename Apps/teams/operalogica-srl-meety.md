...
| Какие данные обрабатываются приложением? | Электронная почта, имя, фамилия, вставленное собрание |
...
| Какие данные хранятся в базах данных? | Электронная почта, имя, фамилия, вставленное собрание |
