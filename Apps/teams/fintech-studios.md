---
title: Сведения о приложении для FinTech Studio от FinTech Studio
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Вся доступная информация о безопасности и соответствии для FinTech Studio, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Просмотр в Teams хранилище</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые FinTech Studio корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | FinTech Studios |
| Идентификатор | WA200003969 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Название партнерской компании | FinTech Studios |
| Веб-сайт компании | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| Условия использования приложения | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| Основные функциональные возможности приложения | Бизнес-аналитика на основе ИИ |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
Эта информация была предоставлена FinTech Studio о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, имена и идентификаторы групп, имена и идентификаторы каналов (без данных сообщений), имена и идентификаторы чата (без данных сообщения) |
...
| Какие данные хранятся в базах данных? | Данные профиля пользователя (имя, электронная почта, microsoft Graph доступ + маркеры обновления) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Делегированные | Запрос на предоставление пользователю каналов общего доступа к содержимому из модуля задачи в приложении | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | Делегированные | Отправка общего содержимого в каналы из модуля задачи в приложении | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | Делегированные | Запрос на предоставление пользователю чатов общего доступа к содержимому из модуля задач в приложении | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | Делегированные | Отправка общего содержимого в чаты из модуля задач в приложении | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | Делегированные | Чтобы пользователи могли получить доступ к каналам, доступным для пользователя, необходимо получить доступ к командам. | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | Делегированные | Получение идентификационных и информационных сведений о пользователе | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
