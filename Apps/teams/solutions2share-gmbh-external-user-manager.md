---
title: Сведения о приложениях для внешнего менеджера пользователей от Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для внешнего диспетчера пользователей, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64463978"
---
# <a name="external-user-manager"></a>Внешний менеджер пользователей

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 24 марта 2022 г.</p>

* <a href="https://teams.microsoft.com/l/app/e41aa305-2f95-4a15-a2b7-026338541850" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003014" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Внешний менеджер пользователей |
| Идентификатор | WA200003014 |
...
| Основные функции приложения | Управление внешними пользователями в Microsoft Teams |
| Расположение штаб-квартиры компании | Германия |
| Страница информация о приложении | [https://www.solutions2share.com/external-user-manager](https://www.solutions2share.com/external-user-manager) |
...
| Какие данные хранятся в базах данных? | TenantID, имя пользователя, внешняя электронная почта пользователя |
