---
title: 'Сведения о приложениях для 1Page от OAYAW, Inc.'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: 'Все доступные сведения о безопасности и соответствия требованиям для 1Page, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.'
...
<p>Последнее обновление разработчика: 31 декабря 2021 г.</p>

* <a href="https://teams.microsoft.com/l/app/2b876f4d-2e6b-4ee7-9b09-8893808c1380" target="_blank">Просмотр в Teams магазине</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003900" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные корпорацией Майкрософт OAYAW, Inc.

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | 1Page |
| ID | WA200003900 |
| Office 365 поддерживаемые клиенты | Microsoft Teams |
| Имя компании-партнера | OAYAW, Inc. |
| Веб-сайт компании | [https://www.get1page.com](https://www.get1page.com) |
| Условия использования приложения | [https://www.get1page.com/en/terms-of-use](https://www.get1page.com/en/terms-of-use) |
| Основные функции приложения | Надстройка собраний с помощью 1Page сводных &amp; переговоров за несколько минут до каждого собрания |
| Расположение штаб-квартиры компании | США Америки |
| Страница информация о приложении | [https://www.get1page.com](https://www.get1page.com) |
...
Эти сведения предоставлены OAYAW, Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Адрес электронной почты, имя, события календаря |
| Если в процессе infastructure или хранятся данные клиентов Microsoft, где эти данные географически хранятся? | Франция |
...
| URL-адрес политики конфиденциальности | https://www.get1page.com/en/privacy-policy |
...
| Список типов поддерживаемых политик | На основе приложений, подключенных к приложению и приобретенных в приложении элементов, пользователь сможет видеть или не видеть определенные карты. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | делегирована | С информацией о календаре мы сможем предоставить соответствующие данные для отдельных лиц на собрании. | [d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73](../azure/d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73.md) |
