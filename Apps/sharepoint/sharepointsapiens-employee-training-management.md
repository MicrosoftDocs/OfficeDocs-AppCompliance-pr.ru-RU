---
title: Сведения о приложениях для SharePoint|sapiens по управлению обучением сотрудников sharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для управления обучением сотрудников SharePoint|sapiens, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: a38ce28fef94b44898e015f3784e5d0d765c94d6
ms.sourcegitcommit: 7c03de919310456c10f7cc3685f83d40cac504de
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/24/2022
ms.locfileid: "63778429"
---
# <a name="sharepointsapiens-employee-training-management"></a>SharePoint|sapiens управление обучением сотрудников

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 22 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые SharePointSapiens корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | SharePoint-sapiens Управление обучением сотрудников |
| ID | WA104380833 |
| Office 365 поддерживаемые клиенты | SharePoint 2016 или более поздней |
| Имя компании-партнера | SharePointSapiens |
...
| Основные функции приложения | Надстройка для управления обучением сотрудников упрощает организацию и администрирование непрерывного профессионального развития сотрудников. От настройки и планирования учебных мероприятий, управления обучающимися и их назначениями и регистрацией до отслеживания достижений и отзывов — все это покрывается. Надстройка поможет вам выполнить правила и политики безопасности. Это позволяет назначать требуемую подготовку, отслеживать достижения, управлять сроками годности и многое другое. |
| Расположение штаб-квартиры компании | Австрия |
| Страница информация о приложении | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
...
Эти сведения предоставлены SharePointSapiens о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемыми приложением.
...
| Есть ли у вас установленный процесс управления изменениями, используемый для проверки и утверждения запросов на изменения, прежде чем они будут развернуты в производстве? | Нет |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | делегирована | Чтение базовых сведений о пользователях, Exchange бронирование номеров | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
