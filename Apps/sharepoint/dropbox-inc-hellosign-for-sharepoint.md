---
title: Сведения о приложениях для HelloSign для SharePoint по Dropbox Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
| Основные функции приложения | Платформа цифрового рабочего&#8217;HelloSign &#8211; которая включает eSignature, цифровой рабочий процесс и решения электронного факса &#8212; помогает более чем 80 000 клиентов и миллионам людей быстрее вести бизнес. Мы помогаем нашим клиентам быстрее закрывать сделки, с легкостью нанимать новых сотрудников, заполнять документы без ошибок и многое другое. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.hellosign.com/integrations](https://www.hellosign.com/integrations) |
...
Эти сведения предоставлены Dropbox Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | id клиента, id сайта, электронная почта, id диска, id элемента диска |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | приложение | Отправка электронно подписанных файлов обратно в SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | приложение | Отправка электронно подписанных файлов обратно в SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| User.Read | делегирована | Для получения электронной почты пользователя | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
