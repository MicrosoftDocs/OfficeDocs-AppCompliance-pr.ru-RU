---
title: Сведения о приложениях для соединиттеля FormMachines для SharePoint ENTERPRISE DIGITAL MACHINES PTY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
| Веб-сайт компании | [https://www.formmachines.com](https://www.formmachines.com) |
| Условия использования приложения | [https://www.formmachines.com/dist/docs#/statements_and_agre...](https://www.formmachines.com/dist/docs#/statements_and_agreements/terms_of_service) |
| Основные функции приложения | Предоставляет formMachines для Teams возможность чтения и записи в SharePoint списков |
| Расположение штаб-квартиры компании | Австралия |
| Страница информация о приложении | [https://www.formmachines.com](https://www.formmachines.com) |
...
| Какие данные хранятся в базах данных? | Разработанные клиентом шаблоны форм и отправки форм |
...
| URL-адрес политики конфиденциальности | https://www.formmachines.com/dist/docs#/statements_and_agreements/privacy |
