...
description: Вся доступная информация о безопасности и соответствии для Agile Task Board для SharePoint Online, ее политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64753904"
---
# <a name="agile-task-board-for-sharepoint-online"></a>Гибкая доска задач для SharePoint Online

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 8 апреля 2022 г.</p>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Гибкая доска задач для SharePoint Online |
| ID | WA200002087 |
| Office 365 поддерживаемые клиенты | SharePoint 2016 или более поздней версии |
| Название партнерской компании | Agile-IS |
| Веб-сайт компании | [https://www.agile-is.de](https://www.agile-is.de) |
| Условия использования приложения | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| Основные функциональные возможности приложения | Гибкая доска задач помогает вам и вашей команде получить более полное представление о гибком проекте. Преобразуйте физическую плату в цифровую версию. Вы можете сопоставить процесс с такими функциями, как столбцы для отображения состояния, любое количество дорожек, цвет карт на основе метаданных, назначение обязанностей, редактирование перетаскивания и многие другие параметры. Все данные останутся в клиенте M365. |
| Расположение компании | Германия |
| Страница сведений о приложении | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
Эта информация была предоставлена Agile-IS о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемыми приложением.
...
| Какие данные хранятся в базах данных? | Zur Lizenzverwaltung имени участника-пользователя; Unternehmensdaten zur Rechnungslegung |
...
| URL-адрес политики конфиденциальности | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Делегированные | Позволяет приложению запрашивать установленную в данный момент версию приложения. Используется для предоставления нужных ресурсов приложения. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | Делегированные | Чтение членов группы для назначения задачи планировщика  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | Делегированные | Работа с планами и задачами Планировщика   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | Делегированные | Отправка сообщений в действия teams | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | Делегированные | Позволяет приложению запрашивать установленную в данный момент версию приложения. Используется для предоставления нужных ресурсов приложения. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | Делегированные | Позволяет пользователю входить в систему и читать основные сведения о профиле | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | Делегированные | Позволяет пользователю читать основные сведения о профиле других пользователей. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
