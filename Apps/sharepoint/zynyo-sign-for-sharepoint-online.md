---
title: Сведения о приложениях для знака Zynyo для SharePoint Online от Zynyo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для Zynyo Sign для SharePoint Online, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63553258"
---
# <a name="zynyo-sign-for-sharepoint-online"></a>Знак Zynyo для SharePoint Online

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 11 ноября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Zynyo корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Знак Zynyo для SharePoint Online |
| ID | WA200003673 |
| Office 365 поддерживаемые клиенты | SharePoint 2016 или более поздней |
| Имя компании-партнера | Zynyo |
| Веб-сайт компании | [https://zynyo.com](https://zynyo.com) |
| Условия использования приложения | [https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf](https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf) |
| Основные функции приложения | Alle documenten eenvoudig en rechtsgeldig digitaal laten ondertekenen. |
| Расположение штаб-квартиры компании | Нидерланды (the) |
| Страница информация о приложении | [https://zynyo.com/signing-service-diensten/sharepoint/](https://zynyo.com/signing-service-diensten/sharepoint/) |
...
Эта информация была предоставлена Zynyo о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | При отправке пользователем запроса на знак сохраняется выбранный документ и вписаные данные, которые могут включать данные клиента, такие как имя, электронная почта и номер телефона. Эти данные удаляются по истечении срока действия запроса на знак по умолчанию в течение 30 дней. |
...
| URL-адрес политики конфиденциальности | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
