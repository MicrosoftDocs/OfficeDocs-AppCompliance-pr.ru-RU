---
title: Сведения о приложениях для Ichicraft Boards - Ваше цифровое рабочее место по ichicraft b.v.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/25/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для Ichicraft Boards - Ваше цифровое рабочее место, его политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63550297"
---
# <a name="ichicraft-boards---your-digital-workplace"></a>Ichicraft Boards — цифровое рабочее место

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 24 сентября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001990" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные ichicraft b.v. в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Ichicraft Boards — цифровое рабочее место |
| ID | WA200001990 |
| Office 365 поддерживаемые клиенты | SharePoint 2016 или более поздней |
| Имя компании-партнера | ichicraft b.v. |
| Веб-сайт компании | [https://ichicraft.com](https://ichicraft.com) |
| Условия использования приложения | [https://ichicraft.com/terms/](https://ichicraft.com/terms/) |
| Основные функции приложения | Наиболее полное и простое в использовании личное цифровое рабочее место.  |
| Расположение штаб-квартиры компании | Нидерланды (the) |
| Страница информация о приложении | [https://ichicraft.com](https://ichicraft.com) |
...
Эти сведения предоставлены ichicraft b.v. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
...
| URL-адрес политики конфиденциальности | https://ichicraft.com/privacy |
