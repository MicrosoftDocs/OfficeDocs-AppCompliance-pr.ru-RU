---
title: Сведения о приложениях для SharePoint|sapiens от SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для управления событиями SharePoint|sapiens, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 87994af7101b99169226ec3a7cfd2a4f48be5cf6
ms.sourcegitcommit: 7c03de919310456c10f7cc3685f83d40cac504de
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/24/2022
ms.locfileid: "63778439"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens Event Management

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 22 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | SharePoint-sapiens Event Management |
| ID | WA104380834 |
...
| Основные функции приложения | Надстройка Event Management помогает организовывать различные типы событий. События могут быть запланированы в течение нескольких простых действий. Участники могут зарегистрироваться в Интернете одним щелчком мыши. В качестве организатора вы также можете записать внутренних или внешних пользователей от имени или отправить приглашения по электронной почте. Участники получают запросы на собрания и обновления по электронной почте, чтобы убедиться, что у них всегда есть последняя информация в Outlook календаре. Надстройка отслеживает всех участников в одном месте. |
| Расположение штаб-квартиры компании | Австрия |
| Страница информация о приложении | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
