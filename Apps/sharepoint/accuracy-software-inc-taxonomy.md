---
title: Сведения о приложениях для таксономии от Accuracy Software Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/18/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для таксономии, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые корпорацией Майкрософт в корпорации Майкрософт в службе Accuracy Software Inc.:
...
| Имя компании-партнера | Accuracy Software Inc. |
...
| Основные функции приложения | Таксономия предоставляет эффективный способ управления планом классификации файлов, предоставляя возможность совместной работы специалистов по чату с различными заинтересованными сторонами для создания, рассмотрения и публикации плана файлов для всей организации. Кроме того, таксономия позволяет создавать экспорт меток хранения M365, которые можно импортировать в Центр соответствия требованиям Майкрософт, и экспортировать файловый план в формате Term Set, который можно импортировать в SharePoint Term Store. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/](https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/) |
| Какова среда размещения или модель службы, используемая для запуска приложения? | Paas |
| Какие поставщики облачных хостингов используют приложение? | Клиент SharePoint клиента |
...
Эти сведения предоставлены организацией Accuracy Software Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
