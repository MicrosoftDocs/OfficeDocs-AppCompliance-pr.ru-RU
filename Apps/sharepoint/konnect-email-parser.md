---
title: Application Information for Konnect eMail Parser by Konnect eMail
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: Все доступные сведения о безопасности и соответствии для Средства синтаксического анализа электронной почты Konnect, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 3a53a8f22612d4c2df9fa8a0551635344b0827eb
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/15/2022
ms.locfileid: "64877346"
---
# <a name="konnect-email-parser"></a>Средство синтаксического анализа электронной почты Konnect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 1 февраля 2022 г.</p>
...
Сведения, предоставляемые Konnect eMail корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Средство синтаксического анализа электронной почты Konnect |
| Идентификатор | WA200001893 |
| Office 365 поддерживаемые клиенты | SharePoint 2016 или более поздней версии |
| Название партнерской компании | Konnect eMail |
| Веб-сайт компании | [https://www.konnectemail.com](https://www.konnectemail.com) |
| Условия использования приложения | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| Основные функциональные возможности приложения | Автоматически записывает атрибуты электронной почты в виде метаданных. |
| Расположение компании | Австралия |
| Страница сведений о приложении | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
Эта информация была предоставлена Konnect eMail о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные электронной почты пользователя |
