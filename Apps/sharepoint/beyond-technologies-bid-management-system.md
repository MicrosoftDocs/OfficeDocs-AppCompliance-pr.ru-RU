...
description: Все доступные сведения о безопасности и соответствия требованиям для системы управления ставками, политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Какие данные хранятся в базах данных? | Url-адрес веб-SharePoint электронной почты SharePoint пользователя |
