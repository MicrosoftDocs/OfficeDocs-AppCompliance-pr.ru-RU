---
title: Сведения о приложениях для системы управления ставками по beyond technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для системы управления ставками, ее политики обработки данных, Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
---
# <a name="bid-management-system"></a>Система управления ставками

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 16 ноября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией Майкрософт в компании Beyond Technologies:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Система управления ставками |
| ID | WA200001787 |
| Office 365 поддерживаемые клиенты | SharePoint 2013 или более поздней |
| Имя компании-партнера | Помимо технологий |
| Веб-сайт компании | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| Условия использования приложения | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| Основные функции приложения | Программное обеспечение SharePoint управления предложениями и программным обеспечением для оцифровки действий по ставкам. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
...
Эти сведения предоставлены beyond Technologies о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | URL-адрес SharePoint электронной почты и веб-сайта |
...
| URL-адрес политики конфиденциальности | https://www.beyondintranet.com/privacypolicy |
