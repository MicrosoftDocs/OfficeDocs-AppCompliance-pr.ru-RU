...
---
# <a name="iglobe-crm-office-365-for-microsoft-office-365"></a>iGlobe CRM Office 365 для Microsoft Office 365
...
* <a href="https://appsource.microsoft.com/product/office/WA104379222" target="_blank">Посмотреть в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | iGlobe CRM Office 365 для Microsoft Office 365 |
| ID | WA104379222 |
| Office 365 клиенты поддержали | SharePoint 2013 г. или позже |
...
| URL условий использования | [https://www.iglobecrm.com/content/iglobe-crm-office-365-end...](https://www.iglobecrm.com/content/iglobe-crm-office-365-end-user-license-agreement) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.ReadWrite | Делегированные | Данные не хранятся в базах данных приложений. | Иметь доступ к календарям пользователей при дремации отчета о собрании от canlendar до iGlobe | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
...
>| Directory.Read.All | Делегированные | Данные не хранятся в базах данных приложений. | Проверьте наличие разрешения и получите сайты и списки. Создавайте папки, получьте файлы и сохраните файлы. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
...
>| Files.ReadWrite.All | Делегированные | Данные не хранятся в базах данных приложений. | Читайте, обновляйте, создавайте задачи Panner, читайте последние и общие файлы пользователей, чтобы получить SharePoint список, библиотеки и файлы. Сохранение файлов и данных для SharePoint списков. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Group.Read.All | Делегированные | Данные не хранятся в базах данных приложений. | Читайте, обновляйте, создавайте задачи Panner, читайте последние и общие файлы пользователей, чтобы получить SharePoint список, библиотеки и файлы. Сохранить файлы для SharePoint списков. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
...
>| Mail.ReadWrite | Делегированные | Данные не хранятся в базах данных приложений. | Svae eamil для iGlobe CRM и получить informatiopn от iGlobe к новому e-amil | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Manage.All | Делегированные | Данные не хранятся в базах данных приложений. | Создание, редактирование и удаление элементов и списков в iGlobe CRM | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Read.All | Делегированные | Данные не хранятся в базах данных приложений. | Читать элементы в iGlobe CRM | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.ReadWrite.All | Делегированные | Данные не хранятся в базах данных приложений. |  Редактировать и удалять элементы и списки в iGlobe CRM | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
...
>| User.Read | Делегированные | Данные не хранятся в базах данных приложений. | Чтобы получить информацию о iGlobe CRM для пользователя speficic | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
...
>| SharePoint - Сайты.Управление.Все | Нет |  |  |  |  |
>| SharePoint - Сайты.Читайте.Все | Нет |  |  |  |  |
>| SharePoint - Сайты.ReadWrite.All | Нет |  |  |  |  |
>| SharePoint - Сайты.Поиск.Все | Нет |  |  |  |  |
...
<iframe height='1020' title='Microsoft Cloud App Security информация' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36163' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36163" target="_blank">Просмотр в новой вкладке</a>
