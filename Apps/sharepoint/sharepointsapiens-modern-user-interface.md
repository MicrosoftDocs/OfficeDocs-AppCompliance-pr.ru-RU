---
title: Сведения о приложениях для SharePoint|sapiens современный пользовательский интерфейс sharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для SharePoint|sapiens Современный пользовательский интерфейс, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: fce68f53a63ea290b95e1826fd1d9e8e6d8a9daf
ms.sourcegitcommit: 021c258a4aad74b2525c08b60926fbbcd421f0c0
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/01/2022
ms.locfileid: "64602670"
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint|sapiens Современный пользовательский интерфейс

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 30 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Просмотр в AppSource</a>
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | SharePoint-sapiens Современный пользовательский интерфейс |
| ID | WA200003529 |
...
| Основные функции приложения | Это приложение необходимо использовать совместно с нашим SharePoint|приложение sapiens Event Management (WA104380834) или SharePoint|приложение sapiens Для управления обучением сотрудников (WA104380833).  Это приложение предоставляет интуитивно понятный пользовательский интерфейс, который позволяет создавать и управлять событиями, темами, курсами и учебными программами в SharePoint, зарегистрировать пользователей или разрешить им самостоятельно зарегистрироваться и отслеживать всех участников, назначения и достижения. |
