---
title: Сведения о приложении для наложения календаря от Cloudwell
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: Все доступные сведения о безопасности и соответствии для наложения календаря, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
...
| Название партнерской компании | Cloudwell |
...
| Основные функциональные возможности приложения | Веб-часть "Наложение календаря" позволяет просматривать все события Microsoft SharePoint, Планировщика и Exchange в одном месте! |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://cloudwell.io/products/calendar-overlay](https://cloudwell.io/products/calendar-overlay) |
...
Эти сведения были предоставлены Cloudwell о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Адрес электронной почты пользователя, идентификатор клиента пользователя |
...
| Какие данные хранятся в базах данных? | Адрес электронной почты пользователя, идентификатор клиента пользователя |
