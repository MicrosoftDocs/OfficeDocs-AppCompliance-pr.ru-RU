---
title: Сведения о приложениях для RocketDocs LaunchPad от RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Все доступные сведения о безопасности и соответствия требованиям для RocketDocs LaunchPad, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: c7d2322c648d2bdc1f384a9a95f84b5bb32d0510
ms.sourcegitcommit: b7ef94cf5fb12f6730a8688834ceee4f8fe8e0da
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/25/2022
ms.locfileid: "64463946"
---
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | RocketDocs LaunchPad |
| Идентификатор | WA200003648 |
| Office 365 поддерживаемые клиенты | Excel 2016 или позже на Mac, Excel 2016 или более поздней Windows, Excel в Интернете, Word 2016 или позднее на Mac, Word в Интернете, Word 2016 или более поздней Windows |
| Имя компании-партнера | RocketDocs |
...
| Основные функции приложения | Позволяет пользователям находить контент на платформе RocketDocs и вставлять его в документ. |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
Эта информация была предоставлена RocketDocs о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
