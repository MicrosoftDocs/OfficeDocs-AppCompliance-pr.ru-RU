---
title: Информация о применении для графиков быстрых телефонов cc-1C
ms.author: elmalova
author: elenamalova
ms.date: 01/05/2021
ms.topic: article
...
description: Вся доступная информация о безопасности и соответствии требованиям для графиков быстрых приложений, политики обработки данных, информации каталога Microsoft Cloud App Security приложений и информации о безопасности/соответствии требованиям в реестре CSA STAR.
...
---
# <a name="quickcells-graphs"></a>Графики быстрых селлей

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчиком на: Январь 5, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001574" target="_blank">Посмотреть в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Информация, предоставленная CC-1C корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Графики быстрых селлей |
| ID | WA200001574 |
| Office 365 клиенты поддержали | Excel 2016 или позже на Mac, Excel 2016 или позже Windows, Excel в Интернете |
| Название компании-партнера | CC-1C |
...
| URL политики конфиденциальности | [https://quickcells.co/legal/privacy](https://quickcells.co/legal/privacy) |
| URL условий использования | [https://quickcells.co/legal/tos](https://quickcells.co/legal/tos) |
...
Эта информация была предоставлена CC-1C о том, как это приложение собирает и хранит организационные данные и контроль, который ваша организация будет иметь над данными, которые приложение собирает.
...
<iframe height='1020' title='Microsoft Cloud App Security информация' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36363' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36363" target="_blank">Просмотр в новой вкладке</a>
...
Эта информация была предоставлена CC-1C о том, как это приложение обрабатывает аутентификацию, авторизацию, лучшие практики регистрации приложений и другие критерии идентификации.
...
| Запрашивает ли приложение наименьшее разрешение на привилегии для вашего сценария? | Нет |
