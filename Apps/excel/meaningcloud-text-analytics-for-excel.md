---
title: Сведения о приложениях для text Analytics MeaningCloud для Excel в MeaningCloud
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для MeaningCloud Text Analytics для Excel, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Веб-сайт компании | [https://meaningcloud.com](https://meaningcloud.com) |
| Условия использования приложения | [https://www.meaningcloud.com/terms-and-conditions](https://www.meaningcloud.com/terms-and-conditions) |
| Основные функции приложения | Выполните анализ текста непосредственно в Excel таблице |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://www.meaningcloud.com/developer/excel-365-addin](https://www.meaningcloud.com/developer/excel-365-addin) |
...
| URL-адрес политики конфиденциальности | https://www.meaningcloud.com/data-protection-policy |
