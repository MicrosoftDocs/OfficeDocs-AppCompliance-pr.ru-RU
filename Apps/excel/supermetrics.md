---
title: Сведения о приложениях для supermetrics by Supermetrics
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/22/2021
...
description: Все доступные сведения о безопасности и соответствия требованиям для Supermetrics, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые службой Supermetrics Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Supermetrics |
| ID | WA104381807 |
| Office 365 поддерживаемые клиенты | Excel 2016 или более поздней Windows, Excel 2016 или позднее на Mac, Excel в Интернете |
| Имя компании-партнера | Supermetrics |
| Веб-сайт компании | [https://supermetrics.com](https://supermetrics.com) |
| Условия использования приложения | [https://supermetrics.com/terms-of-service](https://supermetrics.com/terms-of-service) |
| Основные функции приложения | С помощью Supermetrics предприятия могут агрегировать данные с помощью 70+ маркетинговых и торговых платформ, таких как Facebook Ads, Google Analytics, Instagram и других, а также передавать данные непосредственно в Excel для целей отчетности. Это позволяет: — автоматизировать задачи по импорту данных вручную; - Используйте формулы и инструменты, которые уже доступны в Excel для анализа и визуализации маркетинговых данных; - Получите обывальную картину, просмотрев несколько источников данных непосредственно в Excel. |
| Расположение штаб-квартиры компании | Финляндия |
| Страница информация о приложении | [https://supermetrics.com/product/excel](https://supermetrics.com/product/excel) |
| Какова среда размещения или модель службы, используемая для запуска приложения? | Iaas |
| Какие поставщики облачных хостингов используют приложение? | GCP, Aws |
...
Эта информация была предоставлена supermetrics о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Имя, адрес электронной почты, контактные данные |
...
| Самая недавняя дата сертификации SOC1 |  2020-12-15 |
...
| Самая недавняя дата сертификации SOC2 |  2021-07-07 |
...
| URL-адрес политики конфиденциальности | https://supermetrics.com/privacy-policy |
