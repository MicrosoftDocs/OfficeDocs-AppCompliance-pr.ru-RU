...
description: Все доступные сведения о безопасности и соответствия требованиям для Supermetrics, политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | С помощью Supermetrics предприятия могут агрегировать данные с помощью 70+ маркетинговых и торговых платформ, таких как Facebook Ads, Google Analytics, Instagram и других, а также передавать данные непосредственно в Excel для целей отчетности. Это позволяет: — автоматизировать задачи по импорту данных вручную; - Используйте формулы и средства, которые уже доступны в Excel, чтобы анализировать и визуализировать маркетинговые данные; - Получить обывную картину, просмотрев несколько источников данных непосредственно в Excel. |
