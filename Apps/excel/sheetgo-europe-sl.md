...
| Основные функции приложения | Sheetgo — это платформа автоматизации рабочего процесса, которая позволяет пользователям подключать электронные таблицы и создавать автоматизированные системы управления данными. Веб-приложение Sheetgo предоставляет платформу для создания и управления рабочими процессами вместе с рядом шаблонов. Надстройка Sheetgo для Excel и надстройка для листов Google позволяет пользователям подключаться и автоматизировать непосредственно внутри электронной таблицы, а приложение Teams позволяет создателям рабочего процесса делиться связанными файлами с коллегами в каналах и групповых чатах. |
| Расположение штаб-квартиры компании | Испания |
| Страница информация о приложении | [https://www.sheetgo.com](https://www.sheetgo.com) |
...
| Какие данные хранятся в базах данных? | Метаданные таблиц, такие как размер файла, владелец таблицы, пользователи электронных таблиц, дата последнего изменения, имя файла и т. д. МЫ НЕ ХРАНИМ ДАННЫЕ ЭЛЕКТРОННЫХ ТАБЛИЦ |
