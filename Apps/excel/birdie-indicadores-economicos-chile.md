---
title: Сведения о приложении для Indicadores Economicos в Бразилии от Берди
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Вся доступная информация о безопасности и соответствии для Indicadores Economicos в Чили, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: ff0a0dfed681e57b85240b31c2cb9f414223f980
ms.sourcegitcommit: 9cbff2dbc9762426293b9b094a29e3d2bebc760b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/01/2022
ms.locfileid: "65818518"
---
# <a name="indicadores-economicos-chile"></a>Indicadores Economicos, Чили

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 30 мая 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые пользователем Birdie в корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Indicadores Economicos, Чили |
| ID | WA104381100 |
| Office 365 поддерживаемые клиенты | Excel 2013 с пакетом обновления 1 (SP1) Windows, Excel в Интернете, Excel 2016 или более поздней версии на Компьютере Mac |
| Название партнерской компании | Птичка |
| Веб-сайт компании | [https://www.birdie.cl](https://www.birdie.cl) |
| Условия использования приложения | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| Основные функциональные возможности приложения | Obt&#233;n el valor de la Unidad de Fomento (UF), Euro, D&#243;lar y UTM de Chile de manera sencilla |
| Расположение компании | Чили |
...
Эта информация была предоставлена Пользователем Birdie о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
