---
title: Сведения о приложениях для редактора PDF Foxit для Microsoft Word, Excel и PowerPoint foxit Software Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для редактора PDF Foxit для Microsoft Word, Excel и PowerPoint, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64602637"
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>Редактор PDF Foxit для Microsoft Word, Excel и PowerPoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 17 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003206" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные Корпорацией Майкрософт по программному обеспечению Foxit:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Редактор PDF Foxit для Microsoft Word, Excel и PowerPoint |
| ID | WA200003206 |
| Office 365 поддерживаемые клиенты | Excel 2016 или позднее на Mac, Excel 2013 или более поздней Windows, Excel в Интернете, Word 2016 или более поздней основе на Mac, Word в Интернете, Word 2013 или более поздней Windows, PowerPoint 2016 или позже на Mac, PowerPoint в Интернете, PowerPoint 2013 или более поздней Windows |
| Имя компании-партнера | Foxit Software Inc. |
...
| Основные функции приложения | С помощью редактора PDF Foxit для Microsoft Teams можно сделать больше с документами, не выходя из Microsoft Teams: 1.Secure совместной совместной работы и совместной работы со всеми в вашем канале, а также хранимые документы в Microsoft SharePoint или один диск&#65307; 2.High quality viewing-With high quality viewing PDF безопасно и легко в Microsoft Teams&#65307; 3.Annotate PDF-Provide к документам с помощью текстовой разметки и аннотации инструментов PDF; |
...
Эти сведения предоставлены foxit Software Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Электронная почта, имя пользователя, пользовательский ID |
...
| Самая недавняя дата сертификации SOC2 |  2021/06/15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | делегирована | Чтение документов пользователей и сохранение документов. | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
