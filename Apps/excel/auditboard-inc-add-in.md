---
title: Сведения о приложении для надстройки AuditBoard от Auditboard, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
Сведения, предоставляемые Auditboard, Inc. корпорации Майкрософт:
...
| Основные функциональные возможности приложения | Позволяет подписчикам AuditBoard внедрять данные ссылок &amp; на сайт AB при редактировании описаний AB.  |
...
Эта информация была предоставлена Auditboard, Inc. о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Дата последней сертификации SOC2 | 2020-12-01 |
