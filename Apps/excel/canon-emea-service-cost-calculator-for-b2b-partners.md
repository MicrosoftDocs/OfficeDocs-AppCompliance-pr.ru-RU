---
title: Application Information for Canon EMEA Service Cost Calculator for B2B Partners by Canon EMEA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Все доступные сведения о безопасности и соответствии требованиям для Canon EMEA Service Cost Calculator для партнеров B2B, политики обработки данных, сведения о каталоге приложений Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "64879886"
---
# <a name="canon-emea-service-cost-calculator-for-b2b-partners"></a>Калькулятор затрат на службу Canon EMEA для партнеров B2B
...
Сведения, предоставляемые Canon EMEA корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Калькулятор затрат на службу Canon EMEA для партнеров B2B |
| Идентификатор | WA200003098 |
| Office 365 поддерживаемые клиенты | Excel 2016 mac, Excel 2013 или более поздней версии Windows, Excel в Интернете |
| Название партнерской компании | Canon EMEA |
| Веб-сайт компании | [https://www.canon-europe.com](https://www.canon-europe.com) |
| Условия использования приложения | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| Основные функциональные возможности приложения | Точное, прозрачное и продуктивное вычисление затрат на обслуживание принтеров Canon (B2B) |
...
Эта информация была предоставлена Canon EMEA о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
