---
title: Application Information for XBRL Filed Data by XBRL US
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Все доступные сведения о безопасности и соответствии для XBRL-данных, их политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 5eaba1b38f50fbeea0de4bf869139a810d758210
...
Сведения, предоставляемые XBRL US в корпорацию Майкрософт:
...
| Название партнерской компании | XBRL US |
| Веб-сайт компании | [https://xbrl.us](https://xbrl.us) |
| Условия использования приложения | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Основные функциональные возможности приложения | XBRL US — это некоммерческий консорциум, создающий и поддерживающий бесплатные, открытые, непроприетарные стандарты бизнес-отчетности в США. XBRL США является руководством по разработке и реализации стандартов данных для государственных учреждений — Комиссии по ценным бумагам и Exchange (SEC), Федеральной комиссии по энергопотреблу (FERC) и министерства энергии. XBRL в США отслеживает данные и помогает создавать стандарты качества данных, используемые SEC, чтобы помочь общедоступным компаниям создавать качественные финансовые отчеты XBRL.  |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Какая среда размещения или модель службы используются для запуска приложения? |  |
| Какие поставщики облачных служб используются приложением? | GitHub |
...
Эта информация была предоставлена XBRL США о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
