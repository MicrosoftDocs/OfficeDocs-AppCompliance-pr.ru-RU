...
description: Все доступные сведения о безопасности и соответствии требованиям для XBRL Filed Data, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | XBRL US — это некоммерческий консорциум, который строит и поддерживает бесплатные, открытые, непрофессиональные стандарты бизнес-отчетности в США XBRL US, который руководил разработкой и внедрением стандартов данных для государственных учреждений — Комиссии по ценным бумагам и Exchange (SEC), Федеральной комиссии по регулированию энергетики (FERC) и Министерства энергетики. XBRL US отслеживает данные и помогает создавать стандарты качества данных, используемые SEC, чтобы помочь публичным компаниям создавать финансовые отчеты XBRL хорошего качества.  |
| Расположение штаб-квартиры компании | Соединенные Штаты Америки |
| Страница информация о приложении | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Какова среда размещения или модель службы, используемая для запуска приложения? |  |
| Какие поставщики облачных хостингов используют приложение? | GitHub |
