---
title: Excel сведений о приложении для officeatwork | Выбор изображений для Office officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Excel корпорацией Майкрософт на соответствие отраслевым стандартам и средствам контроля в отношении безопасности, соответствия требованиям и методов обработки данных. На этой странице отображаются доступные сведения о безопасности и соответствии требованиям для officeatwork | Выбор образа для Office, его политик обработки данных, его Microsoft Cloud App Security сведений о каталоге приложений, а также сведений о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: de7d2fadf857b210cd12e2529f96e2bfa4807e5d
ms.sourcegitcommit: ec1d4f7013722fe672830e3664b0fb8b0f33bd37
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/12/2022
ms.locfileid: "64784383"
---
# <a name="excel-information-for-officeatwork--image-chooser-for-office"></a>Excel сведения о officeatwork | Выбор изображений для Office
