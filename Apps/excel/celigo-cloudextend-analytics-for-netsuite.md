...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | оба | Ознакомьтесь с коллекцией сайтов, для которых пользователь имеет доступ, чтобы получить доступ к данным книги, совместной с помощью сайтов | [7040f194-bf08-400e-acb1-69df7939416a](https://docs.microsoft.com/microsoft-365-app-certification/azure/7040f194-bf08-400e-acb1-69df7939416a) |
>| Files.ReadWrite.All | оба | Чтение содержимого книги, как таблицы и листы, и возможность записи контента в эти таблицы | [7040f194-bf08-400e-acb1-69df7939416a](https://docs.microsoft.com/microsoft-365-app-certification/azure/7040f194-bf08-400e-acb1-69df7939416a) |
