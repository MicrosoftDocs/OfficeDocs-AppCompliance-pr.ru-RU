...
description: Все доступные сведения о безопасности и соответствия требованиям для CloudExtend Analytics для NetSuite, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Основные функции приложения | Для пользователей NetSuite CloudExtend Analytics для NetSuite (CEAN) визуализирует данные, чтобы предоставить все сведения, необходимые для принятия правильного бизнес-решения в нужное время. CEAN — это средство, которое предоставляет все необходимые средства, обеспечивающие гибкость для настройки и управления данными для получения информации о данных NetSuite. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | оба | Ознакомьтесь с коллекцией сайтов, для которых пользователь имеет доступ, чтобы получить доступ к данным книги, совместной с помощью сайтов | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Files.ReadWrite.All | оба | Чтение содержимого книги, как таблицы и листы, и возможность записи контента в эти таблицы | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
