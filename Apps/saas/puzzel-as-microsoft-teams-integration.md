---
title: Сведения о приложении для Puzzel Microsoft Teams интеграции от Puzzel AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/09/2022
...
description: Вся доступная информация о безопасности и соответствии для Puzzel Microsoft Teams Integration, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
---
# <a name="puzzel-microsoft-teams-integration"></a>Интеграция Microsoft Teams Puzzel

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчиком: 9 июня 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/web-apps/puzzel-5257631.puzzel_teams_integration" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Puzzel AS корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Интеграция Microsoft Teams Puzzel |
| Идентификатор | puzzel-5257631.puzzel_teams_integration |
| Название партнерской компании | Puzzel AS |
| Веб-сайт компании | [https://www.puzzel.com](https://www.puzzel.com) |
| Условия использования приложения | [https://www.puzzel.com/neighbourhood/trust-centre/privacy-p...](https://www.puzzel.com/neighbourhood/trust-centre/privacy-policy) |
| Основные функциональные возможности приложения | Интеграция Puzzel с Microsoft Teams упрощает совместную работу агентов. Агенты могут Teams, отправлять сообщения, искать и передавать контакты, не выходя из приложения агента Puzzel. Пользователи могут видеть, находятся ли другие агенты в сети, заняты, отсутствуют или в звонках, а также состояние присутствия всех других коллег в своей организации. Агенты могут просматривать&#8217; календари и расписания в Teams для улучшения согласования планов, собраний и звонков. |
| Расположение компании | Норвегия |
| Страница сведений о приложении | [https://www.puzzel.com/microsoft-teams](https://www.puzzel.com/microsoft-teams) |
...
Эти сведения были предоставлены Puzzel AS о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные о присутствии, данные пользователя, данные календаря |
...
| Какие данные хранятся в базах данных? | Данные пользователя, данные календаря |
| Если базовые процессы в структуре или хранят данные клиента Майкрософт, где эти данные хранятся географически? | Норвегия, Соединенное Королевство, Северная Ирландия и Северная Ирландия |
...
| URL-адрес политики конфиденциальности | https://www.puzzel.com/neighbourhood/trust-centre |
