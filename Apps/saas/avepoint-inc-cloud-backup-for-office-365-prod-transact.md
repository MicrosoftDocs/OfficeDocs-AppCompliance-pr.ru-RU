---
title: Сведения о приложениях для облачного резервного копирования для Office 365 - Prod (transact) AvePoint Inc.
ms.author: elmalova
author: elenamalova
ms.date: 10/27/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для облачного резервного копирования для Office 365 - Prod (transact), политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "60875086"
---
# <a name="cloud-backup-for-office-365---prod-transact"></a>Облачное резервное копирование для Office 365 - Prod (transact)
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Облачное резервное копирование для Office 365 - Prod (transact) |
...
>| Directory.Read.All | приложение | Чтение данных каталога |
>| Files.Read.All | приложение | Чтение файлов во всех семействах веб-сайтов |
>| Group.ReadWrite.All | приложение | Чтение и запись всех групп |
>| Sites.ReadWrite.All | приложение | Чтение и запись элементов во всех семействах веб-сайтов |
>| Reports.Read.All | приложение | Чтение всех отчетов об использовании |
>| ChannelMember.ReadWrite.All | приложение | Добавление и удаление участников из всех каналов |
>| ChannelMessage.Read.All | приложение | Чтение всех сообщений в каналах |
>| ChannelSettings.ReadWrite.All | приложение | Чтение и написание имен, описаний и параметров всех каналов |
