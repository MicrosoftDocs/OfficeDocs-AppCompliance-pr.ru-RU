---
title: Сведения о приложении для storm Cloud Contact Center Teams Integration by Content Guru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для storm Cloud Contact Center Teams Integration, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: f85b35bd34b1a8d103c53a69f8bcf93566714ec1
ms.sourcegitcommit: ac75dd8bb815bc9e8b1d5b39a2d2dbe46e65f680
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/15/2022
ms.locfileid: "66806330"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>Интеграция Teams в Storm Cloud Contact Center

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 10 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые content Guru корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Интеграция Teams в Storm Cloud Contact Center |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Название партнерской компании | Content Guru |
| Веб-сайт компании | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| Условия использования приложения | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| Основные функциональные возможности приложения | Интеграция Storm Cloud Contact Center с Microsoft Teams для единого решения CCaaS. |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
Эта информация была предоставлена в content Овна о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Us User Reference (EUII), MS Organization Reference (OII), Call details and User Profile Data (EUII) |
...
| Дата последней сертификации SOC2 | 2020-12-31 |
...
| URL-адрес политики конфиденциальности | https://www.contentguru.com/about-us/privacy-cookies-policy/ |
