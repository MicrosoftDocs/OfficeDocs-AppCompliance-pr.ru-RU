---
title: Сведения о приложениях для центра контактов storm Cloud Teams интеграции гуру контента
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Вся доступная информация о безопасности и соответствии требованиям для центра облачных контактов Teams интеграции, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63551698"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>Центр контактов storm Cloud Teams интеграции
...
Сведения, предоставляемые гуру контента в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Центр контактов storm Cloud Teams интеграции |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Имя компании-партнера | Гуру контента |
...
| Основные функции приложения | Интеграция облачного центра контактов с Microsoft Teams для единого решения CCaaS. |
| Расположение штаб-квартиры компании | Соединенное Королевство Великобритании и Северной Ирландии (the) |
| Страница информация о приложении | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
Эти сведения предоставлены гуру контента о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
