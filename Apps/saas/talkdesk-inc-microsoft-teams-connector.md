...
Сведения, предоставленные Корпорацией Майкрософт в Talkdesk, Inc.
...
| Основные функции приложения | Microsoft Teams в Talkdesk, которая включает каталог и прямую маршрутику |
...
Эти сведения предоставлены в Talkdesk, Inc. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет управлять данными, собираемой приложением.
...
| Самая недавняя дата сертификации SOC2 |  2021-02-22 |
| Соответствует ли приложение средствам управления службами (SOC 3)? | Да |
| Самая недавняя дата сертификации SOC3 |  2021-02-22 |
