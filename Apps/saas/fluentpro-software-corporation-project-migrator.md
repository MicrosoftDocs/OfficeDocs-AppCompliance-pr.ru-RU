---
title: Application Information for Project Migrator by FluentPro Software Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Все доступные сведения о безопасности и соответствии для Project Migrator, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/fluentpro-4571949.project_migrator" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые корпорацией FluentPro Software Corporation корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Project Migrator |
| ID | fluentpro-4571949.project_migrator |
| Название партнерской компании | FluentPro Software Corporation |
| Веб-сайт компании | [https://fluentpro.com](https://fluentpro.com) |
| Условия использования приложения | [https://projectmigrator.com/terms-of-use/](https://projectmigrator.com/terms-of-use/) |
| Основные функциональные возможности приложения | Перенос проектов между наиболее популярным программным обеспечением для управления проектами. |
| Расположение компании | США Америки |
| Страница сведений о приложении | [https://projectmigrator.com](https://projectmigrator.com) |
...
Корпорация FluentPro Software corporation предоставила эти сведения о том, как это приложение собирает и хранит данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Данные профиля пользователя, данные группы MS365 Project для веб-данных. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Делегированные | Чтение и запись данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Group.ReadWrite.All | Делегированные | Чтение и запись данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Sites.ReadWrite.All | Делегированные | Чтение и запись данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | Делегированные | Чтение и запись данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.ReadBasic.All | Делегированные | Чтение и запись данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| offline_access | Делегированные | Перезапуск неудачных миграций данных Планировщика | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | Делегированные | Вход пользователя | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| email | Делегированные | Чтение почтового ящика пользователя | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| openid | Делегированные | Вход пользователя | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| profile | Делегированные | Вход пользователя | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| Directory.Read.All | Делегированные | Чтение и запись Project для веб-данных | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.Read.All | Делегированные | Чтение и запись Project для веб-данных | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.ReadWrite.All | Делегированные | Чтение и запись Project для веб-данных | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.Read | Делегированные | Чтение и запись Project для веб-данных | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.ReadBasic.All | Делегированные | Чтение и запись Project для веб-данных | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
