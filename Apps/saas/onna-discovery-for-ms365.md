---
title: Сведения о приложениях для onna Discovery для MS365 onna
ms.author: elmalova
author: elenamalova
ms.date: 11/22/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для Onna Discovery для MS365, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "61146842"
---
# <a name="onna-discovery-for-ms365"></a>Обнаружение Onna для MS365

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 2 ноября 2021 г.</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Onna Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Обнаружение Onna для MS365 |
| Идентификатор | onna1600902517721.onna-discovery-1 |
| Имя компании-партнера | Onna |
| Веб-сайт компании | [https://onna.com](https://onna.com) |
| Условия использования приложения | [https://onna.com/master-subscription-agreement](https://onna.com/master-subscription-agreement) |
| Основные функции приложения | Onna предоставляет допустимый сбор данных, поиск и ранняя оценка Microsoft 365 |
...
Эта информация была предоставлена Onna о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Сообщения электронной почты, адреса электронной почты, пользовательские ids, чаты, файлы. Политики хранения и удаления настраиваются конечным пользователем.  |
...
| Самая недавняя дата сертификации SOC2 |  2019-06-01 |
...
| URL-адрес политики конфиденциальности | https://onna.com/privacy-policy/ |
