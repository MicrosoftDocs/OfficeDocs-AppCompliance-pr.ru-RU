---
title: Информация о приложениях для широких идей — инновационное программное обеспечение с помощью широких идей/Idea2Innovation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/08/2021
...
description: Вся доступная информация о безопасности и соответствия требованиям для Wide Ideas - Innovation Software, ее политики обработки данных, сведения о каталоге Microsoft Cloud App Security, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые Корпорацией Майкрософт с помощью Wide Ideas/Idea2Innovation:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Широкие идеи — программное обеспечение для инноваций |
| ID | wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application |
| Имя компании-партнера | Wide Ideas/Idea2Innovation |
| Веб-сайт компании | [https://getwideideas.com](https://getwideideas.com) |
| Условия использования приложения | [https://getwideideas.com/eula](https://getwideideas.com/eula) |
| Основные функции приложения | С помощью программного обеспечения управления инновациями из Wide Ideas, встроенного в Microsoft 365 и Teams, совместное использование проблем, опыта клиентов и идей новых решений становится частью культуры работы сотрудников. |
...
Эти сведения предоставлены в Wide Ideas/Idea2Innovation о том, как это приложение собирает и хранит организационные данные, а также управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Имя пользователя и адрес электронной почты |
| Если в процессе infastructure или хранятся данные клиентов Microsoft, где эти данные географически хранятся? | Швеция |
...
| URL-адрес политики конфиденциальности | https://getwideideas.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | делегирована | позволяет Центру администрирования широких идей создавать канал в любой команде от имени пользователя, заявив о себе.  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| Directory.Read.All | делегирована | позволяет Центру администрирования широких идей читать данные в каталоге&#8217;организации, такие как пользователи, группы и приложения | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| Group.Read.All | делегирована | позволяет центру администрирования Wide Ideas перечислять группы, а также читать их свойства и все члены группы от имени подписанного пользователя. | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| TeamsAppInstallation.ReadWriteForTeam | делегирована | позволяет центру администрирования Wide Ideas читать, устанавливать, обновлять и Teams приложения в командах, к которые пользователь может получить доступ.  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| TeamsTab.Create | делегирована |  позволяет Центру администрирования широких идей создавать вкладки в любой группе Microsoft Teams в Microsoft Teams от имени пользователя, заявив о себе. | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
>| User.Read | делегирована | позволяет пользователям войти в Центр администрирования широких идей и позволяет приложению читать профиль пользователей, входив в нее.  | [0d56e89d-8356-457f-89a2-618386a39eb8](../azure/0d56e89d-8356-457f-89a2-618386a39eb8.md) |
