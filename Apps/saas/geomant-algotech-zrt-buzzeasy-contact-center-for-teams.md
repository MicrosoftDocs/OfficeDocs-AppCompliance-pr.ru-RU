...
<p>Последнее обновление разработчика: 21 октября 2021 г.</p>
...
| Идентификатор | geomant.buzzeasy_teams_contact_center |
...
Эта информация предоставлена Geomant-Algotech Zrt. о том, как это приложение собирает и хранит организационные данные, а также о том, как ваша организация будет иметь контроль над данными, которые собирает приложение.
