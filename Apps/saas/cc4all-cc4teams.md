---
title: Сведения о приложениях для CC4Teams от CC4ALL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/11/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для CC4Teams, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/contactcenter4all1634641680587.cc4all_01" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставленные корпорацией Майкрософт CC4ALL:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | CC4Teams |
| ID | contactcenter4all1634641680587.cc4all_01 |
| Имя компании-партнера | CC4ALL |
| Веб-сайт компании | [https://contactcenter4all.com](https://contactcenter4all.com) |
| Условия использования приложения | [https://contactcenter4all.com/contactcenter4all-saas-agreem...](https://contactcenter4all.com/contactcenter4all-saas-agreement/) |
| Основные функции приложения | CC4Teams добавляет в Teams |
| Расположение штаб-квартиры компании | Нидерланды (the) |
| Страница информация о приложении | [https://contactcenter4all.com/cc4teams/](https://contactcenter4all.com/cc4teams/) |
...
Эти сведения предоставлены CC4ALL о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Имена агентов, адреса электронной почты, активность агентов в центре обработки вызовов |
...
| URL-адрес политики конфиденциальности | https://ss-usa.s3.amazonaws.com/c/308460351/media/12330608ab57a01be064335765158501/CC4ALL%20-%20Data%20Processing%20Agreement%20V1.0.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| CallRecords.Read.All | приложение | для записей | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.AccessMedia.All | приложение | используется для доступа к мультимедиа | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.Initiate.All | приложение | используется для инициировать вызовы в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.InitiateGroupCall.All | приложение | используется для инициировать вызовы в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.JoinGroupCall.All | приложение | используется для инициировать вызовы в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.JoinGroupCallasGuest.All | приложение | используется для инициировать вызовы в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Presence.Read | делегирована | используется для проверки состояния агентов в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Presence.Read.All | делегирована | используется для проверки состояния агентов в контакт-центре | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
