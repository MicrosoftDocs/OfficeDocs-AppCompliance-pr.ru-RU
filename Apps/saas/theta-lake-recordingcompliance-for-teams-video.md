---
title: Сведения о приложении для записи theta Lake Compliance &amp; для Teams видео по Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для theta Lake Recording &amp; Compliance for Teams Video, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложений и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставленные Theta Lake Корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Theta Lake Recording Compliance &amp; for Teams Video |
| Идентификатор | thetalake.thetalake_recording_and_compliance_for_teams |
| Имя компании-партнера | Theta Lake |
...
| Основные функции приложения | Запись, архивация, соответствие требованиям и смягчение рисков для Microsoft Teams аудио- и видеоконференций |
...
Эта информация предоставлена theta Lake о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, собираемой приложением.
...
| Какие данные хранятся в базах данных? | Microsoft Video, Microsoft Teams Чат |
...
| Самая недавняя дата сертификации SOC2 |  2021-08-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | делегирована | Graph API должен быть доступом для получения записи вызова | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
