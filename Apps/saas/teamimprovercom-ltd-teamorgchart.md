---
title: Сведения о приложении для TeamOrgChart от TeamImprover.Com Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Вся доступная информация о безопасности и соответствии для TeamOrgChart, ее политики обработки данных, сведения Microsoft Cloud App Security каталога приложений и сведения о безопасности и соответствии в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 52ca62adc37b77aaaffded584db24366e873a638
ms.sourcegitcommit: aa6c1546afd356990d681ee68ce976cb7faebd02
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/14/2022
ms.locfileid: "64859783"
---
# <a name="teamorgchart"></a>TeamOrgChart

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Последнее обновление разработчика: 21 марта 2022 г.</p>

* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">Просмотр в AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Общие сведения

Сведения, предоставляемые TeamImprover.Com Ltd корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | TeamOrgChart |
| Идентификатор | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| Название партнерской компании | TeamImprover.Com Ltd |
| Веб-сайт компании | [https://teamimprover.com](https://teamimprover.com) |
| Условия использования приложения | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| Основные функциональные возможности приложения | Создание, совместное использование, поиск и печать организационных диаграмм |
| Расположение компании | Соединенное Королевство — Северная Ирландия и Северная Ирландия |
| Страница сведений о приложении | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
Эта информация была предоставлена TeamImprover.Com Ltd о том, как это приложение собирает и сохраняет данные организации, а также контроль над данными, собираемые приложением.
...
| Какие данные обрабатываются приложением? | Сведения об иерархии организации обрабатываются приложением.   |
...
| Какие данные хранятся в базах данных? | TeamOrgChart хранит метаданные, описываемые диаграммой, например имя диаграммы, правила, закладки, количество уровней отображения и т. д. |
...
| URL-адрес политики конфиденциальности | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Делегированные | Приложение создает и отображает организационная диаграмма из Azure AD.  Он должен иметь возможность считывать сведения о пользователе из Azure AD.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | Делегированные | Приложение создает и отображает организационная диаграмма из Azure AD.  Он должен иметь возможность считывать сведения о пользователе из Azure AD.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
