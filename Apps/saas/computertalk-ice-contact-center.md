---
title: Сведения о приложениях для центра контактов ice by ComputerTalk
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: Все доступные сведения о безопасности и соответствии требованиям для центра контактов ice, политики обработки данных, Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63542467"
---
# <a name="ice-contact-center"></a>Центр контактов ice
...
Сведения, предоставляемые ComputerTalk в Корпорацию Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Центр контактов ice |
| ID | computertalk.ice-contact-center |
| Имя компании-партнера | ComputerTalk |
...
| Основные функции приложения | Ice предоставляет контактный центр в качестве функции службы, включая маршрутику вызовов, запись, мониторинг и отчеты. |
| Расположение штаб-квартиры компании | Канада |
| Страница информация о приложении | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
...
Эта информация была предоставлена ComputerTalk о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | AzureADGuid (увязка учетных записей).  Адрес электронной почты и номер телефона можно импортировать из AAD. |
...
| Самая недавняя дата сертификации SOC2 |  2021-10-15 |
