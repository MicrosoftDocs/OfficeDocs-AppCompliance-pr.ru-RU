...
| Основные функции приложения | AvePoint Cloud Backup — это&#8217;наиболее полное решение облачного и облачного резервного копирования для Microsoft 365. С неограниченными автоматическими резервными копиями и безопасным хранилищем в AvePoint&#8217;хранилище Azure или собственном облаке вы просто решите, сколько восстановить и когда. Восстановление на уровне элементов по запросу и детализация предоставляет в любое время доступ к критически важным для бизнеса электронным письмам, файлам, беседам, записям, проектам, задачам, группам, Teams, планировщику и сайтам. |
| Расположение штаб-квартиры компании | США Америки |
| Страница информация о приложении | [https://www.avepoint.com/products/cloud/backup/microsoft-of...](https://www.avepoint.com/products/cloud/backup/microsoft-office-365-backup) |
