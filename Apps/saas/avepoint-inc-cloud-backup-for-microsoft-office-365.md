...
description: Все доступные сведения о безопасности и соответствия требованиям для облачного резервного копирования для Microsoft Office 365, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "63546567"
---
# <a name="cloud-backup-for-microsoft-office-365"></a>Облачное резервное копирование для Microsoft Office 365
...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Облачное резервное копирование для Microsoft Office 365 |
...
| Основные функции приложения | AvePoint Cloud Backup — это&#8217;наиболее полное решение облачного и облачного резервного копирования для Microsoft 365. На
Неограниченное, автоматизированное резервное копирование и безопасное хранилище в AvePoint&#8217;azure или собственном облаке, вы просто решаете, сколько восстановить и когда. Восстановление на уровне элементов по запросу и детализация предоставляет в любое время доступ к критически важным для бизнеса электронным письмам, файлам, беседам, записям, проектам, задачам, группам, Teams, планировщику и сайтам. | | Расположение штаб-квартиры | Соединенные Штаты Америки | | Страница info приложения | [https://www.avepoint.com/products/cloud/backup/microsoft-of...](https://www.avepoint.com/products/cloud/backup/microsoft-office-365-backup) | | Какова среда размещения или модель службы, используемая для запуска приложения? | Paas | | Какие поставщики облачных хостингов используют приложение? | Azure |
...
| Какие данные хранятся в базах данных? | SharePoint сайта/сайта ODFB/Microsoft 365 group/Team id, имя, URL-адрес; |
...
>| ChannelSettings.ReadWrite.All | приложение | Чтение и написание имен, описаний и параметров всех каналов | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
...
>| User.Read | делегирована | Вход и чтение профиля пользователя | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
