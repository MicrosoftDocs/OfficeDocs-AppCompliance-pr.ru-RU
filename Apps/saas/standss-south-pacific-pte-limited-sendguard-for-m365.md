---
title: Сведения о приложениях для SendGuard для M365 по стендам (южная части Тихого океана) PTE Limited
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствия требованиям для SendGuard для M365, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: 410d28bec39a793c16c175a5d011b9bf2f6eba0e
...
---
# <a name="sendguard-for-m365"></a>SendGuard для M365
...
Сведения, предоставляемые службой PTE Limited в Корпорации Майкрософт.
...
Эти сведения предоставлены PTE Limited в standss (south Pacific) о том, как это приложение собирает и хранит организационные данные, а также о том, как организация будет управлять данными, собираемой приложением.
...
| Список типов поддерживаемых политик | Требование многофакторной проверки подлинности для пользователей с административными ролями |
