...
| Основные функции приложения | CodeTwo Email Signatures for Office 365 — это облачная служба на основе Azure, которая добавляет автоматические подписи электронной почты, &amp; юридические отказы и брендинг к сообщениям, отправленным с любого клиентского устройства электронной почты. Это позволяет человеку (администратору или делегированию пользователя) или команде централизованно управлять подписями электронной почты в Microsoft 365 (Office 365). Подписи можно добавлять в облаке (после отправки электронной почты) или непосредственно в Outlook тип пользователя. |
| Расположение штаб-квартиры компании | Польша |
| Страница информация о приложении | [https://www.codetwo.com/email-signatures/](https://www.codetwo.com/email-signatures/) |
...
>| Directory.AccessAsUser.All | делегирована | Предоставляет приложению такой же доступ к информации в каталоге, как у вошедшего пользователя. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| Directory.Read.All | оба | Позволяет приложению читать данные в каталоге&#8217;организации, таких как пользователи, группы и приложения. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| User.ReadBasic.All | делегирована | Позволяет приложению просматривать базовый набор свойств профилей других пользователей организации от имени вошедшего пользователя. Это включает отображение имени, имени и фамилии, адреса электронной почты и фотографии. Сведения используются для автоматической персонализации подписей электронной почты для пользователей. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
...
>| email | делегирована | Позволяет приложению считывать основные электронные адреса пользователей. Используется для регистрации пользователя в службе CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
...
>| profile | делегирована | Позволяет приложению просматривать базовые профили пользователей (имя, аватар, имя пользователя). Используется для регистрации пользователя в службе CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
