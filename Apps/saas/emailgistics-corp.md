---
title: Сведения о приложениях для emailgistics от Emailgistics Corp.
ms.author: elmalova
author: elenamalova
ms.date: 01/21/2022
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствии требованиям для emailgistics, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
Сведения, предоставляемые корпорацией Emailgistics Corp. корпорации Майкрософт:

| **Information** | **Отклик** |
|:----------------|:-------------|
| Название приложения | Emailgistics |
| Идентификатор | emailgistics.emailgistics_shared_email |
| Имя компании-партнера | Emailgistics Corp. |
...
| Основные функции приложения | Программное обеспечение управления электронной почтой для командных почтовых ящиков для Microsoft 365 |
...
Эта информация была предоставлена emailgistics Corp. о том, как это приложение собирает и хранит организационные данные и управление, которое будет иметь ваша организация над данными, которые собирает приложение.
...
| Какие данные хранятся в базах данных? | Данные загонщика почты (субъекты, адреса, периоды времени) |
...
| Имеет ли приложение возможности удалять персональные данные человека по запросу? | Недоступно |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | делегирована | Ознакомьтесь с req'd доступа, чтобы получить сведения о сообщениях в общем почтовом ящике. Сведения о сообщениях необходимы для выполнения правил, определенных клиентами (распространение среди пользователей, если сообщение содержит &#8220;счет&#8221;, например), для правильного отслеживания разговоров (для истории беседы и автоматического назначения) и для отчетов (например, отчета о подробностях открытых сообщений).
Записывайте req'd доступа, чтобы отправлять сообщения из правил (например, автоотдачей) и обновлять темы сообщений с помощью ID беседы emailgistics. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
>| Mail.Send | делегирована | Позволяет emailgistics отправлять сообщения электронной почты из общего почтового ящика. Это разрешение необходимо для отправки сообщений из правил (например, автоотписей). | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
>| MailboxSettings.ReadWrite | делегирована | Позволяет emailgistics получить общее имя почтового ящика и создать правило почтовых ящиков для маршрутов входящих сообщений в свою скрытую папку входящих для начальной обработки, выполнения правил и автоматического назначения. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
>| User.Read | делегирована | Позволяет emailgistics войти в общий почтовый ящик и прочитать основные сведения о нем, такие как его основной ID службы, адрес электронной почты и имя пользователя. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
>| User.ReadBasic.All | делегирована | Позволяет emailgistics читать основные сведения о пользователях в клиенте. Требуется для обнаружения изменений в адресах электронной почты и имен членов почтовых ящиков и автоматического обновления этих сведений, используемых для отслеживания и отчетности, в emailgistics. Это единственное разрешение, область действия которого выходит за пределы общего почтового ящика. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
>| offline_access | делегирована | Позволяет emailgistics работать в качестве приложения-интерфейса, а не интерактивного браузерного приложения, требующего, чтобы пользователь вход в систему, когда он работает. Это разрешение позволяет emailgistics получить маркер обновления, который он может обновить по мере необходимости для поддержания постоянного доступа. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](https://docs.microsoft.com/microsoft-365-app-certification/azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3) |
