...
description: Все доступные сведения о безопасности и соответствии требованиям для emailgistics, политики обработки данных, сведения о каталоге Microsoft Cloud App Security приложения и сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
| Страница информация о приложении | [https://emailgistics.com/how-it-works](https://emailgistics.com/how-it-works) |
...
Записывайте req'd доступа, чтобы отправлять сообщения из правил (например, автоотдачей) и обновлять темы сообщений с помощью ID беседы emailgistics. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| Mail.Send | делегирована | Позволяет emailgistics отправлять сообщения электронной почты из общего почтового ящика. Это разрешение необходимо для отправки сообщений из правил (например, автоотписей). | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| MailboxSettings.ReadWrite | делегирована | Позволяет emailgistics получить общее имя почтового ящика и создать правило почтовых ящиков для маршрутов входящих сообщений в свою скрытую папку входящих для начальной обработки, выполнения правил и автоматического назначения. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.Read | делегирована | Позволяет emailgistics войти в общий почтовый ящик и прочитать основные сведения о нем, такие как его основной ID службы, адрес электронной почты и имя пользователя. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
...
>| offline_access | делегирована | Позволяет emailgistics работать в качестве приложения-интерфейса, а не интерактивного браузерного приложения, требующего, чтобы пользователь вход в систему, когда он работает. Это разрешение позволяет emailgistics получить маркер обновления, который он может обновить по мере необходимости для поддержания постоянного доступа. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
