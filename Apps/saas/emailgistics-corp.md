...
Записывайте req'd доступа, чтобы отправлять сообщения из правил (например, автоотдачей) и обновлять темы сообщений с помощью ID беседы emailgistics. |
>| Mail.Send | делегирована | Позволяет emailgistics отправлять сообщения электронной почты из общего почтового ящика. Это разрешение необходимо для отправки сообщений из правил (например, автоотписей). |
>| MailboxSettings.ReadWrite | делегирована | Позволяет emailgistics получить общее имя почтового ящика и создать правило почтовых ящиков для маршрутов входящих сообщений в свою скрытую папку входящих для начальной обработки, выполнения правил и автоматического назначения. |
>| User.Read | делегирована | Позволяет emailgistics войти в общий почтовый ящик и прочитать основные сведения о нем, такие как его основной ID службы, адрес электронной почты и имя пользователя. |
>| User.ReadBasic.All | делегирована | Позволяет emailgistics читать основные сведения о пользователях в клиенте. Требуется для обнаружения изменений в адресах электронной почты и имен членов почтовых ящиков и автоматического обновления этих сведений, используемых для отслеживания и отчетности, в emailgistics. Это единственное разрешение, область действия которого выходит за пределы общего почтового ящика. |
>| offline_access | делегирована | Позволяет emailgistics работать в качестве приложения-интерфейса, а не интерактивного браузерного приложения, требующего, чтобы пользователь вход в систему, когда он работает. Это разрешение позволяет emailgistics получить маркер обновления, который он может обновить по мере необходимости для поддержания постоянного доступа. |
