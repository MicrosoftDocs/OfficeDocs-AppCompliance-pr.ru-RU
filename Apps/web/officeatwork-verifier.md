...
| **Information** | **Отклик** |
|:----------------|:-------------|
| Имя приложения | Verifier |
| Идентификатор | officeatwork-ag.verifier |
...
>| Files.Read.All | делегирована | Данные не хранятся. | Teams: прочитать все файлы, к которые имеет доступ пользователь с входом. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Sites.Read.All | делегирована | Данные не хранятся. | SharePoint Online: чтобы включить чтение данных из SharePoint Online, пользователь, вписав его, имеет доступ к. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
