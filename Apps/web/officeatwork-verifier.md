---
title: Сведения о приложении для средства проверки
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Все доступные сведения о безопасности и соответствии для средства проверки, его политики обработки данных, сведения Microsoft Cloud App Security каталога приложений, а также сведения о безопасности и соответствии требованиям в реестре CSA STAR.
...
ms.locfileid: "65225295"
---
# <a name="application-information-for-verifier-by-officeatwork"></a>Сведения о приложении для проверки по officeatwork
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.Read | Делегированные | Данные не сохраняются. | OneDrive: чтобы иметь возможность считывать файлы вошедвшего пользователя | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Files.Read.All | Делегированные | Данные не сохраняются. | Teams: чтобы прочитать все файлы, к которые пользователь, вошед в систему, имеет доступ. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Sites.Read.All | Делегированные | Данные не сохраняются. | SharePoint Online: чтобы включить чтение данных из SharePoint Online, пользователь, выполнив вход, имеет доступ. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| User.Read | Делегированные | Данные не сохраняются. | Вход: чтобы приложение officeatwork считывания основных свойств пользователя. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| offline_access | Делегированные | Данные не сохраняются. | Вход: чтобы включить автоматический вход с помощью маркеров обновления, как и без этого, пользователям придется выполнять вход вручную каждый раз при запуске приложения Officeatwork. Эта область требуется только для хост-приложений без единого входа. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| openid | Делегированные | Данные не сохраняются. | Sing-In: чтобы пользователи могли входить в приложение officeatwork с помощью своей организации и (или) учетной записи Майкрософт. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| profile | Делегированные | Данные не сохраняются. | Sing-In: чтобы отобразить вошедвшего пользователя в приложении officeatwork. Это помогает гарантировать или подтвердить пользователю, какая учетная запись использовалась для входа в приложение officeatwork. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
...
<iframe height='1020' title='Microsoft Cloud App Security сведения' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755' frameborder='no'></iframe>
